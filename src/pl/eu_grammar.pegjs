...
// No `b` or `ps151`.
ff
  = val_1:(bcv / bcv_weak / bc / cv / cv_weak / integer / c / v) sp ( "nn" / "n" ) abbrev? ![a-z]
...
/* BCV helpers */
c_explicit
  = sp ( "rozdziały"i / "rozdział"i [óo]i "w" / "rozdział"i / "rozdz" / "rr" / "r" ) sp
    { return {"type": "c_explicit"} }

v_explicit
  = sp ( "werset" [óo]i "w" / "wersety" / "werset" / "wers" / "w" ) ![a-z] sp
