...
// No `b` or `ps151`.
ff
  = val_1:(bcv / bcv_weak / bc / cv / cv_weak / integer / c / v) sp ( "et" space "sequentes" / "et" space "seq" ) abbrev? ![a-z]
    { return {"type": "ff", "value": [val_1], "indices": [offset(), peg$currPos - 1]} }

integer_title
  = val_1:integer (cv_sep / sequence_sep)? "titulus"
...
v_letter
  = v_explicit? val:integer sp !( ( "et" space "sequentes" / "et" space "seq" ) ) [a-e] ![a-z]
