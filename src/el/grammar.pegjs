...
// No `b` or `ps151`.
ff
  = val_1:(bcv / bcv_weak / bc / cv / cv_weak / integer / c / v) sp "και"i space "μετ"i [άα]i abbrev? ![a-z]
    { return {"type": "ff", "value": [val_1], "indices": [offset(), peg$currPos - 1]} }

integer_title
  = val_1:integer (cv_sep / sequence_sep)? ( "ο"i space "τ"i [ίι]i "τλος"i / "ο"i space "τ"i [ίι]i "τλοσ"i / "τ"i [ίι]i "τλος"i / "τ"i [ίι]i "τλοσ"i )
...
/* BCV helpers */
c_explicit
  = sp ( "κεφ"i [άα]i "λαια"i / "κεφ"i [άα]i "λαιον"i / "κεφ"i [άα]i "λαιο"i / "κεφ"i ) sp
    { return {"type": "c_explicit"} }

v_explicit
  = sp ( "στ"i [ίι]i "χος"i / "στ"i [ίι]i "χοι"i / "στ"i [ίι]i "χοσ"i ) ![a-z] sp
