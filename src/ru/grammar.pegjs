...
// No `b` or `ps151`.
ff
  = val_1:(bcv / bcv_weak / bc / cv / cv_weak / integer / c / v) sp "и"i space "далее"i abbrev? ![a-z]
    { return {"type": "ff", "value": [val_1], "indices": [offset(), peg$currPos - 1]} }

integer_title
  = val_1:integer (cv_sep / sequence_sep)? "надписаниях"i
...
/* BCV helpers */
c_explicit
  = sp ( "главы"i / "глав"i / "гл"i abbrev? ) sp
    { return {"type": "c_explicit"} }

v_explicit
  = sp ( "стихи"i / "стих"i ) ![a-z] sp
