...
// No `b` or `ps151`.
ff
  = val_1:(bcv / bcv_weak / bc / cv / cv_weak / integer / c / v) sp ( "ff" / "f" ) abbrev? ![a-z]
    { return {"type": "ff", "value": [val_1], "indices": [offset(), peg$currPos - 1]} }

integer_title
  = val_1:integer (cv_sep / sequence_sep)? "overskrift"
...
/* BCV helpers */
c_explicit
  = sp ( "kapittelet" / "kapittel" / "kapitler" / "kapitlene" / "kapitel" / "kap" ) sp
