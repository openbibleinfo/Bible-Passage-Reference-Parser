...
// No `b` or `ps151`.
ff
  = val_1:(bcv / bcv_weak / bc / cv / cv_weak / integer / c / v) sp "kk" abbrev? ![a-z]
    { return {"type": "ff", "value": [val_1], "indices": [offset(), peg$currPos - 1]} }

integer_title
  = val_1:integer (cv_sep / sequence_sep)? "c" [íi]i "m"
...
/* BCV helpers */
c_explicit
  = sp ( "fejezet" [ée]i "ben" / "fejezet" / "fej" ) sp
    { return {"type": "c_explicit"} }

v_explicit
  = sp ( "versekre" / "versek" / "vers" ) ![a-z] sp
