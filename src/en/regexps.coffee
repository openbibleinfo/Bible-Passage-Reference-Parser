...
bcv_parser::regexps.get_books = (include_apocrypha, case_sensitive) ->
	...
	,
		osis: ["1Kgs"]
		regexp: ///(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])(
		(?:Third[\s\xa0]*Kingdoms|3(?:rd(?:\.[\s\xa0]*Kingdoms|[\s\xa0]*Kingdoms)|\.[\s\xa0]*Kingdoms|[\s\xa0]*Kingdoms)|First[\s\xa0]*K(?:gs?|i(?:gs?|n(?:gs?|s)?)?|n(?:gs?|s)?|s)?|1(?:st(?:\.[\s\xa0]*K(?:gs?|i(?:gs?|n(?:gs?|s)?)?|n(?:gs?|s)?|s)?|[\s\xa0]*K(?:gs?|i(?:gs?|n(?:gs?|s)?)?|n(?:gs?|s)?|s)?)|\.[\s\xa0]*K(?:gs?|i(?:gs?|n(?:gs?|s)?)?|n(?:gs?|s)?|s)?|Kgs|[\s\xa0]*K(?:gs?|i(?:gs?|n(?:gs?|s)?)?|n(?:gs?|s)?|s)?)|I(?:II(?:\.[\s\xa0]*Kingdoms|[\s\xa0]*Kingdoms)|\.[\s\xa0]*K(?:gs?|i(?:gs?|n(?:gs?|s)?)?|n(?:gs?|s)?|s)?|[\s\xa0]*K(?:gs?|i(?:gs?|n(?:gs?|s)?)?|n(?:gs?|s)?|s)?))|K(?:ngs|gs|in(?:gs)?)
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["2Chr"]
		regexp: ///(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])(
	...
	,
		osis: ["Matt"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
		(?:The[\s\xa0]*Gospel[\s\xa0]*(?:according[\s\xa0]*to[\s\xa0]*(?:S(?:aint[\s\xa0]*M(?:at(?:h(?:(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:(?:[ht](?:iew|ew))|iew|ew|we)|iew|t(?:h(?:iew|ew)|iew|ew)|ew|we)?)?|t)|t(?:\.[\s\xa0]*M(?:at(?:h(?:(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:(?:[ht](?:iew|ew))|iew|ew|we)|iew|t(?:h(?:iew|ew)|iew|ew)|ew|we)?)?|t)|[\s\xa0]*M(?:at(?:h(?:(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:(?:[ht](?:iew|ew))|iew|ew|we)|iew|t(?:h(?:iew|ew)|iew|ew)|ew|we)?)?|t)))|M(?:at(?:h(?:(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:(?:[ht](?:iew|ew))|iew|ew|we)|iew|t(?:h(?:iew|ew)|iew|ew)|ew|we)?)?|t))|of[\s\xa0]*(?:S(?:aint[\s\xa0]*M(?:at(?:h(?:(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:(?:[ht](?:iew|ew))|iew|ew|we)|iew|t(?:h(?:iew|ew)|iew|ew)|ew|we)?)?|t)|t(?:\.[\s\xa0]*M(?:at(?:h(?:(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:(?:[ht](?:iew|ew))|iew|ew|we)|iew|t(?:h(?:iew|ew)|iew|ew)|ew|we)?)?|t)|[\s\xa0]*M(?:at(?:h(?:(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:(?:[ht](?:iew|ew))|iew|ew|we)|iew|t(?:h(?:iew|ew)|iew|ew)|ew|we)?)?|t)))|M(?:at(?:h(?:(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:(?:[ht](?:iew|ew))|iew|ew|we)|iew|t(?:h(?:iew|ew)|iew|ew)|ew|we)?)?|t)))|Mtt)|(?:Gospel[\s\xa0]*(?:according[\s\xa0]*to[\s\xa0]*(?:S(?:aint[\s\xa0]*M(?:at(?:h(?:(?:[th](?:iew|(?:[ht](?:iew|ew))|ew))|iew|ew)|t(?:t(?:iew|h(?:iew|ew)|ew)|iew|h(?:(?:[th](?:iew|ew))|iew|we|ew)|ew|we)?)?|t)|t(?:\.[\s\xa0]*M(?:at(?:h(?:iew|(?:[th](?:(?:[th](?:iew|ew))|iew|ew))|ew)|t(?:t(?:iew|h(?:iew|ew)|ew)|iew|h(?:iew|(?:[ht](?:iew|ew))|ew|we)|ew|we)?)?|t)|[\s\xa0]*M(?:at(?:h(?:iew|(?:[ht](?:iew|(?:[ht](?:iew|ew))|ew))|ew)|t(?:t(?:h(?:iew|ew)|iew|ew)|iew|h(?:iew|(?:[ht](?:iew|ew))|we|ew)|ew|we)?)?|t)))|M(?:at(?:h(?:iew|(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|ew)|t(?:iew|t(?:iew|h(?:iew|ew)|ew)|h(?:(?:[th](?:iew|ew))|iew|we|ew)|we|ew)?)?|t))|of[\s\xa0]*(?:S(?:aint[\s\xa0]*M(?:at(?:h(?:(?:[ht](?:iew|(?:[ht](?:iew|ew))|ew))|iew|ew)|t(?:iew|t(?:iew|h(?:iew|ew)|ew)|h(?:iew|(?:[ht](?:iew|ew))|ew|we)|ew|we)?)?|t)|t(?:\.[\s\xa0]*M(?:at(?:h(?:iew|(?:[th](?:(?:[th](?:iew|ew))|iew|ew))|ew)|t(?:iew|h(?:(?:[ht](?:iew|ew))|iew|ew|we)|t(?:h(?:iew|ew)|iew|ew)|we|ew)?)?|t)|[\s\xa0]*M(?:at(?:h(?:iew|(?:[th](?:(?:[ht](?:iew|ew))|iew|ew))|ew)|t(?:t(?:h(?:iew|ew)|iew|ew)|iew|h(?:(?:[th](?:iew|ew))|iew|we|ew)|we|ew)?)?|t)))|M(?:at(?:h(?:(?:[ht](?:(?:[th](?:iew|ew))|iew|ew))|iew|ew)|t(?:iew|h(?:(?:[ht](?:iew|ew))|iew|ew|we)|t(?:iew|h(?:iew|ew)|ew)|ew|we)?)?|t)))|S(?:aint[\s\xa0]*M(?:at(?:h(?:(?:[th](?:(?:[th](?:iew|ew))|iew|ew))|iew|ew)|t(?:t(?:iew|h(?:iew|ew)|ew)|iew|h(?:iew|(?:[ht](?:iew|ew))|ew|we)|we|ew)?)?|t)|t(?:\.[\s\xa0]*M(?:at(?:h(?:(?:[ht](?:iew|(?:[ht](?:iew|ew))|ew))|iew|ew)|t(?:iew|t(?:h(?:iew|ew)|iew|ew)|h(?:(?:[ht](?:iew|ew))|iew|we|ew)|we|ew)?)?|t)|[\s\xa0]*M(?:at(?:h(?:(?:[ht](?:(?:[th](?:iew|ew))|iew|ew))|iew|ew)|t(?:iew|t(?:iew|h(?:iew|ew)|ew)|h(?:(?:[ht](?:iew|ew))|iew|we|ew)|we|ew)?)?|t)))|M(?:at(?:h(?:(?:[th](?:(?:[th](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:iew|(?:[ht](?:iew|ew))|ew|we)|iew|t(?:iew|h(?:iew|ew)|ew)|ew|we)?)?|t))
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["Mark"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
		The[\s\xa0]*Gospel[\s\xa0]*(?:according[\s\xa0]*to[\s\xa0]*(?:S(?:aint[\s\xa0]*M(?:ark?|k|rk?)|t(?:\.[\s\xa0]*M(?:ark?|k|rk?)|[\s\xa0]*M(?:ark?|k|rk?)))|M(?:ark?|k|rk?))|of[\s\xa0]*(?:S(?:aint[\s\xa0]*M(?:ark?|k|rk?)|t(?:\.[\s\xa0]*M(?:ark?|k|rk?)|[\s\xa0]*M(?:ark?|k|rk?)))|M(?:ark?|k|rk?)))|(?:Gospel[\s\xa0]*(?:according[\s\xa0]*to[\s\xa0]*(?:S(?:aint[\s\xa0]*M(?:ark?|rk?|k)|t(?:\.[\s\xa0]*M(?:ark?|k|rk?)|[\s\xa0]*M(?:ark?|rk?|k)))|M(?:ark?|k|rk?))|of[\s\xa0]*(?:S(?:aint[\s\xa0]*M(?:ark?|rk?|k)|t(?:\.[\s\xa0]*M(?:ark?|k|rk?)|[\s\xa0]*M(?:ark?|rk?|k)))|M(?:ark?|rk?|k)))|S(?:aint[\s\xa0]*M(?:ark?|rk?|k)|t(?:\.[\s\xa0]*M(?:ark?|rk?|k)|[\s\xa0]*M(?:ark?|k|rk?)))|M(?:ark?|rk?|k))
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["Luke"]
		regexp: ///(^|#{bcv_parser::regexps.pre_book})(
		The[\s\xa0]*Gospel[\s\xa0]*(?:according[\s\xa0]*to[\s\xa0]*(?:S(?:aint[\s\xa0]*L(?:k|u(?:ke?)?)|t(?:\.[\s\xa0]*L(?:k|u(?:ke?)?)|[\s\xa0]*L(?:k|u(?:ke?)?)))|L(?:k|u(?:ke?)?))|of[\s\xa0]*(?:S(?:aint[\s\xa0]*L(?:k|u(?:ke?)?)|t(?:\.[\s\xa0]*L(?:k|u(?:ke?)?)|[\s\xa0]*L(?:k|u(?:ke?)?)))|L(?:k|u(?:ke?)?)))|(?:Gospel[\s\xa0]*(?:according[\s\xa0]*to[\s\xa0]*(?:S(?:aint[\s\xa0]*L(?:u(?:ke?)?|k)|t(?:\.[\s\xa0]*L(?:u(?:ke?)?|k)|[\s\xa0]*L(?:k|u(?:ke?)?)))|L(?:u(?:ke?)?|k))|of[\s\xa0]*(?:S(?:aint[\s\xa0]*L(?:u(?:ke?)?|k)|t(?:\.[\s\xa0]*L(?:u(?:ke?)?|k)|[\s\xa0]*L(?:k|u(?:ke?)?)))|L(?:k|u(?:ke?)?)))|S(?:aint[\s\xa0]*L(?:k|u(?:ke?)?)|t(?:\.[\s\xa0]*L(?:k|u(?:ke?)?)|[\s\xa0]*L(?:k|u(?:ke?)?)))|L(?:k|u(?:ke?)?))
			)(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]/"'\*=~\-\u2013\u2014])|$)///gi
	,
		osis: ["1John"]
		regexp: ///(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])(
