...
print "Joining...\n";
`/usr/local/bin/coffee -j "../js/${lang}_bcv_parser.js" -c "../src/core/bcv_parser.coffee" "../src/core/bcv_passage.coffee" "../src/core/bcv_utils.coffee" "../src/$lang/translations.coffee" "../src/$lang/regexps.coffee"`;
add_peg('');
add_peg('eu');
print "Compiling spec...\n";
`/usr/local/bin/coffee -c "../src/$lang/spec.coffee"`;
