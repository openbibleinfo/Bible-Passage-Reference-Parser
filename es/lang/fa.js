...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = String.raw`(?:I|یکم|یک|اول|[۱1]|1|Yekom|Yek|Avval)\.?\s*`;
    this.second = String.raw`(?:II|دو|دوم|[۲2]|2|Do|Dovvom)\.?\s*`;
    this.third = String.raw`(?:III|سه|سوم|[۳3]|3|Seh|Sevom)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|(?:،|؛|۔)|تا)`;
    this.range_only = String.raw`(?:[\u2013\u2014-]|تا)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Ruth"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:R(?:oot[eh]|ut[hi])|rūth?ī|R(?:oo|u)t|rūth|ر(?:و(?:(?:ت[تـهی]|[ثط])|ت)|ۆت)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Esd"],
        testament: "a",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:dovvom\s*samu['’]ī|2Samo(?:w(?:ey|i)|ue)|2Samu[ei])l|Do(?:(?:vom(?:\s*[Ss]|s)|s)am(?:(?:(?:o(?:w(?:ey|i)|ue)|u[ei])|(?:u['w’]|oe)i)l|w[ei]il)|(?:vomSam(?:o(?:w(?:ey|i)|ue)|u[ei])|vomSam(?:u['w’]|oe)i)l|vomSamw[ei]il|\s*sam(?:(?:(?:o(?:w(?:ey|i)|ue)|u[ei])|(?:u['w’]|oe)i)l|w[ei]il))|دو(?:م?\s*سم(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل)|مس(?:م(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل))?|سم(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل))|2\s*Sam(?:(?:(?:o(?:w(?:ey|i)|ue)|u[ei])|(?:u['w’]|oe)i)l|w[ei]il)|2\s*سم(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل)|۲\s*سم(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل)|DovomSam|2Sam(?:u['w’]|oe)il|2Samw[ei]il|[2۲]سموئ(?:یل[ہی]|ل)|(?:[2۲]سموئ(?:یی|ي)|[2۲]سمویی|[2۲]سموای)ل|(?:[2۲]سموئئ|[2۲]سموائ|2سم(?:وء|ؤ)|۲سم(?:وء|ؤ))یل|[2۲]سموئیل|dovvoms|[2۲]سمئویل|[2۲]سمویل|2(?:sā?mu|سامو)|۲(?:sā?mu|سامو)|2(?:سمو?|sm)|۲(?:سمو?|sm)|2Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Avval(?:\s*[Ss]|s)|1\s*S)am(?:(?:(?:o(?:w(?:ey|i)|ue)|u[ei])|(?:u['w’]|oe)i)l|w[ei]il)|(?:avval\s*samu['’]ī|(?:Avval|1)Samo(?:w(?:ey|i)|ue)|(?:Avval|1)Samu[ei])l|(?:(?:Avval|1)Samu['w’]|(?:Avval|1)Samoe)il|(?:Avval|1)Samw[ei]il|Yek(?:\s*sam(?:(?:(?:o(?:w(?:ey|i)|ue)|u[ei])|(?:u['w’]|oe)i)l|w[ei]il)|sam(?:(?:(?:o(?:w(?:ey|i)|ue)|u[ei])|(?:u['w’]|oe)i)l|w[ei]il))|(?:اول|۱)\s*سم(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل)|اولسم(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل)|یک(?:\s*سم(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل)|سم(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل))|1\s*سم(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل)|AvvalSam|[1۱]سموئ(?:یل[ہی]|ل)|(?:[1۱]سموئ(?:یی|ي)|[1۱]سمویی|[1۱]سموای)ل|(?:[1۱]سموئئ|[1۱]سموائ|1سم(?:وء|ؤ)|۱سم(?:وء|ؤ))یل|[1۱]سموئیل|[1۱]سمئویل|avvals|[1۱]سمویل|1(?:sā?mu|سامو)|۱(?:sā?mu|سامو)|1(?:سمو?|sm)|۱(?:سمو?|sm)|1Sam|اولس))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
      ...
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:dovvom\s*tawārikh|Do(?:(?:vom(?:\s*[Tt]|T)|T)(?:(?:(?:owar[iy]|owri)|oari)|awari)kh|\s*t(?:(?:(?:owar[iy]|owri)|oari)|awari)kh|vomChr)|دو(?:م?\s*توار(?:ی(?:که?|خ)|ي?خ)|مت(?:وار(?:ی(?:که?|خ)|ي?خ))?|توار(?:ی(?:که?|خ)|ي?خ))|2\s*?T(?:(?:(?:owar[iy]|owri)|oari)|awari)kh|2\s*توار(?:ی(?:که?|خ)|ي?خ)|۲\s*توار(?:ی(?:که?|خ)|ي?خ)|[2۲]تواریکه?|2(?:t(?:owāri|awā)|تواری?خ)|۲(?:towāri|تواری?خ)|dovvomt|[2۲]تواريخ|2(?:(?:tow(?:ār)?|توا?)|تواری?)|۲(?:tow(?:ār)?|تو(?:اری?)?)|2Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:avval\s*tawārikh|(?:Avval(?:\s*[Tt]|[Tt])|1\s*?T)(?:(?:(?:owar[iy]|owri)|oari)|awari)kh|Yek(?:\s*t(?:(?:(?:owar[iy]|owri)|oari)|awari)kh|t(?:(?:(?:owar[iy]|owri)|oari)|awari)kh)|(?:اول|۱)\s*توار(?:ی(?:که?|خ)|ي?خ)|اولتوار(?:ی(?:که?|خ)|ي?خ)|یک(?:\s*توار(?:ی(?:که?|خ)|ي?خ)|توار(?:ی(?:که?|خ)|ي?خ))|1\s*توار(?:ی(?:که?|خ)|ي?خ)|AvvalChr|[1۱]تواریکه?|1(?:t(?:owāri|awā)|تواری?خ)|۱(?:towāri|تواری?خ)|[1۱]تواريخ|1(?:(?:tow(?:ār)?|توا?)|تواری?)|۱(?:tow(?:ār)?|تو(?:اری?)?)|avvalt|اولت|1Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["Dan"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Dani?ya(?:[ei]lh|l)|دان(?:یا(?:ئل(?:له|[هی])|ل(?:له|ی))|ي(?:ا(?:ئل(?:له|[هی])|ل(?:له|ی))|ئل(?:له|ی)|ائ?ل|ايل|یا?ل|ئل|لی)|یئلله|یائ?ل|یئ?لی|یايل|ییا?ل|یئل|یل?)?|Dan(?:i?ya[ei]l)?|Dan(?:i?y(?:ah|e)|ie)l|dān(?:iā|ī)l|dānī?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hos"],
        testament: "o",
      ...
      },
      {
        osis: ["Amos"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:عام(?:و(?:و(?:س(?:(?:س(?:یی|[هہ])|ی[ہی]|[ـهہ])|(?:س|ی)?)|و(?:س(?:(?:سس|یی|[هہ])|(?:س|ی)?)|وسہ))|س(?:(?:(?:سیی|(?:س[سه]|یہ|[ـهہ]))|(?:سی|(?:س|ی)?))|ییہ))|س)?|A(?:amo(?:oo?se|use|s[es]|es)|mo(?:oo|u)s|moose|mose)|A(?:amo(?:oo?s|s)|mos)|āmūsī|ām(?:ūs)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Obad"],
        testament: "o",
      ...
      },
      {
        osis: ["Hab"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ح(?:َب(?:َق(?:و(?:ق(?:ی(?:ی(?:یه|[ءئه])|ائ[هہ]|ئی|ہ[ئاه]|[ءةهۂ])|ائ[هہ]|وو|ئی|ہ[ئاه]|[ءةـهۂ])|ق(?:ی(?:ئ|ہ|ی)?|ا|و|ئ|ہ)?|وق|ک)|ق)|قوق)|بق(?:وق|و?))|Hab(?:a(?:kk?o|co)ok|ba(?:c(?:ook|uc)|k(?:kuc|ook|u[ck]))|akk?u[ck]|acuc)|habaqūq|habaqū?|Hab))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Zeph"],
        testament: "o",
      ...
      },
      {
        osis: ["Hag"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ح(?:َج(?:َّی(?:ہ?ئ[ةۀ-ۂ]|ہ[ءةۀۂ]|اء|ہ|[ءة])?|ّی)|ج(?:(?:(?:ییی|ا)|ّی)|یی?))|hajj(?:īyy|ā)|hajjīy?|Hag(?:g(?:a[iy]|[iy])|a[iy]|i)|Hag))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Zech"],
        testament: "o",
      ...
      },
      {
        osis: ["Acts"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))(Amal-?e-?Rusul|(?:A(?:ma(?:al(?:\s*(?:e\s*)?|-?e-?)Rusule|l-?e-?Rusule)en|['’]ma(?:l(?:\s*e\s*Rusul(?:ee|a)n|-?e-?Rusul(?:ee|a)n|e)|al(?:\s*e\s*|-?e-?)Rusul)|ma(?:al(?:\s*(?:e\s*)?|-?e-?)Rusula|l-?e-?Rusula)n|mal\s*e\s*Rusul(?:ee|a)n|ma(?:ale|l[ei])|cts)|اعم(?:ال(?:\s*(?:الرسولین|رسول[ای]ن)|ی\s*رسولان)|ل(?:\s*رسولان|ی))|A(?:['’]ma(?:l(?:\s*e\s*Rusul|-?e-?Rusul)?|al)|ma(?:l\s*e\s*Rusul|a?l))|اعم(?:ال(?:\s*الرسول|ی)?|ل)?|اعما?لها|a['’]mālī|عم(?:ال(?:ها|ی)?|ل(?:ها|ی)?)|a['’]m(?:āl)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mal"],
        testament: "o",
      ...
      },
      {
        osis: ["Matt"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:M(?:(?:a(?:t(?:['’]t(?:hiya|[iy])|t(?:h(?:e[ai]|[iy])|i[ei]|e[ey]|y)|h[iy])|at(?:ha|t)i|t(?:['’]y|a)i)|at['’]tee|aattey|ett(?:ie|y)|itt(?:hy|i))|attheei)|mattā['’]ūsi|mattā(?:['’]ūs)?|Mat(?:(?:['’]thi|ti?)|thee)|م(?:َت(?:ّ(?:تی|[ىيی])|تی|ی[هی]|ي)|ت(?:(?:(?:ایی|تی|[ىيی])|ّی)|(?:ای|ت)))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mark"],
        testament: "n",
      ...
      },
      {
        osis: ["Rom"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:روم(?:ی[او]ن(?:ی?ان|ها|ن)|ی(?:[او]ن(?:ه|ی)?)?|ي(?:ان(?:[هی])?|ون[هی]))?|R(?:oomi(?:ya|[au])n|(?:o(?:ome|my)a|omi[au])n|umi(?:ya|[au])n)|rūm(?:iān)?ī|rūm(?:iān)?|Rom))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Cor"],
        testament: "n",
