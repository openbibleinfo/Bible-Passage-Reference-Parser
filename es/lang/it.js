...
var bcv_regexps = class {
  constructor() {
    ...
    // The `titolo` has `[a-z]` instead of `\w` because it could be followed by a number.
    // [a-d] allows `1:1a`.
    this.escaped_passage = /(?:^|[^\x1e\x1f\p{L}\p{N}])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s.:,;\x1e\x1f&\(\)（）\[\]\\/"'\*=~\-–—]|titolo(?![a-z])|vedi\s+anche|capitoli|capitolo|versetto|versetti|,\s+ecc|versi|capp|vedi|cap|ecc|cfr|cc|ss|al|vv|e|v|[a-d](?!\w)|$)+)/giu;
    ...
    this.match_end_split = /\d\W*titolo|\d\W*(?:ss|,\s+ecc|ecc)(?:[\s*]*\.)?|\d[\s*]*[a-d](?!\w)|\x1e(?:[\s*]*[)\]\uff09])?|[\d\x1f]/gi;
    this.control = /[\x1e\x1f]/g;
    // These are needed for ranges outside of this class.
    this.first = String.raw`(?:Primo|Prima|1°|1|I)\.?\s*`;
    this.second = String.raw`(?:Secondo|Seconda|2°|2|II)\.?\s*`;
    this.third = String.raw`(?:Terzo|Terza|3°|3|III)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|(?:vedi\s+anche|vedi|cfr|e)|al)`;
    this.range_only = String.raw`(?:[\u2013\u2014-]|al)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prim[ao]\s*[EÉ]sdras|Prim[ao]\s*Esdra|Esdra\s*greco|Terz[ao]\s*Esdra|(?:1°?\.|I\.)\s*[EÉ]sdras|(?:III|3°?)\.\s*Esdra|(?:1°?\.|I\.)\s*Esdra|(?:1°|I)\s*[EÉ]sdras|(?:III|3°?)\s*Esdra|(?:1°|I)\s*Esdra|1\s*Esdras|1\s*Ésdras|1\s*Esd(?:ra)?|1Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Second[ao]\s*(?:Esdras?|Ésdras)|Quart[ao]\s*Esdra|(?:2°?|II)\.\s*(?:Esdras?|Ésdras)|(?:4°?|IV)\.\s*Esdra|(?:2°|II)\s*(?:Esdras?|Ésdras)|(?:4°?|IV)\s*Esdra|2\s*Esdras|2\s*Ésdras|2\s*Esd(?:ra)?|2Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Second[ao]\s*Samuele|(?:2°?|II)\.\s*Samuele|(?:2°|II)\s*Samuele|2(?:\s*Samuele|(?:\s*S(?:am)?|Sam))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prim[ao]\s*Samuele|(?:(?:1°|I)|1)\.\s*Samuele|(?:1°|I)\s*Samuele|1(?:\s*Samuele|(?:\s*S(?:am)?|Sam))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Second[ao]\s*Re|(?:2°?|II)\.\s*Re|(?:2°|II)\s*Re|2(?:(?:\s*Re|Kgs)|\s*R)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prim[ao]\s*Re|(?:(?:1°|I)|1)\.\s*Re|(?:1°|I)\s*Re|1(?:(?:\s*Re|Kgs)|\s*R)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Second[ao]\s*Cronache|(?:2°?|II)\.\s*Cronache|(?:2°|II)\s*Cronache|2\s*Cronache|2(?:\s*C|Ch)r))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prim[ao]\s*Cronache|(?:(?:1°|I)|1)\.\s*Cronache|(?:1°|I)\s*Cronache|1\s*Cronache|1(?:\s*C|Ch)r))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(E(?:sdra|zra|s?d))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Neh"],
        testament: "o",
      ...
      },
      {
        osis: ["Matt"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Vangelo\s*di\s*(?:San\s*)?Matteo|Matteo|M(?:at)?t))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mark"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Vangelo\s*di\s*(?:San\s*)?Marco|M(?:arco|(?:ark|[cr]))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Luke"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Vangelo\s*di\s*(?:San\s*)?Luca|L(?:(?:(?:uke|c)|u)|uca)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prim(?:(?:a\s*lettera\s*di|o)|a)\s*Giovanni|(?:(?:1°|I)|1)\.\s*Giovanni|(?:1°|I)\s*Giovanni|1(?:\s*Giovanni|(?:John|\s*Gv))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Second(?:(?:a\s*lettera\s*di|o)|a)\s*Giovanni|(?:2°?|II)\.\s*Giovanni|(?:2°|II)\s*Giovanni|2(?:\s*Giovanni|(?:John|\s*Gv))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Terz(?:(?:a\s*lettera\s*di|o)|a)\s*Giovanni|(?:III|3°?)\.\s*Giovanni|(?:III|3°)\s*Giovanni|3(?:\s*Giovanni|(?:John|\s*Gv))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Vangelo\s*di\s*(?:San\s*)?Giovanni|Giovanni|John|Gv))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Second(?:(?:a\s*lettera\s*ai|o)|a)\s*Corinzi|(?:2°?|II)\.\s*Corinzi|(?:2°|II)\s*Corinzi|2(?:\s*Corinzi|(?:\s*Cor?|Cor))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prim(?:(?:a\s*lettera\s*ai|o)|a)\s*Corinzi|(?:(?:1°|I)|1)\.\s*Corinzi|(?:1°|I)\s*Corinzi|1(?:\s*Corinzi|(?:\s*Cor?|Cor))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Second(?:(?:a\s*lettera\s*ai|o)|a)\s*Tessalonicesi|(?:2°?|II)\.\s*Tessalonicesi|(?:2°|II)\s*Tessalonicesi|2(?:\s*Tessalonicesi|(?:(?:Thes|\s*T)s|\s*Te))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prim(?:(?:a\s*lettera\s*ai|o)|a)\s*Tessalonicesi|(?:(?:1°|I)|1)\.\s*Tessalonicesi|(?:1°|I)\s*Tessalonicesi|1(?:\s*Tessalonicesi|(?:(?:Thes|\s*T)s|\s*Te))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Second(?:(?:a\s*lettera\s*a|o)|a)\s*Timoteo|(?:2°?|II)\.\s*Timoteo|(?:2°|II)\s*Timoteo|2(?:\s*Timoteo|(?:\s*Tim?|(?:\s*T|Ti)m))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prim(?:(?:a\s*lettera\s*a|o)|a)\s*Timoteo|(?:(?:1°|I)|1)\.\s*Timoteo|(?:1°|I)\s*Timoteo|1(?:\s*Timoteo|(?:\s*Tim?|(?:\s*T|Ti)m))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Second(?:(?:a\s*lettera\s*di|o)|a)\s*Pietro|(?:2°?|II)\.\s*Pietro|(?:2°|II)\s*Pietro|2(?:\s*Pietro|(?:(?:\s*P|Pe)t|\s*P))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prim(?:(?:a\s*lettera\s*di|o)|a)\s*Pietro|(?:(?:1°|I)|1)\.\s*Pietro|(?:1°|I)\s*Pietro|1(?:\s*Pietro|(?:(?:\s*P|Pe)t|\s*P))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Second(?:o\s*(?:libro\s*dei\s*)?Maccabei|a\s*Maccabei)|(?:2°?|II)\.\s*Maccabei|(?:2°|II)\s*Maccabei|2\s*Maccabei|2(?:\s*Ma|Mac)c))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Terz(?:o\s*(?:libro\s*dei\s*)?Maccabei|a\s*Maccabei)|(?:III|3°?)\.\s*Maccabei|(?:III|3°)\s*Maccabei|3\s*Maccabei|3(?:\s*Ma|Mac)c))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Quart(?:o\s*(?:libro\s*dei\s*)?Maccabei|a\s*Maccabei)|(?:4°?|IV)\.\s*Maccabei|(?:4°|IV)\s*Maccabei|4\s*Maccabei|4(?:\s*Ma|Mac)c))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prim(?:o\s*(?:libro\s*dei\s*)?Maccabei|a\s*Maccabei)|(?:(?:1°|I)|1)\.\s*Maccabei|(?:1°|I)\s*Maccabei|1\s*Maccabei|1(?:\s*Ma|Mac)c))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      }
    ];
  }
};
...
function peg$parse(input, options) {
  ...
  var peg$e13 = peg$literalExpectation("ecc", false);
  ...
  var peg$e19 = peg$classExpectation([["a", "d"]], false, false);
  var peg$e20 = peg$literalExpectation("c", false);
  var peg$e21 = peg$literalExpectation("apitoli", false);
  var peg$e22 = peg$literalExpectation("apitolo", false);
  var peg$e23 = peg$literalExpectation("app", false);
  var peg$e24 = peg$literalExpectation("ap", false);
  var peg$e25 = peg$literalExpectation("v", false);
  var peg$e26 = peg$literalExpectation("ersetto", false);
  var peg$e27 = peg$literalExpectation("ersetti", false);
  var peg$e28 = peg$literalExpectation("ersi", false);
  var peg$e29 = peg$literalExpectation(":", false);
  var peg$e30 = peg$classExpectation(['"', "'"], false, false);
  var peg$e31 = peg$classExpectation([",", ";", "/", ":", "&", "-", "–", "—", "~"], false, false);
  var peg$e32 = peg$literalExpectation("vedi", false);
  var peg$e33 = peg$literalExpectation("anche", false);
  var peg$e34 = peg$literalExpectation("cfr", false);
  var peg$e35 = peg$literalExpectation("e", false);
  var peg$e36 = peg$classExpectation(["-", "–", "—"], false, false);
  var peg$e37 = peg$literalExpectation("al", false);
  var peg$e38 = peg$literalExpectation("titolo", false);
