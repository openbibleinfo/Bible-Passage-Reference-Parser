...
var bcv_regexps = class {
  constructor() {
    ...
    this.second = String.raw`(?:Anden|2)\.?\s*`;
    this.third = String.raw`(?:Tredje|3)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|(?:og|jf)|-)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Første\s*Mos(?:ebog)?|1\.\s*Mos(?:ebog)?|1\s*Mos(?:ebog)?|Gen(?:esis)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Anden\s*Mos(?:ebog)?|2\.\s*Mos(?:ebog)?|2\s*Mos(?:ebog)?|Exod(?:us)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bel"],
        testament: "a",
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tredje\s*Mos(?:ebog)?|3\.\s*Mos(?:ebog)?|Lev(?:iticus)?|3\s*Mos(?:ebog)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fjerde\s*Mos(?:ebog)?|4\.\s*Mos(?:ebog)?|4\s*Mos(?:ebog)?|Num(?:eri)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Sir"],
        testament: "a",
      ...
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Deut(?:eronomium)?|Femte\s*Mos(?:ebog)?|5\.\s*Mos(?:ebog)?|5\s*Mos(?:ebog)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tredje\s*Esdrasbog|Første\s*Esdrasbog|[13]\.\s*Esdrasbog|[13]\s*Esdrasbog|1Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fjerde\s*Esdrasbog|(?:Anden|[24]\.)\s*Esdrasbog|[24]\s*Esdrasbog|2Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Anden\s*(?:Kongerigernes\s*Bog|Sam(?:uelsbog|(?:uel)?))|2(?:\.\s*(?:Kongerigernes\s*Bog|Sam(?:uelsbog|(?:uel)?))|(?:\s*(?:Kongerigernes\s*Bog|Sam(?:uelsbog|(?:uel)?))|Sam))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Første\s*(?:Kongerigernes\s*Bog|Sam(?:uelsbog|(?:uel)?))|1(?:\.\s*(?:Kongerigernes\s*Bog|Sam(?:uelsbog|(?:uel)?))|(?:\s*(?:Kongerigernes\s*Bog|Sam(?:uelsbog|(?:uel)?))|Sam))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fjerde\s*Kongerigernes\s*Bog|4\.\s*Kongerigernes\s*Bog|4\s*Kongerigernes\s*Bog|(?:Anden|2\.?)\s*Kongebog|(?:Anden|2\.?)\s*Kong|2Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tredje\s*Kongerigernes\s*Bog|3\.\s*Kongerigernes\s*Bog|3\s*Kongerigernes\s*Bog|(?:Første|1\.?)\s*Kongebog|(?:Første|1\.?)\s*Kong|1Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Anden\s*Kr(?:øn(?:ikebog)?|on)|2(?:\.\s*Kr(?:øn(?:ikebog)?|on)|(?:\s*Kr(?:øn(?:ikebog)?|on)|Chr))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Første\s*Kr(?:øn(?:ikebog)?|on)|1(?:\.\s*Kr(?:øn(?:ikebog)?|on)|(?:\s*Kr(?:øn(?:ikebog)?|on)|Chr))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Første\s*Johannes['’]|1(?:\.\s*Johannes['’]|\s*Johannes['’]))\s*Brev|Johannes['’]\s*(?:Første|1\.?)\s*Brev|(?:Første|1\.?)\s*Johannesbrev|Første\s*Joh(?:annes)?|1(?:\.\s*Joh(?:annes)?|\s*Joh(?:annes)?)|1John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Anden\s*Johannes['’]|2(?:\.\s*Johannes['’]|\s*Johannes['’]))\s*Brev|Johannes['’]\s*Andet\s*Brev|(?:Ande[nt]\s*Johannesb|2\.?\s*Johannesb)rev|Anden\s*Joh(?:annes)?|2(?:\.\s*Joh(?:annes)?|\s*Joh(?:annes)?)|2John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Tredje\s*Johannes['’]|3(?:\.\s*Johannes['’]|\s*Johannes['’]))\s*Brev|Johannes['’]\s*(?:Tredje|3\.?)\s*Brev|(?:Tredje|3\.?)\s*Johannesbrev|Tredje\s*Joh(?:annes)?|3(?:\.\s*Joh(?:annes)?|\s*Joh(?:annes)?)|3John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))(Joh(?:annes(?:evangeliet)?|n)?)(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Paulus['’]\s*Andet\s*Brev\s*til\s*Korintherne|Ande(?:n\s*Korinth?|t\s*Korinth)erbrev|2\.?\s*Korintherbrev|(?:Anden|2\.?)\s*Korinterne|2\.?\s*Korinterbrev|(?:Anden|2\.?)\s*Kor|2Cor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Paulus['’]\s*(?:Første|1\.?)\s*Brev\s*til\s*Korintherne|Første\s*Korinth?erbrev|(?:Første|1\.?)\s*Korinterne|1(?:\.\s*Korinth?erbrev|(?:\s*Korinth?erbrev|Cor))|(?:Første|1\.?)\s*Kor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Paulus['’]\s*Andet\s*Brev\s*til\s*Thessalonikerne|Ande[nt]\s*Thessalonikerbrev|2\.?\s*Thessalonikerbrev|(?:Anden|2\.?)\s*Tessalonikerne|(?:Anden|2\.?)\s*Thess|2Thess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Paulus['’]\s*(?:Første|1\.?)\s*Brev\s*til\s*Thessalonikerne|Første\s*Thessalonikerbrev|(?:Første|1\.?)\s*Tessalonikerne|1(?:\.\s*Thessalonikerbrev|(?:\s*Thessalonikerbrev|Thess))|(?:Første|1\.?)\s*Thess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Paulus['’]\s*Andet\s*Brev\s*til\s*Timotheus|Ande(?:n\s*Timoth?|t\s*Timoth)eusbrev|2\.?\s*Timotheusbrev|2\.?\s*Timoteusbrev|Anden\s*Tim(?:oteus)?|2(?:\.\s*Tim(?:oteus)?|\s*Tim(?:oteus)?)|2Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Paulus['’]\s*(?:Første|1\.?)\s*Brev\s*til\s*Timotheus|Første\s*Timoth?eusbrev|1(?:\.\s*Timoth?eusbrev|(?:\s*Timoth?eusbrev|Tim))|Første\s*Tim(?:oteus)?|1(?:\.\s*Tim(?:oteus)?|\s*Tim(?:oteus)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Peters\s*Andet\s*Brev|(?:Ande[nt]\s*Petersb|2\.?\s*Petersb)rev|Anden\s*Pet(?:er)?|2(?:\.\s*Pet(?:er)?|\s*Pet(?:er)?)|2Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Peters\s*(?:Første|1\.?)\s*Brev|(?:Første|1\.?)\s*Petersbrev|Første\s*Pet(?:er)?|1(?:\.\s*Pet(?:er)?|\s*Pet(?:er)?)|1Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Anden\s*Makk(?:abæerbog)?|2(?:\.\s*Makk(?:abæerbog)?|(?:\s*Makk(?:abæerbog)?|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tredje\s*Makk(?:abæerbog)?|3(?:\.\s*Makk(?:abæerbog)?|(?:\s*Makk(?:abæerbog)?|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fjerde\s*Makk(?:abæerbog)?|4(?:\.\s*Makk(?:abæerbog)?|(?:\s*Makk(?:abæerbog)?|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Første\s*Makk(?:abæerbog)?|1(?:\.\s*Makk(?:abæerbog)?|(?:\s*Makk(?:abæerbog)?|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      }
    ];
  }
};
...
function peg$parse(input, options) {
  ...
  var peg$e19 = peg$literalExpectation("kap", false);
  var peg$e20 = peg$literalExpectation("itlerne", false);
  var peg$e21 = peg$literalExpectation("itel", false);
  var peg$e22 = peg$literalExpectation("v", false);
  var peg$e23 = peg$literalExpectation("ers", false);
  var peg$e24 = peg$literalExpectation(":", false);
  var peg$e25 = peg$classExpectation(['"', "'"], false, false);
  var peg$e26 = peg$classExpectation([",", ";", "/", ":", "&", "-", "–", "—", "~"], false, false);
  var peg$e27 = peg$literalExpectation("og", false);
  var peg$e28 = peg$literalExpectation("jf", false);
