...
var bcv_regexps = class {
  constructor() {
    ...
    // The `titulus` has `[a-z]` instead of `\w` because it could be followed by a number.
    // [a-e] allows `1:1a`.
    this.escaped_passage = /(?:^|[^\x1e\x1f\p{L}\p{N}])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s.:,;\x1e\x1f&\(\)（）\[\]\\/"'\*=~\-–—]|titulus(?![a-z])|et\s+sequentes|et\s+seq|versus|caput|vers|cap|ver|ad|et|v|[a-e](?!\w)|$)+)/giu;
    ...
    this.match_end_split = /\d\W*titulus|\d\W*(?:et\s+sequentes|et\s+seq)(?:[\s*]*\.)?|\d[\s*]*[a-e](?!\w)|\x1e(?:[\s*]*[)\]\uff09])?|[\d\x1f]/gi;
    this.control = /[\x1e\x1f]/g;
    // These are needed for ranges outside of this class.
    this.first = String.raw`(?:I|1)\.?\s*`;
    this.second = String.raw`(?:II|2)\.?\s*`;
    this.third = String.raw`(?:III|3)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|et|ad)`;
    this.range_only = String.raw`(?:[\u2013\u2014-]|ad)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Liber\s*(?:Esdrae\s*I|I\s*Esdrae)|1(?:\.\s*Esdrae|(?:\s*Esdrae|Esd))|I\.?\s*Esdrae|1(?:\.\s*Esd(?:ra)?|\s*Esd(?:ra)?)|I(?:\.\s*Esd(?:ra)?|\s*Esd(?:ra)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Liber\s*(?:Esdrae\s*II|II\s*Esdrae)|II\.?\s*Esdrae|II(?:\.\s*Esd(?:ra)?|\s*Esd(?:ra)?)|2(?:\.\s*Esdrae|(?:\s*Esdrae|Esd))|2(?:\.\s*Esd(?:ra)?|\s*Esd(?:ra)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Liber\s*II\s*Samuelis|II\.?\s*Regnorum|(?:II\.?\s*Samu|2\.?\s*Samu)elis|(?:2\.\s*Regnoru|2(?:\s*Regnoru|Sa))m|Samuelis\s*II|II\.?\s*Sam|2\.?\s*Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Liber\s*I\s*Samuelis|(?:1\.\s*Regnoru|1(?:\s*Regnoru|Sa))m|I\.?\s*Regnorum|(?:1\.?\s*Samu|I\.?\s*Samu)elis|Samuelis\s*I|1\.?\s*Sam|I\.?\s*Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Liber\s*II\s*Regum|(?:IV|4)\.?\s*Regnorum|(?:II\.?\s*Regu|2\.?\s*Regu)m|Regum\s*II|II\.?\s*Reg|2\.?\s*Reg|2Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:III|3)\.?\s*Regnorum|Liber\s*I\s*Regum|(?:1\.?\s*Regu|I\.?\s*Regu)m|Regum\s*I|1\.?\s*Reg|I\.?\s*Reg|1Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Liber\s*II\s*Paralipomenon|(?:II\.?\s*Para|2\.?\s*Para)lipomenon|Paralipomenon\s*II|II\.?\s*Par|2\.?\s*Par|2Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Liber\s*I\s*Paralipomenon|(?:1\.?\s*Para|I\.?\s*Para)lipomenon|Paralipomenon\s*I|1\.?\s*Par|I\.?\s*Par|1Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Liber\s*Esdrae|E(?:(?:sdrae|zra)|sd(?:ra?)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Neh"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Epistula\s*I(?:\s*Ioannis|oannis\s*I)|(?:1\.?\s*Io|I\.?\s*Io)annis|Ioannis\s*I|(?:1(?:Joh|\s*I)|1\.\s*I)n|I\.?\s*In))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Epistula\s*I(?:I\s*Ioannis|oannis\s*II)|(?:II\.?\s*Io|2\.?\s*Io)annis|Ioannis\s*II|II\.?\s*In|(?:2(?:Joh|\s*I)|2\.\s*I)n))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Epistula\s*I(?:II\s*Ioannis|oannis\s*III)|(?:III\.?\s*Io|3\.?\s*Io)annis|Ioannis\s*III|III\.?\s*In|(?:3(?:Joh|\s*I)|3\.\s*I)n))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Evangelium\s*secundum\s*Ioannem|I(?:oannes|n)|Ioan|John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Epistula\s*(?:II\s*ad\s*Corinthios|ad\s*Corinthios\s*II)|ad\s*Corinthios\s*II|(?:II\.?\s*Cori|2\.?\s*Cori)nthios|Corinthios\s*II|II\.?\s*Cor|2\.?\s*Cor|2Cor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Epistula\s*(?:I\s*ad\s*Corinthios|ad\s*Corinthios\s*I)|ad\s*Corinthios\s*I|(?:1\.?\s*Cori|I\.?\s*Cori)nthios|Corinthios\s*I|1\.?\s*Cor|I\.?\s*Cor|1Cor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Epistula\s*(?:II\s*ad\s*Thessalonicenses|ad\s*Thessalonicenses\s*II)|ad\s*Thessalonicenses\s*II|(?:(?:II\.?\s*Thessa|2\.?\s*Thessa)lonicense|2Thes)s|Thessalonicenses\s*II|II(?:\.\s*Th(?:ess)?|\s*Th(?:ess)?)|2(?:\.\s*Th(?:ess)?|\s*Th(?:ess)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Epistula\s*(?:I\s*ad\s*Thessalonicenses|ad\s*Thessalonicenses\s*I)|ad\s*Thessalonicenses\s*I|(?:(?:1\.?\s*Thessa|I\.?\s*Thessa)lonicense|1Thes)s|Thessalonicenses\s*I|1(?:\.\s*Th(?:ess)?|\s*Th(?:ess)?)|I(?:\.\s*Th(?:ess)?|\s*Th(?:ess)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Epistula\s*(?:II\s*ad\s*Timotheum|ad\s*Timotheum\s*II)|ad\s*Timotheum\s*II|(?:II\.?\s*Timo|2\.?\s*Timo)theum|Timotheum\s*II|II(?:\.\s*Tim?|\s*Tim?)|2(?:\.\s*Tim?|\s*Tim?)|II\.?\s*Tm|2\.?\s*Tm|2Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Epistula\s*(?:I\s*ad\s*Timotheum|ad\s*Timotheum\s*I)|ad\s*Timotheum\s*I|(?:1\.?\s*Timo|I\.?\s*Timo)theum|Timotheum\s*I|1(?:\.\s*Tim?|\s*Tim?)|I(?:\.\s*Tim?|\s*Tim?)|1\.?\s*Tm|I\.?\s*Tm|1Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Epistula\s*(?:II\s*Petri|Petri\s*II)|(?:II\.?\s*Petr|2\.?\s*Petr)i|Petri\s*II|II\.?\s*Pet|2\.?\s*Pet|2Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Epistula\s*(?:I\s*Petri|Petri\s*I)|(?:1\.?\s*Petr|I\.?\s*Petr)i|Petri\s*I|1\.?\s*Pet|I\.?\s*Pet|1Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Liber\s*(?:II\s*Maccabaeorum|Maccabaeorum\s*II)|(?:II\.?\s*Mach|2\.?\s*Mach)abaeorum|(?:II\.?\s*Maca|2\.?\s*Maca)baeorum|Machabaeorum\s*II|II\.?\s*Mac|2\.?\s*Mac|2Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Liber\s*(?:III\s*Maccabaeorum|Maccabaeorum\s*III)|(?:III\.?\s*Mach|3\.?\s*Mach)abaeorum|(?:III\.?\s*Maca|3\.?\s*Maca)baeorum|Machabaeorum\s*III|III\.?\s*Mac|3\.?\s*Mac|3Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Liber\s*(?:IV\s*Maccabaeorum|Maccabaeorum\s*IV)|(?:IV\.?\s*Mach|4\.?\s*Mach)abaeorum|(?:IV\.?\s*Maca|4\.?\s*Maca)baeorum|Machabaeorum\s*IV|IV\.?\s*Mac|4\.?\s*Mac|4Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Liber\s*(?:I\s*Maccabaeorum|Maccabaeorum\s*I)|(?:1\.?\s*Mach|I\.?\s*Mach)abaeorum|(?:1\.?\s*Maca|I\.?\s*Maca)baeorum|Machabaeorum\s*I|1\.?\s*Mac|I\.?\s*Mac|1Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      }
    ];
  }
};
...
function peg$parse(input, options) {
  ...
  var peg$e12 = peg$literalExpectation("et", false);
  var peg$e13 = peg$literalExpectation("sequentes", false);
  ...
  var peg$e22 = peg$literalExpectation("ut", false);
  var peg$e23 = peg$literalExpectation("v", false);
  var peg$e24 = peg$literalExpectation("ersus", false);
  var peg$e25 = peg$literalExpectation("ers", false);
  var peg$e26 = peg$literalExpectation("er", false);
