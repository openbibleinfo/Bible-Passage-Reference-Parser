...
var bcv_regexps = class {
  constructor() {
    ...
    // The `c[íi]m` has `[a-z]` instead of `\w` because it could be followed by a number.
    // [a-e] allows `1:1a`.
    this.escaped_passage = /(?:^|[^\x1e\x1f\p{L}\p{N}])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s.:,;\x1e\x1f&\(\)（）\[\]\\/"'\*=~\-–—]|c[íi]m(?![a-z])|fejezet[ée]ben|versekre|fejezet|k[öo]v|versek|[ée]s|v[öo]|vagy|vers|fej|kk|[a-e](?!\w)|$)+)/giu;
    ...
    this.match_end_split = /\d\W*c[íi]m|\d\W*kk(?:[\s*]*\.)?|\d[\s*]*[a-e](?!\w)|\x1e(?:[\s*]*[)\]\uff09])?|[\d\x1f]/gi;
    this.control = /[\x1e\x1f]/g;
    // These are needed for ranges outside of this class.
    this.first = String.raw`(?:Els[őo]|1|I)\.?\s*`;
    this.second = String.raw`(?:M[áa]sodik|2|II)\.?\s*`;
    this.third = String.raw`(?:Harmadik|3|III)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|(?:[ée]s|v[öo]|vagy)|k[öo]v)`;
    this.range_only = String.raw`(?:[\u2013\u2014-]|k[öo]v)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Els[oő]\s*M[oó]zes|(?:Teremt[eé]|1\s*M[oó]ze)s|[1I]\.\s*M[oó]zes|M[oó]zes\s*I|I\s*M[oó]zes|1\s*M[oó]z|1\s*Mz|Ter|Gen))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:M(?:[aá]sodik\s*M[oó]zes|[oó]zes\s*II)|(?:Kivonul[aá]|2\s*M[oó]ze)s|(?:II|2)\.\s*M[oó]zes|II\s*M[oó]zes|2\s*M[oó]z|2\s*Mz|Exod|Kiv))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bel"],
        testament: "a",
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Harmadik\s*M[oó]zes|(?:III|3)\.\s*M[oó]zes|M[oó]zes\s*III|III\s*M[oó]zes|Levit[aá]k|3\s*M[oó]zes|3\s*M[oó]z|3\s*Mz|Lev))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:IV(?:\.\s*M[oó]zes|\s*M[oó]zes)|4\.\s*M[oó]zes|M[oó]zes\s*IV|4\s*M[oó]zes|Sz[aá]mok|4\s*M[oó]z|Sz[aá]m|4\s*Mz|Num))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Wis"],
        testament: "a",
      ...
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:M(?:[aá]sodik\s*t[oö]rv[eé]nyk[oö]nyv|[oó]zes\s*(?:[oö]t[oö]dik\s*k[oö]nyve|V)|T[oö]rv)|5\s*M(?:[oó]zes|z)|5\s*M[oó]z|Deut))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:E(?:ls(?:[oő]\s*Ezdr[aá]s|[oő]\s*Ezd)|zdr[aá]s\s*I)|[1I]\.\s*Ezdr[aá]s|[1I]\s*Ezdr[aá]s|(?:[1I]\.|[1I])\s*Ezd|1Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:M[aá]sodik\s*Ezd(?:r[aá]s)?|(?:II|2)\.\s*Ezd(?:r[aá]s)?|Ezdr[aá]s\s*II|(?:II|2)\s*Ezd(?:r[aá]s)?|2Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:M[aá]sodik\s*S[aá]m(?:uel)?|(?:II|2)\.\s*S[aá]m(?:uel)?|S[aá]muel\s*II|(?:II|2)\s*S[aá]m(?:uel)?|2Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Els[oő]\s*S[aá]muel|[1I]\.\s*S[aá]muel|Els[oő]\s*S[aá]m|[1I]\s*S[aá]muel|S[aá]muel\s*I|[1I]\.\s*S[aá]m|[1I]\s*S[aá]m|1Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:M[aá]sodik\s*Kir(?:[aá]lyok)?|(?:II|2)\.\s*Kir(?:[aá]lyok)?|Kir[aá]lyok\s*II|(?:II|2)\s*Kir(?:[aá]lyok)?|2Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Els[oő]\s*Kir[aá]lyok|[1I]\.\s*Kir[aá]lyok|[1I]\s*Kir[aá]lyok|Kir[aá]lyok\s*I|Els[oő]\s*Kir|(?:[1I]\.|[1I])\s*Kir|1Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:M[aá]sodik\s*Kr[oó]n(?:ika)?|Kr[oó]nik[aá]k\s*II|(?:II|2)\.\s*Kr[oó]n(?:ika)?|(?:II|2)\s*Kr[oó]n(?:ika)?|2Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Els[oő]\s*Kr[oó]nika|[1I]\.\s*Kr[oó]nika|Kr[oó]nik[aá]k\s*I|Els[oő]\s*Kr[oó]n|[1I]\s*Kr[oó]nika|[1I]\.\s*Kr[oó]n|[1I]\s*Kr[oó]n|1Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(Ez(?:sd(?:r[aá]s)?|ra|d))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Neh"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Els[oő]\s*J(?:[aá]nos|n)|[1I]\.\s*J(?:[aá]nos|n)|[1I]\s*J(?:[aá]nos|n)|J[aá]nos\s*I|1John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:M[aá]sodik\s*J(?:[aá]nos|n)|(?:II|2)\.\s*J(?:[aá]nos|n)|J[aá]nos\s*II|(?:II|2)\s*J(?:[aá]nos|n)|2John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Harmadik\s*J(?:[aá]nos|n)|(?:III|3)\.\s*J(?:[aá]nos|n)|J[aá]nos\s*III|(?:III|3)\s*J(?:[aá]nos|n)|3John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))(J(?:[aá]nos|(?:oh)?n))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:M[aá]sodik\s*Kor(?:int(?:hus(?:iakhoz)?|usi))?|(?:II|2)\.\s*Kor(?:int(?:hus(?:iakhoz)?|usi))?|(?:II|2)\s*Kor(?:int(?:hus(?:iakhoz)?|usi))?|2Cor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Els[oő]\s*Kor(?:int(?:hus(?:iakhoz)?|usi))?|[1I]\.\s*Kor(?:int(?:hus(?:iakhoz)?|usi))?|[1I]\s*Kor(?:int(?:hus(?:iakhoz)?|usi))?|1Cor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:M[aá]sodik\s*T(?:hessz(?:alonika(?:iakhoz)?)?|essz(?:alonika(?:iakhoz)?)?)|(?:II|2)\.\s*T(?:hessz(?:alonika(?:iakhoz)?)?|essz(?:alonika(?:iakhoz)?)?)|(?:II|2)\s*T(?:hessz(?:alonika(?:iakhoz)?)?|essz(?:alonika(?:iakhoz)?)?)|2Thess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Els[oő]\s*T(?:hessz(?:alonika(?:iakhoz)?)?|essz(?:alonika(?:iakhoz)?)?)|[1I]\.\s*T(?:hessz(?:alonika(?:iakhoz)?)?|essz(?:alonika(?:iakhoz)?)?)|[1I]\s*T(?:hessz(?:alonika(?:iakhoz)?)?|essz(?:alonika(?:iakhoz)?)?)|1Thess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:M[aá]sodik\s*Tim(?:[oó]t(?:eus(?:(?:nak)?|hoz)|heosz))?|(?:II|2)\.\s*Tim(?:[oó]t(?:eus(?:(?:nak)?|hoz)|heosz))?|(?:II|2)\s*Tim(?:[oó]t(?:eus(?:(?:nak)?|hoz)|heosz))?|2Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Els[oő]\s*Tim(?:[oó]t(?:eus(?:(?:nak)?|hoz)|heosz))?|[1I]\.\s*Tim(?:[oó]t(?:eus(?:(?:nak)?|hoz)|heosz))?|[1I]\s*Tim(?:[oó]t(?:eus(?:(?:nak)?|hoz)|heosz))?|1Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:M[aá]sodik\s*P[eé]t(?:er)?|(?:II|2)\.\s*P[eé]t(?:er)?|(?:II|2)\s*P[eé]t(?:er)?|2Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Els[oő]\s*P[eé]t(?:er)?|[1I]\.\s*P[eé]t(?:er)?|[1I]\s*P[eé]t(?:er)?|1Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:M(?:a(?:sodik\s*Mak(?:kabeusok)?|kkabeusok\s*II)|ásodik\s*Mak(?:kabeusok)?)|(?:II|2)\.\s*Mak(?:kabeusok)?|(?:II|2)\s*Mak(?:kabeusok)?|2Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Harmadik\s*Makkabeusok|(?:III|3)\.\s*Makkabeusok|(?:III|3)\s*Makkabeusok|Makkabeusok\s*III|(?:Harmadik|(?:(?:III|3)\.|(?:III|3)))\s*Mak|3Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:IV\.?\s*Makkabeusok|4(?:\.\s*Makkabeusok|(?:\s*Makkabeusok|Macc))|Makkabeusok\s*IV|IV\.?\s*Mak|4\.?\s*Mak))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Els[oő]\s*Makkabeusok|[1I]\.\s*Makkabeusok|[1I]\s*Makkabeusok|Makkabeusok\s*I|Els[oő]\s*Mak|(?:[1I]\.|[1I])\s*Mak|1Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      }
    ];
  }
};
...
function peg$parse(input, options) {
  ...
  var peg$e12 = peg$literalExpectation("kk", false);
  ...
  var peg$e19 = peg$literalExpectation("fej", false);
  var peg$e20 = peg$literalExpectation("ezet", false);
  var peg$e21 = peg$classExpectation(["é", "e"], false, true);
  var peg$e22 = peg$literalExpectation("ben", false);
  var peg$e23 = peg$literalExpectation("vers", false);
  var peg$e24 = peg$literalExpectation("ekre", false);
  var peg$e25 = peg$literalExpectation("ek", false);
  ...
  var peg$e31 = peg$classExpectation(["ö", "o"], false, true);
  var peg$e32 = peg$literalExpectation("vagy", false);
  var peg$e33 = peg$classExpectation(["-", "–", "—"], false, false);
  var peg$e34 = peg$literalExpectation("k", false);
  var peg$e35 = peg$literalExpectation("c", false);
  var peg$e36 = peg$classExpectation(["í", "i"], false, true);
