...
var bcv_regexps = class {
  constructor() {
    ...
    this.match_end_split = /\d\W*title|\d\W*ff(?:[\s*]*\.)?|\d[\s*]*[b-e](?!\w)|\x1e(?:[\s*]*[)\]\uff09])?|[\d\x1f]/gi;
    this.control = /[\x1e\x1f]/g;
    // These are needed for ranges outside of this class.
    this.first = String.raw`(?:Prv[áa]\s+kniha|Prv[ýy]\s+list|Prv[áa]|Prv[ýy]|1\s+k|I|1)\.?\s*`;
    this.second = String.raw`(?:Druh[áa]\s+kniha|Druh[ýy]\s+list|Druh[áa]|Druh[ýy]|2\s+k|II|2)\.?\s*`;
    this.third = String.raw`(?:Tretia\s+kniha|Tretia|Tret[íi]|3\s+k|III|3)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|(?:porov|pozri|alebo|a)|(?:a[žz]|-))`;
    this.range_only = String.raw`(?:[\u2013\u2014-]|(?:a[žz]|-))`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prv(?:[aá]\s*kniha\s*Moj[zž]i[sš]ova|[yý]\s*(?:list\s*Moj[zž]i[sš]ova|Moj[zž]i[sš]ova)|[aá]\s*Moj[zž]i[sš]ova)|K(?:niha|\.?)\s*stvorenia|(?:(?:1\s*k|I)|1)\.\s*Moj[zž]i[sš]ova|(?:1\s*k|I)\s*Moj[zž]i[sš]ova|K(?:niha\s*p[oô]vodu|\.\s*p[oô]vodu|\s*p[oô]vodu)|1\s*Moj[zž]i[sš]ova|G(?:enezis|n)|Gen|1\s*M))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh(?:[aá]\s*kniha\s*Moj[zž]i[sš]ova|[yý]\s*(?:list\s*Moj[zž]i[sš]ova|Moj[zž]i[sš]ova)|[aá]\s*Moj[zž]i[sš]ova)|(?:2(?:\s*k)?|II)\.\s*Moj[zž]i[sš]ova|(?:2\s*k|II)\s*Moj[zž]i[sš]ova|2\s*Moj[zž]i[sš]ova|Exodus|Ex(?:od)?|2\s*M))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bel"],
        testament: "a",
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tret(?:(?:ia\s*kniha|í)\s*Moj[zž]i[sš]ova|i(?:a\s*Moj[zž]i[sš]ova|\s*Moj[zž]i[sš]ova))|(?:3(?:\s*k)?|III)\.\s*Moj[zž]i[sš]ova|(?:3\s*k|III)\s*Moj[zž]i[sš]ova|3\s*Moj[zž]i[sš]ova|L(?:evitikus|v)|Lev|3\s*M))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:[SŠ]tvrt[aá]\s*(?:kniha\s*Moj[zž]i[sš]ova|Moj[zž]i[sš]ova)|(?:4(?:\s*k)?|IV)\.\s*Moj[zž]i[sš]ova|(?:4\s*k|IV)\s*Moj[zž]i[sš]ova|4\s*Moj[zž]i[sš]ova|N(?:umeri|m)|Num|4\s*M))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Sir"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}]))((?:K(?:niha\s*(?:Sirachov(?:ho\s*syn|c(?:ov)?)a|Ekleziastikus)|\.\s*(?:Sirachov(?:ho\s*syn|c(?:ov)?)a|Ekleziastikus)|\s*(?:Sirachov(?:ho\s*syn|c(?:ov)?)a|Ekleziastikus))|Sir(?:achov(?:cova|ec))?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Wis"],
        testament: "a",
      ...
      },
      {
        osis: ["Lam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Pla[cč]\s*Jeremi[aá][sš]ov|Jeremi[aá][sš]ov\s*Pla[cč]|K(?:niha\s*n[aá]rekov|\.\s*n[aá]rekov|\s*n[aá]rekov)|[ZŽ]alospevy|[ZŽ]alosp|N[aá]reky|Pla[cč]|N[aá]r|Lam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["EpJer"],
        testament: "a",
      ...
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Piata\s*(?:kniha\s*Moj[zž]i[sš]ova|Moj[zž]i[sš]ova)|(?:(?:5\s*k|V)|5)\.\s*Moj[zž]i[sš]ova|D(?:euteron[oó]mium|t)|(?:5\s*k|V)\s*Moj[zž]i[sš]ova|5\s*Moj[zž]i[sš]ova|Deut|5\s*M))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prv(?:[aá]\s*kniha\s*Ezdr[aá][sš](?:ova)?|[yý]\s*(?:list\s*Ezdr[aá][sš](?:ova)?|Ezdr[aá][sš](?:ova)?)|[aá]\s*Ezdr[aá][sš](?:ova)?)|(?:(?:1\s*k|I)|1)\.\s*Ezdr[aá][sš](?:ova)?|(?:1\s*k|I)\s*Ezdr[aá][sš](?:ova)?|1(?:\s*Ezdr[aá][sš](?:ova)?|Esd)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh(?:[aá]\s*kniha\s*Ezdr[aá][sš](?:ova)?|[yý]\s*(?:list\s*Ezdr[aá][sš](?:ova)?|Ezdr[aá][sš](?:ova)?)|[aá]\s*Ezdr[aá][sš](?:ova)?)|(?:2(?:\s*k)?|II)\.\s*Ezdr[aá][sš](?:ova)?|(?:2\s*k|II)\s*Ezdr[aá][sš](?:ova)?|2(?:\s*Ezdr[aá][sš](?:ova)?|Esd)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh(?:(?:[aá]\s*kniha|[aá])\s*Samuelova|[yý]\s*(?:list\s*)?Samuelova)|(?:2(?:\s*k)?|II)\.\s*Samuelova|(?:2\s*k|II)\s*Samuelova|2(?:\s*Samuelova|(?:\s*S(?:am)?|Sam))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prv(?:(?:[aá]\s*kniha|[aá])\s*Samuelova|[yý]\s*(?:list\s*)?Samuelova)|(?:(?:1\s*k|I)|1)\.\s*Samuelova|(?:1\s*k|I)\s*Samuelova|1(?:\s*Samuelova|(?:\s*S(?:am)?|Sam))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:[SŠ]tvrt[aá]\s*(?:kniha\s*Kr[aá][lľ]ov|Kr[aá][lľ]ov)|Druh[aá]\s*(?:kniha\s*Kr[aá][lľ]ov|Kr[aá][lľ]ov)|(?:Druh[yý]\s*list|(?:[24]\s*k|[24])\.|I[IV]\.)\s*Kr[aá][lľ]ov|(?:Druh[yý]\s*K|4\s*K)r[aá][lľ]ov|(?:[24]\s*k\s*|I[IV]\s*)Kr[aá][lľ]ov|2\s*Kr[aá][lľ]ov|2(?:(?:\s*Kr[lľ]|Kgs)|\s*Kr)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tret(?:(?:ia\s*kniha|í)\s*Kr[aá][lľ]ov|i(?:a\s*Kr[aá][lľ]ov|\s*Kr[aá][lľ]ov))|(?:Prv[aá]\s*kniha|Prv[yý]\s*list|(?:[13]\s*k|[13])\.|I(?:II)?\.)\s*Kr[aá][lľ]ov|(?:Prv[yý]\s*K|Prv[aá]\s*K|3\s*K)r[aá][lľ]ov|(?:[13]\s*k\s*|I(?:II)?\s*)Kr[aá][lľ]ov|1\s*Kr[aá][lľ]ov|1(?:(?:\s*Kr[lľ]|Kgs)|\s*Kr)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh(?:(?:[aá]\s*kniha|[aá])\s*Paralipomenon|[yý]\s*(?:(?:list\s*)?Paralipomenon|list\s*Kron(?:i(?:ck[aá]|k)|ík)|Kron(?:i(?:ck[aá]|k)|ík))|[aá]\s*kniha\s*Kron(?:i(?:ck[aá]|k)|ík)|[aá]\s*Kron(?:i(?:ck[aá]|k)|ík))|(?:(?:2(?:\s*k)?|II)\.|(?:(?:2\s*k|II)|2))\s*Paralipomenon|(?:2(?:\s*k)?|II)\.\s*Kron(?:i(?:ck[aá]|k)|ík)|(?:2\s*k|II)\s*Kron(?:i(?:ck[aá]|k)|ík)|2(?:(?:\s*Kroni(?:ck[aá]|k)|(?:\s*Krn|Chr))|\s*Kroník)|2\s*Kron))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prv(?:(?:[aá]\s*kniha|[aá])\s*Paralipomenon|[yý]\s*(?:(?:list\s*)?Paralipomenon|list\s*Kron(?:i(?:ck[aá]|k)|ík)|Kron(?:i(?:ck[aá]|k)|ík))|[aá]\s*kniha\s*Kron(?:i(?:ck[aá]|k)|ík)|[aá]\s*Kron(?:i(?:ck[aá]|k)|ík))|(?:(?:(?:1\s*k|I)|1)\.|(?:(?:1\s*k|I)|1))\s*Paralipomenon|(?:(?:1\s*k|I)|1)\.\s*Kron(?:i(?:ck[aá]|k)|ík)|(?:1\s*k|I)\s*Kron(?:i(?:ck[aá]|k)|ík)|1(?:(?:\s*Kroni(?:ck[aá]|k)|(?:\s*Krn|Chr))|\s*Kroník)|1\s*Kron))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(Ez(?:d(?:r[aá][sš])?|ra))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Neh"],
        testament: "o",
      ...
      },
      {
        osis: ["GkEsth"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Gr[eé]cke\s*[cč]asti\s*knihy\s*Ester|Ester\s*gr|GkEsth))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Esth"],
        testament: "o",
      ...
      },
      {
        osis: ["Job"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:K(?:niha\s*J[oó]bova|\.\s*J[oó]bova|\s*J[oó]bova)|J[oó]b))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ps"],
        testament: "oa",
        testament_books: { "Ps": "oa" },
        regexp: /(?:^|(?<=[^\p{L}]))((?:K(?:niha\s*[zž]almov|\.\s*[zž]almov|\s*[zž]almov)|[ZŽ]al(?:t[aá]r|my)|[ZŽ](?:alm)?|Ps))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["PrAzar"],
        testament: "a",
      ...
      },
      {
        osis: ["Prov"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:K(?:niha\s*pr[ií]slov[ií]|\.\s*pr[ií]slov[ií]|\s*pr[ií]slov[ií])|Pr(?:(?:[ií]slovia|ov)|(?:[ií]s)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Eccl"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:K(?:(?:ohelet\s*—\s*Kazate[lľ]|niha\s*kazate[lľ]ova|\.\s*kazate[lľ]ova|\s*kazate[lľ]ova|azate[lľ])|(?:oh(?:elet)?|az))|E(?:kleziastes|ccl)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["SgThree"],
        testament: "a",
      ...
      },
      {
        osis: ["Song"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:V(?:e[lľ]piese[nň]\s*[SŠ]alam[uú]nova|[lľ]p)|Piese[nň]\s*[SŠ]alam[uú]nova|P(?:iese[nň]\s*piesn[ií]|Š)|Ve[lľ]p(?:iese[nň])?|Pies(?:e[nň])?|Song))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jer"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prv(?:[aá]\s*kniha\s*J[aá]nov|[yý]\s*(?:J(?:[aá]nov\s*list|[aá]nov)|list\s*J[aá]nov)|[aá]\s*J[aá]nov)|(?:(?:1\s*k|I)|1)\.\s*J[aá]nov|(?:1\s*k|I)\s*J[aá]nov|1\s*J[aá]nov|1(?:(?:Joh|\s*J)n|\s*J)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh(?:[aá]\s*kniha\s*J[aá]nov|[yý]\s*(?:J(?:[aá]nov\s*list|[aá]nov)|list\s*J[aá]nov)|[aá]\s*J[aá]nov)|(?:2(?:\s*k)?|II)\.\s*J[aá]nov|(?:2\s*k|II)\s*J[aá]nov|2\s*J[aá]nov|2(?:(?:Joh|\s*J)n|\s*J)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tret(?:i(?:a\s*(?:kniha\s*J[aá]nov|J[aá]nov)|\s*J[aá]nov(?:\s*list)?)|í\s*J[aá]nov(?:\s*list)?)|(?:3(?:\s*k)?|III)\.\s*J[aá]nov|(?:3\s*k|III)\s*J[aá]nov|3\s*J[aá]nov|3(?:Joh|\s*J)n|3\s*J))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh(?:[aá]\s*kniha\s*Korin(?:(?:tsk[yý]|tano)|ťano)m|[yý]\s*(?:list\s*Korin(?:(?:tsk[yý]|tano)|ťano)m|Korin(?:(?:tsk[yý]|tano)|ťano)m)|[aá]\s*Korin(?:(?:tsk[yý]|tano)|ťano)m)|(?:2(?:\s*k)?|II)\.\s*Korin(?:(?:tsk[yý]|tano)|ťano)m|(?:2\s*k|II)\s*Korin(?:(?:tsk[yý]|tano)|ťano)m|2\s*Korin(?:(?:tsk[yý]|tano)|ťano)m|2(?:\s*K|C)or))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prv(?:[aá]\s*kniha\s*Korin(?:(?:tsk[yý]|tano)|ťano)m|[yý]\s*(?:list\s*Korin(?:(?:tsk[yý]|tano)|ťano)m|Korin(?:(?:tsk[yý]|tano)|ťano)m)|[aá]\s*Korin(?:(?:tsk[yý]|tano)|ťano)m)|(?:(?:1\s*k|I)|1)\.\s*Korin(?:(?:tsk[yý]|tano)|ťano)m|(?:1\s*k|I)\s*Korin(?:(?:tsk[yý]|tano)|ťano)m|1\s*Korin(?:(?:tsk[yý]|tano)|ťano)m|1(?:\s*K|C)or))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh(?:[aá]\s*kniha\s*(?:Tesaloni(?:(?:cano|ck[yý])|čano)m|(?:Sol[uú]n[cč]ano|Sol[uú]nsky)m)|[yý]\s*(?:list\s*(?:Tesaloni(?:(?:cano|ck[yý])|čano)m|(?:Sol[uú]n[cč]ano|Sol[uú]nsky)m)|Tesaloni(?:(?:cano|ck[yý])|čano)m|(?:Sol[uú]n[cč]ano|Sol[uú]nsky)m)|[aá]\s*Tesaloni(?:(?:cano|ck[yý])|čano)m|(?:[aá]\s*Sol[uú]n[cč]ano|[aá]\s*Sol[uú]nsky)m)|(?:2(?:\s*k)?|II)\.\s*(?:Tesaloni(?:(?:cano|ck[yý])|čano)m|(?:Sol[uú]n[cč]ano|Sol[uú]nsky)m)|(?:2\s*k|II)\s*(?:Tesaloni(?:(?:cano|ck[yý])|čano)m|(?:Sol[uú]n[cč]ano|Sol[uú]nsky)m)|2\s*Tesaloni(?:(?:cano|ck[yý])|čano)m|2\s*Sol[uú]n[cč]anom|2\s*Sol[uú]nskym|2(?:Thess|\s*(?:Sol|Tes))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prv(?:[aá]\s*kniha\s*(?:Tesaloni(?:(?:cano|ck[yý])|čano)m|(?:Sol[uú]n[cč]ano|Sol[uú]nsky)m)|[yý]\s*(?:list\s*(?:Tesaloni(?:(?:cano|ck[yý])|čano)m|(?:Sol[uú]n[cč]ano|Sol[uú]nsky)m)|Tesaloni(?:(?:cano|ck[yý])|čano)m|(?:Sol[uú]n[cč]ano|Sol[uú]nsky)m)|[aá]\s*Tesaloni(?:(?:cano|ck[yý])|čano)m|(?:[aá]\s*Sol[uú]n[cč]ano|[aá]\s*Sol[uú]nsky)m)|(?:(?:1\s*k|I)|1)\.\s*(?:Tesaloni(?:(?:cano|ck[yý])|čano)m|(?:Sol[uú]n[cč]ano|Sol[uú]nsky)m)|(?:1\s*k|I)\s*(?:Tesaloni(?:(?:cano|ck[yý])|čano)m|(?:Sol[uú]n[cč]ano|Sol[uú]nsky)m)|1\s*Tesaloni(?:(?:cano|ck[yý])|čano)m|1\s*Sol[uú]n[cč]anom|1\s*Sol[uú]nskym|1(?:Thess|\s*(?:Sol|Tes))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh(?:[aá]\s*kniha\s*Timotej?ovi|[yý]\s*(?:list\s*Timotej?ovi|Timotej?ovi)|[aá]\s*Timotej?ovi)|(?:2(?:\s*k)?|II)\.\s*Timotej?ovi|(?:2\s*k|II)\s*Timotej?ovi|2\s*Timotej?ovi|2\s*?Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prv(?:[aá]\s*kniha\s*Timotej?ovi|[yý]\s*(?:list\s*Timotej?ovi|Timotej?ovi)|[aá]\s*Timotej?ovi)|(?:(?:1\s*k|I)|1)\.\s*Timotej?ovi|(?:1\s*k|I)\s*Timotej?ovi|1\s*Timotej?ovi|1\s*?Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh(?:(?:[aá]\s*kniha|[aá])\s*Petrov|[yý]\s*(?:Petrov(?:\s*list)?|list\s*Petrov))|(?:2(?:\s*k)?|II)\.\s*Petrov|(?:2\s*k|II)\s*Petrov|2\s*Petrov|2(?:\s*P|Pe)t))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prv(?:(?:[aá]\s*kniha|[aá])\s*Petrov|[yý]\s*(?:Petrov(?:\s*list)?|list\s*Petrov))|(?:(?:1\s*k|I)|1)\.\s*Petrov|(?:1\s*k|I)\s*Petrov|1\s*Petrov|1(?:\s*P|Pe)t))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["Jdt"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}]))((?:K(?:niha|\.?)\s*Juditina|J(?:(?:udita|dt)|udit)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bar"],
        testament: "a",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh(?:[aá]\s*kniha\s*Ma(?:ch|k)abejcov|[yý]\s*(?:list\s*Ma(?:ch|k)abejcov|Ma(?:ch|k)abejcov)|[aá]\s*Ma(?:ch|k)abejcov)|(?:2(?:\s*k)?|II)\.\s*Ma(?:ch|k)abejcov|(?:2\s*k|II)\s*Ma(?:ch|k)abejcov|2\s*Ma(?:ch|k)abejcov|2(?:\s*Ma(?:ch|k)|Macc)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tret(?:(?:ia\s*kniha|í)|ia?)\s*Machabejcov|(?:3(?:\s*k)?|III)\.\s*Machabejcov|(?:3\s*k|III)\s*Machabejcov|3(?:\s*Machabejcov|(?:\s*Mach|(?:\s*Mak|Macc)))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:[SŠ]tvrt[aá]\s*(?:kniha\s*)?Machabejcov|(?:4(?:\s*k)?|IV)\.\s*Machabejcov|(?:4\s*k|IV)\s*Machabejcov|4(?:\s*Machabejcov|(?:\s*Mach|(?:\s*Mak|Macc)))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prv(?:(?:[aá]\s*kniha\s*Mach|(?:[aá]\s*Mach|[aá]\s*Mak))abejcov|[yý]\s*(?:list\s*)?Machabejcov)|(?:(?:1\s*k|I)|1)\.\s*Machabejcov|(?:1\s*k|I)\s*Machabejcov|1(?:\s*Machabejcov|(?:\s*Mach|(?:\s*Mak|Macc)))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      }
    ];
  }
};
...
function peg$parse(input, options) {
  ...
  var peg$c13 = "/2";
  var peg$c14 = ".1";
  var peg$c15 = "kapitoly";
  var peg$c16 = "kapitole";
  var peg$c17 = "kapitolu";
  var peg$c18 = "kapitol";
  var peg$c19 = "hlavy";
  var peg$c20 = "kap";
  var peg$c21 = "ver";
  ...
  var peg$e18 = peg$classExpectation([["b", "e"]], false, false);
  var peg$e19 = peg$literalExpectation("kapitoly", false);
  var peg$e20 = peg$literalExpectation("kapitole", false);
  var peg$e21 = peg$literalExpectation("kapitolu", false);
  var peg$e22 = peg$literalExpectation("kapitol", false);
  var peg$e23 = peg$literalExpectation("hlavy", false);
  var peg$e24 = peg$literalExpectation("kap", false);
  var peg$e25 = peg$literalExpectation("ver", false);
  var peg$e26 = peg$classExpectation(["š", "s"], false, true);
  var peg$e27 = peg$literalExpectation("ov", false);
  var peg$e28 = peg$literalExpectation(":", false);
  var peg$e29 = peg$classExpectation(['"', "'"], false, false);
  var peg$e30 = peg$classExpectation([",", ";", "/", ":", "&", "-", "–", "—", "~"], false, false);
  var peg$e31 = peg$literalExpectation("porov", false);
  var peg$e32 = peg$literalExpectation("pozri", false);
  var peg$e33 = peg$literalExpectation("alebo", false);
  var peg$e34 = peg$literalExpectation("a", false);
  var peg$e35 = peg$classExpectation(["-", "–", "—"], false, false);
  var peg$e36 = peg$classExpectation(["ž", "z"], false, true);
  var peg$e37 = peg$literalExpectation("title", false);
  var peg$e38 = peg$literalExpectation("from", false);
  var peg$e39 = peg$literalExpectation("of", false);
  var peg$e40 = peg$literalExpectation("in", false);
  var peg$e41 = peg$literalExpectation("the", false);
  var peg$e42 = peg$literalExpectation("book", false);
  var peg$e43 = peg$classExpectation(["(", "["], false, false);
  var peg$e44 = peg$classExpectation([")", "]"], false, false);
  var peg$e45 = peg$literalExpectation("", false);
  var peg$e46 = peg$literalExpectation(",000", false);
