...
var bcv_regexps = class {
  constructor() {
    ...
    // The `(?:subt[íi]tulo|t[íi]tulo|t[íi]\`t)` has `[a-z]` instead of `\w` because it could be followed by a number.
    // [a-e] allows `1:1a`.
    this.escaped_passage = /(?:^|[^\x1e\x1f\p{L}\p{N}])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s.:,;\x1e\x1f&\(\)（）\[\]\\/"'\*=~\-–—]|(?:subt[íi]tulo|t[íi]tulo|tít)(?![a-z])|y\s+siguientes|vers[íi]culos|cap[íi]tulos|vers[íi]culo|cap[íi]tulo|y(?!\s+sig)|y\s+sig|caps|vers|cap|ver|vss|vs|vv|á|v|[a-e](?!\w)|$)+)/giu;
    ...
    this.match_end_split = /\d\W*(?:subt[íi]tulo|t[íi]tulo|tít)|\d\W*(?:y\s+siguientes|y\s+sig)(?:[\s*]*\.)?|\d[\s*]*[a-e](?!\w)|\x1e(?:[\s*]*[)\]\uff09])?|[\d\x1f]/gi;
    this.control = /[\x1e\x1f]/g;
    // These are needed for ranges outside of this class.
    this.first = String.raw`(?:1\.?[ºo]|1|I|Primero?)\.?\s*`;
    this.second = String.raw`(?:2\.?[ºo]|2|II|Segundo)\.?\s*`;
    this.third = String.raw`(?:3\.?[ºo]|3|III|Tercero?)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|y(?!\s+sig)|á)`;
    this.range_only = String.raw`(?:[\u2013\u2014-]|á)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Primero?\s*Esdras|(?:1(?:\.[oº]|[oº])|I)\.\s*Esdras|(?:(?:1(?:\.[oº]|[oº])|I)|1\.)\s*Esdras|1(?:\s*Esdras|(?:\s*Esdr?|Esd))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Segundo\s*Esdras|(?:2(?:\.[oº]|[oº])|II)\.\s*Esdras|(?:(?:2(?:\.[oº]|[oº])|2\.)|II)\s*Esdras|2(?:\s*Esdras|(?:\s*Esdr?|Esd))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Segundo\s*Samuel|(?:2(?:\.[oº]|[oº])|II)\.\s*Samuel|(?:(?:2(?:\.[oº]|[oº])|2\.)|II)\s*Samuel|2(?:\s*Samuel|(?:\s*S(?:am?)?|(?:\s*S|Sa)m))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Primero?\s*Samuel|(?:1(?:\.[oº]|[oº])|I)\.\s*Samuel|(?:(?:1(?:\.[oº]|[oº])|I)|1\.)\s*Samuel|1(?:\s*Samuel|(?:\s*S(?:am?)?|(?:\s*S|Sa)m))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Segundo\s*Reyes|(?:2(?:\.[oº]|[oº])|II)\.\s*Reyes|(?:(?:2(?:\.[oº]|[oº])|2\.)|II)\s*Reyes|2(?:\s*R(?:(?:e?ye?s|(?:ee|e?)s)|(?:e?ye?|ee|e)?)|Kgs)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Primero?\s*Reyes|(?:1(?:\.[oº]|[oº])|I)\.\s*Reyes|(?:(?:1(?:\.[oº]|[oº])|I)|1\.)\s*Reyes|1(?:\s*R(?:(?:e?ye?s|(?:ee|e?)s)|(?:e?ye?|ee|e)?)|Kgs)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Segundo\s*Cr[oó]nicas|(?:2(?:\.[oº]|[oº])|II)\.\s*Cr[oó]nicas|(?:(?:2(?:\.[oº]|[oº])|2\.)|II)\s*Cr[oó]nicas|2\s*Cr[oó]nicas|2(?:\s*Cr(?:[oó]n?)?|Chr)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Primer(?:o\s*Cr[oó]nicas|\s*Cr[oó]nicas)|(?:1(?:\.[oº]|[oº])|I)\.\s*Cr[oó]nicas|(?:(?:1(?:\.[oº]|[oº])|I)|1\.)\s*Cr[oó]nicas|1\s*Cr[oó]nicas|1(?:\s*Cr(?:[oó]n?)?|Chr)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["SgThree"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:El\s*(?:Canto\s*de\s*los\s*(?:Tres\s*J[oó]venes\s*(?:Hebre|Jud[ií])os|3\s*J[oó]venes\s*(?:Hebre|Jud[ií])os)|Himno\s*de\s*los\s*(?:Tres\s*J[oó]venes\s*(?:Hebre|Jud[ií])os|3\s*J[oó]venes\s*(?:Hebre|Jud[ií])os))|(?:Canto\s*de\s*los\s*(?:Tres|3)\s*J[oó]venes\s*|Himno\s*de\s*los\s*3\s*J[oó]venes\s*)(?:Hebre|Jud[ií])os|Himno\s*de\s*los\s*Tres\s*J[oó]venes\s*Jud[ií]os|Canto\s*de\s*los\s*(?:Tres|3)\s*J[oó]venes|Himno\s*de\s*los\s*(?:Tres\s*J[oó]venes|3\s*J[oó]venes)|(?:Tres\s*J[oó]vene|3\s*J[oó]vene)s|Ct\s*3\s*J[oó]|SgThree))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Song"],
        testament: "o",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Segundo\s*Mac(?:cab(?:be(?:eos?|os?)|e(?:eos?|os?))|ab(?:be(?:eos?|os?)|e(?:eos?|os?)))|(?:2(?:\.[oº]|[oº])|II)\.\s*Mac(?:cab(?:be(?:eos?|os?)|e(?:eos?|os?))|ab(?:be(?:eos?|os?)|e(?:eos?|os?)))|(?:(?:2(?:\.[oº]|[oº])|2\.)|II)\s*Mac(?:cab(?:be(?:eos?|os?)|e(?:eos?|os?))|ab(?:be(?:eos?|os?)|e(?:eos?|os?)))|2\s*Macc?ab(?:be(?:eos?|os?)|e(?:eos?|os?))|2(?:\s*M(?:acc?)?|(?:Mac|\s*M)c)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tercer(?:o\s*Mac(?:cab(?:be(?:eos?|os?)|e(?:eos?|os?))|ab(?:be(?:eos?|os?)|e(?:eos?|os?)))|\s*Mac(?:cab(?:be(?:eos?|os?)|e(?:eos?|os?))|ab(?:be(?:eos?|os?)|e(?:eos?|os?))))|(?:3(?:\.[oº]|[oº])|III)\.\s*Mac(?:cab(?:be(?:eos?|os?)|e(?:eos?|os?))|ab(?:be(?:eos?|os?)|e(?:eos?|os?)))|(?:(?:3(?:\.[oº]|[oº])|3\.)|III)\s*Mac(?:cab(?:be(?:eos?|os?)|e(?:eos?|os?))|ab(?:be(?:eos?|os?)|e(?:eos?|os?)))|3\s*Macc?ab(?:be(?:eos?|os?)|e(?:eos?|os?))|3(?:\s*M(?:acc?)?|(?:Mac|\s*M)c)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Cuarto\s*Mac(?:cab(?:be(?:eos?|os?)|e(?:eos?|os?))|ab(?:be(?:eos?|os?)|e(?:eos?|os?)))|(?:4(?:\.[oº]|[oº])|IV)\.\s*Mac(?:cab(?:be(?:eos?|os?)|e(?:eos?|os?))|ab(?:be(?:eos?|os?)|e(?:eos?|os?)))|(?:(?:4(?:\.[oº]|[oº])|4\.)|IV)\s*Mac(?:cab(?:be(?:eos?|os?)|e(?:eos?|os?))|ab(?:be(?:eos?|os?)|e(?:eos?|os?)))|4\s*Macc?ab(?:be(?:eos?|os?)|e(?:eos?|os?))|4(?:\s*M(?:acc?)?|(?:Mac|\s*M)c)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Primer(?:o\s*Mac(?:cab(?:be(?:eos?|os?)|e(?:eos?|os?))|ab(?:be(?:eos?|os?)|e(?:eos?|os?)))|\s*Mac(?:cab(?:be(?:eos?|os?)|e(?:eos?|os?))|ab(?:be(?:eos?|os?)|e(?:eos?|os?))))|(?:1(?:\.[oº]|[oº])|I)\.\s*Mac(?:cab(?:be(?:eos?|os?)|e(?:eos?|os?))|ab(?:be(?:eos?|os?)|e(?:eos?|os?)))|(?:(?:1(?:\.[oº]|[oº])|I)|1\.)\s*Mac(?:cab(?:be(?:eos?|os?)|e(?:eos?|os?))|ab(?:be(?:eos?|os?)|e(?:eos?|os?)))|1\s*Macc?ab(?:be(?:eos?|os?)|e(?:eos?|os?))|1(?:\s*M(?:acc?)?|(?:Mac|\s*M)c)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mark"],
        testament: "n",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Primer(?:o\s*(?:San\s*J[au][au]n|J[au][au]n)|\s*(?:San\s*J[au][au]n|J[au][au]n))|(?:1(?:\.[oº]|[oº])|I)\.\s*(?:San\s*J[au][au]n|J[au][au]n)|(?:(?:1(?:\.[oº]|[oº])|I)|1\.)\s*(?:San\s*J[au][au]n|J[au][au]n)|1\s*San\s*J[au][au]n|1\s*J[au][au]n|1(?:Joh|\s*J)n))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Segundo\s*(?:San\s*J[au][au]n|J[au][au]n)|(?:2(?:\.[oº]|[oº])|II)\.\s*(?:San\s*J[au][au]n|J[au][au]n)|(?:(?:2(?:\.[oº]|[oº])|2\.)|II)\s*(?:San\s*J[au][au]n|J[au][au]n)|2\s*San\s*J[au][au]n|2\s*J[au][au]n|2(?:Joh|\s*J)n))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tercer(?:o\s*(?:San\s*J[au][au]n|J[au][au]n)|\s*(?:San\s*J[au][au]n|J[au][au]n))|(?:3(?:\.[oº]|[oº])|III)\.\s*(?:San\s*J[au][au]n|J[au][au]n)|(?:(?:3(?:\.[oº]|[oº])|3\.)|III)\s*(?:San\s*J[au][au]n|J[au][au]n)|3\s*San\s*J[au][au]n|3\s*J[au][au]n|3(?:Joh|\s*J)n))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:El\s*Evangelio\s*de\s*J[au][au]n|(?:(?:San\s*Jua|Joh)|J)n|J[au][au]n))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Segundo\s*Corintios|(?:2(?:\.[oº]|[oº])|II)\.\s*Corintios|(?:(?:2(?:\.[oº]|[oº])|2\.)|II)\s*Corintios|2(?:\s*Corintios|(?:\s*Co(?:r(?:in(?:ti?)?)?)?|(?:\s*Corini|Cor)))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Primero?\s*Corintios|(?:1(?:\.[oº]|[oº])|I)\.\s*Corintios|(?:(?:1(?:\.[oº]|[oº])|I)|1\.)\s*Corintios|1(?:\s*Corintios|(?:\s*Co(?:r(?:in(?:ti?)?)?)?|(?:\s*Corini|Cor)))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Segundo\s*Tesaloni[cs]enses?|(?:2(?:\.[oº]|[oº])|II)\.\s*Tesaloni[cs]enses?|(?:(?:2(?:\.[oº]|[oº])|2\.)|II)\s*Tesaloni[cs]enses?|2(?:\s*Tesaloni[cs]enses?|(?:(?:\s*T(?:hes)?|Thes)s|\s*Tes))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Primer(?:o\s*Tesaloni[cs]enses?|\s*Tesaloni[cs]enses?)|(?:1(?:\.[oº]|[oº])|I)\.\s*Tesaloni[cs]enses?|(?:(?:1(?:\.[oº]|[oº])|I)|1\.)\s*Tesaloni[cs]enses?|1(?:\s*Tesaloni[cs]enses?|(?:(?:\s*T(?:hes)?|Thes)s|\s*Tes))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Segundo\s*Timoteo|(?:2(?:\.[oº]|[oº])|II)\.\s*Timoteo|(?:(?:2(?:\.[oº]|[oº])|2\.)|II)\s*Timoteo|2(?:\s*Timoteo|(?:\s*Tim?|(?:\s*T|Ti)m))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Primero?\s*Timoteo|(?:1(?:\.[oº]|[oº])|I)\.\s*Timoteo|(?:(?:1(?:\.[oº]|[oº])|I)|1\.)\s*Timoteo|1(?:\s*Timoteo|(?:\s*Tim?|(?:\s*T|Ti)m))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Segundo\s*(?:San\s*)?Pedro|(?:2(?:\.[oº]|[oº])|II)\.\s*(?:San\s*)?Pedro|(?:(?:2(?:\.[oº]|[oº])|2\.)|II)\s*(?:San\s*)?Pedro|2(?:\s*San\s*Pedro|(?:\s*Pedro|(?:\s*P(?:ed?)?|(?:\s*Pd|Pet))))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Primer(?:o\s*(?:San\s*)?Pedro|\s*(?:San\s*)?Pedro)|(?:1(?:\.[oº]|[oº])|I)\.\s*(?:San\s*)?Pedro|(?:(?:1(?:\.[oº]|[oº])|I)|1\.)\s*(?:San\s*)?Pedro|1(?:\s*San\s*Pedro|(?:\s*Pedro|(?:\s*P(?:ed?)?|(?:\s*Pd|Pet))))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
...
function peg$parse(input, options) {
  ...
  var peg$e13 = peg$literalExpectation("siguientes", false);
  var peg$e14 = peg$literalExpectation("sig", false);
  ...
  var peg$e21 = peg$literalExpectation("cap", false);
  var peg$e22 = peg$classExpectation(["í", "i"], false, true);
  var peg$e23 = peg$literalExpectation("tulos", false);
  var peg$e24 = peg$literalExpectation("tulo", false);
  var peg$e25 = peg$literalExpectation("s", false);
  var peg$e26 = peg$literalExpectation("v", false);
  var peg$e27 = peg$literalExpectation("ers", false);
  var peg$e28 = peg$literalExpectation("culos", false);
  var peg$e29 = peg$literalExpectation("culo", false);
  var peg$e30 = peg$literalExpectation("er", false);
  var peg$e31 = peg$literalExpectation("ss", false);
  ...
  var peg$e36 = peg$literalExpectation("á", true);
  var peg$e37 = peg$literalExpectation("subt", false);
  var peg$e38 = peg$literalExpectation("t", false);
  var peg$e39 = peg$literalExpectation("tít", true);
