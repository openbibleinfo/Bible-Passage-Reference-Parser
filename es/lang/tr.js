...
var bcv_regexps = class {
  constructor() {
    ...
    // The `ba[şs]l[İIiı]k` has `[a-z]` instead of `\w` because it could be followed by a number.
    // [b-e] allows `1:1a`.
    this.escaped_passage = /(?:^|[^\x1e\x1f\p{L}\p{N}])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s.:,;\x1e\x1f&\(\)（）\[\]\\/"'\*=~\-–—]|ba[şs]l[İIiı]k(?![a-z])|baplar|ayeti|ayet|bap|ile|a\.|bp|vs|vd|ve|[b-e](?!\w)|$)+)/giu;
    ...
    this.match_end_split = /\d\W*ba[şs]l[İIiı]k|\d\W*(?:vs|vd)(?:[\s*]*\.)?|\d[\s*]*[b-e](?!\w)|\x1e(?:[\s*]*[)\]\uff09])?|[\d\x1f]/gi;
    this.control = /[\x1e\x1f]/g;
    // These are needed for ranges outside of this class.
    this.first = String.raw`(?:1|I|Bir|Birinci|[İIiı]lk)\.?\s*`;
    this.second = String.raw`(?:2|II|[İIiı]ki|[İIiı]kinci)\.?\s*`;
    this.third = String.raw`(?:3|III|[ÜU][çc]|[ÜU][çc][üu]nc[üu])\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|ve|ile)`;
    this.range_only = String.raw`(?:[\u2013\u2014-]|ile)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Birinci|[1I]\.)\s*Esdras|(?:Bir|[1I])\s*Esdras|Ilk\s*Esdras|[iİı]lk\s*Esdras|1Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Iki(?:nci)?\s*Esdras|[iİı]ki(?:nci)?\s*Esdras|(?:II|2)\.\s*Esdras|(?:II|2)\s*Esdras|2Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Iki(?:nci)?\s*Samuel|[iİı]ki(?:nci)?\s*Samuel|II\.\s*Samuel|2\.?\s*Samuel|II\s*Samuel|2(?:(?:\.\s*|\s*?)Sa|Sam)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Birinci|I\.)\s*Samuel|(?:Bir|I)\s*Samuel|Ilk\s*Samuel|[iİı]lk\s*Samuel|1\.?\s*Samuel|1(?:(?:\.\s*|\s*?)Sa|Sam)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Iki(?:nci)?\s*Krallar|[iİı]ki(?:nci)?\s*Krallar|II\.\s*Krallar|2\.?\s*Krallar|II\s*Krallar|2(?:\.?\s*Kr|K(?:gs|r))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Birinci|I\.)\s*Krallar|(?:Bir|I)\s*Krallar|Ilk\s*Krallar|[iİı]lk\s*Krallar|1\.?\s*Krallar|1(?:\.?\s*Kr|K(?:gs|r))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Iki(?:nci\s*Tar[Iiİı]hler|\s*Tar[Iiİı]hler)|[iİı]ki(?:nci\s*Tar[Iiİı]hler|\s*Tar[Iiİı]hler)|II\.\s*Tar[Iiİı]hler|2\.?\s*Tar[Iiİı]hler|II\s*Tar[Iiİı]hler|2(?:(?:\.?\s*Ta|Ta)|Chr)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Birinci|I\.)\s*Tar[Iiİı]hler|(?:Bir|I)\s*Tar[Iiİı]hler|Ilk\s*Tar[Iiİı]hler|[iİı]lk\s*Tar[Iiİı]hler|1\.?\s*Tar[Iiİı]hler|1(?:(?:\.?\s*Ta|Ta)|Chr)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["Matt"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))(Mat(?:t(?:a(?:(?:['’])?ya\s*G[oö]re\s*[Iiİı]ncil|(?:['’])?a\s*G[oö]re\s*[Iiİı]ncil|['’](?:n[Iiuİı]|[Iiuİı])n\s*[Iiİı]ncili|(?:n[Iiuİı]|u)n\s*[Iiİı]ncili|[Iiİı]n\s*[Iiİı]ncili|[Iiİı]ncili)?)?)?)(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mark"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))(Mar(?:k(?:os(?:(?:['’])?ya\s*G[oö]re\s*[Iiİı]ncil|(?:['’])?a\s*G[oö]re\s*[Iiİı]ncil|['’](?:n[Iiuİı]|[Iiuİı])n\s*[Iiİı]ncili|(?:n[Iiuİı]|u)n\s*[Iiİı]ncili|[Iiİı]n\s*[Iiİı]ncili|[Iiİı]ncili)?)?)?)(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Luke"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))(Luk(?:a(?:(?:['’])?ya\s*G[oö]re\s*[Iiİı]ncil|(?:['’])?a\s*G[oö]re\s*[Iiİı]ncil|['’](?:n[Iiuİı]|[Iiuİı])n\s*[Iiİı]ncili|(?:n[Iiuİı]|u)n\s*[Iiİı]ncili|[Iiİı]n\s*[Iiİı]ncili|[Iiİı]ncili)|a|e)?)(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Birinci|I\.)\s*Yuhanna|(?:Bir|I)\s*Yuhanna|Ilk\s*Yuhanna|[iİı]lk\s*Yuhanna|1\.?\s*Yuhanna|1(?:\.?\s*Yu|(?:John|Yu))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Iki(?:nci)?\s*Yuhanna|[iİı]ki(?:nci)?\s*Yuhanna|II\.\s*Yuhanna|2\.?\s*Yuhanna|II\s*Yuhanna|2(?:\.?\s*Yu|(?:John|Yu))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:[UÜ][cç](?:[uü]nc[uü]\s*Yuhanna|\s*Yuhanna)|III\.\s*Yuhanna|III\s*Yuhanna|3\.?\s*Yuhanna|3(?:\.?\s*Yu|(?:John|Yu))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Yu(?:hanna(?:(?:['’])?ya\s*G[oö]re\s*[Iiİı]ncil|(?:['’])?a\s*G[oö]re\s*[Iiİı]ncil|['’](?:n[Iiuİı]|[Iiuİı])n\s*[Iiİı]ncili|(?:n[Iiuİı]|u)n\s*[Iiİı]ncili|[Iiİı]n\s*[Iiİı]ncili|[Iiİı]ncili)|(?:h(?:anna)?)?)|John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Iki(?:nci\s*Kor[Iiİı]nt(?:oslula|l[Iiİı]le)r|\s*Kor[Iiİı]nt(?:oslula|l[Iiİı]le)r)|[iİı]ki(?:nci\s*Kor[Iiİı]nt(?:oslula|l[Iiİı]le)r|\s*Kor[Iiİı]nt(?:oslula|l[Iiİı]le)r)|II\.\s*Kor[Iiİı]nt(?:oslula|l[Iiİı]le)r|2\.?\s*Kor[Iiİı]nt(?:oslula|l[Iiİı]le)r|II\s*Kor[Iiİı]nt(?:oslula|l[Iiİı]le)r|2(?:(?:\.?\s*Ko|Ko)|Cor)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Birinci|I\.)\s*Kor[Iiİı]nt(?:oslula|l[Iiİı]le)r|(?:Bir|I)\s*Kor[Iiİı]nt(?:oslula|l[Iiİı]le)r|Ilk\s*Kor[Iiİı]nt(?:oslula|l[Iiİı]le)r|[iİı]lk\s*Kor[Iiİı]nt(?:oslula|l[Iiİı]le)r|1\.?\s*Kor[Iiİı]nt(?:oslula|l[Iiİı]le)r|1(?:(?:\.?\s*Ko|Ko)|Cor)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Iki(?:nci\s*Selan[Iiİı]kl[Iiİı]ler|\s*Selan[Iiİı]kl[Iiİı]ler)|[iİı]ki(?:nci\s*Selan[Iiİı]kl[Iiİı]ler|\s*Selan[Iiİı]kl[Iiİı]ler)|II\.\s*Selan[Iiİı]kl[Iiİı]ler|2\.?\s*Selan[Iiİı]kl[Iiİı]ler|II\s*Selan[Iiİı]kl[Iiİı]ler|2(?:(?:Thess|Se)|\.?\s*Se)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Birinci|I\.)\s*Selan[Iiİı]kl[Iiİı]ler|(?:Bir|I)\s*Selan[Iiİı]kl[Iiİı]ler|Ilk\s*Selan[Iiİı]kl[Iiİı]ler|[iİı]lk\s*Selan[Iiİı]kl[Iiİı]ler|1\.?\s*Selan[Iiİı]kl[Iiİı]ler|1(?:(?:Thess|Se)|\.?\s*Se)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Iki(?:nci\s*T[Iiİı]moteos|\s*T[Iiİı]moteos)|[iİı]ki(?:nci\s*T[Iiİı]moteos|\s*T[Iiİı]moteos)|II\.\s*T[Iiİı]moteos|2(?:\.\s*T[Iiİı]m|\s*T[Iiİı]m)oteos|II\s*T[Iiİı]moteos|2(?:(?:\.\s*T[Iiİı]|\s*T[Iiİı]|Ti)|Tim)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Birinci|I\.)\s*T[Iiİı]moteos|(?:Bir|I)\s*T[Iiİı]moteos|Ilk\s*T[Iiİı]moteos|[iİı]lk\s*T[Iiİı]moteos|1(?:\.\s*T[Iiİı]m|\s*T[Iiİı]m)oteos|1(?:(?:\.\s*T[Iiİı]|\s*T[Iiİı]|Ti)|Tim)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Iki(?:nci)?\s*Petrus|[iİı]ki(?:nci)?\s*Petrus|II\.\s*Petrus|2\.?\s*Petrus|II\s*Petrus|2(?:(?:\.\s*|\s*?)Pe|Pet)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Birinci|I\.)\s*Petrus|(?:Bir|I)\s*Petrus|Ilk\s*Petrus|[iİı]lk\s*Petrus|1\.?\s*Petrus|1(?:(?:\.\s*|\s*?)Pe|Pet)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["Sus"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}]))(Su(?:zanna|s))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Iki(?:nci)?\s*Makabeler|[iİı]ki(?:nci)?\s*Makabeler|(?:II|2)\.\s*Makabeler|(?:II|2)\s*Makabeler|2Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:[UÜ][cç](?:[uü]nc[uü]\s*Makabeler|\s*Makabeler)|(?:III|3)\.\s*Makabeler|(?:III|3)\s*Makabeler|3Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:D[oö]r(?:d[uü]nc[uü]\s*Makabeler|t\s*Makabeler)|(?:IV|4)\.\s*Makabeler|(?:IV|4)\s*Makabeler|4Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Birinci|[1I]\.)\s*Makabeler|(?:Bir|[1I])\s*Makabeler|Ilk\s*Makabeler|[iİı]lk\s*Makabeler|1Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      }
    ];
  }
};
...
function peg$parse(input, options) {
  ...
  var peg$e12 = peg$literalExpectation("vs", false);
  var peg$e13 = peg$literalExpectation("vd", false);
  ...
  var peg$e19 = peg$classExpectation([["b", "e"]], false, false);
  var peg$e20 = peg$literalExpectation("b", false);
  var peg$e21 = peg$literalExpectation("aplar", false);
  var peg$e22 = peg$literalExpectation("ap", false);
  var peg$e23 = peg$literalExpectation("p", false);
  var peg$e24 = peg$literalExpectation("a", false);
  var peg$e25 = peg$literalExpectation("yeti", false);
  var peg$e26 = peg$literalExpectation("yet", false);
  var peg$e27 = peg$literalExpectation(":", false);
  var peg$e28 = peg$classExpectation(['"', "'"], false, false);
  var peg$e29 = peg$classExpectation([",", ";", "/", ":", "&", "-", "–", "—", "~"], false, false);
  var peg$e30 = peg$literalExpectation("ve", false);
  var peg$e31 = peg$classExpectation(["-", "–", "—"], false, false);
  var peg$e32 = peg$literalExpectation("ile", false);
  var peg$e33 = peg$literalExpectation("ba", false);
  var peg$e34 = peg$classExpectation(["ş", "s"], false, true);
  var peg$e35 = peg$literalExpectation("l", false);
  var peg$e36 = peg$classExpectation(["İ", "I", "i", "ı"], false, true);
  var peg$e37 = peg$literalExpectation("k", false);
