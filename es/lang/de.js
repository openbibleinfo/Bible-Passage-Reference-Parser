...
var bcv_regexps = class {
  constructor() {
    ...
    // The `Titel` has `[a-z]` instead of `\w` because it could be followed by a number.
    // [a-e] allows `1:1a`.
    this.escaped_passage = /(?:^|[^\x1e\x1f\p{L}\p{N}])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s.:,;\x1e\x1f&\(\)（）\[\]\\/"'\*=~\-–—]|Titel(?![a-z])|ff(?![a-z0-9äaöoüu])|f(?![a-z0-9äaöoüu])|und\s+siehe\s+auch|sowie\s+auch|siehe\s+auch|und\s+siehe|und\s+auch|Kapiteln|Kapiteln|Kapitel|Versen|Verses|siehe|sowie|Verse|Vers|Vers|Kap|bis|und|vgl|Vs|u|&|[a-e](?!\w)|$)+)/giu;
    ...
    this.match_end_split = /\d\W*Titel|\d\W*f(?![a-z0-9äaöoüu])(?:[\s*]*\.)?|\d\W*ff(?![a-z0-9äaöoüu])(?:[\s*]*\.)?|\d[\s*]*[a-e](?!\w)|\x1e(?:[\s*]*[)\]\uff09])?|[\d\x1f]/gi;
    this.control = /[\x1e\x1f]/g;
    // These are needed for ranges outside of this class.
    this.first = String.raw`(?:Erste[nrs]?|1)\.?\s*`;
    this.second = String.raw`(?:Zweite[nrs]?|2)\.?\s*`;
    this.third = String.raw`(?:Dritte[nrs]?|3)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|(?:und\s+siehe\s+auch|und\s+siehe|und\s+auch|sowie\s+auch|siehe\s+auch|siehe|sowie|und|u|&|vgl)|bis)`;
    this.range_only = String.raw`(?:[\u2013\u2014-]|bis)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Erste(?:[nrs]\s*(?:Buch\s*)?Mose|\s*(?:Buch\s*)?Mose)|1\.?\s*Buch\s*Mose|G(?:enesis|n)|1\.?\s*Mose|1(?:\.\s*Mos?|\s*Mos?)|Gen))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Zweite(?:[nrs]\s*(?:Buch\s*)?Mose|\s*(?:Buch\s*)?Mose)|2\.?\s*Buch\s*Mose|2\.?\s*Mose|2(?:\.\s*Mos?|\s*Mos?)|Exodus|Ex(?:od)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bel"],
        testament: "a",
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dritte(?:[nrs]\s*(?:Buch\s*)?Mose|\s*(?:Buch\s*)?Mose)|3\.?\s*Buch\s*Mose|L(?:evitikus|v)|3\.?\s*Mose|3(?:\.\s*Mos?|\s*Mos?)|Lev))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Vierte(?:[ns]\s*(?:Buch\s*)?Mose|\s*(?:Buch\s*)?Mose)|4\.?\s*Buch\s*Mose|4\.?\s*Mose|4(?:\.\s*Mos?|\s*Mos?)|N(?:umeri|m)|Num))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Sir"],
        testament: "a",
      ...
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:F[uü]nftes\s*(?:Buch\s*)?Mose|D(?:euteronomium|tn)|5\.?\s*Buch\s*Mose|5\.?\s*Mose|5(?:\.\s*Mos?|\s*Mos?)|D(?:eu)?t))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Erste(?:[nrs]\s*Esd?ra|\s*Esd?ra)|1(?:(?:\.\s*Esd?ra|\s*Esd?ra|Esd)|(?:\.\s*Es(?:dr|r)?|\s*Es(?:dr|r)?))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Zweite(?:[nrs]\s*Esd?ra|\s*Esd?ra)|2(?:(?:\.\s*Esd?ra|\s*Esd?ra|Esd)|(?:\.\s*Es(?:dr|r)?|\s*Es(?:dr|r)?))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Zweite(?:[nrs])?\s*Samuel|2\.?\s*Samuel|2(?:(?:\.\s*Sam?|\s*Sam?)|Sam)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Erste(?:[nrs])?\s*Samuel|1\.?\s*Samuel|1(?:(?:\.\s*Sam?|\s*Sam?)|Sam)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Zweite(?:[nrs]\s*K(?:(?:oe|ö)|o)nige|\s*K(?:(?:oe|ö)|o)nige)|2(?:\.\s*K(?:(?:oe|ö)|o)ni|\s*K(?:(?:oe|ö)|o)ni)ge|2(?:(?:\.\s*K(?:(?:oe|ö)n?|on?)|\s*K(?:(?:oe|ö)n?|on?))|(?:\.\s*Kng|\s*Kng|Kgs))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Erste(?:[nrs]\s*K(?:(?:oe|ö)|o)nige|\s*K(?:(?:oe|ö)|o)nige)|1(?:\.\s*K(?:(?:oe|ö)|o)ni|\s*K(?:(?:oe|ö)|o)ni)ge|1(?:(?:\.\s*K(?:(?:oe|ö)n?|on?)|\s*K(?:(?:oe|ö)n?|on?))|(?:\.\s*Kng|\s*Kng|Kgs))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Zweite(?:[nrs])?\s*Chronik|2\.?\s*Chronik|2(?:(?:\.\s*Chr(?:on)?|\s*Chr(?:on)?)|Chr)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Erste(?:[nrs])?\s*Chronik|1\.?\s*Chronik|1(?:(?:\.\s*Chr(?:on)?|\s*Chr(?:on)?)|Chr)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(E(?:sra?|zra))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Neh"],
        testament: "o",
      ...
      },
      {
        osis: ["SgThree"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Gesang\s*der\s*(?:drei(?:\s*(?:(?:M(?:(?:ae|ä)|a)nner\s*i|i)m\s*Feuerofen|M(?:(?:ae|ä)|a)nner))?|Drei)|SgThree|L3J))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Song"],
        testament: "o",
      ...
      },
      {
        osis: ["Matt"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Das\s*Evangelium\s*nach\s*Matth(?:(?:ae|ä)|a)us|Evangelium\s*nach\s*Matth(?:(?:ae|ä)|a)us|M(?:(?:atth(?:(?:ae|ä)|a)usevangelium|t)|att(?:h(?:(?:ae|ä)|a)us)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mark"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Das\s*Evangelium\s*nach\s*Markus|Evangelium\s*nach\s*Markus|M(?:(?:arkusevangelium|k)|ark(?:us)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Luke"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Das\s*Evangelium\s*nach\s*Lukas|Evangelium\s*nach\s*Lukas|L(?:(?:uk(?:asevangelium|e)|k)|uk(?:as)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Erste(?:[nrs])?\s*Johannes|1\.?\s*Johannes|1(?:(?:\.\s*Joh?|\s*Joh?)|John)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Zweite(?:[nrs])?\s*Johannes|2\.?\s*Johannes|2(?:(?:\.\s*Joh?|\s*Joh?)|John)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dritte(?:[nrs])?\s*Johannes|3\.?\s*Johannes|3(?:(?:\.\s*Joh?|\s*Joh?)|John)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Das\s*Evangelium\s*nach\s*Johannes|Evangelium\s*nach\s*Johannes|Joh(?:(?:annesevangelium|n)|(?:annes)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Zweite(?:[nrs])?\s*Korinther|2\.?\s*Korinther|2(?:\.?\s*Kor|Cor)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Erste(?:[nrs])?\s*Korinther|1\.?\s*Korinther|1(?:\.?\s*Kor|Cor)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Zweite(?:[nrs])?\s*Thessalonicher|2\.?\s*Thessalonicher|2(?:(?:\.\s*Th(?:ess)?|\s*Th(?:ess)?)|Thess)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Erste(?:[nrs])?\s*Thessalonicher|1\.?\s*Thessalonicher|1(?:(?:\.\s*Th(?:ess)?|\s*Th(?:ess)?)|Thess)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Zweite(?:[nrs])?\s*Timotheus|2\.?\s*Timotheus|2(?:\.?\s*Tim|Tim)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Erste(?:[nrs])?\s*Timotheus|1\.?\s*Timotheus|1(?:\.?\s*Tim|Tim)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Zweite(?:[nrs])?\s*Petrus|2\.?\s*Petrus|2(?:(?:\.\s*Petr?|\s*Petr?)|(?:\.\s*P|(?:Pe|\s*P))t)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Erste(?:[nrs])?\s*Petrus|1\.?\s*Petrus|1(?:(?:\.\s*Petr?|\s*Petr?)|(?:\.\s*P|(?:Pe|\s*P))t)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Zweite(?:[nrs]\s*Makkab(?:aee?|äe)r|\s*Makkab(?:aee?|äe)r)|2\.?\s*Makkab(?:aee?|äe)r|2(?:\.?\s*Makk|Macc)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dritte(?:[nrs]\s*Makkab(?:aee?|äe)r|\s*Makkab(?:aee?|äe)r)|3\.?\s*Makkab(?:aee?|äe)r|3(?:\.?\s*Makk|Macc)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Vierte(?:[ns]\s*Makkab(?:aee?|äe)r|\s*Makkab(?:aee?|äe)r)|4\.?\s*Makkab(?:aee?|äe)r|4(?:\.?\s*Makk|Macc)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Erste(?:[nrs]\s*Makkab(?:aee?|äe)r|\s*Makkab(?:aee?|äe)r)|1\.?\s*Makkab(?:aee?|äe)r|1(?:\.?\s*Makk|Macc)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      }
    ];
  }
};
...
function peg$parse(input, options) {
  ...
  var peg$e13 = peg$classExpectation([["a", "z"], ["0", "9"], "ä", "a", "ö", "o", "ü", "u"], false, true);
  ...
  var peg$e21 = peg$literalExpectation("kap", false);
  var peg$e22 = peg$literalExpectation("iteln", false);
  var peg$e23 = peg$literalExpectation("itel", false);
  var peg$e24 = peg$literalExpectation("v", false);
  var peg$e25 = peg$literalExpectation("ersen", false);
  var peg$e26 = peg$literalExpectation("erses", false);
  var peg$e27 = peg$literalExpectation("erse", false);
  var peg$e28 = peg$literalExpectation("ers", false);
  ...
  var peg$e33 = peg$literalExpectation("und", false);
  var peg$e34 = peg$literalExpectation("siehe", false);
  var peg$e35 = peg$literalExpectation("auch", false);
  var peg$e36 = peg$literalExpectation("sowie", false);
  var peg$e37 = peg$literalExpectation("u", false);
  var peg$e38 = peg$literalExpectation("&", false);
  var peg$e39 = peg$literalExpectation("vgl", false);
  var peg$e40 = peg$classExpectation(["-", "–", "—"], false, false);
  var peg$e41 = peg$literalExpectation("bis", false);
  var peg$e42 = peg$literalExpectation("titel", false);
  var peg$e43 = peg$literalExpectation("from", false);
  var peg$e44 = peg$literalExpectation("of", false);
  var peg$e45 = peg$literalExpectation("in", false);
  var peg$e46 = peg$literalExpectation("the", false);
  var peg$e47 = peg$literalExpectation("book", false);
  var peg$e48 = peg$classExpectation(["(", "["], false, false);
  var peg$e49 = peg$classExpectation([")", "]"], false, false);
  var peg$e50 = peg$literalExpectation("", false);
  var peg$e51 = peg$literalExpectation(",000", false);
