...
var bcv_regexps = class {
  constructor() {
    ...
    // The `johdannolla` has `[a-z]` instead of `\w` because it could be followed by a number.
    // [a-e] allows `1:1a`.
    this.escaped_passage = /(?:^|[^\x1e\x1f\p{L}\p{N}])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s.:,;\x1e\x1f&\(\)（）\[\]\\/"'\*=~\-–—]|johdannolla(?![a-z])|ja(?![a-z])|jakeissa|jakeet|luvut|luvun|luku|vrt|ss|–|[a-e](?!\w)|$)+)/giu;
    ...
    this.first = String.raw`(?:Ensimm[äa]inen|1|I)\.?\s*`;
    this.second = String.raw`(?:Toinen|2|II)\.?\s*`;
    this.third = String.raw`(?:Kolmas|3|III)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|(?:ja(?![a-z])|vrt)|–)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ensimm[aä]inen\s*Mooseksen(?:\s*kirja)?|[1I]\.\s*Mooseksen(?:\s*kirja)?|1\s*Mooseksen(?:\s*kirja)?|I\s*Mooseksen(?:\s*kirja)?|1\s*Moos|Gen))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Toinen\s*Mooseksen(?:\s*kirja)?|(?:II|2)\.\s*Mooseksen(?:\s*kirja)?|II\s*Mooseksen(?:\s*kirja)?|2\s*Mooseksen(?:\s*kirja)?|2\s*Moos|Exod))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bel"],
        testament: "a",
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Kolmas\s*Mooseksen(?:\s*kirja)?|(?:III|3)\.\s*Mooseksen(?:\s*kirja)?|III\s*Mooseksen(?:\s*kirja)?|3\s*Mooseksen(?:\s*kirja)?|3\s*Moos|Lev))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Nelj[aä]s|4\.)\s*Mooseksen(?:\s*kirja)?|IV(?:\.\s*Mooseksen(?:\s*kirja)?|\s*Mooseksen(?:\s*kirja)?)|4\s*Mooseksen(?:\s*kirja)?|4\s*Moos|Num))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Sir"],
        testament: "a",
      ...
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:V(?:iides\s*Mooseksen(?:\s*kirja)?|\.\s*Mooseksen(?:\s*kirja)?|\s*Mooseksen(?:\s*kirja)?)|5\.\s*Mooseksen(?:\s*kirja)?|5\s*Mooseksen(?:\s*kirja)?|5\s*Moos|Deut))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ensimm[aä]inen\s*Esra|[1I]\.\s*Esra|1(?:\s*Esra|(?:\s*Es|Esd))|I\s*Esra))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Toinen\s*Esra|(?:II|2)\.\s*Esra|II\s*Esra|2(?:\s*Esra|(?:\s*Es|Esd))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Toinen\s*Samuelin(?:\s*kirja)?|(?:II|2)\.\s*Samuelin(?:\s*kirja)?|II\s*Samuelin(?:\s*kirja)?|2\s*Samuelin(?:\s*kirja)?|2\s*?Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ensimm[aä]inen\s*Samuelin(?:\s*kirja)?|[1I]\.\s*Samuelin(?:\s*kirja)?|1\s*Samuelin(?:\s*kirja)?|I\s*Samuelin(?:\s*kirja)?|1\s*?Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Toinen\s*Kuninkaiden(?:\s*kirja)?|(?:II|2)\.\s*Kuninkaiden(?:\s*kirja)?|II\s*Kuninkaiden(?:\s*kirja)?|2(?:\s*Kuninkaiden(?:\s*kirja)?|(?:\s*Kun|Kgs))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ensimm[aä]inen\s*Kuninkaiden(?:\s*kirja)?|[1I]\.\s*Kuninkaiden(?:\s*kirja)?|1(?:\s*Kuninkaiden(?:\s*kirja)?|(?:\s*Kun|Kgs))|I\s*Kuninkaiden(?:\s*kirja)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Toinen\s*Aikakirja|(?:II|2)\.\s*Aikakirja|II\s*Aikakirja|2(?:\s*Aikakirja|(?:\s*Aik(?:ak)?|Chr))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ensimm[aä]inen\s*Aikakirja|[1I]\.\s*Aikakirja|1(?:\s*Aikakirja|(?:\s*Aik(?:ak)?|Chr))|I\s*Aikakirja))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ensimm[aä]inen\s*Johanneksen(?:\s*kirje)?|[1I]\.\s*Johanneksen(?:\s*kirje)?|1(?:\s*Johanneksen(?:\s*kirje)?|(?:\s*Joh|John))|I\s*Johanneksen(?:\s*kirje)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Toinen\s*Joh(?:anneksen(?:\s*kirje)?)?|(?:II|2)\.\s*Joh(?:anneksen(?:\s*kirje)?)?|(?:II|2)\s*Joh(?:anneksen(?:\s*kirje)?)?|2John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Kolmas\s*Johanneksen(?:\s*kirje)?|(?:III|3)\.\s*Johanneksen(?:\s*kirje)?|III\s*Johanneksen(?:\s*kirje)?|3(?:\s*Johanneksen(?:\s*kirje)?|(?:\s*Joh|John))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Evankeliumi\s*Johanneksen\s*mukaan|Joh(?:(?:anneksen\s*evankeliumi|n)|(?:anneksen)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Toinen\s*K(?:irje\s*korinttilaisill|orintt(?:olaiskirj|ilaisill))e|(?:II|2)\.\s*K(?:irje\s*korinttilaisill|orintt(?:olaiskirj|ilaisill))e|II\s*K(?:irje\s*korinttilaisill|orintt(?:olaiskirj|ilaisill))e|2\s*Kirje\s*korinttilaisille|2\s*Korinttolaiskirje|2\s*Korinttilaisille|2(?:\s*K|C)or))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ensimm[aä]inen\s*K(?:irje\s*korinttilaisill|orintt(?:olaiskirj|ilaisill))e|[1I]\.\s*K(?:irje\s*korinttilaisill|orintt(?:olaiskirj|ilaisill))e|1\s*Kirje\s*korinttilaisille|I\s*K(?:irje\s*korinttilaisill|orintt(?:olaiskirj|ilaisill))e|1\s*Korinttolaiskirje|1\s*Korinttilaisille|1(?:\s*K|C)or))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Toinen\s*(?:Kirje\s*tessalonikalaisill|Tessalonikalais(?:kirj|ill))e|(?:II|2)\.\s*(?:Kirje\s*tessalonikalaisill|Tessalonikalais(?:kirj|ill))e|II\s*(?:Kirje\s*tessalonikalaisill|Tessalonikalais(?:kirj|ill))e|2\s*Kirje\s*tessalonikalaisille|2\s*Tessalonikalaiskirje|2\s*Tessalonikalaisille|2(?:\s*T|Th)ess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ensimm[aä]inen\s*(?:Kirje\s*tessalonikalaisill|Tessalonikalais(?:kirj|ill))e|[1I]\.\s*(?:Kirje\s*tessalonikalaisill|Tessalonikalais(?:kirj|ill))e|1\s*Kirje\s*tessalonikalaisille|I\s*(?:Kirje\s*tessalonikalaisill|Tessalonikalais(?:kirj|ill))e|1\s*Tessalonikalaiskirje|1\s*Tessalonikalaisille|1(?:\s*T|Th)ess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Toinen\s*(?:Kirje\s*Timoteuksell|Timoteu(?:skirj|ksell))e|(?:II|2)\.\s*(?:Kirje\s*Timoteuksell|Timoteu(?:skirj|ksell))e|II\s*(?:Kirje\s*Timoteuksell|Timoteu(?:skirj|ksell))e|2\s*Kirje\s*Timoteukselle|2\s*Timoteuskirje|2\s*Timoteukselle|2\s*?Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ensimm[aä]inen\s*(?:Kirje\s*Timoteuksell|Timoteu(?:skirj|ksell))e|[1I]\.\s*(?:Kirje\s*Timoteuksell|Timoteu(?:skirj|ksell))e|1\s*Kirje\s*Timoteukselle|I\s*(?:Kirje\s*Timoteuksell|Timoteu(?:skirj|ksell))e|1\s*Timoteuskirje|1\s*Timoteukselle|1\s*?Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Toinen\s*Pietarin(?:\s*kirje)?|(?:II|2)\.\s*Pietarin(?:\s*kirje)?|II\s*Pietarin(?:\s*kirje)?|2\s*Pietarin(?:\s*kirje)?|2(?:\s*Pi|P)et))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ensimm[aä]inen\s*Pietarin(?:\s*kirje)?|[1I]\.\s*Pietarin(?:\s*kirje)?|1\s*Pietarin(?:\s*kirje)?|I\s*Pietarin(?:\s*kirje)?|1(?:\s*Pi|P)et))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Toinen\s*makkabilaiskirja|(?:II|2)\.\s*makkabilaiskirja|II\s*makkabilaiskirja|2(?:\s*makkabilaiskirja|(?:\s*makk|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Kolmas\s*makkabilaiskirja|(?:III|3)\.\s*makkabilaiskirja|III\s*makkabilaiskirja|3(?:\s*makkabilaiskirja|(?:\s*makk|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Nelj[aä]s\s*makkabilaiskirja|(?:IV|4)\.\s*makkabilaiskirja|IV\s*makkabilaiskirja|4(?:\s*makkabilaiskirja|(?:\s*makk|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ensimm[aä]inen\s*makkabilaiskirja|[1I]\.\s*makkabilaiskirja|1(?:\s*makkabilaiskirja|(?:\s*makk|Macc))|I\s*makkabilaiskirja))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      }
    ];
  }
};
...
function peg$parse(input, options) {
  ...
  var peg$e12 = peg$literalExpectation("ss", false);
  ...
  var peg$e19 = peg$literalExpectation("lu", false);
  var peg$e20 = peg$literalExpectation("ku", false);
  var peg$e21 = peg$literalExpectation("vut", false);
  var peg$e22 = peg$literalExpectation("vun", false);
  var peg$e23 = peg$literalExpectation("jake", false);
  var peg$e24 = peg$literalExpectation("et", false);
  var peg$e25 = peg$literalExpectation("issa", false);
  var peg$e26 = peg$literalExpectation(":", false);
  var peg$e27 = peg$classExpectation(['"', "'"], false, false);
  var peg$e28 = peg$classExpectation([",", ";", "/", ":", "&", "-", "–", "—", "~"], false, false);
  var peg$e29 = peg$literalExpectation("ja", false);
  var peg$e30 = peg$literalExpectation("vrt", false);
  var peg$e31 = peg$classExpectation(["-", "–", "—"], false, false);
  var peg$e32 = peg$literalExpectation("–", true);
  var peg$e33 = peg$literalExpectation("johdannolla", false);
