    ...
    books = [
      {
        ...
        osis: ["Gen"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Te(?:sn[Iİı]ye|kv[Iİı]n)|Gen|Yar(?:at[Iİı]l(?:[Iİı][sş]))?)|(?:Yarat(?:[ıİI]li[şs]|il[iıİI][şs])|Te(?:sniye|kvin)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Exod"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:M[Iİı]s(?:[Iİı]r(?:(?:['’]dan[\\s\\xa0]*(?:[CÇ](?:[Iİı]k(?:[Iİı][sş])))|dan[\\s\\xa0]*[CÇ](?:[Iİı]k(?:[Iİı][sş])))))|Exod|[CÇ](?:[Iİı]k))|(?:M(?:[ıIİ]s(?:(?:[İıI]r(?:(?:['’]dan[\\s\\xa0]*(?:[ÇC](?:(?:[ıİI]ki[sş]|ik[ıIiİ][sş])))|dan[\\s\\xa0]*[ÇC](?:(?:[İıI]ki[sş]|ik[iİıI][şs]))))|ir(?:[’']dan[\\s\\xa0]*(?:[ÇC](?:[iıIİ]k(?:[ıİIi][şs])))|dan[\\s\\xa0]*[CÇ](?:[Iİiı]k(?:[ıİIi][şs])))))|is[İIıi]r(?:(?:['’]dan[\\s\\xa0]*(?:[ÇC](?:[iİıI]k(?:[İıiI][sş])))|dan[\\s\\xa0]*[ÇC](?:[ıiİI]k(?:[iİIı][sş])))))|[CÇ](?:(?:[İıI]k(?:[İıIi][sş])|ik(?:[iİIı][sş])?))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Bel"],
        apocrypha: true,
        ...
        osis: ["Num"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:[CÇ](?:[oö]lde[\\s\\xa0]*Say(?:[Iİı]m))|Num|Say(?:[Iİı]lar)?)|(?:[CÇ](?:[öo]lde[\\s\\xa0]*Sayim)|Sayilar))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Sir"],
        apocrypha: true,
        ...
        osis: ["PrMan"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Mana[sş](?:[sş]e(?:(?:['’]n(?:[Iİı]n[\\s\\xa0]*Duas[Iİı])|n[Iİı]n[\\s\\xa0]*Duas[Iİı])))|PrMan)|Mana(?:[sş](?:[sş]e(?:(?:['’]n(?:in[\\s\\xa0]*Duas[Iıiİ]|[ıIİ]n[\\s\\xa0]*Duasi))|n(?:[Iıİ]n[\\s\\xa0]*Duasi|in[\\s\\xa0]*Duas[İıIi])))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Deut"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Deut|Yas(?:a(?:['’]n(?:[Iİı]n[\\s\\xa0]*Tekrar[Iİı])|n[Iİı]n[\\s\\xa0]*Tekrar[Iİı]))?)|Yasa(?:['’]n(?:(?:[Iıİ]n[\\s\\xa0]*Tekrari|in[\\s\\xa0]*Tekrar[Iiİı]))|n(?:[İıI]n[\\s\\xa0]*Tekrari|in[\\s\\xa0]*Tekrar[Iİiı])))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Josh"],
        ...
        osis: ["PrAzar"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Azarya(?:['’]n(?:[Iİı]n[\\s\\xa0]*Duas[Iİı])|n[Iİı]n[\\s\\xa0]*Duas[Iİı])|PrAzar)|Azarya(?:['’]n(?:(?:[Iİı]n[\\s\\xa0]*Duasi|in[\\s\\xa0]*Duas[İıiI]))|n(?:[Iıİ]n[\\s\\xa0]*Duasi|in[\\s\\xa0]*Duas[İıiI])))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Prov"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:S[uü]leyman(?:(?:['’](?:[Iİı]n[\\s\\xa0]*(?:(?:[OÖ]zdey(?:[Iİı](?:[sş]ler[Iİı]))|Meseller[Iİı])))|[Iİı]n[\\s\\xa0]*(?:(?:[OÖ]zdey(?:[Iİı](?:[sş]ler[Iİı]))|Meseller[Iİı]))))|Meseller|Prov|[OÖ]zd)|S[uü]leyman(?:(?:['’](?:(?:[Iİı]n[\\s\\xa0]*(?:(?:[OÖ]zdey(?:(?:[Iİı](?:[sş]leri)|i[şs]ler[iİıI]))|Meselleri))|in[\\s\\xa0]*(?:[ÖO]zdey(?:[İiıI](?:[şs]ler[İIıi]))|Meseller[iıIİ])))|[İıI]n[\\s\\xa0]*(?:(?:[ÖO]zdey(?:(?:[ıİI](?:[şs]leri)|i[sş]ler[İıIi]))|Meselleri))|in[\\s\\xa0]*(?:[OÖ]zdey(?:[İiıI](?:[sş]ler[iIıİ]))|Meseller[Iiıİ]))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eccl"],
        ...
        osis: ["SgThree"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:[UÜ](?:[cç][\\s\\xa0]*Gen(?:[cç][\\s\\xa0]*Adam(?:[Iİı]n[\\s\\xa0]*Ezg(?:[Iİı]s[Iİı]))))|SgThree)|[UÜ](?:[çc][\\s\\xa0]*Gen(?:[çc][\\s\\xa0]*Adam(?:(?:[İIı]n[\\s\\xa0]*Ezg(?:(?:[ıİI]si|is[iIİı]))|in[\\s\\xa0]*Ezg[ıIiİ]s[İIıi])))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Song"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Song|Ezg[Iİı]ler[\\s\\xa0]*Ezg(?:[Iİı]s[Iİı])?)|Ezg|Ezg(?:[İIı]ler[\\s\\xa0]*Ezg(?:(?:[ıİI]si|is[İıiI]))|iler[\\s\\xa0]*Ezg[Iıİi]s[iıİI]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jer"],
        ...
        osis: ["Matt"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Matta['’](?:a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]ncil)|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)))|Matta['’](?:n(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)))|Matta['’](?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili))|Mat(?:t(?:a(?:[uı]n[\\s\\xa0]*(?:[Iİ]ncili)|[İI]n(?:[\\s\\xa0]*(?:[Iİ]ncili|cili))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]ncil)|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|['’]ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]ncil))|ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]ncil)))?)?|Matta(?:[Iİ]ncili)|Matta['’](?:a[\\s\\xa0]*G(?:[öo]re[\\s\\xa0]*incil|n[ıuIİ]n[\\s\\xa0]*incili|[İıuI]n[\\s\\xa0]*incili))|Matta['’](?:n(?:[ıuIİ]n[\\s\\xa0]*incili|[İıuI]n[\\s\\xa0]*incili))|Matta['’](?:[İıuI]n[\\s\\xa0]*incili)|Matta(?:['’]ya[\\s\\xa0]*G(?:[öo]re[\\s\\xa0]*incil)|n[ıIuİ]n[\\s\\xa0]*incili|[İıuI]n[\\s\\xa0]*incili|ya[\\s\\xa0]*G[öo]re[\\s\\xa0]*incil|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*incil|incili)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mark"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Markos['’](?:a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]ncil)|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)))|Markos['’](?:n(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)))|Markos['’](?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili))|Mar(?:k(?:os(?:[uı]n[\\s\\xa0]*(?:[Iİ]ncili)|[İI]n(?:[\\s\\xa0]*(?:[Iİ]ncili|cili))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]ncil)|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|['’]ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]ncil))|ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]ncil)))?)?|Markos(?:[Iİ]ncili)|Markos['’](?:a[\\s\\xa0]*G(?:[öo]re[\\s\\xa0]*incil|n[uIıİ]n[\\s\\xa0]*incili|[Iİıu]n[\\s\\xa0]*incili))|Markos['’](?:n(?:[uIıİ]n[\\s\\xa0]*incili|[Iİıu]n[\\s\\xa0]*incili))|Markos['’](?:[Iİıu]n[\\s\\xa0]*incili)|Markos(?:['’]ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*incil)|n[Iİıu]n[\\s\\xa0]*incili|[İıuI]n[\\s\\xa0]*incili|ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*incil|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*incil|incili)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Luke"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Luka['’](?:a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]ncil)|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)))|Luka['’](?:n(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)))|Luka['’](?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili))|Luk(?:a(?:[uı]n[\\s\\xa0]*(?:[Iİ]ncili)|[İI]n(?:[\\s\\xa0]*(?:[Iİ]ncili|cili))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]ncil)|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|['’]ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]ncil))|ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]ncil))|e)?|Luka(?:[Iİ]ncili)|Luka['’](?:a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*incil|n[İıuI]n[\\s\\xa0]*incili|[ıIuİ]n[\\s\\xa0]*incili))|Luka['’](?:n(?:[İıuI]n[\\s\\xa0]*incili|[ıIuİ]n[\\s\\xa0]*incili))|Luka['’](?:[ıIuİ]n[\\s\\xa0]*incili)|Luka(?:['’]ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*incil)|n[uIİı]n[\\s\\xa0]*incili|[İıuI]n[\\s\\xa0]*incili|ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*incil|a[\\s\\xa0]*G[öo]re[\\s\\xa0]*incil|incili)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1John"],
        ...
        osis: ["Heb"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Heb|[Iİı]br(?:an(?:[Iİı]ler)?))|(?:[Iİı]br)|(?:[Iİı]braniler|ibr(?:an[iıİI]ler)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jas"],
