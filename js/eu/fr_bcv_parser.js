...
(function() {
  ...
  bcv_parser.prototype.regexps.translations = /(?:(?:LSG(?:21)?|BDS|NEG1979))\b/gi;
    ...
    books = [
      {
        ...
        osis: ["Gen"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(G(?:e(?:n(?:[èe]se)?)?|n))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Exod"],
        ...
        osis: ["Bel"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Bel(?:[\\s\\xa0]*et[\\s\\xa0]*le[\\s\\xa0]*(?:[dD]ragon|[sS]erpent))?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Lev"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(L(?:(?:[ée](?:v(?:itique)?)?)|v))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Num"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(N(?:o(?:m(?:b(?:res)?)?)?|um|[mb]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Sir"],
        apocrypha: true,
        ...
        osis: ["Lam"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(La(?:m(?:entations(?:[\\s\\xa0]*de[\\s\\xa0]*J[eé]r(?:[ée]mie))?)?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["EpJer"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ep(?:\\.[\\s\\xa0]*J(?:[eé]r(?:[ée]mie)?)|Jer|[\\s\\xa0]*J(?:[eé]r(?:[ée]mie)?)|[iî]tre[\\s\\xa0]*de[\\s\\xa0]*J(?:[eé]r(?:[eé]mie)))|Ép(?:\\.[\\s\\xa0]*J(?:[eé]r(?:[eé]mie)?)|[\\s\\xa0]*J(?:[ée]r(?:[ée]mie)?)|[îi]tre[\\s\\xa0]*de[\\s\\xa0]*J(?:[eé]r(?:[ée]mie)))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rev"],
        ...
        osis: ["PrMan"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Pr(?:\\.[\\s\\xa0]*Man(?:ass[ée])?|i[eè]re[\\s\\xa0]*de[\\s\\xa0]*Manass[ée]|[\\s\\xa0]*Man(?:ass[ée])?|Man)|La[\\s\\xa0]*Pri[eè]re[\\s\\xa0]*de[\\s\\xa0]*Manass[ée]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Deut"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(D(?:eu(?:t(?:[ée]ronome)?)?|t))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Josh"],
        ...
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:\.[\s\xa0]*Esdras|re(?:\.[\s\xa0]*Esdras|[\s\xa0]*Esdras)|[\s\xa0]*Es(?:d(?:r(?:as)?)?)?|Esd|er(?:\.[\s\xa0]*Esdras|[\s\xa0]*Esdras)|ère(?:\.[\s\xa0]*Esdras|[\s\xa0]*Esdras))|I(?:\.[\s\xa0]*Esdras|[\s\xa0]*Esdras)|Premi(?:er(?:s[\s\xa0]*Esdras|[\s\xa0]*Esdras)|ère(?:s[\s\xa0]*Esdras|[\s\xa0]*Esdras))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Deuxième(?:s[\s\xa0]*Esdras|[\s\xa0]*Esdras)|II(?:\.[\s\xa0]*Esdras|[\s\xa0]*Esdras)|2(?:\.[\s\xa0]*Esdras|d(?:\.[\s\xa0]*Esdras|[\s\xa0]*Esdras|e(?:\.[\s\xa0]*Esdras|[\s\xa0]*Esdras))|[\s\xa0]*Es(?:d(?:r(?:as)?)?)?|Esd|e(?:\.[\s\xa0]*Esdras|[\s\xa0]*Esdras)|ème(?:\.[\s\xa0]*Esdras|[\s\xa0]*Esdras))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Isa"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:[ÉIE]s(?:a(?:[iï]e)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*S(?:a(?:m(?:uel)?)?)?|\.[\s\xa0]*Samuel|d(?:\.[\s\xa0]*Samuel|e(?:\.[\s\xa0]*Samuel|[\s\xa0]*Samuel)|[\s\xa0]*Samuel)|e(?:\.[\s\xa0]*Samuel|[\s\xa0]*Samuel)|ème(?:\.[\s\xa0]*Samuel|[\s\xa0]*Samuel)|Sam)|Deuxième(?:s[\s\xa0]*Samuel|[\s\xa0]*Samuel)|II(?:\.[\s\xa0]*Samuel|[\s\xa0]*Samuel)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:\.[\s\xa0]*Samuel|[\s\xa0]*Samuel)|Premi(?:er(?:s[\s\xa0]*Samuel|[\s\xa0]*Samuel)|ère(?:s[\s\xa0]*Samuel|[\s\xa0]*Samuel))|1(?:[\s\xa0]*S(?:a(?:m(?:uel)?)?)?|\.[\s\xa0]*Samuel|re(?:\.[\s\xa0]*Samuel|[\s\xa0]*Samuel)|er(?:\.[\s\xa0]*Samuel|[\s\xa0]*Samuel)|Sam|ère(?:\.[\s\xa0]*Samuel|[\s\xa0]*Samuel))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Deuxième(?:[\s\xa0]*Rois|s[\s\xa0]*Rois)|2(?:d(?:e(?:[\s\xa0]*Rois|\.[\s\xa0]*Rois)|[\s\xa0]*Rois|\.[\s\xa0]*Rois)|ème(?:[\s\xa0]*Rois|\.[\s\xa0]*Rois)|e(?:[\s\xa0]*Rois|\.[\s\xa0]*Rois)|Kgs|[\s\xa0]*R(?:ois)?|\.[\s\xa0]*Rois)|II(?:[\s\xa0]*Rois|\.[\s\xa0]*Rois)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:re(?:[\s\xa0]*Rois|\.[\s\xa0]*Rois)|ère(?:[\s\xa0]*Rois|\.[\s\xa0]*Rois)|er(?:[\s\xa0]*Rois|\.[\s\xa0]*Rois)|Kgs|[\s\xa0]*R(?:ois)?|\.[\s\xa0]*Rois)|Premi(?:er(?:[\s\xa0]*Rois|s[\s\xa0]*Rois)|ère(?:[\s\xa0]*Rois|s[\s\xa0]*Rois))|I(?:[\s\xa0]*Rois|\.[\s\xa0]*Rois)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Deuxième(?:s[\s\xa0]*Chroniques|[\s\xa0]*Chroniques)|2(?:d(?:\.[\s\xa0]*Chroniques|e(?:\.[\s\xa0]*Chroniques|[\s\xa0]*Chroniques)|[\s\xa0]*Chroniques)|ème(?:\.[\s\xa0]*Chroniques|[\s\xa0]*Chroniques)|\.[\s\xa0]*Chroniques|[\s\xa0]*Ch(?:r(?:o(?:n(?:iques)?)?)?)?|e(?:\.[\s\xa0]*Chroniques|[\s\xa0]*Chroniques)|Chr)|II(?:\.[\s\xa0]*Chroniques|[\s\xa0]*Chroniques)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:\.[\s\xa0]*Chroniques|re(?:\.[\s\xa0]*Chroniques|[\s\xa0]*Chroniques)|ère(?:\.[\s\xa0]*Chroniques|[\s\xa0]*Chroniques)|[\s\xa0]*Ch(?:r(?:o(?:n(?:iques)?)?)?)?|Chr|er(?:\.[\s\xa0]*Chroniques|[\s\xa0]*Chroniques))|Premi(?:er(?:s[\s\xa0]*Chroniques|[\s\xa0]*Chroniques)|ère(?:s[\s\xa0]*Chroniques|[\s\xa0]*Chroniques))|I(?:\.[\s\xa0]*Chroniques|[\s\xa0]*Chroniques)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(E(?:zra|sd(?:r(?:as)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Neh"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(N(?:[ée](?:h(?:[eé]mie)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["GkEsth"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Esth(?:[\\s\\xa0]*[Gg]r|er[\\s\\xa0]*(?:(?:[gG]r(?:ec)?)|\\([gG]rec\\)))|GkEsth))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Esth"],
        ...
        osis: ["PrAzar"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:La[\\s\\xa0]*Pri[èe]re[\\s\\xa0]*d(?:['’]Azaria[hs])|Pr(?:Azar|\\.[\\s\\xa0]*Azar|[\\s\\xa0]*Azar|i[èe]re[\\s\\xa0]*d(?:['’]Azaria[hs]))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Prov"],
        ...
        osis: ["SgThree"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:SgThree|C(?:antique[\s\xa0]*des[\s\xa0]*(?:3[\s\xa0]*Enfants|Trois[\s\xa0]*Enfants)|t[\s\xa0]*3[\s\xa0]*E)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Song"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Song|C(?:a(?:ntique(?:s|[\\s\\xa0]*des[\\s\\xa0]*[Cc]antiques)?)?|nt|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jer"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(J(?:(?:[ée](?:r(?:[ée]m(?:ie)?)?)?)|r))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ezek"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Éz(?:[ée]ch(?:iel)?)|Ez(?:é(?:ch(?:iel)?)?|e(?:k|ch(?:iel)?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Dan"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Da(?:n(?:iel)?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hos"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Os(?:[eé]e)?|Hos))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Joel"],
        ...
        osis: ["Hab"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Ha(?:b(?:a(?:k(?:uk)?|c(?:uc)?))?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Zeph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:So(?:ph(?:onie)?)?|Zeph))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hag"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Hag|Ag(?:g(?:[ée]e)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Zech"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Z(?:a(?:c(?:c(?:h(?:arie)?)?|h(?:arie)?)?|h)?|ech|c))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(M(?:al(?:ch?|ac(?:h(?:ie)?)?)?|l))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Matt"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(M(?:at(?:t(?:h(?:ieu)?)?)?|t))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mark"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(M(?:[cr]|ar[ck]?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Luke"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(L(?:u(?:c|ke)?|c))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:\.[\s\xa0]*Jean|[\s\xa0]*Jean)|Premi(?:er(?:s[\s\xa0]*Jean|[\s\xa0]*Jean)|ère(?:s[\s\xa0]*Jean|[\s\xa0]*Jean))|1(?:ère(?:\.[\s\xa0]*Jean|[\s\xa0]*Jean)|\.[\s\xa0]*Jean|John|re(?:\.[\s\xa0]*Jean|[\s\xa0]*Jean)|[\s\xa0]*J(?:n|ean)|er(?:\.[\s\xa0]*Jean|[\s\xa0]*Jean))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Deuxième(?:s[\s\xa0]*Jean|[\s\xa0]*Jean)|2(?:d(?:e(?:\.[\s\xa0]*Jean|[\s\xa0]*Jean)|\.[\s\xa0]*Jean|[\s\xa0]*Jean)|e(?:\.[\s\xa0]*Jean|[\s\xa0]*Jean)|\.[\s\xa0]*Jean|John|[\s\xa0]*J(?:n|ean)|ème(?:\.[\s\xa0]*Jean|[\s\xa0]*Jean))|II(?:\.[\s\xa0]*Jean|[\s\xa0]*Jean)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:3(?:e(?:\.[\s\xa0]*Jean|[\s\xa0]*Jean)|\.[\s\xa0]*Jean|John|[\s\xa0]*J(?:n|ean)|ème(?:\.[\s\xa0]*Jean|[\s\xa0]*Jean))|III(?:\.[\s\xa0]*Jean|[\s\xa0]*Jean)|Troisième(?:s[\s\xa0]*Jean|[\s\xa0]*Jean)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(J(?:ohn|n|ean))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Acts"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Ac(?:t(?:es(?:[\\s\\xa0]*des[\\s\\xa0]*Ap[ôo]tres)?|s)?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rom"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(R(?:o(?:m(?:ains)?)?|m))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Deuxième(?:s[\s\xa0]*Corinthiens|[\s\xa0]*Corinthiens)|II(?:\.[\s\xa0]*Corinthiens|[\s\xa0]*Corinthiens)|2(?:d(?:e(?:\.[\s\xa0]*Corinthiens|[\s\xa0]*Corinthiens)|\.[\s\xa0]*Corinthiens|[\s\xa0]*Corinthiens)|ème(?:\.[\s\xa0]*Corinthiens|[\s\xa0]*Corinthiens)|e(?:\.[\s\xa0]*Corinthiens|[\s\xa0]*Corinthiens)|Cor|\.[\s\xa0]*Corinthiens|[\s\xa0]*Co(?:r(?:inthiens)?)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Premi(?:er(?:s[\s\xa0]*Corinthiens|[\s\xa0]*Corinthiens)|ère(?:s[\s\xa0]*Corinthiens|[\s\xa0]*Corinthiens))|I(?:\.[\s\xa0]*Corinthiens|[\s\xa0]*Corinthiens)|1(?:re(?:\.[\s\xa0]*Corinthiens|[\s\xa0]*Corinthiens)|ère(?:\.[\s\xa0]*Corinthiens|[\s\xa0]*Corinthiens)|er(?:\.[\s\xa0]*Corinthiens|[\s\xa0]*Corinthiens)|Cor|\.[\s\xa0]*Corinthiens|[\s\xa0]*Co(?:r(?:inthiens)?)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Gal"],
        ...
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Deuxième(?:[\s\xa0]*Thes(?:aloniciens|saloniciens)|s[\s\xa0]*Thes(?:aloniciens|saloniciens))|II(?:[\s\xa0]*Thes(?:aloniciens|saloniciens)|\.[\s\xa0]*Thes(?:aloniciens|saloniciens))|2(?:[\s\xa0]*Th(?:es(?:aloniciens|s(?:aloniciens)?)?)?|d(?:[\s\xa0]*Thes(?:aloniciens|saloniciens)|e(?:[\s\xa0]*Thes(?:aloniciens|saloniciens)|\.[\s\xa0]*Thes(?:aloniciens|saloniciens))|\.[\s\xa0]*Thes(?:aloniciens|saloniciens))|e(?:[\s\xa0]*Thes(?:aloniciens|saloniciens)|\.[\s\xa0]*Thes(?:aloniciens|saloniciens))|Thess|ème(?:[\s\xa0]*Thes(?:aloniciens|saloniciens)|\.[\s\xa0]*Thes(?:aloniciens|saloniciens))|\.[\s\xa0]*Thes(?:aloniciens|saloniciens))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:[\s\xa0]*Thes(?:aloniciens|saloniciens)|\.[\s\xa0]*Thes(?:aloniciens|saloniciens))|Premi(?:ère(?:[\s\xa0]*Thes(?:aloniciens|saloniciens)|s[\s\xa0]*Thes(?:aloniciens|saloniciens))|er(?:[\s\xa0]*Thes(?:aloniciens|saloniciens)|s[\s\xa0]*Thes(?:aloniciens|saloniciens)))|1(?:er(?:[\s\xa0]*Thes(?:aloniciens|saloniciens)|\.[\s\xa0]*Thes(?:aloniciens|saloniciens))|[\s\xa0]*Th(?:es(?:aloniciens|s(?:aloniciens)?)?)?|Thess|\.[\s\xa0]*Thes(?:aloniciens|saloniciens)|re(?:[\s\xa0]*Thes(?:aloniciens|saloniciens)|\.[\s\xa0]*Thes(?:aloniciens|saloniciens))|ère(?:[\s\xa0]*Thes(?:aloniciens|saloniciens)|\.[\s\xa0]*Thes(?:aloniciens|saloniciens)))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Deuxième(?:[\s\xa0]*Timoth[ée]e|s[\s\xa0]*Timoth[ée]e)|2(?:[\s\xa0]*Ti(?:m(?:oth[eé]e)?)?|Tim|d(?:[\s\xa0]*Timoth[ée]e|e(?:[\s\xa0]*Timoth[ée]e|\.[\s\xa0]*Timoth[ée]e)|\.[\s\xa0]*Timoth[ée]e)|e(?:[\s\xa0]*Timoth[ée]e|\.[\s\xa0]*Timoth[eé]e)|ème(?:[\s\xa0]*Timoth[ée]e|\.[\s\xa0]*Timoth[ée]e)|\.[\s\xa0]*Timoth[ée]e)|II(?:[\s\xa0]*Timoth[eé]e|\.[\s\xa0]*Timoth[eé]e)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:[\s\xa0]*Timoth[eé]e|\.[\s\xa0]*Timoth[ée]e)|Premi(?:ère(?:[\s\xa0]*Timoth[ée]e|s[\s\xa0]*Timoth[eé]e)|er(?:[\s\xa0]*Timoth[eé]e|s[\s\xa0]*Timoth[ée]e))|1(?:[\s\xa0]*Ti(?:m(?:oth[eé]e)?)?|er(?:[\s\xa0]*Timoth[eé]e|\.[\s\xa0]*Timoth[ée]e)|Tim|re(?:[\s\xa0]*Timoth[eé]e|\.[\s\xa0]*Timoth[eé]e)|\.[\s\xa0]*Timoth[eé]e|ère(?:[\s\xa0]*Timoth[eé]e|\.[\s\xa0]*Timoth[ée]e))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Titus"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Tit(?:us|e)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phlm"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Ph(?:lm|m|il[ée]mon))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Heb"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(H(?:[eé](?:b(?:r(?:eux)?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jas"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Ja(?:c(?:q(?:ues)?)?|s|ques)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:d(?:e(?:[\s\xa0]*Pierre|\.[\s\xa0]*Pierre)|[\s\xa0]*Pierre|\.[\s\xa0]*Pierre)|e(?:[\s\xa0]*Pierre|\.[\s\xa0]*Pierre)|ème(?:[\s\xa0]*Pierre|\.[\s\xa0]*Pierre)|Pet|[\s\xa0]*P(?:i(?:erre)?)?|\.[\s\xa0]*Pierre)|Deuxième(?:[\s\xa0]*Pierre|s[\s\xa0]*Pierre)|II(?:[\s\xa0]*Pierre|\.[\s\xa0]*Pierre)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:er(?:[\s\xa0]*Pierre|\.[\s\xa0]*Pierre)|Pet|re(?:[\s\xa0]*Pierre|\.[\s\xa0]*Pierre)|[\s\xa0]*P(?:i(?:erre)?)?|ère(?:[\s\xa0]*Pierre|\.[\s\xa0]*Pierre)|\.[\s\xa0]*Pierre)|I(?:[\s\xa0]*Pierre|\.[\s\xa0]*Pierre)|Premi(?:ère(?:[\s\xa0]*Pierre|s[\s\xa0]*Pierre)|er(?:[\s\xa0]*Pierre|s[\s\xa0]*Pierre))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Jude"],
        ...
        osis: ["Sus"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Su(?:[zs](?:anne(?:[\\s\\xa0]*(?:au[\\s\\xa0]*bain|et[\\s\\xa0]*les[\\s\\xa0]*(?:vieillards|deux[\\s\\xa0]*vieillards)))?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:d(?:\.[\s\xa0]*Maccab[ée]es|[\s\xa0]*Maccab[eé]es|e(?:\.[\s\xa0]*Maccab[ée]es|[\s\xa0]*Maccab[eé]es))|[\s\xa0]*M(?:acc(?:ab[ée]es)?)?|\.[\s\xa0]*Maccab[ée]es|e(?:\.[\s\xa0]*Maccab[ée]es|[\s\xa0]*Maccab[ée]es)|ème(?:\.[\s\xa0]*Maccab[eé]es|[\s\xa0]*Maccab[ée]es)|Macc)|Deuxième(?:s[\s\xa0]*Maccab[eé]es|[\s\xa0]*Maccab[ée]es)|II(?:\.[\s\xa0]*Maccab[ée]es|[\s\xa0]*Maccab[ée]es)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:III(?:\.[\s\xa0]*Maccab[ée]es|[\s\xa0]*Maccab[eé]es)|Troisième(?:s[\s\xa0]*Maccab[ée]es|[\s\xa0]*Maccab[ée]es)|3(?:[\s\xa0]*M(?:acc(?:ab[ée]es)?)?|\.[\s\xa0]*Maccab[ée]es|e(?:\.[\s\xa0]*Maccab[eé]es|[\s\xa0]*Maccab[eé]es)|ème(?:\.[\s\xa0]*Maccab[eé]es|[\s\xa0]*Maccab[ée]es)|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:IV(?:\.[\s\xa0]*Maccab[ée]es|[\s\xa0]*Maccab[ée]es)|Quatrième(?:s[\s\xa0]*Maccab[eé]es|[\s\xa0]*Maccab[ée]es)|4(?:[\s\xa0]*M(?:acc(?:ab[ée]es)?)?|\.[\s\xa0]*Maccab[ée]es|e(?:\.[\s\xa0]*Maccab[eé]es|[\s\xa0]*Maccab[eé]es)|ème(?:\.[\s\xa0]*Maccab[eé]es|[\s\xa0]*Maccab[eé]es)|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:er(?:\.[\s\xa0]*Maccab[eé]es|[\s\xa0]*Maccab[ée]es)|[\s\xa0]*M(?:acc(?:ab[eé]es)?)?|\.[\s\xa0]*Maccab[ée]es|Macc|re(?:\.[\s\xa0]*Maccab[eé]es|[\s\xa0]*Maccab[ée]es)|ère(?:\.[\s\xa0]*Maccab[ée]es|[\s\xa0]*Maccab[ée]es))|I(?:\.[\s\xa0]*Maccab[ée]es|[\s\xa0]*Maccab[ée]es)|Premi(?:ère(?:s[\s\xa0]*Maccab[eé]es|[\s\xa0]*Maccab[ée]es)|er(?:s[\s\xa0]*Maccab[ée]es|[\s\xa0]*Maccab[ée]es))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
...
var grammar = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c46 = "suivant",
        peg$c47 = { type: "literal", value: "suivant", description: "\"suivant\"" },
        peg$c48 = /^[a-z]/,
        ...
        peg$c51 = "titre",
        peg$c52 = { type: "literal", value: "titre", description: "\"titre\"" },
        ...
        peg$c62 = /^[a-e]/,
        peg$c63 = { type: "class", value: "[a-e]", description: "[a-e]" },
        peg$c64 = function(val) { return {"type": "v", "value": [val], "indices": [offset(), peg$currPos - 1]} },
        peg$c65 = "chapitres",
        peg$c66 = { type: "literal", value: "chapitres", description: "\"chapitres\"" },
        peg$c67 = "chapitre",
        peg$c68 = { type: "literal", value: "chapitre", description: "\"chapitre\"" },
        peg$c69 = "chap",
        peg$c70 = { type: "literal", value: "chap", description: "\"chap\"" },
        peg$c71 = "chs",
        peg$c72 = { type: "literal", value: "chs", description: "\"chs\"" },
        peg$c73 = "ch",
        peg$c74 = { type: "literal", value: "ch", description: "\"ch\"" },
        peg$c75 = function() { return {"type": "c_explicit"} },
        peg$c76 = "versets",
        peg$c77 = { type: "literal", value: "versets", description: "\"versets\"" },
        peg$c78 = "verset",
        peg$c79 = { type: "literal", value: "verset", description: "\"verset\"" },
        peg$c80 = "vers",
        peg$c81 = { type: "literal", value: "vers", description: "\"vers\"" },
        peg$c82 = "ver",
        peg$c83 = { type: "literal", value: "ver", description: "\"ver\"" },
        peg$c84 = "vv",
        peg$c85 = { type: "literal", value: "vv", description: "\"vv\"" },
        peg$c86 = "v",
        peg$c87 = { type: "literal", value: "v", description: "\"v\"" },
        peg$c88 = function() { return {"type": "v_explicit"} },
        peg$c89 = ":",
        ...
        peg$c95 = "comparer",
        peg$c96 = { type: "literal", value: "comparer", description: "\"comparer\"" },
        peg$c97 = function() { return "" },
        peg$c98 = /^[\-\u2013\u2014]/,
        peg$c99 = { type: "class", value: "[\\-\\u2013\\u2014]", description: "[\\-\\u2013\\u2014]" },
        peg$c100 = "\xE1",
        peg$c101 = { type: "literal", value: "\xE1", description: "\"\\xE1\"" },
...
var grammar = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c92 = { type: "class", value: "[;\\/:&\\-\\u2013\\u2014~]", description: "[;\\/:&\\-\\u2013\\u2014~]" },
        peg$c93 = "comparer",
        peg$c94 = { type: "literal", value: "comparer", description: "\"comparer\"" },
        peg$c95 = function() { return "" },
        peg$c96 = /^[\-\u2013\u2014]/,
        peg$c97 = { type: "class", value: "[\\-\\u2013\\u2014]", description: "[\\-\\u2013\\u2014]" },
        peg$c98 = "\xE1",
        peg$c99 = { type: "literal", value: "\xE1", description: "\"\\xE1\"" },
