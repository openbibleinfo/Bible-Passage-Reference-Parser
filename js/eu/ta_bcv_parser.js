    ...
    books = [
      {
        ...
        osis: ["Rev"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:யோவானுக்கு[\\s\\xa0]*வெளிப்படுத்தின[\\s\\xa0]*விசேஷம்|Ve[lḷ]ippa(?:[tṭ]utti(?:[nṉ]a[\\s\\xa0]*Vic(?:[eē](?:[tṭ]a(?:[nṅ]ka[lḷ])))))|தி(?:ருவெளிப்பாடு|வெ)|வெளி(?:ப்படுத்தின[\\s\\xa0]*விசேடங்கள்)?|Rev)|Ve[ḷl]ippa(?:[tṭ]utti(?:[ṉn]a)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["PrMan"],
        apocrypha: true,
        ...
        osis: ["John"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:அருளப்பர்[\\s\\xa0]*நற்செய்தி|Y[oō]v(?:[aā](?:[nṉ][\\s\\xa0]*Na(?:[rṛ]ceyti)))|John|யோவா(?:ன்[\\s\\xa0]*(?:எழுதிய[\\s\\xa0]*(?:சுவிசேஷம்|நற்செய்தி)|நற்செய்தி))?)|(?:யோவான்|Y[oō]v(?:[āa][nṉ])))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Acts"],
        ...
        osis: ["Phlm"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:P(?:il[eē]m(?:[oō](?:[nṉ]ukku[\\s\\xa0]*E(?:[lḻ]utiya[\\s\\xa0]*Nirupam)))|hlm)|பில(?:மோன(?:ுக்கு[\\s\\xa0]*எழுதிய[\\s\\xa0]*திருமுகம்|்)|ே(?:மோன(?:ுக்கு[\\s\\xa0]*எழுதிய[\\s\\xa0]*(?:நிருபம்|கடிதம்)|்))?)?)|Pil[ēe]m(?:[ōo](?:[ṉn]ukku)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Heb"],
...
var grammar = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c63 = "\u0B85\u0BA4\u0BBF\u0B95\u0BBE\u0BB0\u0BAE\u0BCD",
        peg$c64 = { type: "literal", value: "\u0B85\u0BA4\u0BBF\u0B95\u0BBE\u0BB0\u0BAE\u0BCD", description: "\"\\u0B85\\u0BA4\\u0BBF\\u0B95\\u0BBE\\u0BB0\\u0BAE\\u0BCD\"" },
        peg$c65 = "\u0B85\u0BA4\u0BBF",
        peg$c66 = { type: "literal", value: "\u0B85\u0BA4\u0BBF", description: "\"\\u0B85\\u0BA4\\u0BBF\"" },
...
var grammar = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c74 = { type: "class", value: "[;\\/:&\\-\\u2013\\u2014~]", description: "[;\\/:&\\-\\u2013\\u2014~]" },
        peg$c75 = "\u0BAE\u0BB1\u0BCD\u0BB1\u0BC1\u0BAE\u0BCD",
        peg$c76 = { type: "literal", value: "\u0BAE\u0BB1\u0BCD\u0BB1\u0BC1\u0BAE\u0BCD", description: "\"\\u0BAE\\u0BB1\\u0BCD\\u0BB1\\u0BC1\\u0BAE\\u0BCD\"" },
