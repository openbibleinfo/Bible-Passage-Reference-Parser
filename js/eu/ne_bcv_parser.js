    ...
    books = [
      {
        ...
        osis: ["Judg"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:ny[aā]yakartt(?:[aā]har(?:[uū]ko[\\s\\xa0]*pustak))|न्यायकर्त(?:्ताहरूको[\\s\\xa0]*पुस्तक|ा(?:हरूको[\\s\\xa0]*पुस्तक)?)|Judg)|(?:न्यायकर्त्ताहरूको|ny[āa]yakartt(?:[aā]har(?:[uū]ko))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ruth"],
        ...
        osis: ["Luke"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:l[uū]k(?:[aā]le[\\s\\xa0]*lekʰeko[\\s\\xa0]*susm(?:[aā]c(?:[aā]r)))|Luke|ल(?:ुका|ूका(?:ले[\\s\\xa0]*लेखेको[\\s\\xa0]*सुसमाचार|को[\\s\\xa0]*सुसमाचार)?))|(?:l[uū]k(?:[āa]le)|लूकाले))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1John"],
        ...
        osis: ["Rom"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:rom[iī]har(?:[uū]l(?:[aā](?:[iī][\\s\\xa0]*patra)))|रोमी(?:हरूलाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*पत्र|त्र))?|Rom)|(?:rom[īi]har(?:[uū]l(?:[aā][iī]))|रोमीहरूलाई))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Cor"],
        ...
        osis: ["Gal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:gal[aā]t(?:[iī]har(?:[uū]l(?:[aā](?:[iī][\\s\\xa0]*patra))))|गलाती(?:हरूलाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*पत्र|त्र))?|Gal)|(?:gal[āa]t(?:[iī]har(?:[ūu]l(?:[āa][iī])))|गलातीहरूलाई))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:epʰis[iī]har(?:[uū]l(?:[aā](?:[iī][\\s\\xa0]*patra)))|एफिसी(?:हरूलाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*पत्र|त्र))?|Eph)|(?:epʰis[iī]har(?:[uū]l(?:[āa][īi]))|एफिसीहरूलाई))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phil"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:pʰilipp[iī]har(?:[uū]l(?:[aā](?:[iī][\\s\\xa0]*patra)))|फिलिप्पी(?:हरूलाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*पत्र|त्र))?|Phil)|(?:pʰilipp[iī]har(?:[ūu]l(?:[āa][īi]))|फिलिप्पीहरूलाई))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Col"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:kalass[iī]har(?:[uū]l(?:[aā](?:[iī][\\s\\xa0]*patra)))|कलस्सी(?:हरूलाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*पत्र|त्र))?|Col)|(?:kalass[īi]har(?:[uū]l(?:[āa][īi]))|कलस्सीहरूलाई))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Thess"],
...
var grammar = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c81 = function(val) { return {type:"title", value: [val], "indices": [offset(), peg$currPos - 1]} },
        peg$c82 = "from",
        ...
        peg$c96 = function(val) { return {"type": "translation_sequence", "value": val, "indices": [offset(), peg$currPos - 1]} },
        peg$c97 = "\x1E",
        peg$c98 = { type: "literal", value: "\x1E", description: "\"\\x1E\"" },
        peg$c99 = function(val) { return {"type": "translation", "value": val.value, "indices": [offset(), peg$currPos - 1]} },
        peg$c100 = ",000",
        peg$c101 = { type: "literal", value: ",000", description: "\",000\"" },
        peg$c102 = function(val) { return {"type": "integer", "value": parseInt(val.join(""), 10), "indices": [offset(), peg$currPos - 1]} },
        peg$c103 = /^[^\x1F\x1E([]/,
        peg$c104 = { type: "class", value: "[^\\x1F\\x1E([]", description: "[^\\x1F\\x1E([]" },
        peg$c105 = function(val) { return {"type": "word", "value": val.join(""), "indices": [offset(), peg$currPos - 1]} },
        peg$c106 = function(val) { return {"type": "stop", "value": val, "indices": [offset(), peg$currPos - 1]} },
        peg$c107 = /^[\s\xa0*]/,
