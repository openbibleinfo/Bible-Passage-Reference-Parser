    ...
    books = [
      {
        ...
        osis: ["Judg"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:ny[aā]yakartt(?:[aā]har(?:[uū]ko[\\s\\xa0]*pustak))|न्यायकर्त(?:्ताहरूको[\\s\\xa0]*पुस्तक|ा(?:हरूको[\\s\\xa0]*पुस्तक)?)|Judg)|(?:ny[āa]yakartt(?:[aā]har(?:[ūu]ko))|न्यायकर्त्ताहरूको))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ruth"],
        ...
        osis: ["Luke"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:l[uū]k(?:[aā]le[\\s\\xa0]*lekʰeko[\\s\\xa0]*susm(?:[aā]c(?:[aā]r)))|Luke|ल(?:ुका|ूका(?:ले[\\s\\xa0]*लेखेको[\\s\\xa0]*सुसमाचार|को[\\s\\xa0]*सुसमाचार)?))|(?:लूकाले|l[ūu]k(?:[āa]le)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1John"],
        ...
        osis: ["John"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:y[uū]hann(?:[aā]le[\\s\\xa0]*lekʰeko[\\s\\xa0]*susm(?:[aā]c(?:[aā]r)))|य(?:हून्ना|ुहन्ना|ूह(?:ान्ना|न(?:्ना(?:ले[\\s\\xa0]*लेखेको[\\s\\xa0]*सुसमाचार|को[\\s\\xa0]*सुसमाचार)?|ा)))|John)|(?:यूहन्नाले|y[ūu]hann(?:[aā]le)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Acts"],
        ...
        osis: ["Rom"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:rom[iī]har(?:[uū]l(?:[aā](?:[iī][\\s\\xa0]*patra)))|रोमी(?:हरूलाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*पत्र|त्र))?|Rom)|(?:रोमीहरूलाई|rom[iī]har(?:[ūu]l(?:[aā][īi]))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Cor"],
        ...
        osis: ["Gal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:gal[aā]t(?:[iī]har(?:[uū]l(?:[aā](?:[iī][\\s\\xa0]*patra))))|गलाती(?:हरूलाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*पत्र|त्र))?|Gal)|(?:गलातीहरूलाई|gal[āa]t(?:[iī]har(?:[uū]l(?:[āa][īi])))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:epʰis[iī]har(?:[uū]l(?:[aā](?:[iī][\\s\\xa0]*patra)))|एफिसी(?:हरूलाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*पत्र|त्र))?|Eph)|(?:एफिसीहरूलाई|epʰis[īi]har(?:[ūu]l(?:[āa][īi]))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phil"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:pʰilipp[iī]har(?:[uū]l(?:[aā](?:[iī][\\s\\xa0]*patra)))|फिलिप्पी(?:हरूलाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*पत्र|त्र))?|Phil)|(?:फिलिप्पीहरूलाई|pʰilipp[īi]har(?:[ūu]l(?:[aā][īi]))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Col"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:kalass[iī]har(?:[uū]l(?:[aā](?:[iī][\\s\\xa0]*patra)))|कलस्सी(?:हरूलाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*पत्र|त्र))?|Col)|(?:कलस्सीहरूलाई|kalass[iī]har(?:[ūu]l(?:[āa][iī]))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Thess"],
        ...
        osis: ["Titus"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:t[iī]tasl(?:[aā](?:[iī][\\s\\xa0]*patra))|Titus|तीतस(?:लाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*पत्र|त्र))?)|(?:t[iī]tasl(?:[āa][īi])|तीतसलाई))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phlm"],
