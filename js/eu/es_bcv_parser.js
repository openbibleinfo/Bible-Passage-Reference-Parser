...
(function() {
  ...
  bcv_parser.prototype.regexps.escaped_passage = RegExp("(?:^|[^\\x1f\\x1e\\dA-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])(\\x1f(\\d+)(?:/[a-z])?\\x1f(?:|/[pq]\\x1f|[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014]|(?:t[íi]tulo|tít)(?![a-z])|y" + bcv_parser.prototype.regexps.space + "+siguientes|y(?!" + bcv_parser.prototype.regexps.space + "+sig)|y" + bcv_parser.prototype.regexps.space + "+sig|vers[íi]culos|cap[íi]tulos|vers[íi]culo|cap[íi]tulo|caps|vers|cap|ver|vss|vs|vv|á|v|[a-e](?!\\w)|$)+)", "gi");
