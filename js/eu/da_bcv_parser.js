    ...
    books = [
      {
        ...
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Johannes(?:['’][\s\xa0]*(?:Første[\s\xa0]*Brev|1(?:\.[\s\xa0]*Brev|[\s\xa0]*Brev)))|Første[\s\xa0]*Joh(?:annes(?:brev)?)?|1(?:\.[\s\xa0]*Joh(?:annes(?:brev)?)?|[\s\xa0]*Joh(?:annes(?:brev)?)?|John)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Johannes['’][\s\xa0]*Andet[\s\xa0]*Brev|Ande(?:t[\s\xa0]*Johannesbrev|n[\s\xa0]*Joh(?:annes(?:brev)?)?)|2(?:\.[\s\xa0]*Joh(?:annes(?:brev)?)?|[\s\xa0]*Joh(?:annes(?:brev)?)?|John)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Johannes(?:['’][\s\xa0]*(?:Tredje[\s\xa0]*Brev|3(?:\.[\s\xa0]*Brev|[\s\xa0]*Brev)))|Tredje[\s\xa0]*Joh(?:annes(?:brev)?)?|3(?:\.[\s\xa0]*Joh(?:annes(?:brev)?)?|[\s\xa0]*Joh(?:annes(?:brev)?)?|John)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
...
var grammar = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c63 = "kapitlerne",
        peg$c64 = { type: "literal", value: "kapitlerne", description: "\"kapitlerne\"" },
        peg$c65 = "kapitel",
        peg$c66 = { type: "literal", value: "kapitel", description: "\"kapitel\"" },
        peg$c67 = "kap",
        ...
        peg$c83 = "jf",
        peg$c84 = { type: "literal", value: "jf", description: "\"jf\"" },
...
var grammar = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c78 = { type: "class", value: "[;\\/:&\\-\\u2013\\u2014~]", description: "[;\\/:&\\-\\u2013\\u2014~]" },
        peg$c79 = "og",
        peg$c80 = { type: "literal", value: "og", description: "\"og\"" },
        peg$c81 = "jf",
        peg$c82 = { type: "literal", value: "jf", description: "\"jf\"" },
