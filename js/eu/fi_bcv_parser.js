    ...
    books = [
      {
        ...
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Ensimm[aä]inen[\s\xa0]*Esra|I(?:\.[\s\xa0]*Esra|[\s\xa0]*Esra)|1(?:\.[\s\xa0]*Esra|[\s\xa0]*Es(?:ra)?|Esd)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Toinen[\s\xa0]*Esra|II(?:\.[\s\xa0]*Esra|[\s\xa0]*Esra)|2(?:\.[\s\xa0]*Esra|[\s\xa0]*Es(?:ra)?|Esd)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Isa"],
        ...
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Ensimm(?:[aä]inen[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?)|I(?:\.[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?|[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?)|1(?:\.[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?|[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?|John)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Toinen[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?|II(?:\.[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?|[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?)|2(?:\.[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?|[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?|John)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Kolmas[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?|III(?:\.[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?|[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?)|3(?:\.[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?|[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?|John)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
...
var grammar = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c49 = "johdannolla",
        peg$c50 = { type: "literal", value: "johdannolla", description: "\"johdannolla\"" },
        ...
        peg$c63 = "luku",
        peg$c64 = { type: "literal", value: "luku", description: "\"luku\"" },
        peg$c65 = "luvut",
        peg$c66 = { type: "literal", value: "luvut", description: "\"luvut\"" },
        peg$c67 = "luvun",
        peg$c68 = { type: "literal", value: "luvun", description: "\"luvun\"" },
        peg$c69 = function() { return {"type": "c_explicit"} },
        peg$c70 = "jakeet",
        peg$c71 = { type: "literal", value: "jakeet", description: "\"jakeet\"" },
        peg$c72 = "jakeissa",
        peg$c73 = { type: "literal", value: "jakeissa", description: "\"jakeissa\"" },
        ...
        peg$c81 = "ja",
        peg$c82 = { type: "literal", value: "ja", description: "\"ja\"" },
        peg$c83 = "vrt",
        peg$c84 = { type: "literal", value: "vrt", description: "\"vrt\"" },
...
var grammar = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c78 = { type: "class", value: "[;\\/:&\\-\\u2013\\u2014~]", description: "[;\\/:&\\-\\u2013\\u2014~]" },
        peg$c79 = "ja",
        peg$c80 = { type: "literal", value: "ja", description: "\"ja\"" },
        peg$c81 = "vrt",
        peg$c82 = { type: "literal", value: "vrt", description: "\"vrt\"" },
