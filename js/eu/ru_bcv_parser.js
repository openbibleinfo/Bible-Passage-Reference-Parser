    ...
    books = [
      {
        ...
        osis: ["Gen"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*Бытия|Быт(?:ие)?|Gen))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Exod"],
        ...
        osis: ["Josh"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Иисус(?:[\\s\\xa0]*Навин|а[\\s\\xa0]*Навина)|Josh|Нав|Книга[\\s\\xa0]*Иисуса[\\s\\xa0]*Навина))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Judg"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*Суде(?:[ий](?:[\\s\\xa0]*Израилевых)?)|Суд(?:е[ий])?|Judg))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ruth"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*Руфи|Ruth|Руфь?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])((?:1Esd|2(?:(?:[ея](?:[\s\xa0]*Ездры|\.[\s\xa0]*Ездры))|-?(?:[яе](?:[\s\xa0]*Ездры|\.[\s\xa0]*Ездры))|[\s\xa0]*Езд(?:ры)?|\.[\s\xa0]*Ездры)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])((?:2Esd|3(?:(?:[яе](?:[\s\xa0]*Ездры|\.[\s\xa0]*Ездры))|-?(?:[ея](?:[\s\xa0]*Ездры|\.[\s\xa0]*Ездры))|[\s\xa0]*Езд(?:ры)?|\.[\s\xa0]*Ездры)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Isa"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*пророка[\\s\\xa0]*Исаии|Isa|Ис(?:аи[яи]?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])(2(?:\.[\s\xa0]*(?:Самуила|Царств|Книга[\s\xa0]*Царств)|-?(?:[яе](?:\.[\s\xa0]*(?:Самуила|Царств|Книга[\s\xa0]*Царств)|[\s\xa0]*(?:Самуила|Царств|Книга[\s\xa0]*Царств)))|(?:[ея](?:\.[\s\xa0]*(?:Самуила|Царств|Книга[\s\xa0]*Царств)|[\s\xa0]*(?:Самуила|Царств|Книга[\s\xa0]*Царств)))|[\s\xa0]*(?:Цар(?:ств)?|Самуила|Книга[\s\xa0]*Царств)|Sam))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])(1(?:\.[\s\xa0]*(?:Самуила|Царств|Книга[\s\xa0]*Царств)|-?(?:[яе](?:\.[\s\xa0]*(?:Самуила|Царств|Книга[\s\xa0]*Царств)|[\s\xa0]*(?:Самуила|Царств|Книга[\s\xa0]*Царств)))|(?:[яе](?:\.[\s\xa0]*(?:Самуила|Царств|Книга[\s\xa0]*Царств)|[\s\xa0]*(?:Самуила|Царств|Книга[\s\xa0]*Царств)))|[\s\xa0]*(?:Цар(?:ств)?|Самуила|Книга[\s\xa0]*Царств)|Sam))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])((?:4(?:-?(?:[яе](?:[\s\xa0]*(?:Царств|Книга[\s\xa0]*Царств)|\.[\s\xa0]*(?:Царств|Книга[\s\xa0]*Царств)))|[\s\xa0]*(?:Цар(?:ств)?|Книга[\s\xa0]*Царств)|(?:[ея](?:[\s\xa0]*(?:Царств|Книга[\s\xa0]*Царств)|\.[\s\xa0]*(?:Царств|Книга[\s\xa0]*Царств)))|\.[\s\xa0]*(?:Царств|Книга[\s\xa0]*Царств))|2(?:[\s\xa0]*Царе[ий]|\.[\s\xa0]*Царе[йи]|(?:[ея](?:[\s\xa0]*Царе[ий]|\.[\s\xa0]*Царе[ий]))|Kgs|-?(?:[ея](?:[\s\xa0]*Царе[ий]|\.[\s\xa0]*Царе[ий])))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])((?:3(?:-?(?:[яе](?:[\s\xa0]*(?:Царств|Книга[\s\xa0]*Царств)|\.[\s\xa0]*(?:Царств|Книга[\s\xa0]*Царств)))|[\s\xa0]*(?:Цар(?:ств)?|Книга[\s\xa0]*Царств)|(?:[ея](?:[\s\xa0]*(?:Царств|Книга[\s\xa0]*Царств)|\.[\s\xa0]*(?:Царств|Книга[\s\xa0]*Царств)))|\.[\s\xa0]*(?:Царств|Книга[\s\xa0]*Царств))|1(?:[\s\xa0]*Царе[ий]|\.[\s\xa0]*Царе[йи]|(?:[ея](?:[\s\xa0]*Царе[ий]|\.[\s\xa0]*Царе[йи]))|Kgs|-?(?:[яе](?:[\s\xa0]*Царе[ий]|\.[\s\xa0]*Царе[йи])))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])(2(?:[\s\xa0]*(?:Пар(?:алипоменон)?|Хроник)|\.[\s\xa0]*(?:Паралипоменон|Хроник)|Chr|(?:[яе](?:[\s\xa0]*(?:Паралипоменон|Хроник)|\.[\s\xa0]*(?:Паралипоменон|Хроник)))|-?(?:[ея](?:[\s\xa0]*(?:Паралипоменон|Хроник)|\.[\s\xa0]*(?:Паралипоменон|Хроник)))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])(1(?:[\s\xa0]*(?:Пар(?:алипоменон)?|Хроник)|\.[\s\xa0]*(?:Паралипоменон|Хроник)|Chr|(?:[яе](?:[\s\xa0]*(?:Паралипоменон|Хроник)|\.[\s\xa0]*(?:Паралипоменон|Хроник)))|-?(?:[ея](?:[\s\xa0]*(?:Паралипоменон|Хроник)|\.[\s\xa0]*(?:Паралипоменон|Хроник)))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])((?:Езд(?:р[аы])?|Первая[\s\xa0]*Ездры|Книга[\s\xa0]*Ездры|Ezra|1[\s\xa0]*Езд))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Neh"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Неем(?:и[яи])?|Книга[\\s\\xa0]*Неемии|Neh))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["GkEsth"],
        apocrypha: true,
        ...
        osis: ["Job"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Job|Книга[\\s\\xa0]*Иова|Иова?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ps"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Пс(?:ал(?:мы|ом|тирь)?)?|Ps))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["PrAzar"],
        apocrypha: true,
        ...
        osis: ["Prov"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*притче[йи][\\s\\xa0]*Соломоновых|Prov|Пр(?:ит(?:чи)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eccl"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*Екклесиаста|Екк(?:лесиаст)?|Eccl))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["SgThree"],
        apocrypha: true,
        ...
        osis: ["Song"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Song|Песн(?:ь[\\s\\xa0]*песне[йи][\\s\\xa0]*Соломона|и[\\s\\xa0]*Песне[ий])?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jer"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Иер(?:еми[яи])?|Книга[\\s\\xa0]*пророка[\\s\\xa0]*Иеремии|Jer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ezek"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Иез(?:екиил[ья])?|Ezek|Книга[\\s\\xa0]*пророка[\\s\\xa0]*Иезекииля))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Dan"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Дан(?:иила?)?|Dan|Книга[\\s\\xa0]*пророка[\\s\\xa0]*Даниила))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hos"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ос(?:и[яи])?|Книга[\\s\\xa0]*пророка[\\s\\xa0]*Осии|Hos))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Joel"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Иоил[ья]?|Книга[\\s\\xa0]*пророка[\\s\\xa0]*Иоиля|Joel))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Amos"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Amos|Амоса?|Книга[\\s\\xa0]*пророка[\\s\\xa0]*Амоса))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Obad"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*пророка[\\s\\xa0]*Авдия|Obad|Авд(?:ия)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jonah"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*пророка[\\s\\xa0]*Ионы|Ион[ыа]|Jonah))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mic"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Mic|Мих(?:е[ияй])?|Книга[\\s\\xa0]*пророка[\\s\\xa0]*Михея))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Nah"],
        ...
        osis: ["Hag"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Hag|Агг(?:е[йия])?|Книга[\\s\\xa0]*пророка[\\s\\xa0]*Аггея))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Zech"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Zech|Книга[\\s\\xa0]*пророка[\\s\\xa0]*Захарии|Зах(?:ари[ия])?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*пророка[\\s\\xa0]*Малахии|Mal|Мал(?:ахи[ия])?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Matt"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:М[тф]|От[\\s\\xa0]*Матфея|Евангелие[\\s\\xa0]*от[\\s\\xa0]*Матфея|Matt))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mark"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:От[\\s\\xa0]*Марка|Mark|М[рк]|Евангелие[\\s\\xa0]*от[\\s\\xa0]*Марка))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Luke"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Luke|Лк|Евангелие[\\s\\xa0]*от[\\s\\xa0]*Луки|От[\\s\\xa0]*Луки))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])(1(?:\.[\s\xa0]*(?:Иоанна|послание[\s\xa0]*Иоанна)|John|(?:[ея](?:\.[\s\xa0]*(?:Иоанна|послание[\s\xa0]*Иоанна)|[\s\xa0]*(?:Иоанна|послание[\s\xa0]*Иоанна)))|[\s\xa0]*(?:И(?:оанна|н)|послание[\s\xa0]*Иоанна)|-?(?:[ея](?:\.[\s\xa0]*(?:Иоанна|послание[\s\xa0]*Иоанна)|[\s\xa0]*(?:Иоанна|послание[\s\xa0]*Иоанна)))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])(2(?:\.[\s\xa0]*(?:Иоанна|послание[\s\xa0]*Иоанна)|John|(?:[ея](?:\.[\s\xa0]*(?:Иоанна|послание[\s\xa0]*Иоанна)|[\s\xa0]*(?:Иоанна|послание[\s\xa0]*Иоанна)))|[\s\xa0]*(?:И(?:оанна|н)|послание[\s\xa0]*Иоанна)|-?(?:[яе](?:\.[\s\xa0]*(?:Иоанна|послание[\s\xa0]*Иоанна)|[\s\xa0]*(?:Иоанна|послание[\s\xa0]*Иоанна)))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])(3(?:\.[\s\xa0]*(?:Иоанна|послание[\s\xa0]*Иоанна)|John|(?:[ея](?:\.[\s\xa0]*(?:Иоанна|послание[\s\xa0]*Иоанна)|[\s\xa0]*(?:Иоанна|послание[\s\xa0]*Иоанна)))|[\s\xa0]*(?:И(?:оанна|н)|послание[\s\xa0]*Иоанна)|-?(?:[яе](?:\.[\s\xa0]*(?:Иоанна|послание[\s\xa0]*Иоанна)|[\s\xa0]*(?:Иоанна|послание[\s\xa0]*Иоанна)))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Евангелие[\\s\\xa0]*от[\\s\\xa0]*Иоанна|От[\\s\\xa0]*Иоанна|John|Ин))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Acts"],
        ...
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])(1(?:-?(?:[яе](?:\.[\s\xa0]*(?:Коринфянам|к[\s\xa0]*Коринфянам)|[\s\xa0]*(?:Коринфянам|к[\s\xa0]*Коринфянам)))|\.[\s\xa0]*(?:Коринфянам|к[\s\xa0]*Коринфянам)|(?:[яе](?:\.[\s\xa0]*(?:Коринфянам|к[\s\xa0]*Коринфянам)|[\s\xa0]*(?:Коринфянам|к[\s\xa0]*Коринфянам)))|[\s\xa0]*(?:Кор(?:инфянам)?|к[\s\xa0]*Коринфянам)|Cor))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Gal"],
        ...
        osis: ["Eph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Eph|К[\\s\\xa0]*Ефесянам|Послание[\\s\\xa0]*к[\\s\\xa0]*Ефесянам|Еф(?:есянам)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phil"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Фил(?:иппи[ий]цам)?|Phil|Послание[\\s\\xa0]*к[\\s\\xa0]*Филиппи[ий]цам|К[\\s\\xa0]*Филиппи[йи]цам))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Col"],
        ...
        osis: ["Jas"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Послание[\\s\\xa0]*Иакова|Jas|Иак(?:ова)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])(2(?:[\s\xa0]*(?:Пет(?:ра)?|послание[\s\xa0]*Петра)|-?(?:[ея](?:[\s\xa0]*(?:Петра|послание[\s\xa0]*Петра)|\.[\s\xa0]*(?:Петра|послание[\s\xa0]*Петра)))|(?:[яе](?:[\s\xa0]*(?:Петра|послание[\s\xa0]*Петра)|\.[\s\xa0]*(?:Петра|послание[\s\xa0]*Петра)))|Pet|\.[\s\xa0]*(?:Петра|послание[\s\xa0]*Петра)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])(1(?:[\s\xa0]*(?:Пет(?:ра)?|послание[\s\xa0]*Петра)|-?(?:[ея](?:[\s\xa0]*(?:Петра|послание[\s\xa0]*Петра)|\.[\s\xa0]*(?:Петра|послание[\s\xa0]*Петра)))|(?:[ея](?:[\s\xa0]*(?:Петра|послание[\s\xa0]*Петра)|\.[\s\xa0]*(?:Петра|послание[\s\xa0]*Петра)))|Pet|\.[\s\xa0]*(?:Петра|послание[\s\xa0]*Петра)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Jude"],
        ...
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])((?:3(?:-?(?:[ея](?:\.[\s\xa0]*Маккавеев|[\s\xa0]*Маккавеев))|(?:[яе](?:\.[\s\xa0]*Маккавеев|[\s\xa0]*Маккавеев))|\.[\s\xa0]*Маккавеев|Macc|[\s\xa0]*Макк(?:авеев)?)|Третья[\s\xa0]*книга[\s\xa0]*Маккаве[йи]ская))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])(4(?:-?(?:[ея](?:\.[\s\xa0]*Маккавеев|[\s\xa0]*Маккавеев))|(?:[яе](?:\.[\s\xa0]*Маккавеев|[\s\xa0]*Маккавеев))|\.[\s\xa0]*Маккавеев|Macc|[\s\xa0]*Макк(?:авеев)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zЀ-ҁ҃-҇Ҋ-ԧⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ])((?:1(?:-?(?:[яе](?:\.[\s\xa0]*Маккавеев|[\s\xa0]*Маккавеев))|(?:[ея](?:\.[\s\xa0]*Маккавеев|[\s\xa0]*Маккавеев))|\.[\s\xa0]*Маккавеев|Macc|[\s\xa0]*Макк(?:авеев)?)|Первая[\s\xa0]*книга[\s\xa0]*Маккаве[ий]ская))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }
    ];
...
var grammar = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c86 = function(val) { return {type:"title", value: [val], "indices": [offset(), peg$currPos - 1]} },
        peg$c87 = "from",
        ...
        peg$c99 = /^[)\]]/,
        peg$c100 = { type: "class", value: "[)\\]]", description: "[)\\]]" },
        peg$c101 = function(val) { return {"type": "translation_sequence", "value": val, "indices": [offset(), peg$currPos - 1]} },
        peg$c102 = "\x1E",
        peg$c103 = { type: "literal", value: "\x1E", description: "\"\\x1E\"" },
        peg$c104 = function(val) { return {"type": "translation", "value": val.value, "indices": [offset(), peg$currPos - 1]} },
        peg$c105 = ",000",
        peg$c106 = { type: "literal", value: ",000", description: "\",000\"" },
        peg$c107 = function(val) { return {"type": "integer", "value": parseInt(val.join(""), 10), "indices": [offset(), peg$currPos - 1]} },
        peg$c108 = /^[^\x1F\x1E([]/,
        peg$c109 = { type: "class", value: "[^\\x1F\\x1E([]", description: "[^\\x1F\\x1E([]" },
        peg$c110 = function(val) { return {"type": "word", "value": val.join(""), "indices": [offset(), peg$currPos - 1]} },
        peg$c111 = function(val) { return {"type": "stop", "value": val, "indices": [offset(), peg$currPos - 1]} },
        peg$c112 = /^[\s\xa0*]/,
