    ...
    books = [
      {
        ...
        osis: ["Lam"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Lam|Pl(?:[aâ]ngeri(?:le[\\s\\xa0]*(?:profetului[\\s\\xa0]*Ieremia|lui[\\s\\xa0]*Ieremia))?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["EpJer"],
        apocrypha: true,
        ...
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Cartea[\s\xa0]*a[\s\xa0]*doua[\s\xa0]*Paralipomena|II(?:\.[\s\xa0]*(?:Paralipomena|Cron(?:ici)?)|[\s\xa0]*(?:Paralipomena|Cron(?:ici)?))|2(?:\.[\s\xa0]*(?:Paralipomena|Cron(?:ici)?)|[\s\xa0]*(?:Paralipomena|Cron(?:ici)?)|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Cartea[\s\xa0]*[iî]nt(?:[aâ]i[\s\xa0]*Paralipomena)|I(?:\.[\s\xa0]*(?:Paralipomena|Cron(?:ici)?)|[\s\xa0]*(?:Paralipomena|Cron(?:ici)?))|1(?:\.[\s\xa0]*(?:Paralipomena|Cron(?:ici)?)|[\s\xa0]*(?:Paralipomena|Cron(?:ici)?)|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        ...
        osis: ["Song"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:C(?:ânt(?:ar(?:ea[\\s\\xa0]*(?:lui[\\s\\xa0]*Solomon|C[aâ]nt(?:[aă]rilor))|i)|ări)|ant(?:ar(?:ea[\\s\\xa0]*(?:lui[\\s\\xa0]*Solomon|C[aâ]nt(?:[aă]rilor)|cantarilor)|i)|ări)?)|Song))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Wis"],
        apocrypha: true,
        ...
        osis: ["Zeph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Sofonie|[ŢȚ]efania|Zeph|Tef(?:ania)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hag"],
        ...
        osis: ["Acts"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Acts|F(?:[\\s\\xa0]*Ap|\\.(?:[\\s\\xa0]*Ap|A)|ap(?:t(?:e(?:le[\\s\\xa0]*Apostolilor)?)?)?|A)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rev"],
        ...
        osis: ["Phil"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Phil|F(?:ilip(?:eni)?|lp)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Col"],
...
var grammar = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c63 = "capitolele",
        peg$c64 = { type: "literal", value: "capitolele", description: "\"capitolele\"" },
        peg$c65 = "capitolul",
        peg$c66 = { type: "literal", value: "capitolul", description: "\"capitolul\"" },
        peg$c67 = "cap",
        peg$c68 = { type: "literal", value: "cap", description: "\"cap\"" },
        peg$c69 = function() { return {"type": "c_explicit"} },
        peg$c70 = "versetul",
        peg$c71 = { type: "literal", value: "versetul", description: "\"versetul\"" },
        peg$c72 = "versetele",
        peg$c73 = { type: "literal", value: "versetele", description: "\"versetele\"" },
        peg$c74 = "versete",
        peg$c75 = { type: "literal", value: "versete", description: "\"versete\"" },
        peg$c76 = "vers",
        peg$c77 = { type: "literal", value: "vers", description: "\"vers\"" },
        peg$c78 = "vs",
        peg$c79 = { type: "literal", value: "vs", description: "\"vs\"" },
        peg$c80 = "v",
        ...
        peg$c89 = /^[\u015Fs]/i,
        peg$c90 = { type: "class", value: "[\\u015Fs]i", description: "[\\u015Fs]i" },
        peg$c91 = "i",
        peg$c92 = { type: "literal", value: "i", description: "\"i\"" },
        peg$c93 = "cf",
        peg$c94 = { type: "literal", value: "cf", description: "\"cf\"" },
        peg$c95 = "cp",
        peg$c96 = { type: "literal", value: "cp", description: "\"cp\"" },
...
var grammar = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c86 = { type: "class", value: "[;\\/:&\\-\\u2013\\u2014~]", description: "[;\\/:&\\-\\u2013\\u2014~]" },
        peg$c87 = /^[\u015Fs]/i,
        peg$c88 = { type: "class", value: "[\\u015Fs]i", description: "[\\u015Fs]i" },
        peg$c89 = "i",
        peg$c90 = { type: "literal", value: "i", description: "\"i\"" },
        peg$c91 = "cf",
        peg$c92 = { type: "literal", value: "cf", description: "\"cf\"" },
        peg$c93 = "cp",
        peg$c94 = { type: "literal", value: "cp", description: "\"cp\"" },
        peg$c95 = function() { return "" },
        peg$c96 = /^[\-\u2013\u2014]/,
        peg$c97 = { type: "class", value: "[\\-\\u2013\\u2014]", description: "[\\-\\u2013\\u2014]" },
        peg$c98 = function(val) { return {type:"title", value: [val], "indices": [offset(), peg$currPos - 1]} },
        peg$c99 = "from",
        peg$c100 = { type: "literal", value: "from", description: "\"from\"" },
        peg$c101 = "of",
        peg$c102 = { type: "literal", value: "of", description: "\"of\"" },
        peg$c103 = "in",
        peg$c104 = { type: "literal", value: "in", description: "\"in\"" },
        peg$c105 = "the",
        peg$c106 = { type: "literal", value: "the", description: "\"the\"" },
        peg$c107 = "book",
        peg$c108 = { type: "literal", value: "book", description: "\"book\"" },
        peg$c109 = /^[([]/,
        peg$c110 = { type: "class", value: "[([]", description: "[([]" },
        peg$c111 = /^[)\]]/,
        peg$c112 = { type: "class", value: "[)\\]]", description: "[)\\]]" },
        peg$c113 = function(val) { return {"type": "translation_sequence", "value": val, "indices": [offset(), peg$currPos - 1]} },
        peg$c114 = "\x1E",
        peg$c115 = { type: "literal", value: "\x1E", description: "\"\\x1E\"" },
        peg$c116 = function(val) { return {"type": "translation", "value": val.value, "indices": [offset(), peg$currPos - 1]} },
        peg$c117 = ",000",
        peg$c118 = { type: "literal", value: ",000", description: "\",000\"" },
        peg$c119 = function(val) { return {"type": "integer", "value": parseInt(val.join(""), 10), "indices": [offset(), peg$currPos - 1]} },
        peg$c120 = /^[^\x1F\x1E([]/,
        peg$c121 = { type: "class", value: "[^\\x1F\\x1E([]", description: "[^\\x1F\\x1E([]" },
        peg$c122 = function(val) { return {"type": "word", "value": val.join(""), "indices": [offset(), peg$currPos - 1]} },
        peg$c123 = function(val) { return {"type": "stop", "value": val, "indices": [offset(), peg$currPos - 1]} },
        peg$c124 = /^[\s\xa0*]/,
        peg$c125 = { type: "class", value: "[\\s\\xa0*]", description: "[\\s\\xa0*]" },
