    ...
    books = [
      {
        ...
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Tre[cæć]a[\s\xa0]*Ivanova(?:[\s\xa0]*(?:[Pp]oslanica)?)|III(?:\.[\s\xa0]*Ivanova(?:[\s\xa0]*Poslanica)?|[\s\xa0]*Ivanova(?:[\s\xa0]*Poslanica)?)|3(?:\.[\s\xa0]*Ivanova(?:[\s\xa0]*Poslanica)?|John|[\s\xa0]*Iv(?:anova(?:[\s\xa0]*Poslanica)?)?))|Tre(?:[cæć]a[\s\xa0]*Ivanova))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        ...
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Pavlova[\s\xa0]*druga[\s\xa0]*poslanica[\s\xa0]*Korin[cć]anima|Druga[\s\xa0]*(?:Korin[cć]anima[\s\xa0]*Poslanica|poslanica[\s\xa0]*Korin[cæć]anima)|II(?:\.[\s\xa0]*Korin[cć]anima[\s\xa0]*Poslanica|[\s\xa0]*Korin[cć]anima[\s\xa0]*Poslanica)|2(?:\.[\s\xa0]*Korin[cć]anima[\s\xa0]*Poslanica|[\s\xa0]*Kor(?:in[cć]anima[\s\xa0]*Poslanica)?|Cor))|(?:II(?:\.[\s\xa0]*Korin[ćc]anima|[\s\xa0]*Korin[ćc]anima)|Druga[\s\xa0]*Korin[ćc]anima|2(?:\.[\s\xa0]*Korin[ćc]anima|[\s\xa0]*Korin[cć]anima)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:P(?:avlova[\s\xa0]*prva[\s\xa0]*poslanica[\s\xa0]*Korin[cć]anima|rva[\s\xa0]*(?:Korin[cć]anima[\s\xa0]*Poslanica|poslanica[\s\xa0]*Korin[cæć]anima))|I(?:\.[\s\xa0]*Korin[cć]anima[\s\xa0]*Poslanica|[\s\xa0]*Korin[cć]anima[\s\xa0]*Poslanica)|1(?:\.[\s\xa0]*Korin[cć]anima[\s\xa0]*Poslanica|[\s\xa0]*Kor(?:in[cć]anima[\s\xa0]*Poslanica)?|Cor))|(?:Prva[\s\xa0]*Korin[ćc]anima|[1I](?:[\s\xa0]*Korin(?:[ćc]anima|\.[\s\xa0]*Korin[ćc]anima)))|[1I]\.[\s\xa0]*Korin(?:[ćc]anima))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Gal"],
...
var grammar = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c63 = "poglavlja",
        peg$c64 = { type: "literal", value: "poglavlja", description: "\"poglavlja\"" },
        peg$c65 = "poglavlje",
        peg$c66 = { type: "literal", value: "poglavlje", description: "\"poglavlje\"" },
        peg$c67 = "glava",
        peg$c68 = { type: "literal", value: "glava", description: "\"glava\"" },
        peg$c69 = function() { return {"type": "c_explicit"} },
        peg$c70 = "verse",
        peg$c71 = { type: "literal", value: "verse", description: "\"verse\"" },
        ...
        peg$c79 = "i",
        peg$c80 = { type: "literal", value: "i", description: "\"i\"" },
