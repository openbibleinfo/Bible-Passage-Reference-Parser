    ...
    books = [
      {
        ...
        osis: ["Lam"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jeremi[aá](?:[sš]ov[\\s\\xa0]*Pla[cč])|Pla[cč][\\s\\xa0]*Jeremi(?:[aá](?:[sš]ov))|K(?:niha[\\s\\xa0]*n[aá]rekov|\\.[\\s\\xa0]*n[aá]rekov|[\\s\\xa0]*n[aá]rekov)|(?:[ZŽ]alosp(?:evy)?)|Lam|N(?:[aá]r(?:eky)?))|Pla[čc])(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["EpJer"],
        apocrypha: true,
        ...
        osis: ["Song"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Song|V(?:e[lľ]p(?:iese(?:[nň][\\s\\xa0]*(?:[SŠ]alam(?:[uú]nova)))?)|[lľ]p)|P(?:ies(?:e[nň][\\s\\xa0]*(?:(?:[SŠ]alam(?:[uú]nova)|piesn[ií])))?|Š))|Ve(?:[lľ]p)|(?:Ve[ľl]piese[nň]|Piese[nň]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jer"],
        ...
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Druh(?:[yý][\s\xa0]*(?:J(?:[aá]nov[\s\xa0]*list|list[\s\xa0]*J[aá]nov))|[aá][\s\xa0]*(?:kniha[\s\xa0]*J(?:[aá]nov|J[aá]nov)))|II(?:\.[\s\xa0]*J[aá]nov|[\s\xa0]*J[aá]nov)|2(?:\.[\s\xa0]*J[aá]nov|John|[\s\xa0]*(?:k(?:\.[\s\xa0]*J[aá]nov|[\s\xa0]*J[aá]nov)|J(?:[aá]nov|n)?)))|Druh(?:[yý][\s\xa0]*list[\s\xa0]*J(?:[aá]nov)|[aá][\s\xa0]*J(?:[aá]nov))|Druh[yý][\s\xa0]*J(?:[áa]nov))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
...
var grammar = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c63 = /^[b-e]/,
        peg$c64 = { type: "class", value: "[b-e]", description: "[b-e]" },
        peg$c65 = function(val) { return {"type": "v", "value": [val], "indices": [offset(), peg$currPos - 1]} },
        peg$c66 = "kapitoly",
        peg$c67 = { type: "literal", value: "kapitoly", description: "\"kapitoly\"" },
        peg$c68 = "kapitole",
        peg$c69 = { type: "literal", value: "kapitole", description: "\"kapitole\"" },
        peg$c70 = "kapitolu",
        peg$c71 = { type: "literal", value: "kapitolu", description: "\"kapitolu\"" },
        peg$c72 = "kapitol",
        peg$c73 = { type: "literal", value: "kapitol", description: "\"kapitol\"" },
        peg$c74 = "hlavy",
        peg$c75 = { type: "literal", value: "hlavy", description: "\"hlavy\"" },
        peg$c76 = "kap",
        peg$c77 = { type: "literal", value: "kap", description: "\"kap\"" },
        peg$c78 = function() { return {"type": "c_explicit"} },
        peg$c79 = "ver",
        peg$c80 = { type: "literal", value: "ver", description: "\"ver\"" },
        peg$c81 = /^[\u0161s]/i,
        peg$c82 = { type: "class", value: "[\\u0161s]i", description: "[\\u0161s]i" },
        peg$c83 = "ov",
        peg$c84 = { type: "literal", value: "ov", description: "\"ov\"" },
        ...
        peg$c90 = "porov",
        peg$c91 = { type: "literal", value: "porov", description: "\"porov\"" },
        peg$c92 = "pozri",
        peg$c93 = { type: "literal", value: "pozri", description: "\"pozri\"" },
        peg$c94 = "alebo",
        peg$c95 = { type: "literal", value: "alebo", description: "\"alebo\"" },
        peg$c96 = "a",
        ...
        peg$c101 = /^[\u017Ez]/i,
        peg$c102 = { type: "class", value: "[\\u017Ez]i", description: "[\\u017Ez]i" },
