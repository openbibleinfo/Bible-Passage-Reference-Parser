    ...
    books = [
      {
        ...
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Third[\s\xa0]*Kingdoms|3(?:rd(?:\.[\s\xa0]*Kingdoms|[\s\xa0]*Kingdoms)|\.[\s\xa0]*Kingdoms|[\s\xa0]*Kingdoms)|First[\s\xa0]*K(?:gs?|i(?:gs?|n(?:gs?|s)?)?|n(?:gs?|s)?|s)?|1(?:st(?:\.[\s\xa0]*K(?:gs?|i(?:gs?|n(?:gs?|s)?)?|n(?:gs?|s)?|s)?|[\s\xa0]*K(?:gs?|i(?:gs?|n(?:gs?|s)?)?|n(?:gs?|s)?|s)?)|\.[\s\xa0]*K(?:gs?|i(?:gs?|n(?:gs?|s)?)?|n(?:gs?|s)?|s)?|Kgs|[\s\xa0]*K(?:gs?|i(?:gs?|n(?:gs?|s)?)?|n(?:gs?|s)?|s)?)|I(?:II(?:\.[\s\xa0]*Kingdoms|[\s\xa0]*Kingdoms)|\.[\s\xa0]*K(?:gs?|i(?:gs?|n(?:gs?|s)?)?|n(?:gs?|s)?|s)?|[\s\xa0]*K(?:gs?|i(?:gs?|n(?:gs?|s)?)?|n(?:gs?|s)?|s)?))|K(?:gs|in(?:gs)?|ngs))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        ...
        osis: ["Matt"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:The[\\s\\xa0]*Gospel[\\s\\xa0]*(?:according[\\s\\xa0]*to[\\s\\xa0]*(?:S(?:aint[\\s\\xa0]*M(?:at(?:h(?:(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:(?:[ht](?:iew|ew))|iew|ew|we)|iew|t(?:h(?:iew|ew)|iew|ew)|ew|we)?)?|t)|t(?:\\.[\\s\\xa0]*M(?:at(?:h(?:(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:(?:[ht](?:iew|ew))|iew|ew|we)|iew|t(?:h(?:iew|ew)|iew|ew)|ew|we)?)?|t)|[\\s\\xa0]*M(?:at(?:h(?:(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:(?:[ht](?:iew|ew))|iew|ew|we)|iew|t(?:h(?:iew|ew)|iew|ew)|ew|we)?)?|t)))|M(?:at(?:h(?:(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:(?:[ht](?:iew|ew))|iew|ew|we)|iew|t(?:h(?:iew|ew)|iew|ew)|ew|we)?)?|t))|of[\\s\\xa0]*(?:S(?:aint[\\s\\xa0]*M(?:at(?:h(?:(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:(?:[ht](?:iew|ew))|iew|ew|we)|iew|t(?:h(?:iew|ew)|iew|ew)|ew|we)?)?|t)|t(?:\\.[\\s\\xa0]*M(?:at(?:h(?:(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:(?:[ht](?:iew|ew))|iew|ew|we)|iew|t(?:h(?:iew|ew)|iew|ew)|ew|we)?)?|t)|[\\s\\xa0]*M(?:at(?:h(?:(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:(?:[ht](?:iew|ew))|iew|ew|we)|iew|t(?:h(?:iew|ew)|iew|ew)|ew|we)?)?|t)))|M(?:at(?:h(?:(?:[ht](?:(?:[ht](?:iew|ew))|iew|ew))|iew|ew)|t(?:h(?:(?:[ht](?:iew|ew))|iew|ew|we)|iew|t(?:h(?:iew|ew)|iew|ew)|ew|we)?)?|t)))|Mtt)|(?:M(?:t|at(?:h(?:ew|(?:[th](?:ew|(?:[th](?:ew|iew))|iew))|iew)|t(?:iew|ew|t(?:iew|h(?:iew|ew)|ew)|we|h(?:ew|(?:[th](?:iew|ew))|iew|we))?)?)|Gospel[\\s\\xa0]*(?:of[\\s\\xa0]*(?:M(?:t|at(?:t(?:ew|we|h(?:(?:[ht](?:ew|iew))|iew|ew|we)|t(?:iew|ew|h(?:ew|iew))|iew)?|h(?:iew|ew|(?:[ht](?:ew|(?:[th](?:iew|ew))|iew))))?)|S(?:aint[\\s\\xa0]*M(?:t|at(?:t(?:we|iew|h(?:iew|ew|(?:[th](?:iew|ew))|we)|ew|t(?:iew|h(?:ew|iew)|ew))?|h(?:iew|ew|(?:[th](?:iew|ew|(?:[ht](?:iew|ew))))))?)|t(?:\\.[\\s\\xa0]*M(?:t|at(?:h(?:iew|ew|(?:[ht](?:ew|(?:[ht](?:iew|ew))|iew)))|t(?:iew|we|ew|h(?:ew|we|(?:[th](?:iew|ew))|iew)|t(?:iew|h(?:ew|iew)|ew))?)?)|[\\s\\xa0]*M(?:t|at(?:h(?:iew|ew|(?:[ht](?:ew|iew|(?:[th](?:ew|iew)))))|t(?:ew|iew|t(?:h(?:ew|iew)|ew|iew)|we|h(?:we|ew|iew|(?:[ht](?:iew|ew))))?)?))))|according[\\s\\xa0]*to[\\s\\xa0]*(?:S(?:t(?:\\.[\\s\\xa0]*M(?:t|at(?:h(?:iew|ew|(?:[th](?:iew|(?:[ht](?:iew|ew))|ew)))|t(?:iew|ew|we|h(?:(?:[th](?:ew|iew))|ew|we|iew)|t(?:iew|ew|h(?:ew|iew)))?)?)|[\\s\\xa0]*M(?:t|at(?:h(?:ew|(?:[th](?:(?:[th](?:ew|iew))|ew|iew))|iew)|t(?:iew|t(?:ew|iew|h(?:ew|iew))|ew|h(?:ew|iew|(?:[ht](?:iew|ew))|we)|we)?)?))|aint[\\s\\xa0]*M(?:t|at(?:t(?:iew|t(?:ew|iew|h(?:ew|iew))|we|h(?:we|iew|(?:[th](?:iew|ew))|ew)|ew)?|h(?:iew|ew|(?:[ht](?:iew|(?:[th](?:ew|iew))|ew))))?))|M(?:t|at(?:h(?:ew|iew|(?:[ht](?:ew|iew|(?:[ht](?:iew|ew)))))|t(?:ew|iew|h(?:ew|(?:[th](?:ew|iew))|iew|we)|t(?:iew|ew|h(?:iew|ew))|we)?)?)))|S(?:aint[\\s\\xa0]*M(?:t|at(?:h(?:iew|ew|(?:[ht](?:iew|ew|(?:[ht](?:iew|ew)))))|t(?:iew|t(?:ew|iew|h(?:ew|iew))|we|h(?:(?:[ht](?:iew|ew))|ew|iew|we)|ew)?)?)|t(?:\\.[\\s\\xa0]*M(?:t|at(?:h(?:ew|(?:[ht](?:(?:[ht](?:ew|iew))|iew|ew))|iew)|t(?:ew|we|iew|t(?:ew|iew|h(?:iew|ew))|h(?:ew|(?:[ht](?:iew|ew))|iew|we))?)?)|[\\s\\xa0]*M(?:t|at(?:h(?:ew|(?:[ht](?:ew|(?:[ht](?:ew|iew))|iew))|iew)|t(?:ew|iew|we|t(?:ew|h(?:iew|ew)|iew)|h(?:iew|we|(?:[ht](?:iew|ew))|ew))?)?)))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mark"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(The[\\s\\xa0]*Gospel[\\s\\xa0]*(?:according[\\s\\xa0]*to[\\s\\xa0]*(?:S(?:aint[\\s\\xa0]*M(?:ark?|k|rk?)|t(?:\\.[\\s\\xa0]*M(?:ark?|k|rk?)|[\\s\\xa0]*M(?:ark?|k|rk?)))|M(?:ark?|k|rk?))|of[\\s\\xa0]*(?:S(?:aint[\\s\\xa0]*M(?:ark?|k|rk?)|t(?:\\.[\\s\\xa0]*M(?:ark?|k|rk?)|[\\s\\xa0]*M(?:ark?|k|rk?)))|M(?:ark?|k|rk?)))|(?:M(?:k|ark?|rk?)|S(?:aint[\\s\\xa0]*M(?:k|ark?|rk?)|t(?:[\\s\\xa0]*M(?:rk?|ark?|k)|\\.[\\s\\xa0]*M(?:k|rk?|ark?)))|Gospel[\\s\\xa0]*(?:of[\\s\\xa0]*(?:M(?:ark?|rk?|k)|S(?:aint[\\s\\xa0]*M(?:k|ark?|rk?)|t(?:[\\s\\xa0]*M(?:rk?|ark?|k)|\\.[\\s\\xa0]*M(?:k|rk?|ark?))))|according[\\s\\xa0]*to[\\s\\xa0]*(?:S(?:aint[\\s\\xa0]*M(?:k|rk?|ark?)|t(?:\\.[\\s\\xa0]*M(?:ark?|rk?|k)|[\\s\\xa0]*M(?:ark?|k|rk?)))|M(?:k|ark?|rk?)))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Luke"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(The[\\s\\xa0]*Gospel[\\s\\xa0]*(?:according[\\s\\xa0]*to[\\s\\xa0]*(?:S(?:aint[\\s\\xa0]*L(?:k|u(?:ke?)?)|t(?:\\.[\\s\\xa0]*L(?:k|u(?:ke?)?)|[\\s\\xa0]*L(?:k|u(?:ke?)?)))|L(?:k|u(?:ke?)?))|of[\\s\\xa0]*(?:S(?:aint[\\s\\xa0]*L(?:k|u(?:ke?)?)|t(?:\\.[\\s\\xa0]*L(?:k|u(?:ke?)?)|[\\s\\xa0]*L(?:k|u(?:ke?)?)))|L(?:k|u(?:ke?)?)))|(?:L(?:k|u(?:ke?)?)|S(?:aint[\\s\\xa0]*L(?:k|u(?:ke?)?)|t(?:\\.[\\s\\xa0]*L(?:k|u(?:ke?)?)|[\\s\\xa0]*L(?:u(?:ke?)?|k)))|Gospel[\\s\\xa0]*(?:according[\\s\\xa0]*to[\\s\\xa0]*(?:L(?:k|u(?:ke?)?)|S(?:aint[\\s\\xa0]*L(?:k|u(?:ke?)?)|t(?:\\.[\\s\\xa0]*L(?:u(?:ke?)?|k)|[\\s\\xa0]*L(?:u(?:ke?)?|k))))|of[\\s\\xa0]*(?:L(?:k|u(?:ke?)?)|S(?:aint[\\s\\xa0]*L(?:k|u(?:ke?)?)|t(?:\\.[\\s\\xa0]*L(?:k|u(?:ke?)?)|[\\s\\xa0]*L(?:k|u(?:ke?)?)))))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1John"],
...
var grammar = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c111 = "compare",
        peg$c112 = { type: "literal", value: "compare", description: "\"compare\"" },
        peg$c113 = "cf",
        peg$c114 = { type: "literal", value: "cf", description: "\"cf\"" },
        peg$c115 = "see",
        peg$c116 = { type: "literal", value: "see", description: "\"see\"" },
        peg$c117 = "also",
        peg$c118 = { type: "literal", value: "also", description: "\"also\"" },
        peg$c119 = function() { return "" },
        peg$c120 = /^[\-\u2013\u2014]/,
        peg$c121 = { type: "class", value: "[\\-\\u2013\\u2014]", description: "[\\-\\u2013\\u2014]" },
        peg$c122 = "through",
        peg$c123 = { type: "literal", value: "through", description: "\"through\"" },
        peg$c124 = "thru",
        peg$c125 = { type: "literal", value: "thru", description: "\"thru\"" },
        peg$c126 = "to",
        peg$c127 = { type: "literal", value: "to", description: "\"to\"" },
        peg$c128 = function(val) { return {type:"title", value: [val], "indices": [offset(), peg$currPos - 1]} },
        peg$c129 = "from",
        peg$c130 = { type: "literal", value: "from", description: "\"from\"" },
        peg$c131 = "of",
        peg$c132 = { type: "literal", value: "of", description: "\"of\"" },
        peg$c133 = "in",
        peg$c134 = { type: "literal", value: "in", description: "\"in\"" },
        peg$c135 = "the",
        peg$c136 = { type: "literal", value: "the", description: "\"the\"" },
        peg$c137 = "book",
        peg$c138 = { type: "literal", value: "book", description: "\"book\"" },
        peg$c139 = /^[([]/,
        peg$c140 = { type: "class", value: "[([]", description: "[([]" },
        peg$c141 = /^[)\]]/,
        peg$c142 = { type: "class", value: "[)\\]]", description: "[)\\]]" },
        peg$c143 = function(val) { return {"type": "translation_sequence", "value": val, "indices": [offset(), peg$currPos - 1]} },
        peg$c144 = "\x1E",
        peg$c145 = { type: "literal", value: "\x1E", description: "\"\\x1E\"" },
        peg$c146 = function(val) { return {"type": "translation", "value": val.value, "indices": [offset(), peg$currPos - 1]} },
        peg$c147 = ",000",
        peg$c148 = { type: "literal", value: ",000", description: "\",000\"" },
        peg$c149 = function(val) { return {"type": "integer", "value": parseInt(val.join(""), 10), "indices": [offset(), peg$currPos - 1]} },
        peg$c150 = /^[^\x1F\x1E([]/,
        peg$c151 = { type: "class", value: "[^\\x1F\\x1E([]", description: "[^\\x1F\\x1E([]" },
        peg$c152 = function(val) { return {"type": "word", "value": val.join(""), "indices": [offset(), peg$currPos - 1]} },
        peg$c153 = function(val) { return {"type": "stop", "value": val, "indices": [offset(), peg$currPos - 1]} },
        peg$c154 = /^[\s\xa0*]/,
        peg$c155 = { type: "class", value: "[\\s\\xa0*]", description: "[\\s\\xa0*]" },
