...
(function() {
  ...
  bcv_parser = (function() {
    ...
    bcv_parser.prototype.verse_iterator = function() {
      var ent, ent_set, next, out, _i, _j, _len, _len1, _ref, _ref1;
      next = function() {
        var ref, res, tr;
        ref = this.entities[this.refPtr];
        if (!ref) {
          return;
        }
        if (this.vPtr === 0) {
          this.bkPtr = ref.start.b;
          this.chPtr = ref.start.c;
          this.vPtr = ref.start.v;
        }
        tr = ref.translations[0] || "default";
        res = this.bkPtr + "." + this.chPtr + "." + this.vPtr;
        this.vPtr++;
        if (this.vPtr > this.parent.translations[tr].chapters[this.bkPtr][this.chPtr - 1]) {
          if (ref.end.c > this.chPtr) {
            this.chPtr++;
            this.vPtr = 1;
          } else {
            this.refPtr++;
        ...
        } else if (this.bkPtr === ref.end.b && this.chPtr === ref.end.c && this.vPtr > ref.end.v) {
          this.refPtr++;
          this.vPtr = 0;
        }
        return res;
    ...
    bcv_parser.prototype.contiguous_verse_range_iterator = function() {
      var ent, ent_set, next, out, _i, _j, _len, _len1, _ref, _ref1;
      next = function() {
        var end, ref, res, tr;
        ref = this.entities[this.refPtr];
        ...
        tr = ref.translations[0] || "default";
        if (this.bkPtr === ref.end.b && this.chPtr === ref.end.c) {
          end = ref.end.v;
        } else {
          end = this.parent.translations[tr].chapters[this.bkPtr][this.chPtr - 1];
        }
        res = this.bkPtr + "." + this.chPtr + "." + this.vPtr;
        if (end !== this.vPtr) {
          res += "-" + end;
    ...
    bcv_parser.prototype.chapter_iter_next = function() {
      throw "Oops";
    };
