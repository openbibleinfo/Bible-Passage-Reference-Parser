...
(function() {
  ...
  bcv_parser.prototype.regexps.translations = /(?:AMP|ASV|CE[BV]|E[RS]V|HCSB|N?KJV|MSG|NAB(?:RE)?|NASB?|NIR?V|NLT|N?RSV|TNIV)\b/gi;
  ...
  bcv_parser.prototype.regexps.fourth = "(?:4th|4|IV|Fourth)\\.?" + bcv_parser.prototype.regexps.space + "*";

  bcv_parser.prototype.regexps.gospel = "(?:(?:The[.\\s\\xa0-]*)?Gospel[.\\s\\xa0-]?(?:of[.\\s\\xa0-]*|according[\\s\\xa0-]*?to[.\\s\\xa0-]*)(?:[.\\s\\xa0-]*?(?:Saint|St)[.\\s\\xa0-]*)?|(?:(?:Saint|St)[.\\s\\xa0-]*))?";
    ...
    books = [
      {
        ...
        osis: ["2Sam"],
        regexp: RegExp("(\\b)(" + bcv_parser.prototype.regexps.second + "(?:Samu[ae]l[ls]?|Sam|Sma|S[am]|Kingdoms)|2" + bcv_parser.prototype.regexps.space + "*S)(?:\\b|(?=\\d))", "gi")
      }, {
        osis: ["1Sam"],
        regexp: RegExp("(\\b)((?:" + bcv_parser.prototype.regexps.first + ")?Samu[ae]l[ls]?|" + bcv_parser.prototype.regexps.first + "(?:Sam|Sma|S[am]|Kingdoms)|1" + bcv_parser.prototype.regexps.space + "*S)(?:\\b|(?=\\d))", "gi")
      }, {
        osis: ["2Kgs"],
        regexp: RegExp("(\\b)(" + bcv_parser.prototype.regexps.second + "Ki?n?g?s?|" + bcv_parser.prototype.regexps.fourth + "Kingdoms)(?:\\b|(?=\\d))", "gi")
      }, {
        osis: ["1Kgs"],
        regexp: RegExp("(\\b)((?:" + bcv_parser.prototype.regexps.first + ")?K(?:i?ngs|in|gs)|" + bcv_parser.prototype.regexps.first + "Ki?n?g?s?|" + bcv_parser.prototype.regexps.third + "Kingdoms)(?:\\b|(?=\\d))", "gi")
      }, {
        osis: ["2Chr"],
        regexp: RegExp("(\\b)(" + bcv_parser.prototype.regexps.second + "(?:Ch?o?ron[io]cles?|Chronicals|Chro?n?|Cron|Paralipomenon)|2" + bcv_parser.prototype.regexps.space + "*Ch)(?:\\b|(?=\\d))", "gi")
      }, {
        osis: ["1Chr"],
        regexp: RegExp("(\\b)((?:" + bcv_parser.prototype.regexps.first + ")?(?:Ch?o?ron[io]cles?|Chronicals|Paralipomenon)|" + bcv_parser.prototype.regexps.first + "(?:Chro?n?|Cron)|1" + bcv_parser.prototype.regexps.space + "*Ch)(?:\\b|(?=\\d))", "gi")
      }, {
        osis: ["Ezra"],
        ...
        osis: ["Prov"],
        regexp: /(\d|\b)(P(?:r[eo]?verbs?|robv?erbs|or?verbs|rovebs|rvbs?|ro?v?|v)|Oroverbs)(?:\b|(?=\d))/gi
      }, {
        osis: ["Eccl"],
        ...
        osis: ["Rom"],
        regexp: /(\d|\b)(R(?:omans?|pmans|oamns|omands|omasn|om?s?|mn?s?))(?:\b|(?=\d))/gi
      }, {
        osis: ["2Cor"],
        ...
        osis: ["Sir"],
        apocrypha: true,
        regexp: RegExp("(\\d|\\b)(Sirach|Ben" + bcv_parser.prototype.regexps.space + "*Sira|Sir|Eccl[eu]siasticus|Ecclus|Eccs|(?:The" + bcv_parser.prototype.regexps.space + "*)Wisdom" + bcv_parser.prototype.regexps.space + "*of" + bcv_parser.prototype.regexps.space + "*Jesus" + bcv_parser.prototype.regexps.space + "*(?:Son" + bcv_parser.prototype.regexps.space + "*of|ben)" + bcv_parser.prototype.regexps.space + "*Sirach)(?:\\b|(?=\\d))", "gi")
      }, {
        osis: ["Bar"],
        apocrypha: true,
        ...
        osis: ["4Macc"],
        apocrypha: true,
        regexp: RegExp("(\\b)(" + bcv_parser.prototype.regexps.fourth + bcv_parser.prototype.regexps.space + "*Mac{1,3}(?:ab{1,3}e{1,3}s?)?|4" + bcv_parser.prototype.regexps.space + "*Mc)(?:\\b|(?=\\d))", "gi")
      }, {
        osis: ["1Macc"],
        apocrypha: true,
