  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_c_explicit() {
        ...
        result0 = parse_sp();
        if (result0 !== null) {
          if (input.substr(pos, 8) === "capitoli") {
            result1 = "capitoli";
            pos += 8;
          } else {
            result1 = null;
            if (reportFailures === 0) {
              matchFailed("\"capitoli\"");
            }
          }
          if (result1 === null) {
            if (input.substr(pos, 8) === "capitolo") {
              result1 = "capitolo";
              pos += 8;
            } else {
              result1 = null;
              if (reportFailures === 0) {
                matchFailed("\"capitolo\"");
              }
            }
            if (result1 === null) {
              if (input.substr(pos, 4) === "capp") {
                result1 = "capp";
                pos += 4;
              } else {
                result1 = null;
      ...
      function parse_v_explicit() {
        ...
        result0 = parse_sp();
        if (result0 !== null) {
          if (input.substr(pos, 8) === "versetto") {
            result1 = "versetto";
            pos += 8;
          } else {
            result1 = null;
            if (reportFailures === 0) {
              matchFailed("\"versetto\"");
            }
          }
          if (result1 === null) {
            if (input.substr(pos, 8) === "versetti") {
              result1 = "versetti";
              pos += 8;
            } else {
              result1 = null;
              if (reportFailures === 0) {
                matchFailed("\"versetti\"");
              }
            }
            if (result1 === null) {
              if (input.substr(pos, 5) === "versi") {
                result1 = "versi";
                pos += 5;
              } else {
                result1 = null;
