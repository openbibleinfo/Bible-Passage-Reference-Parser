(function() {
  describe("Pre-parsing", function() {
    ...
    it("should turn on/off the Apocrypha", function() {
      ...
      return expect(p.translations["default"].order.Tob).not.toBeDefined();
    });
  ...
  describe("Parsing", function() {
    ...
    it("should handle `pre_book` ranges", function() {
      ...
      return expect(p.parse("1 and 3 John").osis_and_indices()).toEqual([
        {
          osis: "3John",
          translations: [""],
          indices: [6, 12]
  ...
  describe("Real-world parsing", function() {
    ...
    return it("should handle sample tweets", function() {
      ...
      return expect(p.parse("job is 2 f").osis_and_indices()).toEqual([
        {
