...
(function() {
  ...
  describe("Parsing", function() {
    ...
    it("should round-trip OSIS references", function() {
      ...
      for (_i = 0, _len = books.length; _i < _len; _i++) {
        ...
        _results.push(expect(p.parse(bcv_range).osis()).toEqual(bcv_range.replace(/,/g, ".")));
      }
      return _results;
    });
  ...
  describe("Spanish parsing", function() {
    ...
    it("should handle ranges", function() {
      ...
      return expect(p.parse("2 Cr 1,9b-17").osis()).toEqual("2Chr.1.9-2Chr.1.17");
    });
    ...
    return it("should handle EU-style punctuation", function() {
      return expect(p.parse("Malaquias 1, 3").osis()).toEqual("Mal.1.3");
    });
  });
