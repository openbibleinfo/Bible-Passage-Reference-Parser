    ...
    books = [
      {
        ...
        osis: ["Phlm"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:P(?:il[eē]m(?:[oō](?:[nṉ]ukku[\\s\\xa0]*E(?:[lḻ]utiya[\\s\\xa0]*Nirupam)))|hlm)|பில(?:மோன(?:ுக்கு[\\s\\xa0]*எழுதிய[\\s\\xa0]*திருமுகம்|்)|ே(?:மோன(?:ுக்கு[\\s\\xa0]*எழுதிய[\\s\\xa0]*(?:நிருபம்|கடிதம்)|்))?)?)|Pil[eē]m(?:[ōo](?:[nṉ]ukku)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Heb"],
