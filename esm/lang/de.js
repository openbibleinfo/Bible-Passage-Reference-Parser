...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = /(?:Erste[nrs]?|1)\.?\s*/;
    this.second = /(?:Zweite[nrs]?|2)\.?\s*/;
    this.third = /(?:Dritte[nrs]?|3)\.?\s*/;
    this.range_and = /(?:[&\u2013\u2014-]|(?:und\s+siehe\s+auch|und\s+siehe|und\s+auch|sowie\s+auch|siehe\s+auch|siehe|sowie|und|u|&|vgl)|bis)/;
    this.range_only = /(?:[\u2013\u2014-]|bis)/;
