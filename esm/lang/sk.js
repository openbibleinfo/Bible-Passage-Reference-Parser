...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = /(?:Prv[áa]\s+kniha|Prv[ýy]\s+list|Prv[áa]|Prv[ýy]|1\s+k|I|1)\.?\s*/;
    this.second = /(?:Druh[áa]\s+kniha|Druh[ýy]\s+list|Druh[áa]|Druh[ýy]|2\s+k|II|2)\.?\s*/;
    this.third = /(?:Tretia\s+kniha|Tretia|Tret[íi]|3\s+k|III|3)\.?\s*/;
    this.range_and = /(?:[&\u2013\u2014-]|(?:porov|pozri|alebo|a)|(?:a[žz]|-))/;
    this.range_only = /(?:[\u2013\u2014-]|(?:a[žz]|-))/;
