  ...
  constructor() {
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Lam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(Marathi\s*(?:Er(?:yah|mia)|Irmia)|(?:Chante\s*pou\s*plenn\s*So\s*lavil\s*Jerizalem|(?:(?:Plangerile\s*(?:profetu)?lui\s*I|Maombolezo\s*ya\s*Y)eremi|Lamentacje\s*Jeremiasz|Ermmaasa\s*Zilaassa|Treny\s*Jeremiasz|Marathi(?:\s*(?:Er(?:yi?ah|m(?:ei|ia))|Irm(?:ei|ia))|y['’]|['’]y)|Marathi\s*Eryei|Klagovisorn|Nudub\s*Yermi)a|L(?:am(?:enta(?:(?:coes\s*de\s*Jeremia|tione)s|ciones)|inta(?:cione|tion)s)|m)|Baroorashadii\s*Yeremyaah|(?:Lamenta(?:tions\s*de\s*Jeremi|cij)|Klagesangen)e|K(?:lagelieder\s*Jeremias|niha\s*narku)|(?:Aklat\s*ng\s*Pa(?:nan|gt)agho|Mga\s*Panagho|Panagho|Narek)y|Jeremi(?:jine\s*tuzaljke|as(?:\s*siralmai|ov\s*Plac))|Galarnad\s*Jeremiah|(?:Ks(?:ieg[ai]\s*Lamentacj|\.?\s*Lamentacj)|Lamentazion)i|Marath(?:i(?:\s*(?:(?:Eryaiya|Eryi?aa)h|Erm[ei]yah|Irm[ei]yah)|(?:(?:ey)?a|y(?:ya|e))h|(?:ya|e)h|['’]i)|['’]iya)|(?:Kidung\s*Pangadhu|Marathi(?:\s*(?:Erm['’]yaa|Irm['’]yaa)|yaa))h|Ma(?:rath(?:i(?:\s*(?:Er(?:y(?:aiya|(?:i?aa|a))|m(?:[ei]|['’])ya)|Irm(?:[ei]|['’])ya)|(?:ey)?a|y(?:ya|e)|ey|y(?:a|y)?|e)?|['’]iy)|o(?:mbolezo)?)|P(?:lac\s*Jerem(?:ias[ou]v|jasuv|ii)|ulampal)|(?:Mga\s*(?:Pagbangota|Lamentasyo)|Klaagliedere|Pagbangota|Lamantasyo|Plen)n|(?:Kidung\s*Pasamba|V(?:a(?:litusvirr|jtim)|ilapage)e)t|yarmiyako\s*vilap|Baroor(?:ashadii)?|K(?:niha|\.?)\s*narekov|Lam(?:enta(?:tions?|coes)|entacione|inta(?:cione|tion))?|Jeremias\s*sir|Kl(?:a(?:g(?:e(?:lieder|s))?|agl))?|Lamentacje|Zalospevy|P(?:l(?:a(?:ng(?:eri)?|c))?|a(?:na)?g)|Galar(?:nad)?|Siralmak|wilapgit|Tuzaljke|Ratapan|Siralm?|Zalosp|T(?:r(?:eny)?|uz)|Rat(?:ap)?|Va(?:lit|j)|Ai\s*Ca|Klgl|ErmZ|Nar|Hlj|Omb))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:Dru(?:he\s*poslannja\s*apostola\s*Pe|g(?:a\s*List\s*(?:sw\.?\s*Pio|Pio)|i\s*List\s*(?:sw\.?\s*Pio|Pio)))|(?:II\.?\s*L|2\.?\s*L)ist\s*(?:sw\.?\s*Pio|Pio))tr|Druga\s*Petrova\s*[Pp]oslanic|(?:II\.?\s*Petrova\s*P|2\.?\s*Petrova\s*P)oslanic|p(?:atrusko\s*dostro|etracem\s*dusre)\s*patr|II\.?\s*Phi|2\.?\s*Phi)a|Second(?:(?:a\s*lettera\s*di|o)|a)\s*Pietro|Waraka\s*wa\s*Pili\s*wa\s*Petro|Naa77antto\s*PHeexiroosa|Barua\s*ya\s*Pili\s*ya\s*Petro|Toinen\s*Pietarin\s*kirje|(?:Druh(?:a\s*(?:kniha\s*Petro|(?:list\s*)?Petru)|y\s*(?:list\s*Petr[ou]|Petru))|(?:II\.?\s*l|2\.?\s*l)ist\s*Petru|2\s*k\.\s*Petro|2\s*k\s*Petro)v|And(?:r(?:a\s*Petrusbrevet|e\s*Petersbrev)|e[nt]\s*Petersbrev)|(?:II\.?\s*Pieta|2\.?\s*Pieta)rin\s*kirje|(?:Peters\s*Andet\s*B|Pet(?:rus\s*andra|ers\s*andre)\s*b)rev|(?:Druhy\s*Petrov\s*lis|2(?:\s*[ei]\.?\s*Pjetri|\.\s*Pjetri|\s*Pjetri|p)|dovvomp)t|Epistula\s*(?:II\s*Petri|Petri\s*II)|(?:Segund(?:o\s*(?:San\s*)?Ped|a\s*Ped)|(?:(?:(?:Ikalawang|2a\.)|2a)|(?:II\.?\s*S|2\.?\s*S)an)\s*Ped|2\.?o\.\s*(?:San\s*)?Ped|2\.?o\s*(?:San\s*)?Ped)ro|(?:De(?:uxiemes?\s*Pierr|zyem\s*P[iy])|2(?:eme\.|de?\.)\s*Pierr|2(?:eme\s*|de?\s*)Pierr|(?:II\.?\s*Pier|2\.?\s*Pier)r|2e\.?\s*Pierr|II\.?\s*Py|2(?:\.\s*Py|\s*P[Hy]))e|T(?:oinen\s*Pietarin|weede\s*Petr?)|2\.?\s*Petrusbrevet|D(?:o(?:vom(?:\s*[Pp](?:atrissi|eters)|P(?:atrissi|eters)|p(?:atrissi|eters))|\s*?p(?:atrissi|eters))|o(?:vom(?:\s*[Pp]atras|[Pp]atras)|\s*?patras)a|ru(?:h(?:(?:y\s*P(?:etrova|t)|a\s*Pt)|a\s*Petrova)|g[ai]\s*Piotra))|Zweite(?:[nrs])?\s*Petrus|D(?:o(?:(?:vom(?:\s*[Pp](?:atriss?|eter)|P(?:atriss?|et(?:er)?)|p(?:atriss?|eter))|\s*?p(?:atriss?|eter))|(?:vom(?:\s*[Pp]atras|[Pp]atras)|\s*?patras))|ru(?:g(?:a\s*P(?:etrova|iotr)|i\s*Piotr)|h(?:(?:y\s*P(?:etr(?:ov)?)?|a\s*P(?:etr)?)|a\s*Petrov)))|2\.?\s*Petersbrev|Masodik\s*Peter|Butros\s*Labaad|(?:Do(?:vom(?:\s*[Pp]at(?:ari|ru)|Pat(?:ari|ru)|pat(?:ari|ru))|\s*?pat(?:ari|ru))|Tweede\s*Petru|2(?:\.\s*Patara|\s*(?:Patar[ai]|patra))|II\.?\s*Butro|2e\.?\s*Petru|2\.?\s*Butro|2\s*Patru|2Pat(?:ari|ru))s|dovvom\s*petrus|And(?:re\s*Pet(?:ers?)?|en\s*Pet(?:er)?)|(?:II\.?\s*Pieta|2\.?\s*Pieta)rin|Second\s*P(?:(?:ete|t)r|et?r)|II(?:\.\s*(?:P(?:e(?:t(?:r(?:o(?:va?)?|u)?)?|dr)?|ie)?|But)|\s*(?:P(?:e(?:t(?:r(?:o(?:va?)?|u)?)?|dr)?|ie)?|But))|Second\s*P(?:ete|et?|t)?|Masodik\s*Pet|(?:2(?:(?:\.\s*patrusk|\s*(?:patrusk|Pietr))|\.\s*Pietr)|II\.?\s*Pietr|Pili\s*Petr)o|2\.?\s*Petro(?:va?)?|2(?:(?:(?:\s*(?:(?:petracem|P(?:er|d))|Petr(?:uv|i))|\.\s*Pe(?:tr(?:uv|i)|r))|\s*Pedro)|\.\s*Pedro)|II(?:\.\s*Pe(?:tr(?:u[sv]|i)|dro|r)|\s*Pe(?:tr(?:u[sv]|i)|dro|r))|2\s*Patrissi|(?:II\.?\s*Pio|2\.?\s*Pio)tra|2nd\.?\s*P(?:(?:ete|t)r|et?r)|2(?:\.\s*P(?:e(?:t(?:r(?:us?)?|e)?)?)?|\s*P(?:et(?:r(?:us?)?|e)?|(?:i(?:et?)?|ed?|je?)?))|2\s*Patriss?|(?:II\.?\s*Pio|2\.?\s*Pio)tr|2nd\.?\s*P(?:ete|et?|t)?|2\.?\s*Peters?|2Patrissi|2\s*?Patrasa|(?:II(?:\.\s*P(?:ete|t)|\s*P(?:ete|t))|2\.?\s*Pt)r|2Patriss?|2\s*?Patras|Pili\s*Pet|II(?:\.\s*P(?:ete|t)|\s*P(?:ete|t))|2e\.?\s*Petr?|Petr[io]\s*II|2\.\s*Pedr|2Peters|2\s*Pedr|2\.\s*Pie|2\.?\s*But|2Peter|2\.?\s*Pt|2Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:P(?:erse\s*poslannja\s*apostola\s*Pe|ierwsz[aey]\s*List\s*(?:sw\.?\s*Pio|Pio))|(?:1\.?\s*L|I\.?\s*L)ist\s*(?:sw\.?\s*Pio|Pio))tra|E(?:nsimmainen\s*Pietarin\s*kirje|pistula\s*(?:I\s*Petri|Petri\s*I)|lso\s*Peter)|(?:Fyrra\s*almenna\s*bref\s*Petur|E(?:erste\s*Petru|rste(?:[nrs])?\s*Petru)|avval\s*petru|1(?:\.\s*Patara|\s*(?:Patar[ai]|patra))|1e\.\s*Petru|1\.?\s*Butro|I\.?\s*Butro|1e\s*Petru|1\s*Patru)s|Waraka\s*wa\s*Kwanza\s*wa\s*Petro|Barua\s*ya\s*Kwanza\s*ya\s*Petro|Prim(?:(?:a\s*lettera\s*di|o)|a)\s*Pietro|(?:Prv(?:a\s*Petrova\s*[Pp]oslanic|ni\s*Petrov)|(?:1\.?\s*Petrova\s*P|I\.?\s*Petrova\s*P)oslanic|Koiro\s*PHeexiroos|1\.?\s*Phi|I\.?\s*Phi)a|p(?:atrusko\s*pahilo|etracem\s*pahile)\s*patra|E(?:nsimmainen\s*Pietarin|erste\s*Petr?|lso\s*Pet)|(?:Forsta\s*Petrusbreve|Prvy\s*Petrov\s*lis|1\.?\s*Petrusbreve|1(?:\s*[ei]\.?\s*Pjetri|\.\s*Pjetri|\s*Pjetri|p))t|P(?:et(?:rus\s*forsta\s*b|ers\s*1\.?\s*B)rev|rv(?:ni\s*(?:list\s*)?Petruv|a\s*kniha\s*Petrov|y\s*list\s*Petrov|ni\s*Pt))|(?:1\.?\s*Pieta|I\.?\s*Pieta)rin\s*kirje|(?:(?:(?:Prime(?:ro?\s*San|ir[ao])|1\.?o\.\s*San|1\.?o\s*San|(?:1\.?\s*S|I\.?\s*S)an|1a\.)\s*P|(?:(?:Primero?\s*P|(?:1\.?o\.\s*|1\.?o\s*)P)|1a\s*P))ed|Una(?:ng)?\s*Ped)ro|F(?:yrra\s*Petursbref|irst\s*P(?:(?:ete|t)r|et?r))|(?:Prem(?:ier(?:e?s|e?)\s*Pierr|ye\s*P[iy])|1(?:ere?|re)\.\s*Pierr|1(?:ere?|re)\s*Pierr|(?:1\.?\s*Pier|I\.?\s*Pier)r|1(?:\.\s*Py|\s*P[Hy])|I\.?\s*Py)e|(?:Pierwsz[aey]\s*Piotr|(?:1\.?\s*Pio|I\.?\s*Pio)tr)a|Pierwsz[aey]\s*Piotr|(?:(?:1\.?\s*l|I\.?\s*l)ist\s*Petru|1\.?\s*Petersbre)v|Avval(?:\s*[Pp]|p)(?:at(?:r(?:(?:issi|asa)|us)|aris)|eters)|Avval(?:\s*[Pp]|p)(?:atr(?:iss?|as)|eter)|(?:Avval|1)Pat(?:r(?:(?:issi|asa)|us)|aris)|Butros\s*Kowaad|P(?:rv(?:a\s*Petrova?|y\s*Petrov|ni\s*P(?:etr)?)|eter)|(?:Avval|1)Patr(?:iss?|as)|Yek(?:\s*p(?:at(?:r(?:(?:issi|asa)|us)|aris)|eters)|p(?:at(?:r(?:(?:issi|asa)|us)|aris)|eters))|(?:Kwanza\s*Petr|1(?:(?:\.\s*patrusk|\s*(?:patrusk|Pietr))|\.\s*Pietr)|I\.?\s*Pietr)o|(?:1\.?\s*Pieta|I\.?\s*Pieta)rin|Yek(?:\s*p(?:atr(?:iss?|as)|eter)|p(?:atr(?:iss?|as)|eter))|1\s*k\.\s*Petrov|(?:Avval|1)Peters|1\.?\s*Petro(?:va?)?|I(?:\.\s*(?:P(?:e(?:t(?:r(?:o(?:va?)?|u)?)?|dr)?|ie)?|But)|\s*(?:P(?:e(?:t(?:r(?:o(?:va?)?|u)?)?|dr)?|ie)?|But))|First\s*P(?:ete|et?|t)?|(?:Avval|1)Peter|Kwanza\s*Pet|1(?:(?:(?:\s*(?:(?:petracem|P(?:er|d))|Petr(?:uv|i))|\.\s*Pe(?:tr(?:uv|i)|r))|\s*Pedro)|\.\s*Pedro)|1\s*k\s*Petrov|1st\.\s*P(?:(?:ete|t)r|et?r)|1\s*Patr(?:issi|asa)|1(?:\.\s*P(?:e(?:t(?:e(?:rs?)?|r(?:us?)?)?)?)?|\s*P(?:et(?:e(?:rs?)?|r(?:us?)?)?|(?:i(?:et?)?|ed?|je?)?))|1st\.\s*P(?:ete|et?|t)?|1\s*Patr(?:iss?|as)|I(?:\.\s*Pe(?:tr(?:u[sv]|i)|dro|r)|\s*Pe(?:tr(?:u[sv]|i)|dro|r))|1st\s*P(?:(?:ete|t)r|et?r)|1st\s*P(?:ete|et?|t)?|AvvalPet|1e\.\s*Petr?|(?:1\.?\s*Pio|I\.?\s*Pio)tr|(?:I(?:\.\s*P(?:ete|t)|\s*P(?:ete|t))|1\.?\s*Pt)r|1\.\s*Pedr|I(?:\.\s*P(?:ete|t)|\s*P(?:ete|t))|1e\s*Petr?|avvalpt|Petr[io]\s*I|1\s*Pedr|1\.\s*Pie|1\.?\s*But|1\.?\s*Pt|1Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Rom"],
        testament: "n",
      ...
      },
      {
        osis: ["Neh"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:nahemyahko\s*pustak|K(?:s(?:ieg[ai]\s*Nehemiasz|\.?\s*Nehemiasz)|njiga\s*Nehemijin)a|N(?:e(?:h(?:e(?:m(?:i(?:a(?:n\s*kirj|sz)|j)|y)|em[iy])|imy)|emij)|ahimiya|ehemei|ihemi)a|Li(?:ber\s*Nehemiae|v\s*Neyemi\s*an)|N(?:e(?:h(?:emi(?:a(?:s’\s*Bog|[eh])|[eh])|amiah|em(?:ii|a[ai])h|im(?:(?:a[ai]|a)h|i(?:a?|i)h)|emah|m)|emias|yemi)|eh(?:emia[ai]|em(?:ii|a[ai])[ai]|im(?:a[ai][ai]|i(?:a[ai]|i[ai])))h|exemyaah|ahemyah)|Nehem(?:jas\s*|ia)bok|nahemya(?:hko)?|N(?:e(?:h(?:em(?:ia(?:n|s)?|jas?)|amia|imia)?|em(?:ia?)?|x)?|ahi)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["GkEsth"],
        testament: "a",
      ...
      },
      {
        osis: ["Hos"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ks(?:ieg[ai]\s*Ozeasza|\.?\s*Ozeasza)|Prophetia\s*Osee|(?:Hoos(?:ean\s*kirj|(?:heec|e7))|Liv\s*Oze\s*|O(?:zeasz|sij))a|H(?:o(?:s(?:e(?:as(?:’\s*Bog|\s*bok)|ias)|h(?:aeah|o))|zeas)|osheah|ush(?:ae|ea)h|s)|H(?:o(?:(?:os(?:ean|h)?|s(?:e(?:as?|ia)|hae)?)?|shea?)|ush(?:ae?|ea?))|hos(?:h['’]ai|ey)|hos(?:h(?:['’]a)?|e)|Ose(?:ia[hs]|a[hs]|e)|O(?:s(?:ei?a)?|z(?:e(?:as)?)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Obad"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Pro(?:roctwo\s*Abdyaszow|phetia\s*Abdia)e|(?:Ks(?:ieg[ai]\s*Abdiasz|\.?\s*Abdiasz)|O(?:ba(?:d(?:(?:jan\s*kir|i)j|ei)|j)|[ou]bad[iy]|vadi)|Abdiasz|obadiy)a|Liv\s*Abdyas\s*la|O(?:b(?:ad(?:ia(?:s['’]\s*Bog|h)|jas\s*bok|iyah|eyah|yah)|edias|d)|vdij)|Cobadyaah|Abd(?:diyyu|(?:ij|y)as)|Obadiyeh|Ob(?:a(?:d(?:j(?:a(?:n|s)?)?|ias?|iya|eya|ya)?)?|edia)?|Ob(?:adh|id)ah|Ab(?:d(?:i(?:as?)?)?)?|Cob(?:ad)?|Avdie|obd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hag"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Pro(?:roctwo\s*Aggieuszowe|phetia\s*Aggaei)|Ks(?:ieg[ai]\s*Aggeusza|\.?\s*Aggeusza)|(?:Haggain\s*kirj|Liv\s*Aje\s*|Aggeusz)a|H(?:ag(?:g(?:a(?:is\s*bok|js\s*Bog|y)|ia[hi]|e(?:us|o)|y)|a[ijy]|e[jo]|i)|gg)|H(?:ag(?:g(?:a(?:in?|j)?|i)?)?|g)|Ag(?:gaeus|(?:ge[eo]|e(?:us|[jo])|heu))|(?:Ha(?:(?:gga|j)|-?g)a|A-?ga)i|Ag(?:g(?:eus)?|eu)?|Xaggay|haggay|Xagg?|Ohij|Aje))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hab"],
        testament: "o",
      ...
      },
      {
        osis: ["Zech"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Prophetia\s*Zachariae|Ks(?:ieg[ai]\s*Zachariasza|\.?\s*Zachariasza)|(?:S(?:a(?:karjan\s*ki|cha)rj|echarei)|Z(?:a(?:k(?:kaariyaas|ariyy)|chariasz)|ekariy)|Liv\s*Zakari\s*|Xa-?cha-?ri-?|Za(?:cc|kh)ari|jakariy)a|Z(?:a(?:(?:(?:kari(?:a(?:s['’]\s*Bog|h)|ya)|chari(?:ah|[eh])|harij?a)|charah)|cher[ai]h)|(?:acheria|c)h|e(?:ch[ae]riah|ch[ae]r[ai]h|kariah))|Sa(?:kar(?:ja(?:boken|s\s*bok)|ias)|carias)|Xa(?:-?cha-?ri)?|Z(?:a(?:c(?:h(?:arias?)?|ch?|ar)?|k(?:ari(?:as?)?|k)?|h(?:arij)?)?|acheria|e(?:c(?:h[ae]ria|h?)|k(?:aria)?)|c)|Zac(?:harj|ari)as|Z(?:ach(?:ar(?:ii|a[ai])|er(?:a[ai]|ii))|ech[ae]r(?:a[ai]|ii))h|Sekaryaah|Zaccharie|S(?:a(?:k(?:ar(?:jan?|ia))?|ch)|e(?:ch|k))|Jakaryah))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Zeph"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Pro(?:roctwo\s*Sofoniaszow|phetia\s*Sophonia)e|Ks(?:ieg[ai]\s*Sofoniasza|\.?\s*Sofoniasza)|(?:S(?:efan(?:jan\s*kir|i)j|ofon(?:iasz|aas))|Ze(?:phan(?:ay|j)|fan(?:ay|[jy]))|Seffanei|Tefani)a|Sefanias['’]\s*Bog|Z(?:e(?:fania(?:s’\s*Bog|h)|phania[hs])|ephanaiah|a(?:ph|f)aniah|epanias|ofonias|ph)|Liv\s*Sofoni\s*an|S(?:e(?:fanjas\s*bok|p(?:anias|h))|o(?:foni(?:j[ae]|e)|phonie)|f)|Z(?:ephanaia|e(?:f(?:anias?)?|p(?:h(?:an(?:ia)?)?)?)|a(?:ph|f)ania|p)|Sophonias|Sz(?:ofo|efa)nias|Sefanyaah|S(?:e(?:f(?:an(?:ias?|jan?)|f)?|pania)|o(?:f(?:o(?:ni(?:as?)?)?)?|ph)|zof)|Sofonjas|Sapanyah|sapanyah|Tef|zof))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Luke"],
        testament: "n",
