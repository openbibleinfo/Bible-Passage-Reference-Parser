(function() {
  ...
  describe("Miscellaneous tests", function() {
    ...
    it("should handle ranges (la)", function() {
      ...
      return expect(p.parse("Phlm 2 AD 3").osis()).toEqual("Phlm.1.2-Phlm.1.3");
    });
    ...
    it("should handle 'and' (la)", function() {
      ...
      return expect(p.parse("Phlm 2 ET 6").osis()).toEqual("Phlm.1.2,Phlm.1.6");
    });
    it("should handle titles (la)", function() {
      expect(p.parse("Ps 3 titulus, 4:2, 5:titulus").osis()).toEqual("Ps.3.1,Ps.4.2,Ps.5.1");
      return expect(p.parse("PS 3 TITULUS, 4:2, 5:TITULUS").osis()).toEqual("Ps.3.1,Ps.4.2,Ps.5.1");
    });
    it("should handle 'ff' (la)", function() {
      ...
      expect(p.parse("Rev 3et seq, 4:2et seq").osis()).toEqual("Rev.3-Rev.22,Rev.4.2-Rev.4.11");
      return expect(p.parse("REV 3 ET SEQ, 4:2 ET SEQ").osis()).toEqual("Rev.3-Rev.22,Rev.4.2-Rev.4.11");
    });
    ...
    it("should handle book ranges (la)", function() {
      ...
      return expect(p.parse("I ad III  In").osis()).toEqual("1John.1-3John.1");
    });
