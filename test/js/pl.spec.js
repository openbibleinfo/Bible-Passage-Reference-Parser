(function() {
  ...
  describe("Miscellaneous tests", function() {
    ...
    it("should return the expected language", function() {
      return expect(p.languages).toEqual(["pl"]);
    });
    ...
    it("should handle 'ff' (pl)", function() {
      ...
      return expect(p.parse("REV 3 NN, 4:2 NN").osis()).toEqual("Rev.3-Rev.22,Rev.4.2-Rev.4.11");
    });
    it("should handle 'next' (pl)", function() {
      ...
      return expect(p.parse("Gen 1:32n, Gen 51n").osis()).toEqual("");
    });
