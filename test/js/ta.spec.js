(function() {
  ...
  describe("Miscellaneous tests", function() {
    ...
    it("should handle chapters (ta)", function() {
      ...
      return expect(p.parse("Matt 3:4 அதி 6").osis()).toEqual("Matt.3.4,Matt.6");
    });
    ...
    it("should handle 'and' (ta)", function() {
      ...
      return expect(p.parse("Phlm 2 மற்றும் 6").osis()).toEqual("Phlm.1.2,Phlm.1.6");
    });
    ...
    it("should handle book ranges (ta)", function() {
      ...
      return expect(p.parse("முதலாவது to முன்றாம்  யோவான்").osis()).toEqual("1John.1-3John.1");
    });
