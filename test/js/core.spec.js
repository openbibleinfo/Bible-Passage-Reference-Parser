...
(function() {
  ...
  describe("Parsing", function() {
    ...
    it("should handle translations with different book orders when setting the `versification_system` manually", function() {
      var kjv, nab, query, string, strings, _i, _len, _results;
      p.include_apocrypha(true);
      strings = [["Genesis 1 to Exodus 2", "Gen.1-Exod.2", "Gen.1-Exod.2"], ["1 Esdras 1 to Tobit 2", "1Esd.1,Tob.2", "1Esd.1-Tob.2"], ["2 Esdras 3\u2014Tobit 5", "2Esd.3,Tob.5", "2Esd.3-Tob.5"]];
      _results = [];
      for (_i = 0, _len = strings.length; _i < _len; _i++) {
        string = strings[_i];
        query = string[0], kjv = string[1], nab = string[2];
        p.set_options({
          versification_system: "default"
        });
        ...
        _results.push(expect(p.parse("" + query).osis()).toEqual(nab));
      }
      return _results;
    });
    it("should handle translations with different book orders in parsed strings", function() {
      ...
      for (_i = 0, _len = strings.length; _i < _len; _i++) {
        ...
        _results.push(expect(p.parse("" + query + " NAB").osis()).toEqual(nab));
      }
      return _results;
    });
  ...
  describe("Passage existence", function() {
    ...
    it("should handle reversed ranges", function() {
      var i, strategies, strategy, _i, _len, _ref, _results;
      strategies = {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push((function() {
          ...
          _results1 = [];
          for (i = _j = 0, _ref1 = strategies.strings.length; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
            _results1.push(expect(bcv.parse(strategies.strings[i]).osis()).toEqual(strategies[strategy][i]));
          }
          return _results1;
        })());
      }
    ...
    return xit("should handle template", function() {
      var i, strategies, strategy, _i, _len, _ref, _results;
      strategies = {
        strings: ["", "", "", ""],
        b: ["", "", ""],
