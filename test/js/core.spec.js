...
(function() {
  ...
  describe("Parsing", function() {
    ...
    it("should handle a `combine` `consecutive_combination_strategy` and a `separate` `sequence_combination_strategy`", function() {
      ...
      return expect(p.parse("2 Chronicles 31, 32").osis()).toEqual("2Chr.31-2Chr.32");
    });
    ...
    it("should handle parentheses with a `combine` `sequence_combination_strategy`", function() {
      ...
      return expect(p.parse("Exodus 12:1-4 (5-10) 11-14").osis_and_indices()).toEqual([
        {
    ...
    it("should handle Psalm 151 with the Apocrypha enabled and `ps151_strategy` = `b`", function() {
      ...
      return expect(p.parse("ps151.1").osis()).toEqual("Ps151.1.1");
    });
    it("should handle Psalm 151 with the Apocrypha enabled and `ps151_strategy` = `bc` (the default)", function() {
      p.set_options({
        osis_compaction_strategy: "bc",
        include_apocrypha: true
      });
      ...
      return expect(p.parse("ps151.1").osis()).toEqual("Ps.151.1");
    });
    it("should handle Psalm 151 with the Apocrypha disabled (the default)", function() {
      p.set_options({
        osis_compaction_strategy: "bc",
      ...
      expect(p.parse("ps151.1.3-ps151.1.4").osis()).toEqual("");
      return expect(p.parse("ps151.1").osis()).toEqual("");
    });
  ...
  describe("Real-world parsing", function() {
    ...
    return it("should handle sample tweets", function() {
      ...
      return expect(p.parse("PSALM 41 F-1-3 O LORD").osis_and_indices()).toEqual([
        {
