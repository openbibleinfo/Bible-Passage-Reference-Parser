...
import * as lang from "../../esm/lang/uk.js";
...
describe("Localized book 2Sam (uk)", () => {
	...
	it("should handle book: 2Sam (uk)", () => {
		...
		expect(p.parse("2-а книга Самуілова 1:1").osis()).toEqual("2Sam.1.1");
		expect(p.parse("2-а книга Самуїлова 1:1").osis()).toEqual("2Sam.1.1");
		expect(p.parse("2-ге. Книга Самуіла 1:1").osis()).toEqual("2Sam.1.1");
		...
		expect(p.parse("Друга Книга Самуіла 1:1").osis()).toEqual("2Sam.1.1");
		expect(p.parse("Друга Книга Самуїла 1:1").osis()).toEqual("2Sam.1.1");
		expect(p.parse("Друге Книга Самуіла 1:1").osis()).toEqual("2Sam.1.1");
		expect(p.parse("Друге Книга Самуїла 1:1").osis()).toEqual("2Sam.1.1");
		expect(p.parse("2-а. Книга Самуіла 1:1").osis()).toEqual("2Sam.1.1");
		expect(p.parse("2-а. Книга Самуїла 1:1").osis()).toEqual("2Sam.1.1");
		expect(p.parse("2-ге Книга Самуіла 1:1").osis()).toEqual("2Sam.1.1");
		expect(p.parse("2-ге Книга Самуїла 1:1").osis()).toEqual("2Sam.1.1");
		expect(p.parse("2-е. Книга Самуіла 1:1").osis()).toEqual("2Sam.1.1");
		...
		expect(p.parse("2-е Книга Самуіла 1:1").osis()).toEqual("2Sam.1.1");
		expect(p.parse("2-е Книга Самуїла 1:1").osis()).toEqual("2Sam.1.1");
		expect(p.parse("II. Книга Самуіла 1:1").osis()).toEqual("2Sam.1.1");
		expect(p.parse("II. Книга Самуїла 1:1").osis()).toEqual("2Sam.1.1");
		expect(p.parse("2. Книга Самуіла 1:1").osis()).toEqual("2Sam.1.1");
...
describe("Localized book 1Sam (uk)", () => {
	...
	it("should handle book: 1Sam (uk)", () => {
		...
		expect(p.parse("1-е книга Самуілова 1:1").osis()).toEqual("1Sam.1.1");
		expect(p.parse("1-е книга Самуїлова 1:1").osis()).toEqual("1Sam.1.1");
		expect(p.parse("1-ше. Книга Самуіла 1:1").osis()).toEqual("1Sam.1.1");
		expect(p.parse("1-ше. Книга Самуїла 1:1").osis()).toEqual("1Sam.1.1");
		expect(p.parse("Перша Книга Самуіла 1:1").osis()).toEqual("1Sam.1.1");
		expect(p.parse("Перша Книга Самуїла 1:1").osis()).toEqual("1Sam.1.1");
		expect(p.parse("Перше Книга Самуіла 1:1").osis()).toEqual("1Sam.1.1");
		expect(p.parse("Перше Книга Самуїла 1:1").osis()).toEqual("1Sam.1.1");
		expect(p.parse("1-а. Книга Самуіла 1:1").osis()).toEqual("1Sam.1.1");
		expect(p.parse("1-а. Книга Самуїла 1:1").osis()).toEqual("1Sam.1.1");
		expect(p.parse("1-е. Книга Самуіла 1:1").osis()).toEqual("1Sam.1.1");
		...
		expect(p.parse("I книга Самуілова 1:1").osis()).toEqual("1Sam.1.1");
		expect(p.parse("I книга Самуїлова 1:1").osis()).toEqual("1Sam.1.1");
		expect(p.parse("1. Книга Самуіла 1:1").osis()).toEqual("1Sam.1.1");
		expect(p.parse("1. Книга Самуїла 1:1").osis()).toEqual("1Sam.1.1");
		expect(p.parse("I. Книга Самуіла 1:1").osis()).toEqual("1Sam.1.1");
...
describe("Localized book Ezek (uk)", () => {
	...
	it("should handle book: Ezek (uk)", () => {
		expect(p.parse("Книга Пророка Езекиіла 1:1").osis()).toEqual("Ezek.1.1");
		...
		expect(p.parse("Езекиіла 1:1").osis()).toEqual("Ezek.1.1");
...
describe("Miscellaneous tests (uk)", () => {
	let p = {};
	beforeEach(() => {
		p = new bcv_parser(lang);
		p.set_options({
	...
	it("should return the expected language", () => {
		expect(p.regexps.languages).toEqual(["uk"]);
	});
