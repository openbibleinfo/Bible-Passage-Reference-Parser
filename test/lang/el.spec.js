...
import * as lang from "../../esm/lang/el.js";
...
describe("Localized book Matt (el)", () => {
	...
	it("should handle book: Matt (el)", () => {
		...
		expect(p.parse("Κατά Μαθθαιον 1:1").osis()).toEqual("Matt.1.1");
		expect(p.parse("Κατά Ματθαίον 1:1").osis()).toEqual("Matt.1.1");
		expect(p.parse("Κατά Ματθαιον 1:1").osis()).toEqual("Matt.1.1");
		expect(p.parse("Κατα Μαθθαίον 1:1").osis()).toEqual("Matt.1.1");
		expect(p.parse("Κατα Μαθθαιον 1:1").osis()).toEqual("Matt.1.1");
		...
		expect(p.parse("Μαθθαιος 1:1").osis()).toEqual("Matt.1.1");
		...
		expect(p.parse("ΚΑΤΑ ΜΑΤΘΑΊΟΝ 1:1").osis()).toEqual("Matt.1.1");
		expect(p.parse("ΚΑΤΑ ΜΑΤΘΑΙΟΝ 1:1").osis()).toEqual("Matt.1.1");
		expect(p.parse("ΜΑΘΘΑΊΟΣ 1:1").osis()).toEqual("Matt.1.1");
		expect(p.parse("ΜΑΘΘΑΙΟΣ 1:1").osis()).toEqual("Matt.1.1");
...
describe("Localized book Col (el)", () => {
	...
	it("should handle book: Col (el)", () => {
		...
		expect(p.parse("ΠΡΟΣ ΚΟΛΑΣΣΑΕΙΣ 1:1").osis()).toEqual("Col.1.1");
...
describe("Miscellaneous tests (el)", () => {
	let p = {};
	beforeEach(() => {
		p = new bcv_parser(lang);
		p.set_options({
	...
	it("should return the expected language", () => {
		expect(p.regexps.languages).toEqual(["el"]);
	});
