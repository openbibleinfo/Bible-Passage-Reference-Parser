...
var bcv_regexps = class {
  constructor() {
    ...
    // The `rubrik` has `[a-z]` instead of `\w` because it could be followed by a number.
    // [a-e] allows `1:1a`.
    this.escaped_passage = /(?:^|[^\x1e\x1f\p{L}\p{N}])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s.:,;\x1e\x1f&\(\)（）\[\]\\/"'\*=~\-–—]|rubrik(?![a-z])|kapitlen|kapitlet|kapitel|verser|till|kap|och|jfr|ff|f|v|[a-e](?!\w)|$)+)/giu;
    ...
    this.match_end_split = /\d\W*rubrik|\d\W*(?:ff|f)(?:[\s*]*\.)?|\d[\s*]*[a-e](?!\w)|\x1e(?:[\s*]*[)\]\uff09])?|[\d\x1f]/gi;
    this.control = /[\x1e\x1f]/g;
    // These are needed for ranges outside of this class.
    this.first = String.raw`(?:F[öo]rsta|1)\.?\s*`;
    this.second = String.raw`(?:Andra|2)\.?\s*`;
    this.third = String.raw`(?:Tredje|3e|3)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|(?:och|jfr)|till)`;
    this.range_only = String.raw`(?:[\u2013\u2014-]|till)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:F[oö]rsta\s*Mosebok(?:en)?|1\.\s*Mosebok(?:en)?|1\s*Mosebok(?:en)?|Genesis|1\s*Mos|Gen))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Andra\s*Mosebok(?:en)?|2\.\s*Mosebok(?:en)?|2\s*Mosebok(?:en)?|Exodus|2\s*Mos|Exod))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bel"],
        testament: "a",
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tredje\s*Mosebok(?:en)?|3e?\.\s*Mosebok(?:en)?|3e\s*Mosebok(?:en)?|3\s*Mosebok(?:en)?|Leviticus|3\s*Mos|Lev))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fj[aä]rde\s*Mosebok(?:en)?|4\.\s*Mosebok(?:en)?|4\s*Mosebok(?:en)?|Numeri|4\s*Mos|Num))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Sir"],
        testament: "a",
      ...
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Femte\s*Mosebok(?:en)?|Deuteronomium|5\.\s*Mosebok(?:en)?|5\s*Mosebok(?:en)?|5\s*Mos|Deut))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:F[oö]rsta|3e?\.|1\.)\s*Esra|Tredje\s*Esra|(?:3e?\s*|1\s*)Esra|1Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fj[aä]rde\s*Esra|(?:Andra|[24]\.)\s*Esra|[24]\s*Esra|2Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Andra\s*Samuelsboken|2\.\s*Samuelsboken|2\s*Samuelsboken|2\s*?Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:F[oö]rsta\s*Samuelsboken|1\.\s*Samuelsboken|1\s*Samuelsboken|1\s*?Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Andra\s*K(?:on)?ungaboken|2(?:\.\s*K(?:on)?ungaboken|(?:\s*Konungaboken|(?:\s*Kungaboken|(?:\s*K(?:ung|on)|Kgs))))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:F[oö]rsta\s*K(?:on)?ungaboken|1(?:\.\s*K(?:on)?ungaboken|(?:\s*Konungaboken|(?:\s*Kungaboken|(?:\s*K(?:ung|on)|Kgs))))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Andra\s*Kr[oö]nikeboken|2\.\s*Kr[oö]nikeboken|2\s*Kr[oö]nikeboken|2(?:\s*Kr[oö]n|Chr)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:F[oö]rsta\s*Kr[oö]nikeboken|1\.\s*Kr[oö]nikeboken|1\s*Kr[oö]nikeboken|1(?:\s*Kr[oö]n|Chr)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["Prov"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ords(?:pr[aå]ksboken)?|Prov))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Eccl"],
        testament: "o",
      ...
      },
      {
        osis: ["Song"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:H(?:(?:oga(?:\s*visan|(?:\s*V|v))|öga(?:\s*[Vv]isan|v))|(?:oga(?:\s*v)?|öga(?:\s*V)?))|Song))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jer"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:F[oö]rsta\s*Johannesbrevet|Johannes\s*f[oö]rsta\s*brev|1\.\s*Johannesbrevet|1\s*Johannesbrevet|1\s*Joh|1John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Andra\s*Johannesbrevet|Johannes\s*andra\s*brev|2\.\s*Johannesbrevet|2\s*Johannesbrevet|2\s*Joh|2John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tredje\s*Johannesbrevet|Johannes\s*tredje\s*brev|3e?\.\s*Johannesbrevet|3e\s*Johannesbrevet|3\s*Johannesbrevet|3\s*Joh|3John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Andra\s*Korint(?:h?i|h?)erbrevet|2\.\s*Korint(?:h?i|h?)erbrevet|2\s*Korint(?:h?i|h?)erbrevet|2(?:\s*K|C)or))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:F[oö]rsta\s*Korint(?:h?i|h?)erbrevet|1\.\s*Korint(?:h?i|h?)erbrevet|1\s*Korint(?:h?i|h?)erbrevet|1(?:\s*K|C)or))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Andra\s*Th?essalonikerbrevet|2\.\s*Th?essalonikerbrevet|2\s*Th?essalonikerbrevet|2(?:\s*Th?ess|Thess)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:F[oö]rsta\s*Th?essalonikerbrevet|1\.\s*Th?essalonikerbrevet|1\s*Th?essalonikerbrevet|1(?:\s*Th?ess|Thess)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Andra\s*Timot(?:heo|eu)sbrevet|2\.\s*Timot(?:heo|eu)sbrevet|2\s*Timot(?:heo|eu)sbrevet|2\s*?Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:F[oö]rsta\s*Timot(?:heo|eu)sbrevet|1\.\s*Timot(?:heo|eu)sbrevet|1\s*Timot(?:heo|eu)sbrevet|1\s*?Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Andra\s*Petrusbrevet|Petrus\s*andra\s*brev|2\.\s*Petrusbrevet|2\s*Petrusbrevet|2\s*Petr?|2Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:F[oö]rsta\s*Petrusbrevet|Petrus\s*f[oö]rsta\s*brev|1\.\s*Petrusbrevet|1\s*Petrusbrevet|1\s*Petr?|1Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Andra\s*Mackab[eé]erboken|2(?:\.\s*Mackab[eé]erboken|(?:\s*Mackab[eé]erboken|(?:\s*Mack|Macc)))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tredje\s*Mackab[eé]erboken|3e?\.\s*Mackab[eé]erboken|3(?:e\s*Mackab[eé]erboken|(?:\s*Mackab[eé]erboken|(?:\s*Mack|Macc)))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fj[aä]rde\s*Mackab[eé]erboken|4(?:\.\s*Mackab[eé]erboken|(?:\s*Mackab[eé]erboken|(?:\s*Mack|Macc)))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:F[oö]rsta\s*Mackab[eé]erboken|1(?:\.\s*Mackab[eé]erboken|(?:\s*Mackab[eé]erboken|(?:\s*Mack|Macc)))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      }
    ];
  }
};
...
function peg$parse(input, options) {
  ...
  var peg$e21 = peg$literalExpectation("itlen", false);
  var peg$e22 = peg$literalExpectation("itlet", false);
  var peg$e23 = peg$literalExpectation("itel", false);
  var peg$e24 = peg$literalExpectation("v", false);
  var peg$e25 = peg$literalExpectation("erser", false);
  var peg$e26 = peg$literalExpectation(":", false);
  var peg$e27 = peg$classExpectation(['"', "'"], false, false);
  var peg$e28 = peg$classExpectation([",", ";", "/", ":", "&", "-", "–", "—", "~"], false, false);
  var peg$e29 = peg$literalExpectation("och", false);
  var peg$e30 = peg$literalExpectation("jfr", false);
  var peg$e31 = peg$classExpectation(["-", "–", "—"], false, false);
  var peg$e32 = peg$literalExpectation("till", false);
  var peg$e33 = peg$literalExpectation("rubrik", false);
