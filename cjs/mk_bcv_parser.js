  ...
  constructor() {
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Трет[ао]\s*(?:книга\s*)?Мојсеева|(?:III|3)\.\s*(?:книга\s*)?Мојсеева|(?:III|3)\s*(?:книга\s*)?Мојсеева|Левитска\s*книга|Левит(?:ска)?|Lev))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Четврта\s*(?:книга\s*)?Мојсеева|(?:IV|4)\.\s*(?:книга\s*)?Мојсеева|(?:IV|4)\s*(?:книга\s*)?Мојсеева|Броеви|Num))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Sir"],
        testament: "a",
      ...
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:П(?:етта\s*(?:книга\s*)?Мојсеева|овторени\s*закони)|[5V]\.\s*(?:книга\s*)?Мојсеева|[5V]\s*(?:книга\s*)?Мојсеева|Второзаконие|Deut))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Втор[ао]\s*(?:книга\s*Самоилова|Сам(?:уил(?:ова)?|оилова))|(?:II|2)\.\s*(?:книга\s*Самоилова|Сам(?:уил(?:ова)?|оилова))|(?:II|2)\s*(?:книга\s*Самоилова|Сам(?:уил(?:ова)?|оилова))|2Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Прв[ао]\s*(?:книга\s*Самоилова|Сам(?:уил(?:ова)?|оилова))|[1I]\.\s*(?:книга\s*Самоилова|Сам(?:уил(?:ова)?|оилова))|[1I]\s*(?:книга\s*Самоилова|Сам(?:уил(?:ова)?|оилова))|1Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Втор[ао]\s*(?:книга\s*(?:за\s*царевите|цареви(?:те)?)|Цареви(?:те)?)|(?:II|2)\.\s*(?:книга\s*(?:за\s*царевите|цареви(?:те)?)|Цареви(?:те)?)|(?:II|2)\s*(?:книга\s*(?:за\s*царевите|цареви(?:те)?)|Цареви(?:те)?)|2Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Прв[ао]\s*(?:книга\s*(?:за\s*царевите|цареви(?:те)?)|Цареви(?:те)?)|[1I]\.\s*(?:книга\s*(?:за\s*царевите|цареви(?:те)?)|Цареви(?:те)?)|[1I]\s*(?:книга\s*(?:за\s*царевите|цареви(?:те)?)|Цареви(?:те)?)|1Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Втор[ао]\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Солун|Солун(?:(?:јан|ц)ите|јани))|(?:II|2)\.\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Солун|Солун(?:(?:јан|ц)ите|јани))|(?:II|2)\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Солун|Солун(?:(?:јан|ц)ите|јани))|2Thess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Прв[ао]\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Солун|Солун(?:(?:јан|ц)ите|јани))|[1I]\.\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Солун|Солун(?:(?:јан|ц)ите|јани))|[1I]\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Солун|Солун(?:(?:јан|ц)ите|јани))|1Thess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Втор[ао]\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*Тимотеј|Тимоте(?:ева|ј))|(?:II|2)\.\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*Тимотеј|Тимоте(?:ева|ј))|(?:II|2)\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*Тимотеј|Тимоте(?:ева|ј))|2Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Прв[ао]\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*Тимотеј|Тимоте(?:ева|ј))|[1I]\.\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*Тимотеј|Тимоте(?:ева|ј))|[1I]\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*Тимотеј|Тимоте(?:ева|ј))|1Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
