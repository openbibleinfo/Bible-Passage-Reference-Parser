...
var bcv_regexps = class {
  constructor() {
    ...
    this.match_end_split = /\d\W*title|\d\W*ff(?:[\s*]*\.)?|\d[\s*]*[аб](?!\w)|\x1e(?:[\s*]*[)\]\uff09])?|[\d\x1f]/gi;
    this.control = /[\x1e\x1f]/g;
    // These are needed for ranges outside of this class.
    this.first = String.raw`(?:Прва|Прво|1|I)\.?\s*`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Прв[ао]\s*книга\s*Мојсеева|[1I]\.\s*книга\s*Мојсеева|[1I]\s*книга\s*Мојсеева|Настанување|Битие|Gen))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Втор[ао]\s*книга\s*Мојсеева|(?:II|2)\.\s*книга\s*Мојсеева|(?:II|2)\s*книга\s*Мојсеева|Излез|Exod))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bel"],
        testament: "a",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Втор[ао]\s*(?:книга\s*Самоилова|Самуил)|(?:II|2)\.\s*(?:книга\s*Самоилова|Самуил)|(?:II|2)\s*(?:книга\s*Самоилова|Самуил)|2Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Прв[ао]\s*(?:книга\s*Самоилова|Самуил)|[1I]\.\s*(?:книга\s*Самоилова|Самуил)|[1I]\s*(?:книга\s*Самоилова|Самуил)|1Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Втор[ао]\s*(?:книга\s*за\s*царевите|Цареви)|(?:II|2)\.\s*(?:книга\s*за\s*царевите|Цареви)|(?:II|2)\s*(?:книга\s*за\s*царевите|Цареви)|2Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Прв[ао]\s*(?:книга\s*за\s*царевите|Цареви)|[1I]\.\s*(?:книга\s*за\s*царевите|Цареви)|[1I]\s*(?:книга\s*за\s*царевите|Цареви)|1Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Втор[ао]\s*(?:книга\s*л|Л)етописи|(?:II|2)\.\s*(?:книга\s*л|Л)етописи|(?:II|2)\s*(?:книга\s*л|Л)етописи|2Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Прв[ао]\s*(?:книга\s*л|Л)етописи|[1I]\.\s*(?:книга\s*л|Л)етописи|[1I]\s*(?:книга\s*л|Л)етописи|1Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Прв[ао]\s*(?:п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Јован|Јован(?:ово)?)|[1I]\.\s*(?:п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Јован|Јован(?:ово)?)|[1I]\s*(?:п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Јован|Јован(?:ово)?)|1John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Втор[ао]\s*(?:п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Јован|Јован(?:ово)?)|(?:II|2)\.\s*(?:п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Јован|Јован(?:ово)?)|(?:II|2)\s*(?:п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Јован|Јован(?:ово)?)|2John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Трет[ао]\s*(?:п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Јован|Јован(?:ово)?)|(?:III|3)\.\s*(?:п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Јован|Јован(?:ово)?)|(?:III|3)\s*(?:п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Јован|Јован(?:ово)?)|3John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Евангелие(?:то)?\s*според\s*Јован|Јован|John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Втор[ао]\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Солун|Солун(?:ците|јани))|(?:II|2)\.\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Солун|Солун(?:ците|јани))|(?:II|2)\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Солун|Солун(?:ците|јани))|2Thess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Прв[ао]\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Солун|Солун(?:ците|јани))|[1I]\.\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Солун|Солун(?:ците|јани))|[1I]\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Солун|Солун(?:ците|јани))|1Thess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Втор[ао]\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*)?Тимотеј|(?:II|2)\.\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*)?Тимотеј|(?:II|2)\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*)?Тимотеј|2Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Прв[ао]\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*)?Тимотеј|[1I]\.\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*)?Тимотеј|[1I]\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*)?Тимотеј|1Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Втор[ао]\s*(?:п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Петар|Пет(?:рово|ар))|(?:II|2)\.\s*(?:п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Петар|Пет(?:рово|ар))|(?:II|2)\s*(?:п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Петар|Пет(?:рово|ар))|2Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Прв[ао]\s*(?:п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Петар|Пет(?:рово|ар))|[1I]\.\s*(?:п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Петар|Пет(?:рово|ар))|[1I]\s*(?:п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Петар|Пет(?:рово|ар))|1Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
...
function peg$parse(input, options) {
  ...
  var peg$e18 = peg$classExpectation(["а", "б"], false, true);
  var peg$e19 = peg$literalExpectation("глав", true);
  var peg$e20 = peg$classExpectation(["а", "и"], false, true);
  var peg$e21 = peg$literalExpectation("verse", false);
  var peg$e22 = peg$literalExpectation(":", false);
  var peg$e23 = peg$classExpectation(['"', "'"], false, false);
  var peg$e24 = peg$classExpectation([",", ";", "/", ":", "&", "-", "–", "—", "~"], false, false);
  var peg$e25 = peg$literalExpectation("и", true);
