...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = String.raw`(?:Prva|1|I)\.?\s*`;
    this.second = String.raw`(?:Druga|2|II)\.?\s*`;
    this.third = String.raw`(?:Treæa|Tre[ćc]a|3|III)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|i|-)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druga\s*(?:Samuelova(?:\s*knjiga)?|knjiga\s*o\s*Samuelu)|(?:II\.?\s*Samuelov|2\.?\s*Samuelov)a|2\s*Sam|2Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prva\s*(?:Samuelova(?:\s*knjiga)?|knjiga\s*o\s*Samuelu)|(?:1\.?\s*Samuelov|I\.?\s*Samuelov)a|1\s*Sam|1Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druga\s*(?:knjiga\s*o\s*)?Kraljevima|(?:II|2)\.\s*Kraljevima|II\s*Kraljevima|2(?:\s*Kraljevima|(?:\s*Kr|Kgs))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prva\s*(?:knjiga\s*o\s*)?Kraljevima|[1I]\.\s*Kraljevima|1(?:\s*Kraljevima|(?:\s*Kr|Kgs))|I\s*Kraljevima))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druga\s*(?:knjiga\s*)?Ljetopisa|(?:II|2)\.\s*Ljetopisa|II\s*Ljetopisa|2(?:\s*Ljetopisa|(?:\s*Ljet|Chr))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prva\s*(?:knjiga\s*)?Ljetopisa|[1I]\.\s*Ljetopisa|1(?:\s*Ljetopisa|(?:\s*Ljet|Chr))|I\s*Ljetopisa))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prva\s*Ivanova(?:\s*[Pp]oslanica)?|(?:1\.?\s*Ivanova\s*P|I\.?\s*Ivanova\s*P)oslanica|1(?:\.\s*Ivanova|\s*Iv(?:anova)?)|I\.?\s*Ivanova|1John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druga\s*Ivanova(?:\s*[Pp]oslanica)?|(?:II\.?\s*Ivanova\s*P|2\.?\s*Ivanova\s*P)oslanica|II\.?\s*Ivanova|2(?:\.\s*Ivanova|\s*Iv(?:anova)?)|2John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tre[cæć]a\s*Ivanova(?:\s*[Pp]oslanica)?|(?:III\.?\s*Ivanova\s*P|3\.?\s*Ivanova\s*P)oslanica|III\.?\s*Ivanova|3(?:\.\s*Ivanova|\s*Iv(?:anova)?)|3John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Pavlova\s*druga\s*poslanica\s*Korin[cć]anima|(?:Druga\s*Korin[cć]anima\s*Poslanic|(?:II\.?\s*K|2\.\s*K)orin[cć]anima\s*Poslanic|2\s*Korin[cć]anima\s*Poslanic)a|Druga\s*poslanica\s*Korin[cæć]anima|Druga\s*Korin[cć]anima|(?:II\.?\s*K|2\.\s*K)orin[cć]anima|2\s*Kor(?:in[cć]anima)?|2Cor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:P(?:avlova\s*prva\s*poslanica\s*Korin[cć]anima|rva\s*Korin[cć]anima\s*Poslanica|rva\s*poslanica\s*Korin[cæć]anima|rva\s*Korin[cć]anima)|(?:(?:1\.\s*K|I\.?\s*K)orin[cć]anima\s*Poslanic|1\s*Korin[cć]anima\s*Poslanic)a|(?:1\.\s*K|I\.?\s*K)orin[cć]anima|1\s*Kor(?:in[cć]anima)?|1Cor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Pavlova\s*druga\s*poslanica\s*Solunjanima|(?:Druga\s*S|(?:(?:II\.?\s*S|2\.\s*S)|2\s*S))olunjanima\s*Poslanica|Druga\s*poslanica\s*Solunjanima|Druga\s*Solunjanima|(?:II\.?\s*S|2\.\s*S)olunjanima|2\s*Sol(?:unjanima)?|2Thess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:P(?:avlova\s*prva\s*poslanica\s*Solunjanima|rva\s*(?:Solunjanima(?:\s*Poslanica)?|poslanica\s*Solunjanima))|(?:(?:1\.\s*S|I\.?\s*S)|1\s*S)olunjanima\s*Poslanica|(?:1\.\s*S|I\.?\s*S)olunjanima|1\s*Sol(?:unjanima)?|1Thess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Pavlova\s*druga\s*poslanica\s*Timoteju|Druga\s*Timoteju\s*Poslanica|Druga\s*poslanica\s*Timoteju|(?:II\.?\s*T|2\.\s*T)imoteju\s*Poslanica|2(?:\s*Timoteju\s*Poslanica|Tim)|Druga\s*Timoteju|(?:II\.?\s*T|2\.\s*T)imoteju|2\s*Tim(?:oteju)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:P(?:avlova\s*prva\s*poslanica\s*Timoteju|rva\s*(?:Timoteju(?:\s*Poslanica)?|poslanica\s*Timoteju))|(?:1\.\s*T|I\.?\s*T)imoteju\s*Poslanica|1(?:\s*Timoteju\s*Poslanica|Tim)|(?:1\.\s*T|I\.?\s*T)imoteju|1\s*Tim(?:oteju)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druga\s*Petrova(?:\s*[Pp]oslanica)?|(?:II\.?\s*Petrova\s*P|2\.?\s*Petrova\s*P)oslanica|II\.?\s*Petrova|2\.?\s*Petrova|2(?:\s*P|Pe)t))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prva\s*Petrova(?:\s*[Pp]oslanica)?|(?:1\.?\s*Petrova\s*P|I\.?\s*Petrova\s*P)oslanica|1\.?\s*Petrova|I\.?\s*Petrova|1(?:\s*P|Pe)t))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
...
function peg$parse(input, options) {
  ...
  var peg$c13 = "/2";
  var peg$c14 = ".1";
  var peg$c15 = "poglavlja";
  var peg$c16 = "poglavlje";
  var peg$c17 = "glava";
  var peg$c18 = "verse";
  var peg$c19 = ":";
  var peg$c20 = "i";
  ...
  var peg$e19 = peg$literalExpectation("poglavlja", false);
  var peg$e20 = peg$literalExpectation("poglavlje", false);
  var peg$e21 = peg$literalExpectation("glava", false);
  var peg$e22 = peg$literalExpectation("verse", false);
