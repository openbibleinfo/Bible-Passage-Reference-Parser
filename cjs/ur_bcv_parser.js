...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = /(?:اوّل|۱|1)\.?\s*/;
    this.second = /(?:دوم|۲|2)\.?\s*/;
    this.third = /(?:تیسرا|۳|3)\.?\s*/;
    this.range_and = /(?:[&\u2013\u2014-]|(?:،|؛|۔)|تا)/;
    this.range_only = /(?:[\u2013\u2014-]|تا)/;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:دوم(?:[\s*-]سموئ|۔سموا)یل|2(?:\s*samūʾīl|Sam)|[2۲]\.(?:[\s*-]سموئ|۔سموا)یل|(?:2\s*|(?:2-?|۲[\s*-]))سموئیل|[2۲]۔سموایل))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:اوّل(?:(?:\s*سموئ[يی]|-?سموئی)|۔سموای)ل|1(?:\s*samūʾīl|Sam)|[1۱]\.(?:(?:\s*سموئ[يی]|-?سموئی)|۔سموای)ل|(?:1\s*سموئ[يی]|۱\s*سموئ[يی])ل|[1۱]-?سموئیل|[1۱]۔سموایل))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:دوم(?:-?سلاطِ|[\s*۔]سلاط)ین|[2۲]\.(?:-?سلاطِ|[\s*۔]سلاط)ین|2(?:\s*salāṭīn|Kgs)|[2۲]-?سلاطِین|(?:2\s*|(?:2۔|۲[\s*۔]))سلاطین))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:اوّل(?:-?سلاطِ|[\s*۔]سلاط)ین|[1۱]\.(?:-?سلاطِ|[\s*۔]سلاط)ین|1(?:\s*salāṭīn|Kgs)|[1۱]-?سلاطِین|(?:1\s*|(?:1۔|۱[\s*۔]))سلاطین))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:دوم(?:-?\s*توارِ|(?:\s*تو\s*|۔تو)ار)یخ|[2۲]\.(?:-?\s*توارِ|(?:\s*تو\s*|۔تو)ار)یخ|[2۲]-?\s*توارِیخ|2(?:\s*tavārīḫ|Chr)|(?:[2۲]\s*تو\s*|[2۲]۔تو)اریخ))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:اوّل(?:-?توارِ|[\s*۔]توار)یخ|[1۱]\.(?:-?توارِ|[\s*۔]توار)یخ|1(?:\s*tavārīḫ|Chr)|[1۱]-?توارِیخ|(?:1\s*|(?:1۔|۱[\s*۔]))تواریخ))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:yūḥannā\s*kā\s*dūsrā\s*ʿām\s*ḫaṭ|ی(?:ُوحنّا\s*کا\s*دوسرا\s*عام|وحن(?:ا\s*کا\s*دوسرا\s*عام|ّا\s*کا\s*دوسرا))\s*خط|دوم(?:(?:\s*یُوحنّ|(?:\s*یوحنّ|۔یوحن))|-?یُوحنّ)ا|[2۲]\.(?:(?:\s*یُوحنّ|(?:\s*یوحنّ|۔یوحن))|-?یُوحنّ)ا|[2۲]\s*یُوحنّا|[2۲]-?یُوحنّا|[2۲]\s*یوحنّا|[2۲]۔یوحنا|2John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:yūḥannā\s*kā\s*tīsrā\s*ʿām\s*ḫaṭ|ی(?:ُوحنّا\s*کا\s*تیسرا\s*عام\s*|(?:وحنا\s*کا\s*تیسرا\s*عام\s*|(?:وحنّا\s*کا\s*(?:تیسرا|[3۳]\.)\s*|وحنّا\s*کا\s*[3۳]\s*)))خط|تیسرا(?:(?:\s*یُوحنّ|(?:\s*یوحنّ|۔یوحن))|-?یُوحنّ)ا|[3۳]\.(?:(?:\s*یُوحنّ|(?:\s*یوحنّ|۔یوحن))|-?یُوحنّ)ا|[3۳]\s*یُوحنّا|[3۳]-?یُوحنّا|[3۳]\s*یوحنّا|[3۳]۔یوحنا|3John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:yūḥannā\s*kā\s*pahlā\s*ʿām\s*ḫaṭ|ی(?:ُوحنّ|وحنّ?)ا\s*کا\s*پہلا\s*عام\s*خط|اوّل(?:(?:\s*یُوحنّ|(?:\s*یوحنّ|۔یوحن))|-?یُوحنّ)ا|[1۱]\.(?:(?:\s*یُوحنّ|(?:\s*یوحنّ|۔یوحن))|-?یُوحنّ)ا|[1۱]\s*یُوحنّا|[1۱]-?یُوحنّا|[1۱]\s*یوحنّا|[1۱]۔یوحنا|1John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ی(?:ُوحنّ|وحن)ا\s*کی\s*انجیل|yūḥannā\s*kī\s*injīl|ی(?:ُوحنّ|وحن)ا|John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ک(?:رنتھ(?:ِیُوں\s*کے\s*نام\s*پولس\s*رسول|یوں\s*کے\s*نام)|ُرِنتھِیوں\s*کے\s*نام)\s*کا\s*دوسرا\s*خط|kurintʰiyōṅ\s*ke\s*nām\s*kā\s*dūsrā\s*ḫaṭ|دوم(?:-?کُرِنتھِی|(?:(?:\s*کرنتھ(?:ِیُ|ی)|۔کرنتھی)|\s*کُرنتھِی))وں|[2۲]\.(?:-?کُرِنتھِی|(?:(?:\s*کرنتھ(?:ِیُ|ی)|۔کرنتھی)|\s*کُرنتھِی))وں|[2۲]-?کُرِنتھِیوں|[2۲]\s*کرنتھ(?:ِیُ|ی)وں|[2۲]\s*کُرنتھِیوں|[2۲]۔کرنتھیوں|2Cor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ک(?:رنتھ(?:ِیُوں\s*کے\s*نام\s*پولس\s*رسول|یوں\s*کے\s*نام)|ُرِنتھِیوں\s*کے\s*نام)\s*کا\s*پہلا\s*خط|kurintʰiyōṅ\s*ke\s*nām\s*kā\s*pahlā\s*ḫaṭ|اوّل(?:-?کُرِنتھِی|(?:(?:\s*کرنتھِیُ|۔کرنتھی)|\s*کُرنتھِی))وں|[1۱]\.(?:-?کُرِنتھِی|(?:(?:\s*کرنتھِیُ|۔کرنتھی)|\s*کُرنتھِی))وں|[1۱]-?کُرِنتھِیوں|[1۱]\s*کرنتھِیُوں|[1۱]\s*کُرنتھِیوں|[1۱]۔کرنتھیوں|1Cor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:تھ(?:سلنیک(?:وں\s*کے\s*نام\s*پو\s*لس\s*رسول\s*کا|یوں\s*کے\s*نام\s*کا\s*)|ِسّلُنیکیوں\s*کے\s*نام\s*کا\s*)دوسرا\s*خط|tʰissalunīkiyōṅ\s*ke\s*nām\s*kā\s*dūsrā\s*ḫaṭ|دوم(?:-?تھِسّلُنیکی|(?:\s*تھِسلُنیکی|(?:(?:\s*تھسّ|۔تھس)لنیکی|\s*تھسلنیک)))وں|[2۲]\.(?:-?تھِسّلُنیکی|(?:\s*تھِسلُنیکی|(?:(?:\s*تھسّ|۔تھس)لنیکی|\s*تھسلنیک)))وں|[2۲]-?تھِسّلُنیکیوں|[2۲]\s*تھِسلُنیکیوں|(?:[2۲]\s*تھسّ|[2۲]۔تھس)لنیکیوں|[2۲]\s*تھسلنیکوں|2Thess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:تھ(?:س(?:ّلنیکیوں\s*کے\s*نام\s*پولس\s*رسول|لنیکیوں\s*کے\s*نام)|ِسّلُنیکیوں\s*کے\s*نام)\s*کا\s*پہلا\s*خط|tʰissalunīkiyōṅ\s*ke\s*nām\s*kā\s*pahlā\s*ḫaṭ|اوّل(?:-?تھِسّلُ|(?:\s*تھِسلُ|(?:\s*تھسّ|۔تھس)ل))نیکیوں|[1۱]\.(?:-?تھِسّلُ|(?:\s*تھِسلُ|(?:\s*تھسّ|۔تھس)ل))نیکیوں|[1۱]-?تھِسّلُنیکیوں|[1۱]\s*تھِسلُنیکیوں|(?:[1۱]\s*تھسّ|[1۱]۔تھس)لنیکیوں|1Thess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ت(?:ی(?:ِمُتھِیُس\s*کے\s*نام\s*پولس\s*رسول|متھیس\s*کے\s*نام)|ِیمُتھِیُس\s*کے\s*نام)\s*کا\s*دوسرا\s*خط|tīmutʰiyus\s*ke\s*nām\s*kā\s*dūsrā\s*ḫaṭ|دوم(?:(?:(?:\s*تیِمُتھِیُ|(?:\s*تیمِتھُ|۔تیمتھ)ی)|\s*تِیمُتھِیُ)|-?تِیمُتھِیُ)س|[2۲]\.(?:(?:(?:\s*تیِمُتھِیُ|(?:\s*تیمِتھُ|۔تیمتھ)ی)|\s*تِیمُتھِیُ)|-?تِیمُتھِیُ)س|[2۲]\s*تیِمُتھِیُس|[2۲]\s*تِیمُتھِیُس|[2۲]-?تِیمُتھِیُس|(?:[2۲]\s*تیمِتھُ|[2۲]۔تیمتھ)یس|2Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ت(?:ِیمُتھِیُس\s*کے\s*نام\s*(?:پولُس\s*رسول\s*)?کا\s*پہلا\s*خط|یمتھیس\s*کے\s*نام\s*کا\s*پہلا\s*خط)|tīmutʰiyus\s*ke\s*nām\s*kā\s*pahlā\s*ḫaṭ|اوّل(?:(?:\s*تِیمُتھِیُ|(?:\s*تیمِتھُ|۔تیمتھ)ی)|-?تِیمُتھِیُ)س|[1۱]\.(?:(?:\s*تِیمُتھِیُ|(?:\s*تیمِتھُ|۔تیمتھ)ی)|-?تِیمُتھِیُ)س|[1۱]\s*تِیمُتھِیُس|[1۱]-?تِیمُتھِیُس|(?:[1۱]\s*تیمِتھُ|[1۱]۔تیمتھ)یس|1Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:paṭras\s*kā\s*dūsrā\s*ʿām\s*ḫaṭ|پطرس\s*کا\s*دوسرا\s*عام\s*خط|دوم(?:\s*پطر\s*?|[-۔]پطر)س|[2۲]\.(?:\s*پطر\s*?|[-۔]پطر)س|[2۲]\s*پطر\s*س|[2۲]\s*پطرس|(?:2[-۔]|۲[-۔])پطرس|2Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:paṭras\s*kā\s*pahlā\s*ʿām\s*ḫaṭ|پطر(?:\s*س\s*کاپہلا\s*عا\s*|س\s*کا\s*پہلا\s*عا)م\s*خط|اوّل(?:\s*پطر\s*?|[-۔]پطر)س|[1۱]\.(?:\s*پطر\s*?|[-۔]پطر)س|[1۱]\s*پطر\s*س|[1۱]\s*پطرس|(?:1[-۔]|۱[-۔])پطرس|1Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
...
function peg$parse(input, options) {
  ...
  var peg$e21 = peg$literalExpectation("آی", true);
  var peg$e22 = peg$literalExpectation("ت", true);
  var peg$e23 = peg$literalExpectation("ات", true);
  var peg$e24 = peg$literalExpectation(":", false);
  var peg$e25 = peg$classExpectation(['"', "'"], false, false);
  var peg$e26 = peg$classExpectation(["&", [",", "-"], "/", [":", ";"], "~", ["–", "—"]], false, false);
  var peg$e27 = peg$classExpectation(["،", "؛", "۔"], false, true);
  var peg$e28 = peg$classExpectation(["-", "–", "—"], false, false);
  var peg$e29 = peg$literalExpectation("تا", true);
