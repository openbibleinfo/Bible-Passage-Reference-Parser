  ...
  constructor() {
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Samuu['’]eel\s*Labaad|II(?:\.\s*Samuu['’]eel|\s*Samuu['’]eel)|2(?:\.\s*Samuu['’]eel|(?:\s*Samuu['’]eel|Sam))|II\.?\s*Sam|2\.?\s*Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Samuu['’]eel\s*Kowaad|1(?:\.\s*Samuu['’]eel|(?:\s*Samuu['’]eel|Sam))|I(?:\.\s*Samuu['’]eel|\s*Samuu['’]eel)|1\.?\s*Sam|I\.?\s*Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Boqorradii\s*Labaad|II\.?\s*Boqorradii|2(?:\.\s*Boqorradii|(?:\s*Boqorradii|Kgs))|II\.?\s*Boq|2\.?\s*Boq))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Boqorradii\s*Kowaad|1(?:\.\s*Boqorradii|(?:\s*Boqorradii|Kgs))|I\.?\s*Boqorradii|1\.?\s*Boq|I\.?\s*Boq))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Taariikhdii\s*Labaad|II\.?\s*Taariikhdii|2(?:\.\s*Taariikhdii|(?:\s*Taariikhdii|Chr))|II\.?\s*Taar|2\.?\s*Taar))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Taariikhdii\s*Kowaad|1(?:\.\s*Taariikhdii|(?:\s*Taariikhdii|Chr))|I\.?\s*Taariikhdii|1\.?\s*Taar|I\.?\s*Taar))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Yooxanaa\s*Kowaad|1(?:\.\s*Yooxanaa|(?:\s*Yooxanaa|John))|I\.?\s*Yooxanaa|1\.?\s*Yoox|I\.?\s*Yoox))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Yooxanaa\s*Labaad|II\.?\s*Yooxanaa|2(?:\.\s*Yooxanaa|(?:\s*Yooxanaa|John))|II\.?\s*Yoox|2\.?\s*Yoox))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Yooxanaa\s*Saddexaad|III\.?\s*Yooxanaa|3(?:\.\s*Yooxanaa|(?:\s*Yooxanaa|John))|III\.?\s*Yoox|3\.?\s*Yoox))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Yoox(?:anaa)?|John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Korintos\s*Labaad|II\.?\s*Korintos|2(?:\.\s*Korintos|(?:\s*Korintos|Cor))|II\.?\s*Kor|2\.?\s*Kor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Korintos\s*Kowaad|1(?:\.\s*Korintos|(?:\s*Korintos|Cor))|I\.?\s*Korintos|1\.?\s*Kor|I\.?\s*Kor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tesoloniika\s*Labaad|II\.?\s*Tesaloniika|2(?:\.\s*Tesaloniika|(?:\s*Tesaloniika|Thess))|II\.?\s*Tes|2\.?\s*Tes))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tesoloniika\s*Kowaad|1(?:\.\s*Tesaloniika|(?:\s*Tesaloniika|Thess))|I\.?\s*Tesaloniika|1\.?\s*Tes|I\.?\s*Tes))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Timoteyos\s*Labaad|II\.?\s*Timoteyos|2(?:\.\s*Timoteyos|(?:\s*Timoteyos|Tim))|II\.?\s*Tim|2\.?\s*Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Timoteyos\s*Kowaad|1(?:\.\s*Timoteyos|(?:\s*Timoteyos|Tim))|I\.?\s*Timoteyos|1\.?\s*Tim|I\.?\s*Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Butros\s*Labaad|II\.?\s*Butros|2(?:\.\s*Butros|(?:\s*Butros|Pet))|II\.?\s*But|2\.?\s*But))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Butros\s*Kowaad|1(?:\.\s*Butros|(?:\s*Butros|Pet))|I\.?\s*Butros|1\.?\s*But|I\.?\s*But))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
...
function peg$parse(input, options) {
  ...
  var peg$e24 = peg$literalExpectation("iyo", false);
