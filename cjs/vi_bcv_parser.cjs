...
var bcv_regexps = class {
  constructor() {
    ...
    this.range_and = String.raw`(?:[&\u2013\u2014-]|và|to)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:II(?:\.\s*Sa(?:-?mu-?ên|muel|m)?|\s*Sa(?:-?mu-?ên|muel|m)?)|2(?:\.\s*Sa(?:-?mu-?ên|muel|m)?|(?:\s*Sa(?:-?mu-?ên|muel|m)?|Sam))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:\.\s*Sa(?:-?mu-?ên|muel|m)?|(?:\s*Sa(?:-?mu-?ên|muel|m)?|Sam))|I(?:\.\s*Sa(?:-?mu-?ên|muel|m)?|\s*Sa(?:-?mu-?ên|muel|m)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:II(?:\.\s*(?:Các\s*)?Vua|\s*(?:Các\s*)?Vua)|2(?:\.\s*(?:Các\s*)?Vua|(?:\s*(?:Các\s*)?Vua|Kgs))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:\.\s*(?:Các\s*)?Vua|(?:\s*(?:Các\s*)?Vua|Kgs))|I(?:\.\s*(?:Các\s*)?Vua|\s*(?:Các\s*)?Vua)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:II(?:\.\s*(?:Sử\s*(?:biên\s*niên|ký)|Lịch\s*sử|\s*Sử\s*Ký|Sử)|\s*(?:Sử\s*(?:biên\s*niên|ký)|Lịch\s*sử|\s*Sử\s*Ký|Sử))|2(?:\.\s*(?:Sử\s*(?:biên\s*niên|ký)|Lịch\s*sử|\s*Sử\s*Ký|Sử)|(?:\s*(?:Sử\s*(?:biên\s*niên|ký)|Lịch\s*sử|\s*Sử\s*Ký|Sử)|Chr))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:\.\s*(?:Sử(?:\s*(?:biên\s*niên|[Kk]ý))?|Lịch\s*sử)|(?:\s*(?:Sử(?:\s*(?:biên\s*niên|[Kk]ý))?|Lịch\s*sử)|Chr))|I(?:\.\s*(?:Sử(?:\s*(?:biên\s*niên|[Kk]ý))?|Lịch\s*sử)|\s*(?:Sử(?:\s*(?:biên\s*niên|[Kk]ý))?|Lịch\s*sử))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:\.\s*Gi(?:oan|ăng)?|(?:\s*Gi(?:oan|ăng)?|John))|I(?:\.\s*Gi(?:oan|ăng)?|\s*Gi(?:oan|ăng)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:II(?:\.\s*Gi(?:oan|ăng)?|\s*Gi(?:oan|ăng)?)|2(?:\.\s*Gi(?:oan|ăng)?|(?:\s*Gi(?:oan|ăng)?|John))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:III(?:\.\s*Gi(?:oan|ăng)?|\s*Gi(?:oan|ăng)?)|3(?:\.\s*Gi(?:oan|ăng)?|(?:\s*Gi(?:oan|ăng)?|John))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:G(?:(?:(?:iăn)?g|i)|ioan)|John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:II(?:\.\s*Cô(?:-?rinh-?tô|-?rinh|rintô)?|\s*Cô(?:-?rinh-?tô|-?rinh|rintô)?)|2(?:\.\s*Cô(?:-?rinh-?tô|-?rinh|rintô)?|(?:\s*Cô(?:-?rinh-?tô|-?rinh|rintô)?|Cor))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:\.\s*Cô(?:-?rinh-?tô|-?rinh|rintô)?|(?:\s*Cô(?:-?rinh-?tô|-?rinh|rintô)?|Cor))|I(?:\.\s*Cô(?:-?rinh-?tô|-?rinh|rintô)?|\s*Cô(?:-?rinh-?tô|-?rinh|rintô)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:II(?:\.\s*T(?:hê(?:-?sa-?lô-?ni-?|xalôni)ca|ê(?:-?sa-?lô-?ni-?ca)?)|\s*T(?:hê(?:-?sa-?lô-?ni-?|xalôni)ca|ê(?:-?sa-?lô-?ni-?ca)?))|2(?:\.\s*T(?:hê(?:-?sa-?lô-?ni-?|xalôni)ca|ê(?:-?sa-?lô-?ni-?ca)?)|(?:\s*T(?:hê(?:-?sa-?lô-?ni-?|xalôni)ca|ê(?:-?sa-?lô-?ni-?ca)?)|Thess))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:\.\s*T(?:hê(?:-?sa-?lô-?ni-?|xalôni)ca|ê(?:-?sa-?lô-?ni-?ca)?)|(?:\s*T(?:hê(?:-?sa-?lô-?ni-?|xalôni)ca|ê(?:-?sa-?lô-?ni-?ca)?)|Thess))|I(?:\.\s*T(?:hê(?:-?sa-?lô-?ni-?|xalôni)ca|ê(?:-?sa-?lô-?ni-?ca)?)|\s*T(?:hê(?:-?sa-?lô-?ni-?|xalôni)ca|ê(?:-?sa-?lô-?ni-?ca)?))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:II(?:\.\s*Ti(?:-?mô-?thê|m(?:ôthê)?)|\s*Ti(?:-?mô-?thê|m(?:ôthê)?))|2(?:\.\s*Ti(?:-?mô-?thê|m(?:ôthê)?)|(?:\s*Ti(?:-?mô-?thê|m(?:ôthê)?)|Tim))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:\.\s*Ti(?:-?mô-?thê|m(?:ôthê)?)|(?:\s*Ti(?:-?mô-?thê|m(?:ôthê)?)|Tim))|I(?:\.\s*Ti(?:-?mô-?thê|m(?:ôthê)?)|\s*Ti(?:-?mô-?thê|m(?:ôthê)?))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:II(?:\.\s*Ph(?:i(?:-?e|a)-?rơ|i(?:-?rơ|a)|ê(?:-?rơ|rô))|\s*Ph(?:i(?:-?e|a)-?rơ|i(?:-?rơ|a)|ê(?:-?rơ|rô)))|2(?:\.\s*Ph(?:i(?:-?e|a)-?rơ|i(?:-?rơ|a)|ê(?:-?rơ|rô))|(?:\s*Ph(?:i(?:-?e|a)-?rơ|i(?:-?rơ|a)|ê(?:-?rơ|rô))|Pet))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:\.\s*Ph(?:i(?:-?e|a)-?rơ|i(?:-?rơ|a)|ê(?:-?rơ|rô))|(?:\s*Ph(?:i(?:-?e|a)-?rơ|i(?:-?rơ|a)|ê(?:-?rơ|rô))|Pet))|I(?:\.\s*Ph(?:i(?:-?e|a)-?rơ|i(?:-?rơ|a)|ê(?:-?rơ|rô))|\s*Ph(?:i(?:-?e|a)-?rơ|i(?:-?rơ|a)|ê(?:-?rơ|rô)))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
...
function peg$parse(input, options) {
  ...
  var peg$e19 = peg$literalExpectation("chương", true);
  ...
  var peg$e24 = peg$literalExpectation("và", true);
