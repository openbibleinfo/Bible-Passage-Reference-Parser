...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = String.raw`(?:1|I)\.?\s*`;
    this.second = String.raw`(?:2|II)\.?\s*`;
    this.third = String.raw`(?:3|III)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|og|-)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fyrsta\s*(?:b[oó]k\s*M[oó]se|M[oó]seb[oó]k)|(?:1(?:\.\s*M[oó]se|\s*M[oó]se)|I(?:\.\s*M[oó]se|\s*M[oó]se))b[oó]k|(?:Genesi|1Mó)s|1\.\s*M[oó]s|I(?:\.\s*M[oó]s|\s*M[oó]s)|1\s*M[oó]s|Gen))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:[OÖ]nnur\s*(?:b[oó]k\s*M[oó]se|M[oó]seb[oó]k)|(?:II(?:\.\s*M[oó]se|\s*M[oó]se)|2(?:\.\s*M[oó]se|\s*M[oó]se))b[oó]k|II(?:\.\s*M[oó]s|\s*M[oó]s)|2\.\s*M[oó]s|(?:Exodu|2Mó)s|2\s*M[oó]s|Exod))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bel"],
        testament: "a",
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Þriðja\s*(?:b[oó]k\s*M[oó]se|M[oó]seb[oó]k)|(?:III(?:\.\s*M[oó]se|\s*M[oó]se)|3(?:\.\s*M[oó]se|\s*M[oó]se))b[oó]k|(?:Leviticu|3Mó)s|III(?:\.\s*M[oó]s|\s*M[oó]s)|3\.\s*M[oó]s|3\s*M[oó]s|Lev))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fj[oó]rða\s*(?:b[oó]k\s*M[oó]se|M[oó]seb[oó]k)|(?:IV(?:\.\s*M[oó]se|\s*M[oó]se)|4(?:\.\s*M[oó]se|\s*M[oó]se))b[oó]k|IV(?:\.\s*M[oó]s|\s*M[oó]s)|4\.\s*M[oó]s|Numeri|4\s*M[oó]s|4Mós|Num))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Sir"],
        testament: "a",
      ...
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fimmta\s*(?:b[oó]k\s*M[oó]se|M[oó]seb[oó]k)|Deuteronomium|(?:5(?:\.\s*M[oó]se|\s*M[oó]se)|V(?:\.\s*M[oó]se|\s*M[oó]se))b[oó]k|5\.\s*M[oó]s|V(?:\.\s*M[oó]s|\s*M[oó]s)|5\s*M[oó]s|Deut|5Mós))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:S[ií]ðari\s*Sam[uú]elsb[oó]k|II\.?\s*Sam|(?:2\.\s*|2\s*?)Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fyrri\s*Sam[uú]elsb[oó]k|(?:1\.\s*|1\s*?)Sam|I\.?\s*Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:S(?:iðari\s*b[oó]k\s*konunganna|íðari\s*(?:b[oó]k\s*konunganna|(?:Konungab[oó]|konungabó)k)|iðari\s*Konungab[oó]k)|II\.?\s*Kon|2(?:\.\s*Kon|(?:\s*Kon|Kgs))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fyrri\s*(?:b[oó]k\s*konunganna|(?:Konungab[oó]|konungabó)k)|1(?:\.\s*Kon|(?:\s*Kon|Kgs))|I\.?\s*Kon))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:S(?:iðari\s*Kron[ií]kub[oó]k|íðari\s*(?:Kron[ií]kub[oó]|kroníkubó)k)|II\.?\s*Kro|2(?:\.\s*Kro|(?:\s*Kro|Chr))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fyrri\s*(?:Kron[ií]kub[oó]|kroníkubó)k|1(?:\.\s*Kro|(?:\s*Kro|Chr))|I\.?\s*Kro))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fyrsta\s*(?:br[eé]f\s*J[oó]hannesar(?:\s*hið\s*almenna)?|J[oó]hannesarbr[eé]f)|1(?:\.\s*J[oó]h|(?:John|\s*J[oó]h))|I(?:\.\s*J[oó]h|\s*J[oó]h)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Annað\s*(?:br[eé]f\s*J[oó]hannesar|J[oó]hannesarbr[eé]f)|II(?:\.\s*J[oó]h|\s*J[oó]h)|2(?:\.\s*J[oó]h|(?:John|\s*J[oó]h))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Þriðja\s*(?:br[eé]f\s*J[oó]hannesar|J[oó]hannesarbr[eé]f)|III(?:\.\s*J[oó]h|\s*J[oó]h)|3(?:\.\s*J[oó]h|(?:John|\s*J[oó]h))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))(J(?:oh(?:annesarguðspjall|n?)|óh(?:annesarguðspjall)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:S[ií]ðara\s*(?:br[eé]f\s*P[aá]ls\s*til\s*Kori(?:ntumanna)?|K[oó]rintubr[eé]f)|II\.?\s*Kor|(?:2\.\s*K|2(?:\s*K|C))or))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fyrra\s*(?:br[eé]f\s*P[aá]ls\s*til\s*Korin(?:tumanna)?|Korintubr[eé]f)|(?:1\.\s*K|1(?:\s*K|C))or|I\.?\s*Kor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:S[ií]ðara\s*(?:br[eé]f\s*P[aá]ls\s*til\s*Þess(?:alon[ií]kumanna)?|Þessalon[ií]kubr[eé]f)|II\.?\s*Þess|(?:2\.\s*Þ|2(?:Th|\s*Þ))ess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fyrra\s*(?:br[eé]f\s*P[aá]ls\s*til\s*Þessa(?:lon[ií]kumanna)?|Þessalon[ií]kubr[eé]f)|(?:1\.\s*Þ|1(?:Th|\s*Þ))ess|I\.?\s*Þess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:S[ií]ðara\s*(?:br[eé]f\s*P[aá]ls\s*til\s*T[ií]m[oó](?:teusar)?|T[ií]m[oó]teusarbr[eé]f)|II(?:\.\s*T[ií]m|\s*T[ií]m)|2(?:\.\s*T[ií]m|(?:\s*T[ií]m|Tim))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fyrra\s*(?:br[eé]f\s*P[aá]ls\s*til\s*T[ií]m[oó]t(?:eusar)?|T[ií]m[oó]teusarbr[eé]f)|1(?:\.\s*T[ií]m|(?:\s*T[ií]m|Tim))|I(?:\.\s*T[ií]m|\s*T[ií]m)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:S[ií]ðara\s*(?:almenna\s*br[eé]f\s*P[eé]turs|P[eé]tursbr[eé]f)|II(?:\.\s*P[eé]t|\s*P[eé]t)|2(?:\.\s*P[eé]t|(?:\s*P[eé]t|Pet))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fyrra\s*(?:almenna\s*br[eé]f\s*P[eé]turs|P[eé]tursbr[eé]f)|1(?:\.\s*P[eé]t|(?:\s*P[eé]t|Pet))|I(?:\.\s*P[eé]t|\s*P[eé]t)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:[OÖ]nnur\s*Makkabeab[oó]k|(?:II\.?\s*Mak|2\.?\s*Mak)k|2Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Þriðja\s*Makkabeab[oó]k|(?:III\.?\s*Mak|3\.?\s*Mak)k|3Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fj[oó]rða\s*Makkabeab[oó]k|(?:IV\.?\s*Mak|4\.?\s*Mak)k|4Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fyrsta\s*Makkabeab[oó]k|(?:1\.?\s*Mak|I\.?\s*Mak)k|1Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      }
    ];
  }
};
...
function peg$parse(input, options) {
  ...
  var peg$e19 = peg$literalExpectation("ka", false);
  var peg$e20 = peg$literalExpectation("fli", false);
  var peg$e21 = peg$literalExpectation("fla", false);
  var peg$e22 = peg$literalExpectation("p", false);
  var peg$e23 = peg$classExpectation(["í", "i"], false, true);
  var peg$e24 = peg$literalExpectation("tuli", false);
  var peg$e25 = peg$literalExpectation("vers", false);
  var peg$e26 = peg$literalExpectation(":", false);
  var peg$e27 = peg$classExpectation(['"', "'"], false, false);
  var peg$e28 = peg$classExpectation([",", ";", "/", ":", "&", "-", "–", "—", "~"], false, false);
  var peg$e29 = peg$literalExpectation("og", false);
