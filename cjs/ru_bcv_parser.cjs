...
var bcv_regexps = class {
  constructor() {
    ...
    // The `надписаниях` has `[a-z]` instead of `\w` because it could be followed by a number.
    // [аб] allows `1:1a`.
    this.escaped_passage = /(?:^|[^\x1e\x1f\p{L}\p{N}])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s.:,;\x1e\x1f&\(\)（）\[\]\\/"'\*=~\-–—]|надписаниях(?![a-z])|и\s+далее|главы|стихи|глав|стих|гл|—|и|[аб](?!\w)|$)+)/giu;
    ...
    this.match_end_split = /\d\W*надписаниях|\d\W*и\s+далее(?:[\s*]*\.)?|\d[\s*]*[аб](?!\w)|\x1e(?:[\s*]*[)\]\uff09])?|[\d\x1f]/gi;
    this.control = /[\x1e\x1f]/g;
    // These are needed for ranges outside of this class.
    this.first = String.raw`(?:1-?я|1-?е|1)\.?\s*`;
    this.second = String.raw`(?:2-?я|2-?е|2)\.?\s*`;
    this.third = String.raw`(?:3-?я|3-?е|3)\.?\s*`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:2(?:-?[ея]\.?\s*Ездры|[ея]\.?\s*Ездры|\.\s*Ездры|\s*Езд(?:ры)?)|1Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:3(?:-?[ея]\.?\s*Ездры|[ея]\.?\s*Ездры|\.\s*Ездры|\s*Езд(?:ры)?)|2Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:-?[ея](?:\.\s*(?:Книга\s*Царств|Самуила|Царств)|\s*(?:Книга\s*Царств|Самуила|Царств))|[ея](?:\.\s*(?:Книга\s*Царств|Самуила|Царств)|\s*(?:Книга\s*Царств|Самуила|Царств))|\.\s*(?:Книга\s*Царств|Самуила|Царств)|\s*Книга\s*Царств|\s*Самуила|\s*Царств|\s*Цар|Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:-?[ея](?:\.\s*(?:Книга\s*Царств|Самуила|Царств)|\s*(?:Книга\s*Царств|Самуила|Царств))|[ея](?:\.\s*(?:Книга\s*Царств|Самуила|Царств)|\s*(?:Книга\s*Царств|Самуила|Царств))|\.\s*(?:Книга\s*Царств|Самуила|Царств)|\s*Книга\s*Царств|\s*Самуила|\s*Царств|\s*Цар|Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:4(?:-?[ея](?:\.\s*(?:Книга\s*)?Царств|\s*(?:Книга\s*)?Царств)|[ея](?:\.\s*(?:Книга\s*)?Царств|\s*(?:Книга\s*)?Царств)|\.\s*(?:Книга\s*)?Царств|\s*(?:Книга\s*Царств|Цар(?:ств)?))|2(?:-?[ея](?:\.\s*Царе[ий]|\s*Царе[ий])|[ея](?:\.\s*Царе[ий]|\s*Царе[ий])|\.\s*Царе[ий]|\s*Царе[ий]|Kgs)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:3(?:-?[ея](?:\.\s*(?:Книга\s*)?Царств|\s*(?:Книга\s*)?Царств)|[ея](?:\.\s*(?:Книга\s*)?Царств|\s*(?:Книга\s*)?Царств)|\.\s*(?:Книга\s*)?Царств|\s*(?:Книга\s*Царств|Цар(?:ств)?))|1(?:-?[ея](?:\.\s*Царе[ий]|\s*Царе[ий])|[ея](?:\.\s*Царе[ий]|\s*Царе[ий])|\.\s*Царе[ий]|\s*Царе[ий]|Kgs)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:-?[ея](?:\.\s*(?:Книга\s*Паралипоменон|Паралипоменон|Летопись|Хроник)|\s*(?:Книга\s*Паралипоменон|Паралипоменон|Летопись|Хроник))|[ея](?:\.\s*(?:Книга\s*Паралипоменон|Паралипоменон|Летопись|Хроник)|\s*(?:Книга\s*Паралипоменон|Паралипоменон|Летопись|Хроник))|\.\s*(?:Книга\s*Паралипоменон|Паралипоменон|Летопись|Хроник)|\s*Книга\s*Паралипоменон|\s*Паралипоменон|\s*Летопись|\s*Хроник|\s*(?:Лет|Пар)|Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:-?[ея](?:\.\s*(?:Книга\s*Паралипоменон|Паралипоменон|Летопись|Хроник)|\s*(?:Книга\s*Паралипоменон|Паралипоменон|Летопись|Хроник))|[ея](?:\.\s*(?:Книга\s*Паралипоменон|Паралипоменон|Летопись|Хроник)|\s*(?:Книга\s*Паралипоменон|Паралипоменон|Летопись|Хроник))|\.\s*(?:Книга\s*Паралипоменон|Паралипоменон|Летопись|Хроник)|\s*Книга\s*Паралипоменон|\s*Паралипоменон|\s*Летопись|\s*Хроник|\s*(?:Лет|Пар)|Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Первая\s*Ездры|Книга\s*Ездры|Ездр[аы]|1\s*Езд|Уза[ий]р|Ezra|Езд))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Neh"],
        testament: "o",
      ...
      },
      {
        osis: ["GkEsth"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Дополнения\s*к\s*Есфири|GkEsth))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Esth"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:-?[ея](?:\.\s*(?:послание\s*Иоан|Ио(?:ха|ан))на|\s*(?:послание\s*Иоан|Ио(?:ха|ан))на)|[ея](?:\.\s*(?:послание\s*Иоан|Ио(?:ха|ан))на|\s*(?:послание\s*Иоан|Ио(?:ха|ан))на)|\.\s*(?:послание\s*Иоан|Ио(?:ха|ан))на|\s*послание\s*Иоанна|\s*Иохана|\s*Иоанна|John|\s*Ин))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:-?[ея](?:\.\s*(?:послание\s*Иоан|Ио(?:ха|ан))на|\s*(?:послание\s*Иоан|Ио(?:ха|ан))на)|[ея](?:\.\s*(?:послание\s*Иоан|Ио(?:ха|ан))на|\s*(?:послание\s*Иоан|Ио(?:ха|ан))на)|\.\s*(?:послание\s*Иоан|Ио(?:ха|ан))на|\s*послание\s*Иоанна|\s*Иохана|\s*Иоанна|John|\s*Ин))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:-?[ея](?:\.\s*(?:послание\s*Иоан|Ио(?:ха|ан))на|\s*(?:послание\s*Иоан|Ио(?:ха|ан))на)|[ея](?:\.\s*(?:послание\s*Иоан|Ио(?:ха|ан))на|\s*(?:послание\s*Иоан|Ио(?:ха|ан))на)|\.\s*(?:послание\s*Иоан|Ио(?:ха|ан))на|\s*послание\s*Иоанна|\s*Иохана|\s*Иоанна|John|\s*Ин))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Евангелие\s*от\s*Иоанна|От\s*Иоанна|Иоанна|И(?:оха)?н|John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:-?[ея](?:\.\s*(?:к\s*)?Коринфянам|\s*(?:к\s*)?Коринфянам)|[ея](?:\.\s*(?:к\s*)?Коринфянам|\s*(?:к\s*)?Коринфянам)|\.\s*(?:к\s*)?Коринфянам|\s*к\s*Коринфянам|\s*Коринфянам|\s*Кор|Cor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:-?[ея](?:\.\s*(?:к\s*)?Коринфянам|\s*(?:к\s*)?Коринфянам)|[ея](?:\.\s*(?:к\s*)?Коринфянам|\s*(?:к\s*)?Коринфянам)|\.\s*(?:к\s*)?Коринфянам|\s*к\s*Коринфянам|\s*Коринфянам|\s*Кор|Cor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:-?[ея](?:\.\s*(?:к\s*Тимоф|Тим(?:ет|оф))ею|\s*(?:к\s*Тимоф|Тим(?:ет|оф))ею)|[ея](?:\.\s*(?:к\s*Тимоф|Тим(?:ет|оф))ею|\s*(?:к\s*Тимоф|Тим(?:ет|оф))ею)|\.\s*(?:к\s*Тимоф|Тим(?:ет|оф))ею|\s*к\s*Тимофею|\s*Тиметею|\s*Тимофею|\s*Тим|Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:-?[ея](?:\.\s*(?:к\s*Тимоф|Тим(?:ет|оф))ею|\s*(?:к\s*Тимоф|Тим(?:ет|оф))ею)|[ея](?:\.\s*(?:к\s*Тимоф|Тим(?:ет|оф))ею|\s*(?:к\s*Тимоф|Тим(?:ет|оф))ею)|\.\s*(?:к\s*Тимоф|Тим(?:ет|оф))ею|\s*к\s*Тимофею|\s*Тиметею|\s*Тимофею|\s*Тим|Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:-?[ея](?:\.\s*(?:послание\s*Петр|(?:Петр(?:ус)?|Петир))а|\s*(?:послание\s*Петр|(?:Петр(?:ус)?|Петир))а)|[ея](?:\.\s*(?:послание\s*Петр|(?:Петр(?:ус)?|Петир))а|\s*(?:послание\s*Петр|(?:Петр(?:ус)?|Петир))а)|\.\s*(?:послание\s*Петр|(?:Петр(?:ус)?|Петир))а|\s*послание\s*Петра|\s*Петруса|\s*Петира|\s*Петра|\s*Пет|Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:-?[ея](?:\.\s*(?:послание\s*Петр|(?:Петр(?:ус)?|Петир))а|\s*(?:послание\s*Петр|(?:Петр(?:ус)?|Петир))а)|[ея](?:\.\s*(?:послание\s*Петр|(?:Петр(?:ус)?|Петир))а|\s*(?:послание\s*Петр|(?:Петр(?:ус)?|Петир))а)|\.\s*(?:послание\s*Петр|(?:Петр(?:ус)?|Петир))а|\s*послание\s*Петра|\s*Петруса|\s*Петира|\s*Петра|\s*Пет|Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["Bar"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Книга\s*(?:пророка\s*Вару́|Вару)ха|Бару́ха|Варуха|Вар|Bar))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Sus"],
        testament: "a",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Вторая\s*книга\s*Маккаве[ий]ская|2(?:(?:-?[ея]\.?\s*Маккавеев|[ея]\.?\s*Маккавеев|\.\s*Маккавеев|\s*Маккавеев|Macc)|\s*Макк)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Третья\s*книга\s*Маккаве[ий]ская|3(?:(?:-?[ея]\.?\s*Маккавеев|[ея]\.?\s*Маккавеев|\.\s*Маккавеев|\s*Маккавеев|Macc)|\s*Макк)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(4(?:-?[ея]\.?\s*Маккавеев|[ея]\.?\s*Маккавеев|\.\s*Маккавеев|\s*Маккавеев|\s*Макк|Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Первая\s*книга\s*Маккаве[ий]ская|1(?:(?:-?[ея]\.?\s*Маккавеев|[ея]\.?\s*Маккавеев|\.\s*Маккавеев|\s*Маккавеев|Macc)|\s*Макк)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      }
    ];
  }
};
...
function peg$parse(input, options) {
  ...
  var peg$e13 = peg$literalExpectation("далее", true);
  ...
  var peg$e19 = peg$classExpectation(["а", "б"], false, true);
  var peg$e20 = peg$literalExpectation("гл", true);
  var peg$e21 = peg$literalExpectation("авы", true);
  var peg$e22 = peg$literalExpectation("ав", true);
  var peg$e23 = peg$literalExpectation("стих", true);
  ...
  var peg$e28 = peg$literalExpectation("—", true);
  var peg$e29 = peg$literalExpectation("надписаниях", true);
  var peg$e30 = peg$literalExpectation("from", false);
  var peg$e31 = peg$literalExpectation("of", false);
  var peg$e32 = peg$literalExpectation("in", false);
  var peg$e33 = peg$literalExpectation("the", false);
  var peg$e34 = peg$literalExpectation("book", false);
  var peg$e35 = peg$classExpectation(["(", "["], false, false);
  var peg$e36 = peg$classExpectation([")", "]"], false, false);
  var peg$e37 = peg$literalExpectation("", false);
  var peg$e38 = peg$literalExpectation(",000", false);
