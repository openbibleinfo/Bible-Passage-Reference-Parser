...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = String.raw`1\.?\s*`;
    this.second = String.raw`2\.?\s*`;
    this.third = String.raw`3\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|and|-)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:उत्पत्ति(?:को(?:\s*पुस्तक)?)?|utpattiko\s*pustak|utpattiko|Gen))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:prastʰ[aā]nko\s*pustak|प्रस्थान(?:को(?:\s*पुस्तक)?)?|prastʰ[aā]nko|Exod))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bel"],
        testament: "a",
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:lev[iī]har[uū]ko\s*pustak|लेव(?:ी(?:हरूको(?:\s*पुस्तक)?)?|ि)|lev[iī]har[uū]ko|Lev))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:gant[iī]ko\s*pustak|गन्ती(?:को(?:\s*पुस्तक)?)?|gant[iī]ko|Num))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Sir"],
        testament: "a",
      ...
      },
      {
        osis: ["Lam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:yarmiy[aā]ko\s*vil[aā]p|यर्मियाको\s*विलाप|विलाप|Lam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["EpJer"],
        testament: "a",
      ...
      },
      {
        osis: ["Rev"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:y[uū]hann[aā]l[aā][iī]\s*bʰaeko\s*prak[aā][sš]|यूहन्नालाई\s*भएको\s*प्रकाश|प्रकाश|Rev))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["PrMan"],
        testament: "a",
      ...
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:vyavastʰ[aā]ko\s*pustak|व्य(?:वस्था(?:को\s*पुस्तक|(?:को)?)|ावस्था)|vyavastʰ[aā]ko|Deut))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:yaho[sš][uū]ko\s*pustak|यहोशू(?:को(?:\s*पुस्तक)?)?|yaho[sš][uū]ko|Josh))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Judg"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ny[aā]yakartt[aā]har[uū]ko\s*pustak|न्यायकर्त(?:्ताहरूको(?:\s*पुस्तक)?|ा(?:हरूको\s*पुस्तक)?)|ny[aā]yakartt[aā]har[uū]ko|Judg))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ruth"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:r[uū]tʰko\s*pustak|रूथ(?:को(?:\s*पुस्तक)?)?|r[uū]tʰko|Ruth))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Esd"],
        testament: "a",
      ...
      },
      {
        osis: ["Isa"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ya[sš]əiy[aā]ko\s*pustak|य(?:शैया(?:को\s*पुस्तक|(?:को)?)|ेशैया)|ya[sš]əiy[aā]ko|Isa))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:शमूएलको\s*दोस्रो\s*पुस्तक|2(?:(?:\.\s*(?:[sš]am[uū]elko|श(?:मूएलको|ामुएल))|\s*(?:[sš]am[uū]elko|श(?:मूएलको|ामुएल))|Sam)|\.?\s*शमूएल)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:शमूएलको\s*पहिलो\s*पुस्तक|[sš]am[uū]elko\s*pustak|1(?:\.\s*(?:[sš]am[uū]elko|श(?:मूएलको|ामुएल))|\s*(?:[sš]am[uū]elko|श(?:मूएलको|ामुएल))|Sam)|1\.?\s*शमूएल))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:राजाहरूको\s*दोस्रो\s*पुस्तक|2(?:(?:\.\s*(?:r[aā]ǳ[aā]har[uū]ko|राजाहरूको)|\s*(?:r[aā]ǳ[aā]har[uū]ko|राजाहरूको)|Kgs)|\.?\s*राजा)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:राजाहरूक\s*पहिल\s*पुस्तक|r[aā]ǳ[aā]har[uū]ko\s*pustak|1(?:\.\s*(?:r[aā]ǳ[aā]har[uū]ko|राजाहरूको)|\s*(?:r[aā]ǳ[aā]har[uū]ko|राजाहरूको)|Kgs)|1\.?\s*राजा))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:इतिहासको\s*दोस्रो\s*पुस्तक|2(?:(?:\.\s*(?:itih[aā]sko|इतिहासको)|\s*(?:itih[aā]sko|इतिहासको)|Chr)|\.?\s*इतिहास)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:इतिहासको\s*पहिलो\s*पुस्तक|itih[aā]sko\s*pustak|1(?:\.\s*(?:itih[aā]sko|इतिहासको)|\s*(?:itih[aā]sko|इतिहासको)|Chr)|1\.?\s*इतिहास))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:एज्रा(?:को(?:\s*पुस्तक)?)?|eǳr[aā]ko|Ezra))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Neh"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:nahemy[aā]hko\s*pustak|नहेम्याह(?:को(?:\s*पुस्तक)?)?|nahemy[aā]hko|Neh))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["GkEsth"],
        testament: "a",
      ...
      },
      {
        osis: ["Esth"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:estarko\s*pustak|एस्तर(?:को(?:\s*पुस्तक)?)?|estarko|Esth))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Job"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:अय्यूब(?:को(?:\s*पुस्तक)?)?|ayy[uū]bko\s*pustak|ayy[uū]bko|Job))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ps"],
        testament: "oa",
        testament_books: { "Ps": "oa" },
        regexp: /(?:^|(?<=[^\p{L}]))((?:bʰaǳansa[mṃ]grah|भजनसं?ग्रह|भजन|Ps))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["PrAzar"],
        testament: "a",
      ...
      },
      {
        osis: ["Prov"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:hitopade[sš]ko\s*pustak|हितोपदेश(?:को(?:\s*पुस्तक)?)?|hitopade[sš]ko|Prov))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Eccl"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:upade[sš]akko\s*pustak|उपदेशक(?:को(?:\s*पुस्तक)?)?|upade[sš]akko|Eccl))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["SgThree"],
        testament: "a",
      ...
      },
      {
        osis: ["Song"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:sulem[aā]nko\s*[sš]re[sṣ][tṭ]ʰag[iī]t|सुलेमानको\s*श्रेष्ठगीत|श्रेष्ठगीत|Song))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jer"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:yarmiy[aā]ko\s*pustak|यर्मिया(?:को(?:\s*पुस्तक)?)?|yarmiy[aā]ko|Jer))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezek"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:(?:iǳakielko\s*pusta|Eze)k|इजकिएल(?:को(?:\s*पुस्तक)?)?|iǳakielko))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Dan"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:d[aā]niyalko\s*pustak|दानियल(?:को(?:\s*पुस्तक)?)?|d[aā]niyalko|Dan))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hos"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:होशे(?:को\s*पुस्तक)?|ho[sš]e|Hos))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Joel"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:योएल(?:को\s*पुस्तक)?|[Jy]oel))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Amos"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:आमोस(?:को\s*पुस्तक)?|[Aaā]mos|अमोस))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Obad"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ओबदिया(?:को\s*पुस्तक)?|obadiy[aā]|Obad))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jonah"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:योना(?:को\s*पुस्तक)?|Jonah|yon[aā]))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mic"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:म(?:ीका(?:को\s*पुस्तक)?|िका)|m[iī]k[aā]|Mic))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Nah"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:नहूम(?:को\s*पुस्तक)?|nah[uū]m|Nah))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hab"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:हबकूक(?:को\s*पुस्तक)?|habak[uū]k|Hab))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Zeph"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:सपन्याह(?:को\s*पुस्तक)?|sapany[aā]h|Zeph))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hag"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:हाग्गै(?:को\s*पुस्तक)?|h[aā]ggəi|Hag))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Zech"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:जकरिया(?:को\s*पुस्तक)?|jakariy[aā]|Zech))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mal"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:मल(?:ाकी(?:को\s*पुस्तक)?|की)|mal[aā]k[iī]|Mal))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Matt"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:matt[iī]le\s*lekʰeko\s*susm[aā]c[aā]r|मत्त(?:ी(?:(?:ले\s*लेखे)?को\s*सुसमाचार|ले)?|ि)|matt[iī]le|Matt))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mark"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:mark[uū]sle\s*lekʰeko\s*susm[aā]c[aā]r|मर्क(?:ू(?:स(?:(?:ले\s*लेखे)?को\s*सुसमाचार|ले)?|श)|ुस)|mark[uū]sle|र्मकूस|र्मकस|Mark))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Luke"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:l[uū]k[aā]le\s*lekʰeko\s*susm[aā]c[aā]r|ल(?:ूका(?:(?:ले\s*लेखे)?को\s*सुसमाचार|ले)?|ुका)|l[uū]k[aā]le|Luke))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:y[uū]hann[aā]ko\s*pahilo\s*patra|यूहन्नाको\s*पहिलो\s*पत्र|1(?:\.\s*(?:y[uū]hann[aā]ko|यूहन्नाको)|\s*(?:y[uū]hann[aā]ko|यूहन्नाको)|John)|1\.?\s*यूहन्ना))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:यूहन्नाको\s*दोस्(?:त्)?रो\s*पत्र|y[uū]hann[aā]ko\s*dostro\s*patra|2(?:\.\s*(?:y[uū]hann[aā]ko|यूहन्नाको)|\s*(?:y[uū]hann[aā]ko|यूहन्नाको)|John)|2\.?\s*यूहन्ना))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:यूहन्नाको\s*तेस्(?:त्)?रो\s*पत्र|y[uū]hann[aā]ko\s*testro\s*patra|3(?:\.\s*(?:y[uū]hann[aā]ko|यूहन्नाको)|\s*(?:y[uū]hann[aā]ko|यूहन्नाको)|John)|3\.?\s*यूहन्ना))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:y[uū]hann[aā]le\s*lekʰeko\s*susm[aā]c[aā]r|य(?:ूहन(?:(?:्ना(?:ले\s*लेखे)?को\s*सुसमाचार|ा)|्ना(?:ले)?)|(?:ूहा|हू)न्ना|ुहन्ना)|y[uū]hann[aā]le|John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:prerithar[uū]k[aā]\s*k[aā]m|प्रेरित(?:हरूका\s*काम)?|Acts))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Rom"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:रोमी(?:हरूलाई(?:\s*प(?:ावलको\s*प)?त्र)?)?|rom[iī]har[uū]l[aā][iī]\s*patra|rom[iī]har[uū]l[aā][iī]|Rom))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:कोरिन्थीहरूलाई\s*(?:पावलको\s*दोस|दोस्त)्रो\s*पत्र|korintʰ[iī]har[uū]l[aā][iī]\s*dostro\s*patra|2(?:\.\s*(?:korintʰ[iī]har[uū]l[aā][iī]|कोरिन्थीहरूलाई)|\s*(?:korintʰ[iī]har[uū]l[aā][iī]|कोरिन्थीहरूलाई)|Cor)|2\.?\s*कोरिन्थी))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:कोरिन्थीहरूलाई\s*प(?:ावलको\s*प)?हिलो\s*पत्र|korintʰ[iī]har[uū]l[aā][iī]\s*pahilo\s*patra|1(?:\.\s*(?:korintʰ[iī]har[uū]l[aā][iī]|कोरिन्थीहरूलाई)|\s*(?:korintʰ[iī]har[uū]l[aā][iī]|कोरिन्थीहरूलाई)|Cor)|1\.?\s*कोरिन्थी))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:गलाती(?:हरूलाई(?:\s*प(?:ावलको\s*प)?त्र)?)?|gal[aā]t[iī]har[uū]l[aā][iī]\s*patra|gal[aā]t[iī]har[uū]l[aā][iī]|Gal))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Eph"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:एफिसी(?:हरूलाई(?:\s*प(?:ावलको\s*प)?त्र)?)?|epʰis[iī]har[uū]l[aā][iī]\s*patra|epʰis[iī]har[uū]l[aā][iī]|Eph))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Phil"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:फिलिप्पी(?:हरूलाई(?:\s*प(?:ावलको\s*प)?त्र)?)?|pʰilipp[iī]har[uū]l[aā][iī]\s*patra|pʰilipp[iī]har[uū]l[aā][iī]|Phil))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Col"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:कलस्सी(?:हरूलाई(?:\s*प(?:ावलको\s*प)?त्र)?)?|kalass[iī]har[uū]l[aā][iī]\s*patra|kalass[iī]har[uū]l[aā][iī]|Col))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:थिस्सलोनिकीहरूलाई\s*(?:पावलको\s*दोस|दोस्त)्रो\s*पत्र|tʰissalonik[iī]har[uū]l[aā][iī]\s*dostro\s*patra|2(?:\.\s*(?:tʰissalonik[iī]har[uū]l[aā][iī]|थिस्सलोनिकीहरूलाई)|\s*(?:tʰissalonik[iī]har[uū]l[aā][iī]|थिस्सलोनिकीहरूलाई)|Thess)|2\.?\s*थिस्सलोनिकी))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:थिस्सलोनिकीहरूलाई\s*प(?:ावलको\s*प)?हिलो\s*पत्र|tʰissalonik[iī]har[uū]l[aā][iī]\s*pahilo\s*patra|1(?:\.\s*(?:tʰissalonik[iī]har[uū]l[aā][iī]|थिस्सलोनिकीहरूलाई)|\s*(?:tʰissalonik[iī]har[uū]l[aā][iī]|थिस्सलोनिकीहरूलाई)|Thess)|1\.?\s*थिस्सलोनिकी))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:तिमोथीलाई\s*(?:पावलको\s*दोस|दोस्त)्रो\s*पत्र|timotʰ[iī]l[aā][iī]\s*dostro\s*patra|2(?:\.\s*(?:timotʰ[iī]l[aā][iī]|तिमोथीलाई)|\s*(?:timotʰ[iī]l[aā][iī]|तिमोथीलाई)|Tim)|2\.?\s*तिमोथी))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:तिमोथीलाई(?:र्\s*पावलको)?\s*पहिलो\s*पत्र|timotʰ[iī]l[aā][iī]\s*pahilo\s*patra|1(?:\.\s*(?:timotʰ[iī]l[aā][iī]|तिमोथीलाई)|\s*(?:timotʰ[iī]l[aā][iī]|तिमोथीलाई)|Tim)|1\.?\s*तिमोथी))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:तीतस(?:लाई(?:\s*प(?:ावलको\s*प)?त्र)?)?|t[iī]tasl[aā][iī]\s*patra|t[iī]tasl[aā][iī]|Titus))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Phlm"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:फिलेमोन(?:लाई(?:\s*प(?:ावलको\s*प)?त्र)?)?|pʰilemonl[aā][iī]\s*patra|pʰilemonl[aā][iī]|Phlm))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Heb"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:hibr[uū]har[uū]ko\s*nimti\s*patra|हिब्रू(?:हरूको\s*निम्ति(?:\s*पत्र)?)?|hibr[uū]har[uū]ko\s*nimti|Heb))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jas"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:y[aā]k[uū]bko\s*patra|याकूब(?:को(?:\s*पत्र)?)?|y[aā]k[uū]bko|Jas))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:पत्रुसको\s*दोस्(?:त्)?रो\s*पत्र|patrusko\s*dostro\s*patra|2(?:\.\s*(?:patrusko|पत्रुसको)|\s*(?:patrusko|पत्रुसको)|Pet)|2\.?\s*पत्रुस))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:patrusko\s*pahilo\s*patra|पत्रुसको\s*पहिलो\s*पत्र|1(?:\.\s*(?:patrusko|पत्रुसको)|\s*(?:patrusko|पत्रुसको)|Pet)|1\.?\s*पत्रुस))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:yah[uū]d[aā]ko\s*patra|यहूदा(?:को(?:\s*पत्र)?)?|yah[uū]d[aā]ko|Jude))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Tob"],
        testament: "a",
...
function peg$parse(input, options) {
  ...
  var peg$e19 = peg$literalExpectation("chapter", false);
  var peg$e20 = peg$literalExpectation("verse", false);
