...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = String.raw`(?:اوّل|[۱1]|1)\.?\s*`;
    this.second = String.raw`(?:دوم|[۲2]|2)\.?\s*`;
    this.third = String.raw`(?:تیسرا|[۳3]|3)\.?\s*`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:دوم(?:[\s*-]سموئ|۔سموا)یل|2(?:\s*samūʾīl|Sam)|(?:2\.|۲)(?:[\s*-]سموئ|۔سموا)یل|2[\s*-]سموئیل|2۔سموایل))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:اوّل(?:(?:\s*سموئ[يی]|-?سموئی)|۔سموای)ل|1(?:\s*samūʾīl|Sam)|(?:1\.|۱)(?:(?:\s*سموئ[يی]|-?سموئی)|۔سموای)ل|1\s*سموئ[يی]ل|1-?سموئیل|1۔سموایل))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:دوم(?:-?سلاطِ|[\s*۔]سلاط)ین|(?:2\.|۲)(?:-?سلاطِ|[\s*۔]سلاط)ین|2(?:\s*salāṭīn|Kgs)|2-?سلاطِین|2[\s*۔]سلاطین))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:اوّل(?:-?سلاطِ|[\s*۔]سلاط)ین|(?:1\.|۱)(?:-?سلاطِ|[\s*۔]سلاط)ین|1(?:\s*salāṭīn|Kgs)|1-?سلاطِین|1[\s*۔]سلاطین))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:دوم(?:-?\s*توارِ|(?:\s*تو\s*|۔تو)ار)یخ|(?:2\.|۲)(?:-?\s*توارِ|(?:\s*تو\s*|۔تو)ار)یخ|2-?\s*توارِیخ|2(?:\s*tavārīḫ|Chr)|2(?:\s*تو\s*|۔تو)اریخ))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:اوّل(?:-?توارِ|[\s*۔]توار)یخ|(?:1\.|۱)(?:-?توارِ|[\s*۔]توار)یخ|1(?:\s*tavārīḫ|Chr)|1-?توارِیخ|1[\s*۔]تواریخ))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:yūḥannā\s*kā\s*dūsrā\s*ʿām\s*ḫaṭ|ی(?:ُوحنّا\s*کا\s*دوسرا\s*عام|وحن(?:ا\s*کا\s*دوسرا\s*عام|ّا\s*کا\s*دوسرا))\s*خط|دوم(?:(?:\s*یُوحنّ|(?:\s*یوحنّ|۔یوحن))|-?یُوحنّ)ا|(?:2\.|۲)(?:(?:\s*یُوحنّ|(?:\s*یوحنّ|۔یوحن))|-?یُوحنّ)ا|2(?:(?:\s*یُوحنّا|(?:\s*یوحنّا|(?:۔یوحنا|John)))|-?یُوحنّا)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:yūḥannā\s*kā\s*tīsrā\s*ʿām\s*ḫaṭ|ی(?:ُوحنّا\s*کا\s*تیسرا\s*عام|(?:وحنا\s*کا\s*تیسرا\s*عام|(?:وحنّا\s*کا\s*(?:تیسرا|3\.|۳)|وحنّا\s*کا\s*3)))\s*خط|تیسرا(?:(?:\s*یُوحنّ|(?:\s*یوحنّ|۔یوحن))|-?یُوحنّ)ا|(?:3\.|۳)(?:(?:\s*یُوحنّ|(?:\s*یوحنّ|۔یوحن))|-?یُوحنّ)ا|3(?:(?:\s*یُوحنّا|(?:\s*یوحنّا|(?:۔یوحنا|John)))|-?یُوحنّا)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:yūḥannā\s*kā\s*pahlā\s*ʿām\s*ḫaṭ|ی(?:ُوحنّ|وحنّ?)ا\s*کا\s*پہلا\s*عام\s*خط|اوّل(?:(?:\s*یُوحنّ|(?:\s*یوحنّ|۔یوحن))|-?یُوحنّ)ا|(?:1\.|۱)(?:(?:\s*یُوحنّ|(?:\s*یوحنّ|۔یوحن))|-?یُوحنّ)ا|1(?:(?:\s*یُوحنّا|(?:\s*یوحنّا|(?:۔یوحنا|John)))|-?یُوحنّا)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:تھ(?:سلنیک(?:وں\s*کے\s*نام\s*پو\s*لس\s*رسول\s*کا|یوں\s*کے\s*نام\s*کا\s*)|ِسّلُنیکیوں\s*کے\s*نام\s*کا\s*)دوسرا\s*خط|tʰissalunīkiyōṅ\s*ke\s*nām\s*kā\s*dūsrā\s*ḫaṭ|دوم(?:-?تھِسّلُنیکی|(?:\s*تھِسلُنیکی|(?:(?:\s*تھسّ|۔تھس)لنیکی|\s*تھسلنیک)))وں|(?:2\.|۲)(?:-?تھِسّلُنیکی|(?:\s*تھِسلُنیکی|(?:(?:\s*تھسّ|۔تھس)لنیکی|\s*تھسلنیک)))وں|2-?تھِسّلُنیکیوں|2\s*تھِسلُنیکیوں|2(?:\s*تھسّ|۔تھس)لنیکیوں|2(?:\s*تھسلنیکوں|Thess)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:تھ(?:س(?:ّلنیکیوں\s*کے\s*نام\s*پولس\s*رسول|لنیکیوں\s*کے\s*نام)|ِسّلُنیکیوں\s*کے\s*نام)\s*کا\s*پہلا\s*خط|tʰissalunīkiyōṅ\s*ke\s*nām\s*kā\s*pahlā\s*ḫaṭ|اوّل(?:-?تھِسّلُ|(?:\s*تھِسلُ|(?:\s*تھسّ|۔تھس)ل))نیکیوں|(?:1\.|۱)(?:-?تھِسّلُ|(?:\s*تھِسلُ|(?:\s*تھسّ|۔تھس)ل))نیکیوں|1-?تھِسّلُنیکیوں|1\s*تھِسلُنیکیوں|1(?:\s*تھسّ|۔تھس)لنیکیوں|1Thess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ت(?:ی(?:ِمُتھِیُس\s*کے\s*نام\s*پولس\s*رسول|متھیس\s*کے\s*نام)|ِیمُتھِیُس\s*کے\s*نام)\s*کا\s*دوسرا\s*خط|tīmutʰiyus\s*ke\s*nām\s*kā\s*dūsrā\s*ḫaṭ|دوم(?:(?:(?:\s*تیِمُتھِیُ|(?:\s*تیمِتھُ|۔تیمتھ)ی)|\s*تِیمُتھِیُ)|-?تِیمُتھِیُ)س|(?:2\.|۲)(?:(?:(?:\s*تیِمُتھِیُ|(?:\s*تیمِتھُ|۔تیمتھ)ی)|\s*تِیمُتھِیُ)|-?تِیمُتھِیُ)س|2\s*تیِمُتھِیُس|2\s*تِیمُتھِیُس|2-?تِیمُتھِیُس|2(?:\s*تیمِتھُ|۔تیمتھ)یس|2Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ت(?:ِیمُتھِیُس\s*کے\s*نام\s*(?:پولُس\s*رسول\s*)?کا\s*پہلا\s*خط|یمتھیس\s*کے\s*نام\s*کا\s*پہلا\s*خط)|tīmutʰiyus\s*ke\s*nām\s*kā\s*pahlā\s*ḫaṭ|اوّل(?:(?:\s*تِیمُتھِیُ|(?:\s*تیمِتھُ|۔تیمتھ)ی)|-?تِیمُتھِیُ)س|(?:1\.|۱)(?:(?:\s*تِیمُتھِیُ|(?:\s*تیمِتھُ|۔تیمتھ)ی)|-?تِیمُتھِیُ)س|1\s*تِیمُتھِیُس|1-?تِیمُتھِیُس|1(?:\s*تیمِتھُ|۔تیمتھ)یس|1Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:paṭras\s*kā\s*dūsrā\s*ʿām\s*ḫaṭ|پطرس\s*کا\s*دوسرا\s*عام\s*خط|دوم(?:\s*پطر\s*?|[-۔]پطر)س|(?:2\.|۲)(?:\s*پطر\s*?|[-۔]پطر)س|2(?:\s*پطر\s*س|(?:\s*پطرس|Pet))|2[-۔]پطرس))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:paṭras\s*kā\s*pahlā\s*ʿām\s*ḫaṭ|پطر(?:\s*س\s*کاپہلا\s*عا\s*|س\s*کا\s*پہلا\s*عا)م\s*خط|اوّل(?:\s*پطر\s*?|[-۔]پطر)س|(?:1\.|۱)(?:\s*پطر\s*?|[-۔]پطر)س|1(?:\s*پطر\s*س|(?:\s*پطرس|Pet))|1[-۔]پطرس))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
