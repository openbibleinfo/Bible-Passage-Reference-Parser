...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = String.raw`(?:Premye|1|I)\.?\s*`;
    this.second = String.raw`(?:Dezy[èe]m|2|II)\.?\s*`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dezy[eè]m\s*(?:liv\s*Samy[eè]l\s*la|Samy[eè]l)|(?:II\.?\s*S|2\.\s*S)amy[eè]l|2(?:\s*Samy[eè]l|Sam)|2\s*Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Premye\s*(?:liv\s*Samy[eè]l\s*la|Samy[eè]l)|(?:1\.\s*S|I\.?\s*S)amy[eè]l|1(?:\s*Samy[eè]l|Sam)|1\s*Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dezy[eè]m\s*(?:liv\s*Wa\s*yo|Wa)|(?:II\.?\s*W|2\.?\s*W)a|2Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Premye\s*(?:liv\s*Wa\s*yo|Wa)|(?:1\.?\s*W|I\.?\s*W)a|1Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dezy[eè]m\s*(?:liv\s*Kwonik\s*la|Kwonik|Istwa)|(?:II\.?\s*K|2\.?\s*K)wonik|(?:(?:II\.?\s*I|2\.\s*I)|2\s*I)stwa|2\s*Ist|2Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Premye\s*(?:liv\s*Kwonik\s*la|Kwonik|Istwa)|(?:1\.?\s*K|I\.?\s*K)wonik|(?:(?:1\.\s*I|I\.?\s*I)|1\s*I)stwa|1\s*Ist|1Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Premye\s*Ja|(?:[1I]\.\s*Ja|(?:(?:1(?:\s*Ja|Joh)|1\s*J)|I\s*Ja)))n)(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dezy[eè]m\s*Jan|(?:(?:II|2)\.\s*Ja|(?:II\s*Ja|(?:2(?:\s*Ja|Joh)|2\s*J)))n))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:III\s*Ja|(?:3(?:\s*Ja|Joh)|3\s*J))n)(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))(J(?:oh|a?)n)(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dezy[eè]m\s*Kor(?:entyen|int)|(?:II|2)\.\s*Kor(?:entyen|int)|II\s*Kor(?:entyen|int)|2(?:\s*Korentyen|(?:(?:\s*Korint|Cor)|\s*Kor))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Premye\s*Kor(?:entyen|int)|[1I]\.\s*Kor(?:entyen|int)|1(?:\s*Korentyen|(?:(?:\s*Korint|Cor)|\s*Kor))|I\s*Kor(?:entyen|int)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dezy[eè]m\s*Tesalonik(?:yen)?|(?:II|2)\.\s*Tesalonik(?:yen)?|II\s*Tesalonik(?:yen)?|2\s*Tesalonik(?:yen)?|2(?:Thes|\s*Te)s))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Premye\s*Tesalonik(?:yen)?|[1I]\.\s*Tesalonik(?:yen)?|1\s*Tesalonik(?:yen)?|I\s*Tesalonik(?:yen)?|1(?:Thes|\s*Te)s))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dezy[eè]m\s*Timote|(?:II|2)\.\s*Timote|II\s*Timote|2\s*Timote|2\s*?Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Premye\s*Timote|[1I]\.\s*Timote|1\s*Timote|I\s*Timote|1\s*?Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dezy[eè]m\s*P[iy][eè]|(?:II|2)\.\s*P[iy][eè]|(?:II|2)\s*P[iy][eè]|2Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Premye\s*P[iy][eè]|[1I]\.\s*P[iy][eè]|[1I]\s*P[iy][eè]|1Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
...
function peg$parse(input, options) {
  ...
  var peg$e21 = peg$classExpectation(["è", "e"], false, true);
