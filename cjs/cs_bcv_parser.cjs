...
var bcv_regexps = class {
  constructor() {
    ...
    // The `titul` has `[a-z]` instead of `\w` because it could be followed by a number.
    // [a-e] allows `1:1a`.
    this.escaped_passage = /(?:^|[^\x1e\x1f\p{L}\p{N}])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s.:,;\x1e\x1f&\(\)（）\[\]\\/"'\*=~\-–—]|titul(?![a-z])|kapitola|kapitoly|ver[šs]e|kapitol|n(?!n)|kap|srv|nn|-|a|[a-e](?!\w)|$)+)/giu;
    ...
    this.match_end_split = /\d\W*titul|\d\W*n(?!n)(?:[\s*]*\.)?|\d\W*nn(?:[\s*]*\.)?|\d[\s*]*[a-e](?!\w)|\x1e(?:[\s*]*[)\]\uff09])?|[\d\x1f]/gi;
    this.control = /[\x1e\x1f]/g;
    // These are needed for ranges outside of this class.
    this.first = String.raw`(?:Prvn[íi]|1|I)\.?\s*`;
    this.second = String.raw`(?:Druh[áa]|Druh[ýy]|2|II)\.?\s*`;
    this.third = String.raw`(?:T[řr]et[íi]|3|III)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|(?:a|srv)|-)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prvn[ií]\s*(?:kniha\s*Moj[zž][ií][sš]ova|Moj[zž][ií][sš]ova)|[1I]\.\s*(?:kniha\s*Moj[zž][ií][sš]ova|Moj[zž][ií][sš]ova)|[1I]\s*(?:kniha\s*Moj[zž][ií][sš]ova|Moj[zž][ií][sš]ova)|G(?:(?:enesis|n)|en)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh[ayáý]\s*(?:kniha\s*Moj[zž][ií][sš]ova|Moj[zž][ií][sš]ova)|(?:II|2)\.\s*(?:kniha\s*Moj[zž][ií][sš]ova|Moj[zž][ií][sš]ova)|(?:II|2)\s*(?:kniha\s*Moj[zž][ií][sš]ova|Moj[zž][ií][sš]ova)|Ex(?:odus|(?:od)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bel"],
        testament: "a",
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:T[rř]et[ií]\s*(?:kniha\s*Moj[zž][ií][sš]ova|Moj[zž][ií][sš]ova)|(?:III|3)\.\s*(?:kniha\s*Moj[zž][ií][sš]ova|Moj[zž][ií][sš]ova)|(?:III|3)\s*(?:kniha\s*Moj[zž][ií][sš]ova|Moj[zž][ií][sš]ova)|L(?:(?:eviti(?:cusi|kus)|v)|ev(?:iticus)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:[CČ]tvrt[aá]\s*(?:kniha\s*Moj[zž][ií][sš]ova|Moj[zž][ií][sš]ova)|(?:IV|4)\.\s*(?:kniha\s*Moj[zž][ií][sš]ova|Moj[zž][ií][sš]ova)|(?:IV|4)\s*(?:kniha\s*Moj[zž][ií][sš]ova|Moj[zž][ií][sš]ova)|N(?:(?:umeri|m)|um?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Sir"],
        testament: "a",
      ...
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:P[aá]t[aá]\s*(?:kniha\s*Moj[zž][ií][sš]ova|Moj[zž][ií][sš]ova)|[5V]\.\s*(?:kniha\s*Moj[zž][ií][sš]ova|Moj[zž][ií][sš]ova)|[5V]\s*(?:kniha\s*Moj[zž][ií][sš]ova|Moj[zž][ií][sš]ova)|D(?:(?:euteronomium|t)|eut)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prvn[ií]\s*Ezdr[aá][sš]|[1I]\.\s*Ezdr[aá][sš]|[1I]\s*Ezdr[aá][sš]|1Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh[ayáý]\s*Ezdr[aá][sš]|(?:II|2)\.\s*Ezdr[aá][sš]|(?:II|2)\s*Ezdr[aá][sš]|2Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh[ayáý]\s*(?:kniha\s*Samuelova|S(?:amuelova|(?:am(?:uel)?)?))|(?:II|2)\.\s*(?:kniha\s*Samuelova|S(?:amuelova|(?:am(?:uel)?)?))|(?:II|2)\s*(?:kniha\s*Samuelova|S(?:amuelova|(?:am(?:uel)?)?))|2Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prvn[ií]\s*(?:kniha\s*Samuelova|S(?:amuelova|(?:am(?:uel)?)?))|[1I]\.\s*(?:kniha\s*Samuelova|S(?:amuelova|(?:am(?:uel)?)?))|[1I]\s*(?:kniha\s*Samuelova|S(?:amuelova|(?:am(?:uel)?)?))|1Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh[ayáý]\s*(?:kniha\s*kr[aá]lovsk[aá]|Kr[aá]lovsk[aá]|Kr(?:[aá]l)?)|(?:II|2)\.\s*(?:kniha\s*kr[aá]lovsk[aá]|Kr[aá]lovsk[aá]|Kr(?:[aá]l)?)|(?:II|2)\s*(?:kniha\s*kr[aá]lovsk[aá]|Kr[aá]lovsk[aá]|Kr(?:[aá]l)?)|2Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prvn[ií]\s*(?:kniha\s*kr[aá]lovsk[aá]|Kr[aá]lovsk[aá]|Kr(?:[aá]l)?)|[1I]\.\s*(?:kniha\s*kr[aá]lovsk[aá]|Kr[aá]lovsk[aá]|Kr(?:[aá]l)?)|[1I]\s*(?:kniha\s*kr[aá]lovsk[aá]|Kr[aá]lovsk[aá]|Kr(?:[aá]l)?)|1Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh[ayáý]\s*(?:Paralipomenon|kniha\s*kronik|Letopis[uů]|Kronik|Kron|Pa)|(?:II|2)\.\s*(?:Paralipomenon|kniha\s*kronik|Letopis[uů]|Kronik|Kron|Pa)|(?:II|2)\s*(?:Paralipomenon|kniha\s*kronik|Letopis[uů]|Kronik|Kron|Pa)|2Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prvn[ií]\s*(?:Paralipomenon|kniha\s*kronik|Letopis[uů]|Kronik|Kron|Pa)|[1I]\.\s*(?:Paralipomenon|kniha\s*kronik|Letopis[uů]|Kronik|Kron|Pa)|[1I]\s*(?:Paralipomenon|kniha\s*kronik|Letopis[uů]|Kronik|Kron|Pa)|1Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["GkEsth"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ester\s*(?:\(řecké\s*(?:dodatky|části)\)|[rř]eck[eé]\s*(?:dodatky|[cč][aá]sti))|GkEsth))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Esth"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prvn[ií]\s*(?:list\s*Jan[uů]v|J(?:anova|(?:an)?)|Jan[uů]v)|[1I]\.\s*(?:list\s*Jan[uů]v|J(?:anova|(?:an)?)|Jan[uů]v)|[1I]\s*(?:list\s*Jan[uů]v|J(?:anova|(?:an)?)|Jan[uů]v)|1John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh[ayáý]\s*(?:list\s*Jan[uů]v|J(?:anova|(?:an)?)|Jan[uů]v)|(?:II|2)\.\s*(?:list\s*Jan[uů]v|J(?:anova|(?:an)?)|Jan[uů]v)|(?:II|2)\s*(?:list\s*Jan[uů]v|J(?:anova|(?:an)?)|Jan[uů]v)|2John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:T[rř]et[ií]\s*(?:list\s*Jan[uů]v|J(?:anova|(?:an)?)|Jan[uů]v)|(?:III|3)\.\s*(?:list\s*Jan[uů]v|J(?:anova|(?:an)?)|Jan[uů]v)|(?:III|3)\s*(?:list\s*Jan[uů]v|J(?:anova|(?:an)?)|Jan[uů]v)|3John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Evangelium\s*podle\s*Jana|J(?:(?:anovo\s*evangelium|ohn)|(?:an)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh[ayáý](?:\s*(?:list\s*Korin(?:tsk[yý]m|sk[yý]m)|K(?:orintsk[yý]m)?)|K)|(?:II|2)\.(?:\s*(?:list\s*Korin(?:tsk[yý]m|sk[yý]m)|K(?:orintsk[yý]m)?)|K)|II\s*(?:list\s*Korin(?:tsk[yý]m|sk[yý]m)|K(?:orintsk[yý]m)?)|2\s*list\s*Korin(?:tsk[yý]m|sk[yý]m)|2\s*Korintsk[yý]m|2(?:\s*K(?:or)?|K)|2[CK]or|IIK))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prvn[ií](?:\s*(?:list\s*Korin(?:tsk[yý]m|sk[yý]m)|K(?:orintsk[yý]m|(?:or)?))|K)|[1I]\.(?:\s*(?:list\s*Korin(?:tsk[yý]m|sk[yý]m)|K(?:orintsk[yý]m|(?:or)?))|K)|[1I]\s*(?:list\s*Korin(?:tsk[yý]m|sk[yý]m)|K(?:orintsk[yý]m|(?:or)?))|1(?:Cor|K)|IK))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh[ayáý]\s*(?:list\s*(?:Tesalonick[yý]m|Solu[nň]sk[yý]m)|(?:Tessalonicens|Solu[nň]s)k[yý]m|Tesalonick[yý]m|Sol|Te)|(?:II|2)\.\s*(?:list\s*(?:Tesalonick[yý]m|Solu[nň]sk[yý]m)|(?:Tessalonicens|Solu[nň]s)k[yý]m|Tesalonick[yý]m|Sol|Te)|(?:II|2)\s*(?:list\s*(?:Tesalonick[yý]m|Solu[nň]sk[yý]m)|(?:Tessalonicens|Solu[nň]s)k[yý]m|Tesalonick[yý]m|Sol|Te)|2Thess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prvn[ií]\s*(?:list\s*(?:Tesalonick[yý]m|Solu[nň]sk[yý]m)|(?:Tessalonicens|Solu[nň]s)k[yý]m|Tesalonick[yý]m|Sol|Te)|[1I]\.\s*(?:list\s*(?:Tesalonick[yý]m|Solu[nň]sk[yý]m)|(?:Tessalonicens|Solu[nň]s)k[yý]m|Tesalonick[yý]m|Sol|Te)|[1I]\s*(?:list\s*(?:Tesalonick[yý]m|Solu[nň]sk[yý]m)|(?:Tessalonicens|Solu[nň]s)k[yý]m|Tesalonick[yý]m|Sol|Te)|1Thess))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh[ayáý]\s*(?:list\s*Tim(?:otej?|etej)ovi|T(?:imotejovi|(?:imoteovi|(?:(?:imoteus|m)|im))))|(?:II|2)\.\s*(?:list\s*Tim(?:otej?|etej)ovi|T(?:imotejovi|(?:imoteovi|(?:(?:imoteus|m)|im))))|(?:II|2)\s*(?:list\s*Tim(?:otej?|etej)ovi|T(?:imotejovi|(?:imoteovi|(?:(?:imoteus|m)|im))))|2Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prvn[ií]\s*(?:list\s*Tim(?:otej?ovi|eteovi)|T(?:imotejovi|(?:imoteovi|(?:(?:imoteus|m)|im))))|[1I]\.\s*(?:list\s*Tim(?:otej?ovi|eteovi)|T(?:imotejovi|(?:imoteovi|(?:(?:imoteus|m)|im))))|[1I]\s*(?:list\s*Tim(?:otej?ovi|eteovi)|T(?:imotejovi|(?:imoteovi|(?:(?:imoteus|m)|im))))|1Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh[ayáý]\s*(?:list\s*Petr[uů]v|P(?:(?:etrova|t)|(?:etr)?)|Petr[uů]v)|(?:II|2)\.\s*(?:list\s*Petr[uů]v|P(?:(?:etrova|t)|(?:etr)?)|Petr[uů]v)|(?:II|2)\s*(?:list\s*Petr[uů]v|P(?:(?:etrova|t)|(?:etr)?)|Petr[uů]v)|2Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prvn[ií]\s*(?:list\s*Petr[uů]v|P(?:(?:etrova|t)|(?:etr)?)|Petr[uů]v)|[1I]\.\s*(?:list\s*Petr[uů]v|P(?:(?:etrova|t)|(?:etr)?)|Petr[uů]v)|[1I]\s*(?:list\s*Petr[uů]v|P(?:(?:etrova|t)|(?:etr)?)|Petr[uů]v)|1Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druh[ayáý]\s*Mak(?:abejsk[aá])?|(?:II|2)\.\s*Mak(?:abejsk[aá])?|(?:II|2)\s*Mak(?:abejsk[aá])?|2Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:T[rř]et[ií]\s*Mak(?:abejsk[aá])?|(?:III|3)\.\s*Mak(?:abejsk[aá])?|(?:III|3)\s*Mak(?:abejsk[aá])?|3Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:[CČ]tvrt[aá]\s*Mak(?:abejsk[aá])?|(?:IV|4)\.\s*Mak(?:abejsk[aá])?|(?:IV|4)\s*Mak(?:abejsk[aá])?|4Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Prvn[ií]\s*Mak(?:abejsk[aá])?|[1I]\.\s*Mak(?:abejsk[aá])?|[1I]\s*Mak(?:abejsk[aá])?|1Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      }
    ];
  }
};
...
function peg$parse(input, options) {
  ...
  var peg$e19 = peg$classExpectation([["a", "e"]], false, false);
  var peg$e20 = peg$literalExpectation("kap", false);
  var peg$e21 = peg$literalExpectation("itola", false);
  var peg$e22 = peg$literalExpectation("itoly", false);
  var peg$e23 = peg$literalExpectation("itol", false);
  var peg$e24 = peg$literalExpectation("ver", false);
  var peg$e25 = peg$classExpectation(["š", "s"], false, true);
  ...
  var peg$e30 = peg$literalExpectation("a", false);
  var peg$e31 = peg$literalExpectation("srv", false);
  var peg$e32 = peg$classExpectation(["-", "–", "—"], false, false);
  var peg$e33 = peg$literalExpectation("titul", false);
