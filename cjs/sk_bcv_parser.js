...
var grammar_options = {
  ab: /^(?:[b-e])(?!\p{L})/iu,
  and: /^(?:porov|pozri|alebo|a|&)/i,
  c_explicit: /^[\s*]*(?:kapitoly|kapitole|kapitolu|kapitol|hlavy|kap\.?)[\s*]*/i,
  ...
  range: /^[\s*]*(?:[\-–—]|a[žz]|-)+[\s*]*/i,
  sequence_eu: /^(?:[;/:&\-–—~\s*]|\.(?!\s*\.\s*\.)|porov|pozri|alebo|a)+/i,
  sequence_us: /^(?:[,;/:&\-–—~\s*]|\.(?!\s*\.\s*\.)|porov|pozri|alebo|a)+/i,
  space: /^[\s*]+/,
  title: /^[\s*]*(?:title)(?!\p{L})[\s*]*/iu,
  v_explicit: /^[\s*]*(?:ver[šs]ov)[\s*]*(?!\p{L})/iu
};
