  ...
  constructor() {
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:P(?:(?:(?:edai(?:yesh|s)|ed(?:aa)?yes)|edaiyes)h|edaiyishe|ida(?:ay(?:ishe|esh)|(?:(?:iy[ei]|ye)|i)sh))|pedāyesh|پ(?:یدا(?:يشه|(?:ی[ثسشچژ]|ىش|ش))|یدا(?:(?:یى|ىی)|يی)ش|يدا(?:يشه|ي?یش))|پ(?:ید(?:ايش|(?:ای?)?)|يدايش)|pedāy?|Gen))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:La(?:(?:vvyi|(?:v[ay]y|w(?:[ae]y|ya|i)|vi))|awi)an|ل(?:او(?:ی(?:ان[نهی]|ین|ت)|(?:ی(?:ان)?)?)|ا(?:و(?:ی[ای]ا|يا)|(?:و[ئو]|ؤ)یا|[ءئ]ویا)ن|وی(?:ان)?)|l(?:awi(?:ān|y)|eviy)|lawi?|Lev))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
      ...
      },
      {
        osis: ["Josh"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Y(?:osh(?:uah|a)|o(?:shu['’]|sh['’]u|wshu)a|ushu?a)|yūsh['’](?:ai|a|ā)|Yoshua|یو(?:ش(?:ع[عهوی]|[ئهوی]ع|ا)|وش[اع])|یوشع?|Josh))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Judg"],
        testament: "o",
      ...
      },
      {
        osis: ["Ruth"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:R(?:oot[eh]|ut[hi])|rūth?ī|R(?:oo|u)t|rūth|ر(?:و(?:(?:ت[اتـهی]|[ثط])|ت)|ۆت)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Esd"],
        testament: "a",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:dovvom\s*samu['’]ī|2Samo(?:w(?:ey|i)|ue)|2Samu[ei])l|Do(?:(?:vom(?:\s*[Ss]|s)|s)am(?:(?:(?:o(?:w(?:ey|i)|ue)|u[ei])|(?:u['w’]|oe)i)l|w[ei]il)|(?:vomSam(?:o(?:w(?:ey|i)|ue)|u[ei])|vomSam(?:u['w’]|oe)i)l|vomSamw[ei]il|\s*sam(?:(?:(?:o(?:w(?:ey|i)|ue)|u[ei])|(?:u['w’]|oe)i)l|w[ei]il))|دو(?:م?\s*سم(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل)|مس(?:م(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل))?|سم(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل))|2\s*Sam(?:(?:(?:o(?:w(?:ey|i)|ue)|u[ei])|(?:u['w’]|oe)i)l|w[ei]il)|۲\s*سم(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل)|DovomSam|2Sam(?:u['w’]|oe)il|2Samw[ei]il|۲سموئ(?:یل[ہی]|ل)|۲سمو(?:(?:ئ(?:یی|ي)|یی)|ای)ل|۲سم(?:(?:وئئ|(?:وء|ؤ))|وائ)یل|۲سموئیل|dovvoms|۲سمئویل|۲(?:س(?:مویل|امو)|sā?mu)|۲(?:سم(?:وی?)?|sm)|2Sam|2(?:sm|سم)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Avval(?:\s*[Ss]|s)|1\s*S)am(?:(?:(?:o(?:w(?:ey|i)|ue)|u[ei])|(?:u['w’]|oe)i)l|w[ei]il)|(?:avval\s*samu['’]ī|(?:Avval|1)Samo(?:w(?:ey|i)|ue)|(?:Avval|1)Samu[ei])l|(?:(?:Avval|1)Samu['w’]|(?:Avval|1)Samoe)il|(?:Avval|1)Samw[ei]il|Yek(?:\s*sam(?:(?:(?:o(?:w(?:ey|i)|ue)|u[ei])|(?:u['w’]|oe)i)l|w[ei]il)|sam(?:(?:(?:o(?:w(?:ey|i)|ue)|u[ei])|(?:u['w’]|oe)i)l|w[ei]il))|(?:اول|۱)\s*سم(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل)|اولسم(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل)|یک(?:\s*سم(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل)|سم(?:و(?:(?:ئ(?:یل[ہی]|ل)|یل)|ئیل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل))|AvvalSam|۱سموئ(?:یل[ہی]|ل)|۱سمو(?:(?:ئ(?:یی|ي)|یی)|ای)ل|۱سم(?:(?:وئئ|(?:وء|ؤ))|وائ)یل|۱سموئیل|۱سمئویل|۱(?:س(?:مویل|امو)|sā?mu)|avvals|۱(?:سم(?:وی?)?|sm)|1Sam|اولس|1(?:sm|سم)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Do(?:(?:vom(?:\s*[Pp]|[Pp])|p)ad(?:(?:eshahna|(?:eshah[ao]|shah[ao]))|ishaha)n|\s*pad(?:(?:eshahna|(?:eshah[ao]|shah[ao]))|ishaha)n|vomKgs)|2\s*?Pad(?:(?:eshahna|(?:eshah[ao]|shah[ao]))|ishaha)n|دو(?:م?\s*پادش(?:اه(?:اان|(?:ا?ن|ا))|هان)|مپ(?:ادش(?:اه(?:اان|(?:ا?ن|ا))|هان))?|پادش(?:اه(?:اان|(?:ا?ن|ا))|هان))|۲\s*پادش(?:اه(?:اان|(?:ا?ن|ا))|هان)|۲پادشاهاان|۲پادشاها?ن|۲(?:پادشاها|(?:پا(?:دش?)?|pād?))|۲پادشهان|۲pādsh|2(?:pād|پاد)|2Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Avval(?:\s*[Pp]|[Pp])|1\s*?P)ad(?:(?:eshahna|(?:eshah[ao]|shah[ao]))|ishaha)n|Yek(?:\s*pad(?:(?:eshahna|(?:eshah[ao]|shah[ao]))|ishaha)n|pad(?:(?:eshahna|(?:eshah[ao]|shah[ao]))|ishaha)n)|(?:اول|۱)\s*پادش(?:اه(?:اان|(?:ا?ن|ا))|هان)|اولپادش(?:اه(?:اان|(?:ا?ن|ا))|هان)|یک(?:\s*پادش(?:اه(?:اان|(?:ا?ن|ا))|هان)|پادش(?:اه(?:اان|(?:ا?ن|ا))|هان))|۱پادشاهاان|۱پادشاها?ن|۱پادشاها|AvvalKgs|۱پادشهان|۱pādsh|۱(?:پا(?:دش?)?|pād?)|اولپ|1(?:pād|پاد)|1Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:dovvom\s*tawārikh|Do(?:(?:vom(?:\s*[Tt]|T)|T)(?:(?:(?:owar[iy]|owri)|oari)|awari)kh|\s*t(?:(?:(?:owar[iy]|owri)|oari)|awari)kh|vomChr)|دو(?:م?\s*توار(?:ی(?:که?|خ)|ي?خ)|مت(?:وار(?:ی(?:که?|خ)|ي?خ))?|توار(?:ی(?:که?|خ)|ي?خ))|2\s*?T(?:(?:(?:owar[iy]|owri)|oari)|awari)kh|۲\s*توار(?:ی(?:که?|خ)|ي?خ)|۲تواریکه?|۲(?:towāri|تواری?خ)|dovvomt|۲تواريخ|۲(?:tow(?:ār)?|تو(?:ا(?:ری?)?)?)|2(?:tawā|توا)|2Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:avval\s*tawārikh|(?:Avval(?:\s*[Tt]|[Tt])|1\s*?T)(?:(?:(?:owar[iy]|owri)|oari)|awari)kh|Yek(?:\s*t(?:(?:(?:owar[iy]|owri)|oari)|awari)kh|t(?:(?:(?:owar[iy]|owri)|oari)|awari)kh)|(?:اول|۱)\s*توار(?:ی(?:که?|خ)|ي?خ)|اولتوار(?:ی(?:که?|خ)|ي?خ)|یک(?:\s*توار(?:ی(?:که?|خ)|ي?خ)|توار(?:ی(?:که?|خ)|ي?خ))|AvvalChr|۱تواریکه?|۱(?:towāri|تواری?خ)|۱تواريخ|۱(?:tow(?:ār)?|تو(?:ا(?:ری?)?)?)|avvalt|1(?:tawā|توا)|اولت|1Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ع(?:ِ(?:\s*(?:زر(?:اء|ا|ه)|ذرا)|زر(?:اء|ا|ه)|ذرا)|\s*(?:زر(?:اء|ا|ه)|ذرا)|زر(?:ا[ءی]|ه)|زرا?|ذرا)|[EI]zra(?:\s*[ah]|[ah])|ezrāy|ezrā?|[EI]zra))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Neh"],
        testament: "o",
      ...
      },
      {
        osis: ["Esth"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Est(?:(?:he|h?)r|eh?r)|esterh|ا(?:ِ(?:ستره?|س(?:ت[ـَ]|[طٹ])ر|\s*ستر)|ست(?:(?:ره|ر?)|ِر))|ester|Esth|ast))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Job"],
        testament: "o",
      ...
      },
      {
        osis: ["Prov"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(امثل\s*ل|(?:Am(?:\s*(?:thal[es]|sale)|thal(?:eh|[ls])|sal)|a(?:['’]mthāli|msāl)|Am(?:\s*(?:th|s)al|thale?)|a['’]mthāl?|Am(?:th(?:a[ae]|e)|saa)l|ام(?:ث(?:ل(?:اء?ل|[له])|الل)|ث(?:ل(?:اء?)?|ال|ا)?|ث(?:اا|ـا|آ)ل|صا?ل|ت)|hikmāt|hikmā?|Prov))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Eccl"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:kolliyāt|jāme['’]eh|Jam(?:(?:\s*ae|(?:ai|[3a]a))h|(?:a['’]|['’])a[ht])|Jam(?:\s*ae|(?:a['’]|['’])a|[3a]a)|جام(?:ع(?:ه[ـهی]|[اۀہ])|ع[\s*ـی]ه|ـعه|[هہ]ع)|jām(?:e['’])?|جام(?:عه?)?|کلیات|Eccl))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["SgThree"],
        testament: "a",
      ...
      },
      {
        osis: ["Song"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ghaz(?:al(?:(?:\s*Ghazalha|(?:\s*Ghazal_|Ghazal)h)aa|_Ghazal(?:_haa|haa?|-?ha)|\s*Ghazalhaa?|(?:\s*Ghazal_|Ghazal)ha|(?:(?:\s*Ghazal[\s*-]|-?Ghazal-?|Ghazal[\s*-_])|-?Ghazal)ha)|(?:l\s*Ghazalha|l(?:\s*Ghazal_|Ghazal)h)aa|l_Ghazal(?:_haa|haa?|-?ha)|l\s*Ghazalhaa?|l(?:\s*Ghazal_|Ghazal)ha|(?:l(?:(?:\s*Ghazal-?|Ghazal[-_])|-?Ghazal-?)|l-?Ghazal)ha)|غزل(?:ۀ?\s*غزلۀ\s*ها|\s*غزل\s*?هاا|غزل\s*هاا|(?:ۀ\s*)?غزلها|‌غزل‌ها|یات|ه)|غزل(?:\s*غزل\s*?ها|غزل\s*ها|غ|ی)?|shīr(?:āy|i)|shīrā?|So(?:ng|l)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jer"],
        testament: "o",
      ...
      },
      {
        osis: ["Ezek"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ح(?:ِز(?:قیی?ائله|قی(?:(?:الله|(?:(?:(?:ال[هی]|یل)|لی)|ئل))|یاله)|کی(?:ا(?:ل(?:له|ی)|ئله)|لی|ئل)|(?:ق(?:(?:یا[\s*اي]|ا)|یئا)|ک(?:ی(?:ئا|اي)|ا))ل|کییال|ِقیال)|ز(?:(?:قیا[ئي]|کی(?:ا[ئي]|ئ))|قیئا)ل|ز[قک]ییال|ز(?:(?:قیا?|کیا)ل|قیئل))|Hiz(?:(?:kiya[ei]|kiya)lh|q(?:iy(?:a(?:(?:lha|[aei]lh)|(?:lh?|[aei]l))|aha?l|['’]aa?l|a['’]l)|(?:eya[ei]|eya)l)|(?:kiya[ei]|kiya)l)|ح(?:ِز(?:قیی?ائل|قی(?:یال|(?:ال?|ل))|کی(?:ائ?ل|ل))|زقی?)|hazqiāl|hazqīl|hazqī?|Ezek))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Dan"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Dani?ya(?:[ei]lh|l)|دان(?:یائل(?:له|[هی])|ي(?:ا(?:ئل(?:له|[هی])|ل(?:له|ی))|ئل(?:له|ی)|ائ?ل|ايل|یا?ل|ئل|لی)|ی[ئا]لله|یائل|(?:ی[ئا]|ی)لی|یايل|ییا?ل|ی[ئا]ل|ی(?:ا|ل)?)?|Dan(?:i?ya[ei]l)?|Dan(?:i?y(?:ah|e)|ie)l|dān(?:iā|ī)l|dānī?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hos"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:H(?:osha?eah|ush(?:ae|ea)h)|hosh['’]ai|H(?:os(?:(?:hae)?|hea?)|ush(?:ae?|ea?))|hosh(?:['’]a)?|هوش(?:ع(?:ع?ه|لل|یی)|[؏ا]عع?|ئعع?|ع(?:ع|ل|ی)?|؏ه|؏|ا)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Joel"],
        testament: "o",
      ...
      },
      {
        osis: ["Amos"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:عام(?:و(?:و(?:س(?:(?:س(?:یی|[هہ])|ی[ہی]|[ـهہ])|(?:س|ی)?)|و(?:س(?:(?:سس|یی|[هہ])|(?:س|ی)?)|وسہ))|س(?:سیی|(?:س[سه]|یہ|[ـهہ]))|سییہ|سسی|س(?:س|ی)?)?|س)?|A(?:amo(?:oo?se|use|s[es]|es)|mo(?:oo|u)s|moose|mose)|A(?:amo(?:oo?s|s)|mos)|āmūsī|ām(?:ūs)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Obad"],
        testament: "o",
      ...
      },
      {
        osis: ["Mic"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:M(?:ik(?:ahah|ha)|i(?:ka|c)aha|y(?:kaha|cah))|م(?:یک(?:ا(?:ه(?:ئی|ی[هی]|[ءةـوِہ])|ئ[هہ]|ہ[ئاهوی]|[ةۂی])|ه)|یکا[ءاِ]ه|یكاه|ي[كک]اه)|mīkhā(?:yā?)?|M(?:i(?:ka|c)ah|i(?:kah?|c)|ykah)|میک(?:اه?)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Nah"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ن(?:اح(?:(?:(?:وم(?:ی(?:ی(?:یه|[ءئه])|ائ[هہ]|ئی|ہ[ئاه]|[ءةهۂ])|ائ[هہ]|وو|ئی|ہ[ئاه]|[ءةـهۂ])|م)|(?:و(?:م(?:ی(?:ئ|ہ|ی)?|ا|و|ئ|ہ)?)?)?)|ووم)|حوم)|Na(?:h(?:umme|om)|ah(?:o?u|o)m|h[ou]um)|nāhūmi|Nah(?:um)?|nāhūm?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hab"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ح(?:َب(?:َق(?:و(?:ق(?:ی(?:ی(?:یه|[ءئه])|ائ[هہ]|ئی|ہ[ئاه]|[ءةهۂ])|ائ[هہ]|وو|ئی|ہ[ئاه]|[ءةـهۂ])|ق(?:ی(?:ئ|ہ|ی)?|ا|و|ئ|ہ)?|وق|ک)|ق)|قوق)|بق(?:(?:وق|ا)|و?))|Hab(?:a(?:kk?o|co)ok|ba(?:c(?:ook|uc)|k(?:kuc|ook|u[ck]))|akk?u[ck]|acuc)|habaqūq|habaqū?|Hab))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Zeph"],
        testament: "o",
      ...
      },
      {
        osis: ["Hag"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ح(?:َج(?:َّی(?:ہ?ئ[ةۀ-ۂ]|ہ[ءةۀۂ]|اء|ہ|[ءة])?|ّی)|ج(?:(?:(?:ییی|ـی|ا)|ّی)|(?:یی?|ـ)))|hajj(?:īyy|ā)|hajjīy?|Hag(?:g(?:a[iy]|[iy])|a[iy]|i)|Hag))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Zech"],
        testament: "o",
      ...
      },
      {
        osis: ["Acts"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))(Amal-?e-?Rusul|(?:A(?:ma(?:al(?:\s*(?:e\s*)?|-?e-?)Rusule|l-?e-?Rusule)en|['’]ma(?:l(?:\s*e\s*Rusul(?:ee|a)n|-?e-?Rusul(?:ee|a)n|e)|al(?:\s*e\s*|-?e-?)Rusul)|ma(?:al(?:\s*(?:e\s*)?|-?e-?)Rusula|l-?e-?Rusula)n|mal\s*e\s*Rusul(?:ee|a)n|ma(?:ale|l[ei])|cts)|اعم(?:(?:ال\s*(?:الرسولی|رسول[ای])|الی\s*رسولا)ن|ل(?:\s*رسولان|ی))|A(?:['’]ma(?:l(?:\s*e\s*Rusul|-?e-?Rusul)?|al)|ma(?:l\s*e\s*Rusul|a?l))|اعم(?:ا(?:ل(?:\s*الرسول|ی)?)?|ل)?|اعما?لها|a['’]mālī|عم(?:ال(?:ها|ی)?|ل(?:ها|ی)?)|a['’]m(?:āl)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mal"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:M(?:a(?:(?:la(?:aki[ei]|k(?:e[ey]|i[ei]))|alaki[ei])|lachi)|al['’]aaki|[ei]laki)|mal['’](?:ākh[iī]|a)|Ma(?:l(?:aaki|(?:aki)?)|alaki)|م(?:َل(?:اک(?:یی|ی|[ىيے])|کي|كی|ك)|ل(?:(?:اکیه|ک[ىیے])|ا(?:کی?)?))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Matt"],
        testament: "n",
      ...
      },
      {
        osis: ["Luke"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:L(?:o(?:oqa(?:at|h)|[kq]aa[ht])|u(?:k(?:aah|e)|qa(?:at|h)))|L(?:o(?:oqaa?|[kq]a)|u(?:qaa?|ka))|لو(?:ق(?:(?:ا(?:ءه|[تهی])|[آةهىی])|(?:اء?)?)|[كک](?:ا[ءه]|ا|ة))|lūqān|lūqā?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Avval|[1۱])\s*Y(?:o(?:ohan(?:aah|na)|han[an]ah)|uhan[an]ah)|(?:(?:Avval|[1۱])Y|Yek\s*?Y)(?:o(?:ohan(?:aah|na)|han[an]ah)|uhan[an]ah)|(?:Avval|[1۱])\s*Y(?:o(?:ohana|hann?a)|uhann?a)|avv(?:al\s*yohannā|lyo)|اول(?:\s*Y(?:o(?:ohan(?:aah|na)|han[an]ah)|uhan[an]ah)|Y(?:o(?:ohan(?:aah|na)|han[an]ah)|uhan[an]ah))|(?:(?:(?:Avval|[1۱])\s*|Avval)|اول\s*)یو[حه]ن(?:ا(?:ءه|[ته])|اء?|[آةهىی])|(?:(?:Avval|[1۱])Y|Yek\s*?Y)(?:o(?:ohana|hann?a)|uhann?a)|اول(?:\s*Y(?:o(?:ohana|hann?a)|uhann?a)|Y(?:o(?:ohana|hann?a)|uhann?a)|یو)|(?:اولیو[حه]|۱یوه|1یو[حه])ن(?:ا(?:ءه|[ته])|اء?|[آةهىی])|یک(?:\s*یو[حه]ن(?:ا(?:ءه|[ته])|اء?|[آةهىی])|یو[حه]ن(?:ا(?:ءه|[ته])|اء?|[آةهىی]))|AvvalJohn|۱یوحنا(?:ءه|[ته])|۱یوحناء?|۱(?:یوحن[آةهىی]|yohn)|۱(?:یو(?:حن?)?|yoh?)|1John|1یو|1yo))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Dovom|[2۲])\s*Y(?:o(?:ohan(?:aah|na)|han[an]ah)|uhan[an]ah)|dovvom(?:\s*yohannā|yo)|(?:Do(?:vom|\s*?)Y|[2۲]Y)(?:o(?:ohan(?:aah|na)|han[an]ah)|uhan[an]ah)|(?:Dovom|[2۲])\s*Y(?:o(?:ohana|hann?a)|uhann?a)|(?:(?:Dovom|[2۲])\s*|Dovom)یو[حه]ن(?:ا(?:ءه|[ته])|اء?|[آةهىی])|دو(?:م(?:(?:\s*Y(?:o(?:ohan(?:aah|na)|han[an]ah)|uhan[an]ah)|Y(?:o(?:ohan(?:aah|na)|han[an]ah)|uhan[an]ah))|(?:\s*Y(?:o(?:ohana|hann?a)|uhann?a)|Y(?:o(?:ohana|hann?a)|uhann?a)|یو))|(?:م\s*)?یو[حه]ن(?:ا(?:ءه|[ته])|اء?|[آةهىی])|میو[حه]ن(?:ا(?:ءه|[ته])|اء?|[آةهىی])|\s*یو[حه]ن(?:ا(?:ءه|[ته])|اء?|[آةهىی]))|(?:Do(?:vom|\s*?)Y|[2۲]Y)(?:o(?:ohana|hann?a)|uhann?a)|DovomJohn|۲یوحنا(?:ءه|[ته])|(?:۲یوه|2یو[حه])ن(?:ا(?:ءه|[ته])|اء?|[آةهىی])|۲یوحناء?|۲(?:یوحن[آةهىی]|yohn)|۲(?:یو(?:حن?)?|yoh?)|2John|2یو|2yo))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Se(?:vom(?:\s*Y(?:o(?:ohan(?:aah|na)|han[an]ah)|uhan[an]ah)|Y(?:o(?:ohan(?:aah|na)|han[an]ah)|uhan[an]ah))|h(?:\s*Y(?:o(?:ohan(?:aah|na)|han[an]ah)|uhan[an]ah)|Y(?:o(?:ohan(?:aah|na)|han[an]ah)|uhan[an]ah))|\s*Y(?:o(?:ohan(?:aah|na)|han[an]ah)|uhan[an]ah)|Y(?:o(?:ohan(?:aah|na)|han[an]ah)|uhan[an]ah))|sevvom(?:\s*yohannā|yo)|Se(?:vom(?:\s*Y(?:o(?:ohana|hann?a)|uhann?a)|Y(?:o(?:ohana|hann?a)|uhann?a))|h(?:\s*Y(?:o(?:ohana|hann?a)|uhann?a)|Y(?:o(?:ohana|hann?a)|uhann?a))|\s*Y(?:o(?:ohana|hann?a)|uhann?a)|Y(?:o(?:ohana|hann?a)|uhann?a))|(?:3\s*?Y|۳\s*?Y)(?:o(?:ohan(?:aah|na)|han[an]ah)|uhan[an]ah)|س(?:وم\s*یو[حه]ن(?:ا(?:ءه|[ته])|اء?|[آةهىی])|ومیو[حه]ن(?:ا(?:ءه|[ته])|اء?|[آةهىی])|ه(?:\s*یو[حه]ن(?:ا(?:ءه|[ته])|اء?|[آةهىی])|یو[حه]ن(?:ا(?:ءه|[ته])|اء?|[آةهىی]))|ومیو)|(?:3\s*?Y|۳\s*?Y)(?:o(?:ohana|hann?a)|uhann?a)|[3۳]\s*یو[حه]ن(?:ا(?:ءه|[ته])|اء?|[آةهىی])|۳یوحنا(?:ءه|[ته])|(?:۳یوه|3یو[حه])ن(?:ا(?:ءه|[ته])|اء?|[آةهىی])|۳یوحناء?|۳(?:یوحن[آةهىی]|yohn)|۳(?:یو(?:حن?)?|yoh?)|3John|3یو|3yo))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Y(?:o(?:ohan(?:aah|na)|han[an]ah)|uhan[an]ah)|(?:yohannā|Joh)n|yo(?:hannā)?|Y(?:o(?:ohana|hann?a)|uhann?a)|یو(?:ح(?:ن(?:اءه|(?:ا[تهی]|[آةهىی]))|(?:ناء|(?:نا?)?))|هن(?:ا(?:ءه|[ته])|اء?|[آةهىی]))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Rom"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:روم(?:ی(?:ان(?:ی?ان|ها|ن)|ون(?:ی?ان|ها|ن))|ی(?:ان(?:ه|ی)?|ون(?:ه|ی)?|ا)?|ي(?:ان(?:[هی])?|ون[هی]))?|R(?:oomi(?:ya|[au])n|(?:o(?:ome|my)a|omi[au])n|umi(?:ya|[au])n)|rūm(?:iān)?ī|rūm(?:iān)?|Rom))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Do(?:(?:vom)?\s*Corinth?ians|(?:(?:vom)?\s*|(?:vom)?)Qorint(?:h(?:iy?a|yu)n|(?:iy?a|yu)n)|vomCorinth?ians|(?:(?:vom)?\s*|(?:vom)?)Korinth?ian|Corinth?ians)|Do(?:(?:vom)?\s*Corinth(?:ian)?|vomCor(?:inth(?:ian)?)?|Corinth(?:ian)?)|دو(?:م?\s*قرنت(?:ی[او]ن(?:ی?ان|ها|ه|ی|ن)?|يان)|مق(?:رنت(?:ی[او]ن(?:ی?ان|ها|ه|ی|ن)?|يان))?|قرنت(?:ی[او]ن(?:ی?ان|ها|ه|ی|ن)?|يان))|2\s*Corinth?ians|2\s*?Qorint(?:h(?:iy?a|yu)n|(?:iy?a|yu)n)|2\s*Corinth(?:ian)?|2Corinth?ians|2\s*?Korinth?ian|۲\s*قرنت(?:ی[او]ن(?:ی?ان|ها|ه|ی|ن)?|يان)|2Corinth(?:ian)?|۲قرنتی[او]ن(?:ی?ان|ها|ه|ی|ن)?|۲قرنتيان|۲(?:قر(?:نت?)?|qrn?)|۲qrnt|2Cor|2(?:qr|قر)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Avval|1)\s*Corinth?ians|(?:(?:Avval|1)\s*|(?:Avval|1))Qorint(?:h(?:iy?a|yu)n|(?:iy?a|yu)n)|(?:Avval|1)\s*Corinth(?:ian)?|(?:Avval|1)Corinth?ians|(?:(?:Avval|1)\s*|(?:Avval|1))Korinth?ian|(?:Avval|1)Corinth(?:ian)?|Yek(?:\s*Corinth?ians|\s*?Qorint(?:h(?:iy?a|yu)n|(?:iy?a|yu)n)|Corinth?ians|\s*?Korinth?ian)|Yek(?:\s*Corinth(?:ian)?|Corinth(?:ian)?)|(?:اول|۱)\s*قرنت(?:ی[او]ن(?:ی?ان|ها|ه|ی|ن)?|يان)|اولقرنت(?:ی[او]ن(?:ی?ان|ها|ه|ی|ن)?|يان)|یک(?:\s*قرنت(?:ی[او]ن(?:ی?ان|ها|ه|ی|ن)?|يان)|قرنت(?:ی[او]ن(?:ی?ان|ها|ه|ی|ن)?|يان))|۱قرنتی[او]ن(?:ی?ان|ها|ه|ی|ن)?|AvvalCor|۱قرنتيان|۱(?:قر(?:نت?)?|qrn?)|۱qrnt|1Cor|اولق|1(?:qr|قر)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["Eph"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Af(?:is(?:isiyanians|siy(?:un(?:ians)?|an)|iyun(?:ians)?|(?:is?ya|ya)ni|(?:i(?:s(?:i(?:yu|a)|yu)|yyu|a)|yoo)n)|esisyani|es(?:(?:i(?:si|y)ya|si(?:sia|y[ou])|i(?:syu|a))|iyoo)n|esisyan)|ا(?:َفِسسی[او]نه|ف(?:ِس(?:سی[او]ن[نه]|ی[او]ن[نه])|س(?:سی[او]ن|ی[او]ن|[ـو])))|ا(?:َفِسسیان|ف(?:ِس(?:سی[او]ن|ی[او]ن)|س))|Ephesians|Eph(?:esian)?|afss?iyān|afso|afs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Phil"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Filip(?:i(?:yanians|ans?)|y(?:(?:uni)?ans|un))|ف(?:یلیپی[او]نیان|یل(?:یپی[او]نا|پیا)ن|یلیپی(?:[او]ن[نه]|ها)|لیپیان)|Philipp?ians|fīlīpp(?:iān|ī)|ف(?:یل(?:ی(?:پی(?:[او]ن|ه))?|پی?)?|لیپ)|fīlīp|Phil))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Col"],
        testament: "n",
      ...
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:dovvom(?:\s*tīmutā['’]ūs|tī)|(?:Do(?:vomTimot(?:haio|eo?u|hao|ai?o)|vomTimotha?eu|Timot(?:h(?:a?eu|ao)|e[ou]))|2Timot(?:haio|eo?u|hao|ai?o)|2Timotha?eu)s|DovomTimot(?:eos|hy)|دو(?:م(?:(?:\s*تیموتائوس|تی)|تیموت(?:ا(?:ئ(?:وس[هی]|س)|ؤسی)|ا(?:ئو|ؤ)س|ئوسه|ئاؤس|ی(?:ئو|[ؤو])س|ئوس))|تیموت(?:ا(?:ئ(?:وس[هی]|س)|ؤسی)|ا(?:ئو|ؤ)س|ئوسه|ئاؤس|ی(?:ئو|[ؤو])س|ئوس))|DovomTim(?:oteo)?|[2۲]\s*تیموتائوس|۲تیموت(?:ا(?:ئ(?:وس[هی]|س)|ؤسی)|ا(?:ئو|ؤ)س|ئوسه|ئاؤس|ی(?:ئو|[ؤو])س|ئوس)|2Timot(?:eos|hy)|2Tim(?:oteo)?|۲(?:تی(?:مو?)?|tīm?)|۲(?:tīmt|تیمت)|2(?:tīm|تیم)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:AvvalTimot(?:haio|eo?u|hao|ai?o)|avval\s*tīmutā['’]ū|1Timot(?:haio|eo?u|hao|ai?o))s|(?:AvvalTimotha?e|1Timotha?e)us|Avval(?:stTimothy|Timot(?:eos|hy))|YekTimot(?:h(?:a?eu|ao)s|e[ou]s)|(?:اول|[1۱])\s*تیموتائوس|اولتیموت(?:ا(?:ئ(?:وس[هی]|س)|ؤسی)|ا(?:ئو|ؤ)س|ئوسه|ئاؤس|ی(?:ئو|[ؤو])س|ئوس)|AvvalTim(?:oteo)?|یکتیموت(?:ا(?:ئ(?:وس[هی]|س)|ؤسی)|ا(?:ئو|ؤ)س|ئوسه|ئاؤس|ی(?:ئو|[ؤو])س|ئوس)|۱تیموت(?:ا(?:ئ(?:وس[هی]|س)|ؤسی)|ا(?:ئو|ؤ)س|ئوسه|ئاؤس|ی(?:ئو|[ؤو])س|ئوس)|1stTimothy|1Timot(?:eos|hy)|1Tim(?:oteo)?|avvaltī|۱(?:تی(?:مو?)?|tīm?)|اولتی|۱(?:tīmt|تیمت)|1(?:tīm|تیم)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["Phlm"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ف(?:یل(?:یمون(?:اء|ی[ةی]|[ئتهى])|مون(?:اء|ی[ةی]|[ئتهى]))|ل(?:یمون|م))|Philemon[ain]|Phil(?:emo[ou]|mo?u|imo)n|Filim(?:o(?:onn|unt|n[ain])|un)|ف(?:یل(?:یمون(?:ا|ی)?|مون(?:ا|ی)?)|لی(?:مو?)?)|Philemon|Filimo(?:o?|u)n|fīlīm(?:oni?)?|Phlm))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Heb"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:(?:Ibraaniyaa|Ebra(?:ni(?:y(?:aa|[ou])|[ou])|ani(?:yu|[eo]))|Hebrania|Ebraniaa|ebrāniā)n|(?:Ebr(?:a(?:an(?:iya|y)|n(?:i(?:yy|e)|ee))|eeani)|Hebraniy|(?:Hebra|Ebri)ani|Ibra(?:any|ni))an|Abraan(?:(?:iya|y)a|i[ao])n|Ebra(?:anians|niyan)|عبر(?:ان(?:ی(?:ان(?:ات|[تدزسـهڈی])|ونه)|ی(?:ائ|[آهی])ن|يان)|ی)|Ibraani(?:ans|yan)|Ebr(?:a(?:an(?:ian)?|n(?:iya)?)|eean)|عبر(?:ا(?:ن(?:ی(?:انا?|ون)?)?)?)?|Ebranian|ebr(?:ānī|i)|Heb|ebr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jas"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ya(?:aqoob(?:ey|i)|q(?:o(?:ob(?:e[ehy]|i)|ub)|ub(?:e[eh]|i)))|Ya(?:(?:aqoob|q(?:oo|u)b)|aqub)|Yaaqubi|ya['’]qūbi|یعق(?:و(?:ب(?:ا[ءت]|ته|[ئهىی])|ب(?:ا|ت)?|پ[هی]?)?)?|ya['’]qūb?|Jas))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Do(?:vom(?:\s*[Pp](?:atr(?:issi|asa)|eters)|P(?:atr(?:issi|asa)|eters)|p(?:atr(?:issi|asa)|eters))|\s*?p(?:atr(?:issi|asa)|eters))|Do(?:vom(?:\s*[Pp](?:atr(?:iss?|as)|eter)|P(?:atr(?:iss?|as)|et(?:er)?)|p(?:atr(?:iss?|as)|eter))|\s*?p(?:atr(?:iss?|as)|eter))|(?:Do(?:vom(?:\s*[Pp]at(?:ari|ru)|Pat(?:ari|ru)|pat(?:ari|ru))|\s*?pat(?:ari|ru))|2\s*Pat(?:ari|ru)|2Pat(?:ari|ru)|۲ptru)s|dovvom(?:\s*petrus|pt)|دو(?:م?\s*پطر(?:س(?:(?:س(?:اه|[ئهىی])|[ئاهىی])|(?:سا?)?)|ص[ئاسهىی]?)|مپط(?:ر(?:س(?:(?:س(?:اه|[ئهىی])|[ئاهىی])|(?:سا?)?)|ص[ئاسهىی]?))?|پطر(?:س(?:(?:س(?:اه|[ئهىی])|[ئاهىی])|(?:سا?)?)|ص[ئاسهىی]?))|2\s*P(?:atr(?:issi|asa)|eters)|2\s*P(?:atr(?:iss?|as)|eter)|2Patr(?:issi|asa)|۲\s*پطر(?:س(?:(?:س(?:اه|[ئهىی])|[ئاهىی])|(?:سا?)?)|ص[ئاسهىی]?)|2Patr(?:iss?|as)|۲پطرس(?:س(?:اه|[ئهىی])|[ئاهىی])|۲پطرس(?:سا?)?|2Peters|2Peter|۲پطرص[ئاسهىی]?|۲(?:ptr?|پطر)|2Pet|2پط|۲پت|2pt))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Avval(?:\s*[Pp]|p)|1\s*P)(?:at(?:r(?:(?:issi|asa)|us)|aris)|eters)|(?:Avval(?:\s*[Pp]|p)|1\s*P)(?:atr(?:iss?|as)|eter)|(?:Avval|1)Pat(?:r(?:(?:issi|asa)|us)|aris)|(?:Avval|1)Patr(?:iss?|as)|(?:avval\s*pe|۱p)trus|Yek(?:\s*p(?:at(?:r(?:(?:issi|asa)|us)|aris)|eters)|p(?:at(?:r(?:(?:issi|asa)|us)|aris)|eters))|Yek(?:\s*p(?:atr(?:iss?|as)|eter)|p(?:atr(?:iss?|as)|eter))|(?:Avval|1)Peters|(?:اول|۱)\s*پطر(?:س(?:(?:س(?:اه|[ئهىی])|[ئاهىی])|(?:سا?)?)|ص[ئاسهىی]?)|(?:Avval|1)Peter|اولپطر(?:س(?:(?:س(?:اه|[ئهىی])|[ئاهىی])|(?:سا?)?)|ص[ئاسهىی]?)|یک(?:\s*پطر(?:س(?:(?:س(?:اه|[ئهىی])|[ئاهىی])|(?:سا?)?)|ص[ئاسهىی]?)|پطر(?:س(?:(?:س(?:اه|[ئهىی])|[ئاهىی])|(?:سا?)?)|ص[ئاسهىی]?))|AvvalPet|۱پطرس(?:س(?:اه|[ئهىی])|[ئاهىی])|۱پطرس(?:سا?)?|avvalpt|۱پطرص[ئاسهىی]?|اولپط|۱(?:ptr?|پطر)|1Pet|1پط|۱پت|1pt))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Y(?:ah(?:udaa?|ooda)h|eh(?:udaa?h|ood(?:aa|eh)))|Y(?:ah(?:udaa?|ooda)|eh(?:oo|u)da)|y(?:ahūdān|ūdā)|ی(?:هو(?:(?:دا(?:ءه|[ته])|(?:د[آةهىی]|ذ))|(?:داء?|د?))|ہود(?:ا(?:ءه|[ته])|اء?|[آةهىی]))|y(?:ahū(?:dā)?|ūd)|Jude))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Tob"],
        testament: "a",
