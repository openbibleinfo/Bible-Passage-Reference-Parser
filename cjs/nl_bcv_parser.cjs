...
var bcv_regexps = class {
  constructor() {
    ...
    // The `opschrift` has `[a-z]` instead of `\w` because it could be followed by a number.
    // [a-e] allows `1:1a`.
    this.escaped_passage = /(?:^|[^\x1e\x1f\p{L}\p{N}])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s.:,;\x1e\x1f&\(\)（）\[\]\\/"'\*=~\-–—]|opschrift(?![a-z])|en\s+volgende\s+verzen|hoofdstukken|hoofdstuk|zie\s+ook|verzen|vers|vgl|en|vs|-|v|[a-e](?!\w)|$)+)/giu;
    ...
    this.first = String.raw`(?:Eerste|1e|I|1)\.?\s*`;
    this.second = String.raw`(?:Tweede|2e|II|2)\.?\s*`;
    this.third = String.raw`(?:Derde|3e|III|3)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|(?:en|vgl|zie\s+ook)|-)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Eerste\s*Mozes|Beresjiet|(?:(?:1e|I)|1)\.\s*Mozes|(?:(?:1e|I)|1)\s*Mozes|Genesis|Gen|Gn))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tweede\s*Mozes|(?:2e?|II)\.\s*Mozes|(?:2e?|II)\s*Mozes|Sjemot|Exodus|Ex(?:od)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bel"],
        testament: "a",
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Derde\s*Mozes|(?:III|3e?)\.\s*Mozes|Leviticus|(?:III|3e?)\s*Mozes|[VW]ajikra|Lev|Lv))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Vierde\s*Mozes|(?:IV|4)\.\s*Mozes|B[ae]midbar|(?:IV|4)\s*Mozes|Numb?eri|Num?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Sir"],
        testament: "a",
      ...
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:D(?:(?:e(?:uteronomiu|warie)m|t)|eut)|V(?:ijfde|\.?)\s*Mozes|5\.\s*Mozes|5\s*Mozes))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Eerste\s*E(?:sdras|zra)|Derde\s*E(?:sdras|zra)|(?:I(?:II)?\.|(?:[13]e|[13])\.)\s*E(?:sdras|zra)|(?:I(?:II)?\s*|(?:[13]e|[13])\s*)E(?:sdras|zra)|1Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tweede\s*E(?:sdras|zra)|Vierde\s*E(?:sdras|zra)|(?:(?:(?:2e|4)|2)\.|I[IV]\.)\s*E(?:sdras|zra)|(?:(?:(?:2e|4)|2)\s*|I[IV]\s*)E(?:sdras|zra)|2Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tweede\s*Sam(?:u[eë]l)?|(?:2e?|II)\.\s*Sam(?:u[eë]l)?|Samuel\s*II|(?:2e|II)\s*Sam(?:u[eë]l)?|2\s*Sam(?:u[eë]l)?|2Sam|2\s*S))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Eerste\s*Sam(?:u[eë]l)?|(?:(?:1e|I)|1)\.\s*Sam(?:u[eë]l)?|(?:1e|I)\s*Sam(?:u[eë]l)?|Samuel\s*I|1\s*Sam(?:u[eë]l)?|1Sam|1\s*S))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tweede\s*Ko(?:n(?:ingen)?)?|(?:2e?|II)\.\s*Ko(?:n(?:ingen)?)?|(?:2e?|II)\s*Ko(?:n(?:ingen)?)?|2Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Eerste\s*Ko(?:n(?:ingen)?)?|(?:(?:1e|I)|1)\.\s*Ko(?:n(?:ingen)?)?|(?:(?:1e|I)|1)\s*Ko(?:n(?:ingen)?)?|1Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tweede\s*Kron(?:ieken)?|(?:2e?|II)\.\s*Kron(?:ieken)?|(?:2e|II)\s*Kron(?:ieken)?|2\s*Kron(?:ieken)?|2(?:\s*K|Ch)r))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Eerste\s*Kron(?:ieken)?|(?:(?:1e|I)|1)\.\s*Kron(?:ieken)?|(?:1e|I)\s*Kron(?:ieken)?|1\s*Kron(?:ieken)?|1(?:\s*K|Ch)r))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Eerste\s*Joh(?:annes)?|(?:(?:1e|I)|1)\.\s*Joh(?:annes)?|(?:(?:1e|I)|1)\s*Joh(?:annes)?|1John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tweede\s*Joh(?:annes)?|(?:2e?|II)\.\s*Joh(?:annes)?|(?:2e?|II)\s*Joh(?:annes)?|2John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Derde\s*Joh(?:annes)?|(?:III|3e?)\.\s*Joh(?:annes)?|(?:III|3e?)\s*Joh(?:annes)?|3John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Evangelie\s*volgens\s*Johannes|Joh(?:annes|n?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tweede\s*(?:Kor(?:int(?:h?i[eë]rs?|he))?|Corint(?:h?i[eë]rs?|he))|(?:2e?|II)\.\s*(?:Kor(?:int(?:h?i[eë]rs?|he))?|Corint(?:h?i[eë]rs?|he))|(?:2e?|II)\s*(?:Kor(?:int(?:h?i[eë]rs?|he))?|Corint(?:h?i[eë]rs?|he))|2Cor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Eerste\s*(?:Kor(?:int(?:h?i[eë]rs?|he))?|Corint(?:h?i[eë]rs?|he))|(?:(?:1e|I)|1)\.\s*(?:Kor(?:int(?:h?i[eë]rs?|he))?|Corint(?:h?i[eë]rs?|he))|(?:(?:1e|I)|1)\s*(?:Kor(?:int(?:h?i[eë]rs?|he))?|Corint(?:h?i[eë]rs?|he))|1Cor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tweede\s*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?)|(?:2e?|II)\.\s*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?)|(?:2e|II)\s*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?)|2\s*Th?ess(?:alonicenzen)?|(?:2\s*Th?e|2Thes)s))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Eerste\s*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?)|(?:(?:1e|I)|1)\.\s*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?)|(?:1e|I)\s*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?)|1\s*Th?ess(?:alonicenzen)?|(?:1\s*Th?e|1Thes)s))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tweede\s*Tim(?:ot(?:he[uü]s|e[uü]s))?|(?:2e?|II)\.\s*Tim(?:ot(?:he[uü]s|e[uü]s))?|(?:2e?|II)\s*Tim(?:ot(?:he[uü]s|e[uü]s))?|2Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Eerste\s*Tim(?:ot(?:he[uü]s|e[uü]s))?|(?:(?:1e|I)|1)\.\s*Tim(?:ot(?:he[uü]s|e[uü]s))?|(?:(?:1e|I)|1)\s*Tim(?:ot(?:he[uü]s|e[uü]s))?|1Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tweede\s*Pet(?:r(?:us)?)?|(?:2e?|II)\.\s*Pet(?:r(?:us)?)?|(?:2e|II)\s*Pet(?:r(?:us)?)?|2(?:\s*Pet(?:r(?:us)?)?|(?:\s*Pe|Pet))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Eerste\s*Pet(?:r(?:us)?)?|(?:(?:1e|I)|1)\.\s*Pet(?:r(?:us)?)?|(?:1e|I)\s*Pet(?:r(?:us)?)?|1(?:\s*Pet(?:r(?:us)?)?|(?:\s*Pe|Pet))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tweede\s*Mak(?:kabee[eë]n)?|(?:2e?|II)\.\s*Mak(?:kabee[eë]n)?|(?:2e?|II)\s*Mak(?:kabee[eë]n)?|2Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Derde\s*Mak(?:kabee[eë]n)?|(?:III|3e?)\.\s*Mak(?:kabee[eë]n)?|(?:III|3e?)\s*Mak(?:kabee[eë]n)?|3Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Vierde\s*Mak(?:kabee[eë]n)?|(?:IV|4)\.\s*Mak(?:kabee[eë]n)?|(?:IV|4)\s*Mak(?:kabee[eë]n)?|4Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Eerste\s*Mak(?:kabee[eë]n)?|(?:(?:1e|I)|1)\.\s*Mak(?:kabee[eë]n)?|(?:(?:1e|I)|1)\s*Mak(?:kabee[eë]n)?|1Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezek", "Ezra"],
        testament: "o",
...
function peg$parse(input, options) {
  ...
  var peg$c10 = "/1";
  var peg$c11 = "en";
  var peg$c12 = "volgende";
  var peg$c13 = "verzen";
  var peg$c14 = "/9";
  var peg$c15 = "/2";
  var peg$c16 = ".1";
  var peg$c17 = "hoofdstuk";
  var peg$c18 = "ken";
  var peg$c19 = "v";
  var peg$c20 = "erzen";
  var peg$c21 = "ers";
  ...
  var peg$e12 = peg$literalExpectation("en", false);
  var peg$e13 = peg$literalExpectation("volgende", false);
  var peg$e14 = peg$literalExpectation("verzen", false);
  ...
  var peg$e21 = peg$literalExpectation("hoofdstuk", false);
  var peg$e22 = peg$literalExpectation("ken", false);
  var peg$e23 = peg$literalExpectation("v", false);
  var peg$e24 = peg$literalExpectation("erzen", false);
  ...
  var peg$e30 = peg$literalExpectation("vgl", false);
  var peg$e31 = peg$literalExpectation("zie", false);
  var peg$e32 = peg$literalExpectation("ook", false);
  var peg$e33 = peg$classExpectation(["-", "–", "—"], false, false);
  var peg$e34 = peg$literalExpectation("opschrift", false);
  ...
  var peg$e38 = peg$literalExpectation("the", false);
  var peg$e39 = peg$literalExpectation("book", false);
  var peg$e40 = peg$classExpectation(["(", "["], false, false);
  var peg$e41 = peg$classExpectation([")", "]"], false, false);
  var peg$e42 = peg$literalExpectation("", false);
  var peg$e43 = peg$literalExpectation(",000", false);
