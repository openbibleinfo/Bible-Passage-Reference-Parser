...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = String.raw`א[’']\.?\s*`;
    this.second = String.raw`ב[’']\.?\s*`;
    this.third = String.raw`ג[’']\.?\s*`;
...
function peg$parse(input, options) {
  ...
  var peg$e19 = peg$literalExpectation("פרק", true);
  var peg$e20 = peg$literalExpectation("ים", true);
