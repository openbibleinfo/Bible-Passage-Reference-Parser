...
var bcv_regexps = class {
  constructor() {
    ...
    // The `tytuł` has `[a-z]` instead of `\w` because it could be followed by a number.
    // [a-e] allows `1:1a`.
    this.escaped_passage = /(?:^|[^\x1e\x1f\p{L}\p{N}])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s.:,;\x1e\x1f&\(\)（）\[\]\\/"'\*=~\-–—]|tytuł(?![a-z])|rozdział[óo]w|werset[óo]w|rozdziały|rozdział|n(?![n])|wersety|werset|rozdz|oraz|wers|por|rr|nn|do|r|i|w|[a-e](?!\w)|$)+)/giu;
    ...
    this.match_end_split = /\d\W*tytuł|\d\W*n(?![n])(?:[\s*]*\.)?|\d\W*nn(?:[\s*]*\.)?|\d[\s*]*[a-e](?!\w)|\x1e(?:[\s*]*[)\]\uff09])?|[\d\x1f]/gi;
    this.control = /[\x1e\x1f]/g;
    // These are needed for ranges outside of this class.
    this.first = String.raw`(?:Pierwsza|Pierwsze|Pierwszy|1|I)\.?\s*`;
    this.second = String.raw`(?:Druga|Drugi|2|II)\.?\s*`;
    this.third = String.raw`(?:Trzecia|Trzeci|3|III)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|(?:oraz|por|i)|do)`;
    this.range_only = String.raw`(?:[\u2013\u2014-]|do)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Pierwsz[aey]\s*(?:Ks(?:i[eę]g[ai]\s*Mo(?:j[zż]eszowa|y[zż]eszowe)|\.\s*Mo(?:j[zż]eszowa|y[zż]eszowe)|\s*Mo(?:j[zż]eszowa|y[zż]eszowe))|Moj[zż]eszowa|Moj[zż])|[1I]\.\s*(?:Ks(?:i[eę]g[ai]\s*Mo(?:j[zż]eszowa|y[zż]eszowe)|\.\s*Mo(?:j[zż]eszowa|y[zż]eszowe)|\s*Mo(?:j[zż]eszowa|y[zż]eszowe))|Moj[zż]eszowa|Moj[zż])|[1I]\s*Ks(?:i[eę]g[ai]\s*Mo(?:j[zż]eszowa|y[zż]eszowe)|\.\s*Mo(?:j[zż]eszowa|y[zż]eszowe)|\s*Mo(?:j[zż]eszowa|y[zż]eszowe))|Ks(?:i[eę]g[ai]\s*Rodzaju|\.?\s*Rodzaju)|(?:1\s*Moj[zż]|I\s*Moj[zż])eszowa|Genezis|1\s*Moj[zż]|I\s*Moj[zż]|1\s*Moj|I\s*Moj|Ro?dz|1\s*M|Gen))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Drug[ai]\s*(?:Ks(?:i[eę]g[ai]\s*Moj[zż]eszow|\.\s*Moj[zż]eszow|\s*Moj[zż]eszow)|Moj[zż]eszow)|(?:II|2)\.\s*(?:Ks(?:i[eę]g[ai]\s*Moj[zż]eszow|\.\s*Moj[zż]eszow|\s*Moj[zż]eszow)|Moj[zż]eszow)|(?:II|2)\s*Ks(?:i[eę]g[ai]\s*Moj[zż]eszow|\.\s*Moj[zż]eszow|\s*Moj[zż]eszow)|(?:II\s*Moj[zż]|2\s*Moj[zż])eszow)a|Ks(?:i[eę]g[ai]\s*Wyj[sś]cia|\.\s*Wyj[sś]cia|\s*Wyj[sś]cia)|Drug[ai]\s*Moj[zż]|(?:II|2)\.\s*Moj[zż]|II\s*Moj[zż]|II\s*Moj|2\s*Moj[zż]|Exodus|2\s*Moj|Ex(?:od)?|2\s*M|Wy?j))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bel"],
        testament: "a",
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Trzeci(?:a\s*(?:Ks(?:i[eę]g[ai]\s*Moj[zż]eszowa|\.\s*Moj[zż]eszowa|\s*Moj[zż]eszowa)|Moj[zż]eszowa|Moj[zż])|\s*(?:Ks(?:i[eę]g[ai]\s*Moj[zż]eszowa|\.\s*Moj[zż]eszowa|\s*Moj[zż]eszowa)|Moj[zż]eszowa|Moj[zż]))|(?:III|3)\.\s*(?:Ks(?:i[eę]g[ai]\s*Moj[zż]eszowa|\.\s*Moj[zż]eszowa|\s*Moj[zż]eszowa)|Moj[zż]eszowa|Moj[zż])|(?:III|3)\s*Ks(?:i[eę]g[ai]\s*Moj[zż]eszowa|\.\s*Moj[zż]eszowa|\s*Moj[zż]eszowa)|Ks(?:i[eę]g[ai]\s*Kapła[nń]sk|\.\s*Kapła[nń]sk|\s*Kapła[nń]sk)a|(?:III\s*Moj[zż]|3\s*Moj[zż])eszowa|III\s*Moj[zż]|III\s*Moj|3\s*Moj[zż]|3\s*M(?:oj)?|K(?:ap[lł]|p[lł])|Lev))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Czwarta\s*(?:Ks(?:i[eę]g[ai]\s*Moj[zż]eszowa|\.\s*Moj[zż]eszowa|\s*Moj[zż]eszowa)|Moj[zż]eszowa|Moj[zż])|(?:IV|4)\.\s*(?:Ks(?:i[eę]g[ai]\s*Moj[zż]eszowa|\.\s*Moj[zż]eszowa|\s*Moj[zż]eszowa)|Moj[zż]eszowa|Moj[zż])|(?:IV|4)\s*Ks(?:i[eę]g[ai]\s*Moj[zż]eszowa|\.\s*Moj[zż]eszowa|\s*Moj[zż]eszowa)|(?:IV\s*Moj[zż]|4\s*Moj[zż])eszowa|Ks(?:i[eę]g[ai]\s*Liczb|\.?\s*Liczb)|IV\s*Moj[zż]|IV\s*Moj|4\s*Moj[zż]|4\s*M(?:oj)?|Liczb|Num|Lb))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Sir"],
        testament: "a",
      ...
      },
      {
        osis: ["Wis"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}]))((?:M(?:[aą]dro[sś][cć]\s*Salomona|dr)|Ks(?:i[eę]g[ai]\s*M[aą]dro[sś]ci|\.\s*M[aą]dro[sś]ci|\s*M[aą]dro[sś]ci)|M[aą]dr|Wis))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Lam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:L(?:amentacje\s*Jeremiasza|m)|Ks(?:i[eę]g[ai]\s*Lamentacji|\.?\s*Lamentacji)|Treny\s*Jeremiasza|La(?:mentacje|m?)|Tr(?:eny)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["EpJer"],
        testament: "a",
      ...
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ks(?:i[eę]g[ai]\s*Powt(?:[oó]rzonego)?\s*Prawa|\.\s*Powt(?:[oó]rzonego)?\s*Prawa|\s*Powt(?:[oó]rzonego)?\s*Prawa)|(?:(?:Pi[aą]ta|5\.)\s*(?:Ks(?:i[eę]g[ai]\s*Moj[zż]eszo|\.\s*Moj[zż]eszo|\s*Moj[zż]eszo)|Moj[zż]eszo)|V(?:\.\s*(?:Ks(?:i[eę]g[ai]\s*Moj[zż]eszo|\.\s*Moj[zż]eszo|\s*Moj[zż]eszo)|Moj[zż]eszo)|\s*Ks(?:i[eę]g[ai]\s*Moj[zż]eszo|\.\s*Moj[zż]eszo|\s*Moj[zż]eszo)|\s*Moj[zż]eszo)|5\s*Ks(?:i[eę]g[ai]\s*Moj[zż]eszo|\.\s*Moj[zż]eszo|\s*Moj[zż]eszo)|5\s*Moj[zż]eszo)wa|(?:Pi[aą]ta|5\.)\s*Moj[zż]|V(?:\.\s*Moj[zż]|\s*Moj(?:[zż])?)|5\s*M(?:oj[zż]|(?:oj)?)|(?:Deu|Pw)t))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Jozuego|\.?\s*Jozuego)|Jo(?:zuego|(?:sh|z))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Judg"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*S[eę]dzi[oó]w|\.\s*S[eę]dzi[oó]w|\s*S[eę]dzi[oó]w)|S[eę]dzi[oó]w|S[eę]dz|Judg|Sdz))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ruth"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Rut(?:hy)?|\.\s*Rut(?:hy)?|\s*Rut(?:hy)?)|R(?:(?:uth|t)|ut?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Pierwsz[aey]\s*(?:Ks(?:i[eę]g[ai]\s*Ezdrasza|\.?\s*Ezdrasza)|Ezdrasza)|[1I]\.\s*(?:Ks(?:i[eę]g[ai]\s*Ezdrasza|\.?\s*Ezdrasza)|Ezdrasza)|[1I]\s*(?:Ks(?:i[eę]g[ai]\s*Ezdrasza|\.?\s*Ezdrasza)|Ezdrasza)|1Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Drug[ai]\s*(?:Ks(?:i[eę]g[ai]\s*Ezdrasza|\.?\s*Ezdrasza)|Ezdrasza)|(?:II|2)\.\s*(?:Ks(?:i[eę]g[ai]\s*Ezdrasza|\.?\s*Ezdrasza)|Ezdrasza)|(?:II|2)\s*(?:Ks(?:i[eę]g[ai]\s*Ezdrasza|\.?\s*Ezdrasza)|Ezdrasza)|2Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Izajasza|\.?\s*Izajasza)|I(?:zajasza|(?:sa|z))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Drug[ai]\s*(?:Ks(?:i[eę]g[ai]\s*Samuel(?:ow)?a|\.\s*Samuel(?:ow)?a|\s*Samuel(?:ow)?a)|Samuelowa)|(?:II|2)\.\s*(?:Ks(?:i[eę]g[ai]\s*Samuel(?:ow)?a|\.\s*Samuel(?:ow)?a|\s*Samuel(?:ow)?a)|Samuelowa)|II\s*(?:Ks(?:i[eę]g[ai]\s*Samuel(?:ow)?a|\.\s*Samuel(?:ow)?a|\s*Samuel(?:ow)?a)|Samuelowa)|2(?:\s*Ks(?:i[eę]g[ai]\s*Samuel(?:ow)?a|\.\s*Samuel(?:ow)?a|\s*Samuel(?:ow)?a)|(?:\s*Samuelowa|(?:\s*Sam?|(?:\s*S|Sa)m)))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Pierwsz[aey]\s*(?:Ks(?:i[eę]g[ai]\s*Samuel(?:ow)?a|\.\s*Samuel(?:ow)?a|\s*Samuel(?:ow)?a)|Samuelowa)|[1I]\.\s*(?:Ks(?:i[eę]g[ai]\s*Samuel(?:ow)?a|\.\s*Samuel(?:ow)?a|\s*Samuel(?:ow)?a)|Samuelowa)|1(?:\s*Ks(?:i[eę]g[ai]\s*Samuel(?:ow)?a|\.\s*Samuel(?:ow)?a|\s*Samuel(?:ow)?a)|(?:\s*Samuelowa|(?:\s*Sam?|(?:\s*S|Sa)m)))|I\s*(?:Ks(?:i[eę]g[ai]\s*Samuel(?:ow)?a|\.\s*Samuel(?:ow)?a|\s*Samuel(?:ow)?a)|Samuelowa)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Czwarta\s*Ks(?:i[eę]g[ai]\s*Kr[oó]lewska|\.\s*Kr[oó]lewska|\s*Kr[oó]lewska)|(?:Drug[ai]\s*Ks(?:i[eę]g[ai]\s*Kr[oó]le|\.\s*Kr[oó]le|\s*Kr[oó]le)|(?:II|2)\.\s*Ks(?:i[eę]g[ai]\s*Kr[oó]le|\.\s*Kr[oó]le|\s*Kr[oó]le)|II\s*Ks(?:i[eę]g[ai]\s*Kr[oó]le|\.\s*Kr[oó]le|\s*Kr[oó]le)|2\s*K(?:s(?:i[eę]g[ai]\s*Kr[oó]le|\.\s*Kr[oó]le|\s*Kr[oó]le)|r[oó]le))wska|(?:IV|4)\.\s*Ks(?:i[eę]g[ai]\s*Kr[oó]lewska|\.\s*Kr[oó]lewska|\s*Kr[oó]lewska)|Drug[ai]\s*Ks(?:i[eę]g[ai]\s*Kr[oó]l[oó]w|\.\s*Kr[oó]l[oó]w|\s*Kr[oó]l[oó]w)|(?:IV|4)\s*Ks(?:i[eę]g[ai]\s*Kr[oó]lewska|\.\s*Kr[oó]lewska|\s*Kr[oó]lewska)|(?:II|2)\.\s*Ks(?:i[eę]g[ai]\s*Kr[oó]l[oó]w|\.\s*Kr[oó]l[oó]w|\s*Kr[oó]l[oó]w)|II\s*Ks(?:i[eę]g[ai]\s*Kr[oó]l[oó]w|\.\s*Kr[oó]l[oó]w|\s*Kr[oó]l[oó]w)|2(?:\s*Ks(?:i[eę]g[ai]\s*Kr[oó]l[oó]w|\.\s*Kr[oó]l[oó]w|\s*Kr[oó]l[oó]w)|(?:\s*Krl|Kgs))|(?:Drug[ai]\s*Kr|(?:(?:II|2)\.|II)\s*Kr)[oó]lewska|2\s*Kr[oó]l))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Pierwsz[aey]\s*Ks(?:i[eę]g[ai]\s*Kr[oó]le|\.\s*Kr[oó]le|\s*Kr[oó]le)|[1I]\.\s*Ks(?:i[eę]g[ai]\s*Kr[oó]le|\.\s*Kr[oó]le|\s*Kr[oó]le)|1\s*K(?:s(?:i[eę]g[ai]\s*Kr[oó]le|\.\s*Kr[oó]le|\s*Kr[oó]le)|r[oó]le)|I\s*Ks(?:i[eę]g[ai]\s*Kr[oó]le|\.\s*Kr[oó]le|\s*Kr[oó]le))wska|Trzeci(?:a\s*Ks(?:i[eę]g[ai]\s*Kr[oó]lewska|\.\s*Kr[oó]lewska|\s*Kr[oó]lewska)|\s*Ks(?:i[eę]g[ai]\s*Kr[oó]lewska|\.\s*Kr[oó]lewska|\s*Kr[oó]lewska))|Pierwsz[aey]\s*Ks(?:i[eę]g[ai]\s*Kr[oó]l[oó]w|\.\s*Kr[oó]l[oó]w|\s*Kr[oó]l[oó]w)|(?:III|3)\.\s*Ks(?:i[eę]g[ai]\s*Kr[oó]lewska|\.\s*Kr[oó]lewska|\s*Kr[oó]lewska)|(?:III|3)\s*Ks(?:i[eę]g[ai]\s*Kr[oó]lewska|\.\s*Kr[oó]lewska|\s*Kr[oó]lewska)|(?:Pierwsz[aey]\s*Kr|(?:[1I]\.|I)\s*Kr)[oó]lewska|[1I]\.\s*Ks(?:i[eę]g[ai]\s*Kr[oó]l[oó]w|\.\s*Kr[oó]l[oó]w|\s*Kr[oó]l[oó]w)|1(?:\s*Ks(?:i[eę]g[ai]\s*Kr[oó]l[oó]w|\.\s*Kr[oó]l[oó]w|\s*Kr[oó]l[oó]w)|(?:\s*Krl|Kgs))|I\s*Ks(?:i[eę]g[ai]\s*Kr[oó]l[oó]w|\.\s*Kr[oó]l[oó]w|\s*Kr[oó]l[oó]w)|1\s*Kr[oó]l))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Drug[ai]\s*K(?:s(?:i[eę]g[ai]\s*Kronik|\.?\s*Kronik)|ronik)|(?:II|2)\.\s*K(?:s(?:i[eę]g[ai]\s*Kronik|\.?\s*Kronik)|ronik)|II\s*K(?:s(?:i[eę]g[ai]\s*Kronik|\.?\s*Kronik)|ronik)|2(?:\s*Ks(?:i[eę]g[ai]\s*Kronik|\.?\s*Kronik)|(?:\s*Kronik|(?:\s*Kron|(?:\s*Krn|Chr))))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Pierwsz[aey]\s*K(?:s(?:i[eę]g[ai]\s*Kronik|\.?\s*Kronik)|ronik)|[1I]\.\s*K(?:s(?:i[eę]g[ai]\s*Kronik|\.?\s*Kronik)|ronik)|1(?:\s*Ks(?:i[eę]g[ai]\s*Kronik|\.?\s*Kronik)|(?:\s*Kronik|(?:\s*Kron|(?:\s*Krn|Chr))))|I\s*K(?:s(?:i[eę]g[ai]\s*Kronik|\.?\s*Kronik)|ronik)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Ezdrasza|\.?\s*Ezdrasza)|Ez(?:drasza|(?:(?:dr?|r)|ra))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Neh"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Nehemiasza|\.?\s*Nehemiasza)|Ne(?:hemiasza|h?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["GkEsth"],
        testament: "a",
      ...
      },
      {
        osis: ["Esth"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Estery|\.?\s*Estery)|Est(?:ery|h?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Job"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*(?:(?:Hi|J)|Ij)oba|\.\s*(?:(?:Hi|J)|Ij)oba|\s*(?:(?:Hi|J)|Ij)oba)|(?:Hi|J)oba|Hi(?:ob)?|Job))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ps"],
        testament: "oa",
        testament_books: { "Ps": "oa" },
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Psalm[oó]w|\.\s*Psalm[oó]w|\s*Psalm[oó]w)|Ps(?:almy|(?:alm)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["PrAzar"],
        testament: "a",
      ...
      },
      {
        osis: ["Prov"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Przy(?:powie[sś]ci\s*Salomona|sł[oó]w)|\.\s*Przy(?:powie[sś]ci\s*Salomona|sł[oó]w)|\s*Przy(?:powie[sś]ci\s*Salomona|sł[oó]w))|Pr(?:(?:zypowie[sś]ci\s*Salomonowych|ov)|(?:z(?:yp?)?)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Eccl"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:K(?:s(?:i[eę]g[ai]\s*(?:K(?:aznodziei\s*Salomon|ohelet)|Eklezjastes)a|\.\s*(?:K(?:aznodziei\s*Salomon|ohelet)|Eklezjastes)a|\s*(?:K(?:aznodziei\s*Salomon|ohelet)|Eklezjastes)a)|aznodziei\s*Salomonowego|ohelet|azn|oh)|E(?:cc|k)l))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["SgThree"],
        testament: "a",
      ...
      },
      {
        osis: ["Jer"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Jeremiasza|\.?\s*Jeremiasza)|Jeremiasza|Je?r))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezek"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Ezechiela|\.?\s*Ezechiela)|Ez(?:echiela|(?:ek|e?))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Dan"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Daniela|\.?\s*Daniela)|D(?:aniela|(?:an?|n))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hos"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Ozeasza|\.?\s*Ozeasza)|Ozeasza|Hos|Oz))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Joel"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Proroctwo\s*Ioelowe|Ks(?:i[eę]g[ai]\s*Joela|\.?\s*Joela)|J(?:oela|l)|Joel))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Amos"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Amosa|\.?\s*Amosa)|Am(?:osa|(?:os)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Obad"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Proroctwo\s*Abdyaszowe|Ks(?:i[eę]g[ai]\s*Abdiasza|\.?\s*Abdiasza)|Abdiasza|Obad|Ab))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jonah"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Proroctwo\s*Ionaszowe|Ks(?:i[eę]g[ai]\s*Jonasza|\.?\s*Jonasza)|Jona(?:sza|h)|Jon))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mic"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Micheasza|\.?\s*Micheasza)|Mi(?:cheasza|(?:ch?)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Nah"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Proroctwo\s*Nahumowe|Ks(?:i[eę]g[ai]\s*Nahuma|\.?\s*Nahuma)|Na(?:huma|ch)|Nah?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hab"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Proroctwo\s*Abakukowe|Ks(?:i[eę]g[ai]\s*Habakuka|\.?\s*Habakuka)|(?:Ha|A)bakuka|Hab?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Zeph"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Proroctwo\s*Sofoniaszowe|Ks(?:i[eę]g[ai]\s*Sofoniasza|\.?\s*Sofoniasza)|Sofoniasza|Zeph|Sof?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hag"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Proroctwo\s*Aggieuszowe|Ks(?:i[eę]g[ai]\s*Aggeusza|\.?\s*Aggeusza)|Aggeusza|Hag|Ag))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Zech"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Zachariasza|\.?\s*Zachariasza)|Z(?:achariasza|(?:a(?:ch)?|ech))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mal"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Proroctwo\s*Malachyaszowe|Ks(?:i[eę]g[ai]\s*Malachiasza|\.?\s*Malachiasza)|M(?:alachiasza|l)|Mal))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Matt"],
        testament: "n",
      ...
      },
      {
        osis: ["Acts"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Dz(?:(?:iej(?:ach\s*Apostolskich|e\s*Apostolskie)|\s*Ap)|(?:ieje(?:\s*Apost)?)?)|Acts))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Rev"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:(?:Apokalipsa\s*[SŚ]wi[eę]tego\s*Jan|Apokalipsa\s*[sś]w\.?\s*Jan|Objawienie\s*(?:[sś]w\.?\s*Jan|Jan))a|Ks(?:i[eę]g[ai]\s*(?:Apokalipsy|Objawienia)|\.\s*(?:Apokalipsy|Objawienia)|\s*(?:Apokalipsy|Objawienia))|Ap(?:okalipsa)?|Obj(?:awienie)?|Rev))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Pierwsz[aey]\s*(?:List\s*(?:[sś]w\.?\s*Jana|Jana)|Jana)|[1I]\.\s*(?:List\s*(?:[sś]w\.?\s*Jana|Jana)|Jana)|1(?:\s*List\s*(?:[sś]w\.?\s*Jana|Jana)|(?:(?:\s*J(?:ana|n)|John)|\s*J(?:an)?))|I\s*(?:List\s*(?:[sś]w\.?\s*Jana|Jana)|Jana)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Drug[ai]\s*(?:List\s*(?:[sś]w\.?\s*Jana|Jana)|Jana)|(?:II|2)\.\s*(?:List\s*(?:[sś]w\.?\s*Jana|Jana)|Jana)|II\s*(?:List\s*(?:[sś]w\.?\s*Jana|Jana)|Jana)|2(?:\s*List\s*(?:[sś]w\.?\s*Jana|Jana)|(?:(?:\s*J(?:ana|n)|John)|\s*J(?:an)?))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Trzeci(?:a\s*(?:List\s*(?:[sś]w\.?\s*Jana|Jana)|Jana)|\s*(?:List\s*(?:[sś]w\.?\s*Jana|Jana)|Jana))|(?:III|3)\.\s*(?:List\s*(?:[sś]w\.?\s*Jana|Jana)|Jana)|III\s*(?:List\s*(?:[sś]w\.?\s*Jana|Jana)|Jana)|3(?:\s*List\s*(?:[sś]w\.?\s*Jana|Jana)|(?:(?:\s*J(?:ana|n)|John)|\s*J(?:an)?))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ew(?:angelia\s*(?:w(?:edług\s*[sś]w\.?\s*Jana|g\s*[sś]w\.?\s*Jana)|Jana)|\.\s*Jana|\s*Jana?)|J(?:(?:(?:oh)?n|ana)|(?:an)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Rom"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Drug[ai]\s*(?:List\s*[sś]w\.?\s*Pawła\s*do\s*Koryntian|list\s*do\s*Koryntian|Korynt(?:ian|[oó]w))|(?:II|2)\.\s*(?:List\s*[sś]w\.?\s*Pawła\s*do\s*Koryntian|list\s*do\s*Koryntian|Korynt(?:ian|[oó]w))|II\s*(?:List\s*[sś]w\.?\s*Pawła\s*do\s*Koryntian|list\s*do\s*Koryntian|Korynt(?:ian|[oó]w))|2(?:\s*List\s*[sś]w\.?\s*Pawła\s*do\s*Koryntian|(?:\s*list\s*do\s*Koryntian|(?:\s*Koryntian|(?:(?:\s*Korynt[oó]w|Cor)|\s*Kor))))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Drug[ai]\s*(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tesaloniczan|do\s*Tesaloniczan)|Tesalonic(?:ens[oó]w|zan))|(?:II|2)\.\s*(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tesaloniczan|do\s*Tesaloniczan)|Tesalonic(?:ens[oó]w|zan))|II\s*(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tesaloniczan|do\s*Tesaloniczan)|Tesalonic(?:ens[oó]w|zan))|2(?:\s*List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tesaloniczan|do\s*Tesaloniczan)|(?:(?:(?:\s*Tesalonicens[oó]w|Thess)|\s*Tes)|\s*Tesaloniczan))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Pierwsz[aey]\s*(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tesaloniczan|do\s*Tesaloniczan)|Tesalonic(?:ens[oó]w|zan))|[1I]\.\s*(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tesaloniczan|do\s*Tesaloniczan)|Tesalonic(?:ens[oó]w|zan))|1(?:\s*List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tesaloniczan|do\s*Tesaloniczan)|(?:(?:(?:\s*Tesalonicens[oó]w|Thess)|\s*Tes)|\s*Tesaloniczan))|I\s*(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tesaloniczan|do\s*Tesaloniczan)|Tesalonic(?:ens[oó]w|zan))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Drug[ai]\s*(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tymoteusza|do\s*Tymoteusza)|Tymoteusza)|(?:II|2)\.\s*(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tymoteusza|do\s*Tymoteusza)|Tymoteusza)|II\s*(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tymoteusza|do\s*Tymoteusza)|Tymoteusza)|2(?:\s*List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tymoteusza|do\s*Tymoteusza)|(?:\s*Tymoteusza|(?:\s*Tym|(?:\s*T|Ti)m)))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Pierwsz[aey]\s*(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tymoteusza|do\s*Tymoteusza)|Tym(?:oteusza)?)|[1I]\.\s*(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tymoteusza|do\s*Tymoteusza)|Tym(?:oteusza)?)|1(?:\s*List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tymoteusza|do\s*Tymoteusza)|(?:\s*Tymoteusza|(?:\s*Tym|(?:\s*T|Ti)m)))|I\s*(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tymoteusza|do\s*Tymoteusza)|Tym(?:oteusza)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Drug[ai]\s*(?:List\s*(?:[sś]w\.?\s*Piotra|Piotra)|Piotra?)|(?:II|2)\.\s*(?:List\s*(?:[sś]w\.?\s*Piotra|Piotra)|Piotra?)|II\s*(?:List\s*(?:[sś]w\.?\s*Piotra|Piotra)|Piotra?)|2(?:\s*List\s*(?:[sś]w\.?\s*Piotra|Piotra)|(?:(?:\s*Piotra|Pet)|\s*P(?:iotr)?))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Pierwsz[aey]\s*(?:List\s*(?:[sś]w\.?\s*Piotra|Piotra)|Piotra?)|[1I]\.\s*(?:List\s*(?:[sś]w\.?\s*Piotra|Piotra)|Piotra?)|1(?:\s*List\s*(?:[sś]w\.?\s*Piotra|Piotra)|(?:(?:\s*Piotra|Pet)|\s*P(?:iotr)?))|I\s*(?:List\s*(?:[sś]w\.?\s*Piotra|Piotra)|Piotra?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["Tob"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Tobi(?:asz|t)a|\.\s*Tobi(?:asz|t)a|\s*Tobi(?:asz|t)a)|To?b))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jdt"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Judyty|\.?\s*Judyty)|J(?:udyty|dt)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bar"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ks(?:i[eę]g[ai]\s*Barucha|\.?\s*Barucha)|Ba(?:rucha|r?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Sus"],
        testament: "a",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Drug[ai]\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|(?:II|2)\.\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|II\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|2(?:\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|(?:\s*Ma?ch|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Trzeci(?:a\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska))|(?:III|3)\.\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|III\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|3(?:\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|(?:\s*Ma?ch|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Czwarta\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|(?:IV|4)\.\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|IV\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|4(?:\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|(?:\s*Ma?ch|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Pierwsz[aey]\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|[1I]\.\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|1(?:\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|(?:\s*Ma?ch|Macc))|I\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      }
    ];
  }
};
...
function peg$parse(input, options) {
  ...
  var peg$e22 = peg$literalExpectation("ozdziały", true);
  var peg$e23 = peg$literalExpectation("ozdział", true);
  var peg$e24 = peg$classExpectation(["ó", "o"], false, true);
  var peg$e25 = peg$literalExpectation("w", false);
  var peg$e26 = peg$literalExpectation("ozdz", false);
  var peg$e27 = peg$literalExpectation("erset", false);
  var peg$e28 = peg$literalExpectation("ersety", false);
  var peg$e29 = peg$literalExpectation("ers", false);
  var peg$e30 = peg$literalExpectation(":", false);
  var peg$e31 = peg$classExpectation(['"', "'"], false, false);
  var peg$e32 = peg$classExpectation([",", ";", "/", ":", "&", "-", "–", "—", "~"], false, false);
  var peg$e33 = peg$literalExpectation("oraz", false);
  var peg$e34 = peg$literalExpectation("por", false);
  var peg$e35 = peg$literalExpectation("i", false);
  var peg$e36 = peg$classExpectation(["-", "–", "—"], false, false);
  var peg$e37 = peg$literalExpectation("do", false);
  var peg$e38 = peg$literalExpectation("tytuł", true);
  ...
  var peg$e42 = peg$literalExpectation("the", false);
  var peg$e43 = peg$literalExpectation("book", false);
  var peg$e44 = peg$classExpectation(["(", "["], false, false);
  var peg$e45 = peg$classExpectation([")", "]"], false, false);
  var peg$e46 = peg$literalExpectation("", false);
  var peg$e47 = peg$literalExpectation(",000", false);
  ...
  var peg$f24 = function(val_1) {
    var r = range();
    return { "type": "next_v", "value": [val_1], "indices": [r.start, r.end - 1] };
  };
  var peg$f25 = function(val_1, val_2) {
    var r = range();
  ...
  var peg$f30 = function(val_1, val_2) {
    var r = range();
