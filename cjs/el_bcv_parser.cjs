...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = String.raw`Α['’΄ʹʹ]\.?\s*`;
    this.second = String.raw`Β['’΄ʹʹ]\.?\s*`;
    this.third = String.raw`Γ['’΄ʹʹ]\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|και|-)`;
...
function peg$parse(input, options) {
  ...
  var peg$e12 = peg$literalExpectation("και", true);
  var peg$e13 = peg$literalExpectation("μετ", true);
  var peg$e14 = peg$classExpectation(["ά", "α"], false, true);
  ...
  var peg$e20 = peg$classExpectation([["α", "ε"]], false, true);
  var peg$e21 = peg$literalExpectation("κεφ", true);
  var peg$e22 = peg$literalExpectation("λαια", true);
  var peg$e23 = peg$literalExpectation("λαιον", true);
  var peg$e24 = peg$literalExpectation("λαιο", true);
  var peg$e25 = peg$literalExpectation("στ", true);
  var peg$e26 = peg$classExpectation(["ί", "ι"], false, true);
  var peg$e27 = peg$literalExpectation("χο", true);
  var peg$e28 = peg$classExpectation(["ι", ["ς", "σ"]], false, true);
  ...
  var peg$e33 = peg$literalExpectation("ο", true);
  var peg$e34 = peg$literalExpectation("τ", true);
  var peg$e35 = peg$literalExpectation("τλος", true);
  var peg$e36 = peg$literalExpectation("τλοσ", true);
