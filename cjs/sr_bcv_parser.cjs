...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = String.raw`(?:Прва|1|I)\.?\s*`;
    this.second = String.raw`(?:Друга|2|II)\.?\s*`;
    this.third = String.raw`(?:Трећом|Трећа|3|III)\.?\s*`;
...
function peg$parse(input, options) {
  ...
  var peg$e19 = peg$literalExpectation("поглавља", true);
  var peg$e20 = peg$literalExpectation("глава", true);
  var peg$e21 = peg$literalExpectation("стих", true);
  var peg$e22 = peg$literalExpectation("ови", true);
  var peg$e23 = peg$literalExpectation(":", false);
  var peg$e24 = peg$classExpectation(['"', "'"], false, false);
  var peg$e25 = peg$classExpectation([",", ";", "/", ":", "&", "-", "–", "—", "~"], false, false);
  var peg$e26 = peg$literalExpectation("и", true);
