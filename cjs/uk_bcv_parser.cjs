...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = String.raw`(?:Перша|Перше|1-ше|1-[ае]|1|I)\.?\s*`;
    this.second = String.raw`(?:Друга|Друге|2-ге|2-[ае]|2|II)\.?\s*`;
    this.third = String.raw`(?:Третя|Третє|3-тє|3-[ае]|3|III)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|і|-)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:1-?(?:ше|[ае])|I)|1)\.\s*книга\s*Мо[ий]сеева|Перш[ае]\s*книга\s*Мо[ий]сеева|(?:1-?(?:ше|[ае])|I)\s*книга\s*Мо[ий]сеева|1\s*книга\s*Мо[ий]сеева|Buttja|Бу(?:ття|г)|Бут|Gen|1\s*М))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:2-?(?:ге|[ае])|2)|II)\.\s*книга\s*Мо[ий]сеева|Друг[ае]\s*книга\s*Мо[ий]сеева|(?:2-?(?:ге|[ае])|II)\s*книга\s*Мо[ий]сеева|2\s*книга\s*Мо[ий]сеева|Vy[hȟ]id|Вихід|Exod|Вих|2\s*М))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bel"],
        testament: "a",
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:3-?(?:тє|[ае])|3)|III)\.\s*книга\s*Мо[ий]сеева|Трет[яє]\s*книга\s*Мо[ий]сеева|(?:3-?(?:тє|[ае])|III)\s*книга\s*Мо[ий]сеева|3\s*книга\s*Мо[ий]сеева|Levyt|Левит|Lev|3\s*М))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Четверта|4\.)\s*книга\s*Мо[ий]сеева|IV(?:\.\s*книга\s*Мо[ий]сеева|\s*книга\s*Мо[ий]сеева)|4\s*книга\s*Мо[ий]сеева|[CČ]ysla|Числа|Чис|Num|4\s*М))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Sir"],
        testament: "a",
      ...
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:П(?:['’]ята\s*книга\s*Мо[ий]сеева|овт(?:орення|\.?)\s*Закону)|Povtorennja\s*Zakonu|Второзаконня|Втор|Повт|Deut|5\s*М))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:1-?(?:ше|[ае])|I)|1)\.\s*Ездр[аи]|Перш[ае]\s*Ездр[аи]|(?:1-?(?:ше|[ае])|I)\s*Ездр[аи]|1(?:\s*Ездр[аи]|(?:\s*Езд|Esd))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:2-?(?:ге|[ае])|2)|II)\.\s*(?:книга\s*Ездри|Ездр[аи])|Друг[ае]\s*(?:книга\s*Ездри|Ездр[аи])|(?:2-?(?:ге|[ае])|II)\s*(?:книга\s*Ездри|Ездр[аи])|2(?:\s*книга\s*Ездри|(?:(?:\s*Ездр[аи]|Esd)|\s*Езд))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:2-?(?:ге|[ае])|2)|II)\.\s*(?:книга\s*Саму[ії]лова|Книга\s*Саму[ії]ла|Саму[ії]лова|Саму[ії]л|Samu[iï]l)|Друг[ае]\s*(?:книга\s*Саму[ії]лова|Книга\s*Саму[ії]ла|Саму[ії]лова|Саму[ії]л|Samu[iï]l)|(?:2-?(?:ге|[ае])|II)\s*(?:книга\s*Саму[ії]лова|Книга\s*Саму[ії]ла|Саму[ії]лова|Саму[ії]л|Samu[iï]l)|2\s*книга\s*Саму[ії]лова|2\s*Книга\s*Саму[ії]ла|2\s*Саму[ії]лова|2(?:\s*Сам(?:у[ії]л)?|(?:\s*Samu[iï]l|Sam))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:1-?(?:ше|[ае])|I)|1)\.\s*(?:книга\s*Саму[ії]лова|Книга\s*Саму[ії]ла|Саму[ії]лова|Саму[ії]л|Samu[iï]l)|Перш[ае]\s*(?:книга\s*Саму[ії]лова|Книга\s*Саму[ії]ла|Саму[ії]лова|Саму[ії]л|Samu[iï]l)|(?:1-?(?:ше|[ае])|I)\s*(?:книга\s*Саму[ії]лова|Книга\s*Саму[ії]ла|Саму[ії]лова|Саму[ії]л|Samu[iï]l)|1\s*книга\s*Саму[ії]лова|1\s*Книга\s*Саму[ії]ла|1\s*Саму[ії]лова|1(?:\s*Сам(?:у[ії]л)?|(?:\s*Samu[iï]l|Sam))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:(?:2-?(?:ге|[ае])|2)|II)\.\s*(?:книга\s*)?ц|Друг[ае]\s*(?:книга\s*)?ц|(?:2-?(?:ге|[ае])|II)\s*(?:книга\s*)?ц|2\s*(?:книга\s*)?ц)арів|Четверта\s*Царів|(?:(?:2-?(?:ге|[ае])|2)|II)\.\s*Cariv|Друг[ае]\s*Cariv|(?:2-?(?:ге|[ае])|II)\s*Cariv|(?:IV|4)\.\s*Царів|(?:IV|4)\s*Царів|2(?:\s*Cariv|(?:\s*Цар|Kgs))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:1(?:-?(?:ше|[ае])\.|\.)|I\.)\s*(?:книга\s*)?ц|Перш[ае]\s*(?:книга\s*)?ц|(?:1-?(?:ше|[ае])\s*|I\s*)(?:книга\s*)?ц|1\s*(?:книга\s*)?ц)арів|(?:1(?:-?(?:ше|[ае])\.|\.)|I\.)\s*Cariv|Перш[ае]\s*Cariv|(?:3(?:-?(?:тє|[ае])\.|\.)|III\.)\s*Царів|Трет[яє]\s*Царів|(?:1-?(?:ше|[ае])\s*|I\s*)Cariv|(?:3(?:-?(?:тє|[ае])\s*|\s*)|III\s*)Царів|1(?:\s*Cariv|(?:\s*Цар|Kgs))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:2-?(?:ге|[ае])|2)|II)\.\s*(?:книга\s*хроніки?|Літопису|[HȞ]roniky|Хроніка|хроніки|Хронік)|Друг[ае]\s*(?:книга\s*хроніки?|Літопису|[HȞ]roniky|Хроніка|хроніки|Хронік)|(?:2-?(?:ге|[ае])|II)\s*(?:книга\s*хроніки?|Літопису|[HȞ]roniky|Хроніка|хроніки|Хронік)|2\s*книга\s*хроніки?|2\s*Літопису|2\s*[HȞ]roniky|2\s*Хроніка|2\s*хроніки|2\s*Хр(?:онік)?|2Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:1-?(?:ше|[ае])|I)|1)\.\s*(?:книга\s*хроніки?|Літопису|[HȞ]roniky|Хроніка|хроніки|Хронік)|Перш[ае]\s*(?:книга\s*хроніки?|Літопису|[HȞ]roniky|Хроніка|хроніки|Хронік)|(?:1-?(?:ше|[ае])|I)\s*(?:книга\s*хроніки?|Літопису|[HȞ]roniky|Хроніка|хроніки|Хронік)|1\s*книга\s*хроніки?|1\s*Літопису|1\s*[HȞ]roniky|1\s*Хроніка|1\s*хроніки|1\s*Хр(?:онік)?|1Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Книга\s*Езд?ри|Ezd?ra|Ездр[аи]|(?:Єзд|Ез)ри|[ЄЕ]зд))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Neh"],
        testament: "o",
      ...
      },
      {
        ...
        regexp: /(?:^|(?<=[^\p{L}]))((?:Книга\s*Псалмів|Псал(?:ти́р|ми)|Псалмів|Psalmy|Ps|Пс))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["PrAzar"],
        testament: "a",
      ...
      },
      {
        osis: ["Eccl"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:(?:Книга\s*Екк?лезіястов|Екк?лезіястов)а|Проповідника|E(?:kklezijast|ccl)|Екклезіяста|Ек(?:кл(?:езіяст)?|л)|Екклезіаст|Коге́лет))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["SgThree"],
        testament: "a",
      ...
      },
      {
        osis: ["Song"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Книга\s*Пісні\s*Пісень\s*Соломона|Пісня\s*над\s*піснями\s*Соломона|Pisnja\s*nad\s*pisnjamy|Пісн(?:я\s*над\s*піснями)?|П(?:існ(?:я\s*Пісне[ий]|і\s*Пісень)|\.?\s*П)|Song))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jer"],
        testament: "o",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:2-?(?:ге|[ае])|2)|II)\.\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|Друг[ае]\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|(?:2-?(?:ге|[ае])|II)\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|2(?:\s*книга\s*Макаве[ії]в|(?:\s*Макаве[ії]в|(?:\s*Мак|(?:Macc|\s*Мк))))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:3-?(?:тє|[ае])|3)|III)\.\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|Трет[яє]\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|(?:3-?(?:тє|[ае])|III)\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|3(?:\s*книга\s*Макаве[ії]в|(?:\s*Макаве[ії]в|(?:\s*Мак|(?:Macc|\s*Мк))))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Четверта\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|(?:IV|4)\.\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|IV\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|4(?:\s*книга\s*Макаве[ії]в|(?:\s*Макаве[ії]в|(?:\s*Мак|(?:Macc|\s*Мк))))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:1-?(?:ше|[ае])|I)|1)\.\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|Перш[ае]\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|(?:1-?(?:ше|[ае])|I)\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|1(?:\s*книга\s*Макаве[ії]в|(?:\s*Макаве[ії]в|(?:\s*Мак|(?:Macc|\s*Мк))))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mark"],
        testament: "n",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:1-?(?:ше|[ае])|I)|1)\.\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанна|(?:послання\s*апостола\s*Ів|(?:Послання\s*І[во]|Ів))ана|[ИЙ]оаново|Іоанна|Іоана)|Перш[ае]\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанна|(?:послання\s*апостола\s*Ів|(?:Послання\s*І[во]|Ів))ана|[ИЙ]оаново|Іоанна|Іоана)|(?:1-?(?:ше|[ае])|I)\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанна|(?:послання\s*апостола\s*Ів|(?:Послання\s*І[во]|Ів))ана|[ИЙ]оаново|Іоанна|Іоана)|1\s*соборне\s*послання\s*св\.?\s*апостола\s*Іоанна|Per[sš]e\s*poslannja\s*apostola\s*Ivana|(?:1\s*послання\s*апостола\s*Ів|(?:1\s*Послання\s*І[во]|1\s*Ів))ана|1\s*[ИЙ]оаново|1\s*Іоанна|1(?:\s*Іоана|John)|1\s*Ів))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:(?:2-?(?:ге|[ае])|2)|II)\.\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанн|(?:(?:послання\s*апостола\s*Ів|(?:Послання\s*І[во]|Ів))а|Іоан)н)|Друг[ае]\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанн|(?:(?:послання\s*апостола\s*Ів|(?:Послання\s*І[во]|Ів))а|Іоан)н)|(?:2-?(?:ге|[ае])|II)\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанн|(?:(?:послання\s*апостола\s*Ів|(?:Послання\s*І[во]|Ів))а|Іоан)н)|2\s*соборне\s*послання\s*св\.?\s*апостола\s*Іоанн|(?:(?:2\s*послання\s*апостола\s*Ів|(?:2\s*Послання\s*І[во]|2\s*Ів))а|2\s*Іоан)н)а|Druhe\s*poslannja\s*apostola\s*Ivana|Послання\s*до\s*Тита|(?:(?:2-?(?:ге|[ае])|2)|II)\.\s*(?:[ИЙ]оаново|Іоана)|Друг[ае]\s*(?:[ИЙ]оаново|Іоана)|(?:2-?(?:ге|[ае])|II)\s*(?:[ИЙ]оаново|Іоана)|2\s*[ИЙ]оаново|2(?:\s*Іоана|John)|2\s*Ів))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:3-?(?:тє|[ае])|3)|III)\.\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанна|(?:послання\s*апостола\s*Ів|(?:Послання\s*І[во]|Ів))ана|[ИЙ]оаново|Іоанна|Іоана)|Трет[яє]\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанна|(?:послання\s*апостола\s*Ів|(?:Послання\s*І[во]|Ів))ана|[ИЙ]оаново|Іоанна|Іоана)|(?:3-?(?:тє|[ае])|III)\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанна|(?:послання\s*апостола\s*Ів|(?:Послання\s*І[во]|Ів))ана|[ИЙ]оаново|Іоанна|Іоана)|3\s*соборне\s*послання\s*св\.?\s*апостола\s*Іоанна|Tretje\s*poslannja\s*apostola\s*Ivana|(?:3\s*послання\s*апостола\s*Ів|(?:3\s*Послання\s*І[во]|3\s*Ів))ана|3\s*[ИЙ]оаново|3\s*Іоанна|3(?:\s*Іоана|John)|3\s*Ів))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Євангелі(?:я\s*від\s*(?:св\.?\s*І|І)вана|є\s*від\s*(?:св(?:\.\s*[ИЙ]оана|\s*[ИЙ]оана)|Івана))|J(?:evanhelije\s*vid\s*Ivana|ohn)|(?:Від\s*І[во]|Іо)ана|[ИЙ]оана|Івана|[ИЙ]оан|Ів|Ін))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Druhe\s*poslannja\s*apostola\s*Pavla\s*do\s*korynfjan|(?:(?:2-?(?:ге|[ае])|2)|II)\.\s*(?:послання\s*апостола\s*Павла\s*до\s*коринфян|(?:Послання\s*до\s*Коринт|(?:до\s*)?коринт|Коринф)ян|Коринтяни)|Друг[ае]\s*(?:послання\s*апостола\s*Павла\s*до\s*коринфян|(?:Послання\s*до\s*Коринт|(?:до\s*)?коринт|Коринф)ян|Коринтяни)|(?:2-?(?:ге|[ае])|II)\s*(?:послання\s*апостола\s*Павла\s*до\s*коринфян|(?:Послання\s*до\s*Коринт|(?:до\s*)?коринт|Коринф)ян|Коринтяни)|2\s*послання\s*апостола\s*Павла\s*до\s*коринфян|(?:2\s*Послання\s*до\s*Коринт|2\s*(?:до\s*)?коринт|2\s*Коринф)ян|2(?:\s*Коринтяни|Cor)|2\s*Кор))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Per[sš]e\s*poslannja\s*apostola\s*Pavla\s*do\s*korynfjan|(?:(?:1-?(?:ше|[ае])|I)|1)\.\s*(?:послання\s*апостола\s*Павла\s*до\s*коринфян|(?:Послання\s*до\s*Коринт|(?:до\s*)?коринт|Коринф)ян|Коринтяни)|Перш[ае]\s*(?:послання\s*апостола\s*Павла\s*до\s*коринфян|(?:Послання\s*до\s*Коринт|(?:до\s*)?коринт|Коринф)ян|Коринтяни)|(?:1-?(?:ше|[ае])|I)\s*(?:послання\s*апостола\s*Павла\s*до\s*коринфян|(?:Послання\s*до\s*Коринт|(?:до\s*)?коринт|Коринф)ян|Коринтяни)|1\s*послання\s*апостола\s*Павла\s*до\s*коринфян|(?:1\s*Послання\s*до\s*Коринт|1\s*(?:до\s*)?коринт|1\s*Коринф)ян|1(?:\s*Коринтяни|Cor)|1\s*Кор))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:2-?(?:ге|[ае])|2)|II)\.\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*солунян|апостола\s*Павла\s*до\s*солунян|до\s*(?:(?:фессалонікі[ий]ців|салонікі[ий]ців)|солунян))|фессалонікі[ий]ців|до\s*солунян|Солуньці|Солунян)|Друг[ае]\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*солунян|апостола\s*Павла\s*до\s*солунян|до\s*(?:(?:фессалонікі[ий]ців|салонікі[ий]ців)|солунян))|фессалонікі[ий]ців|до\s*солунян|Солуньці|Солунян)|(?:2-?(?:ге|[ае])|II)\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*солунян|апостола\s*Павла\s*до\s*солунян|до\s*(?:(?:фессалонікі[ий]ців|салонікі[ий]ців)|солунян))|фессалонікі[ий]ців|до\s*солунян|Солуньці|Солунян)|Druhe\s*poslannja\s*apostola\s*Pavla\s*do\s*solunjan|2(?:\s*послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*солунян|апостола\s*Павла\s*до\s*солунян|до\s*(?:(?:фессалонікі[ий]ців|салонікі[ий]ців)|солунян))|(?:(?:(?:\s*фессалонікі[ий]ців|(?:\s*Солуньці|Thess))|\s*Солунян)|\s*до\s*солунян))|2\s*Сол))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:1-?(?:ше|[ае])|I)|1)\.\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*солунян|апостола\s*Павла\s*до\s*солунян|до\s*(?:(?:фессалонікі[ий]ців|салонікі[ий]ців)|солунян))|фессалонікі[ий]ців|до\s*солунян|Солуньці|Солунян)|Перш[ае]\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*солунян|апостола\s*Павла\s*до\s*солунян|до\s*(?:(?:фессалонікі[ий]ців|салонікі[ий]ців)|солунян))|фессалонікі[ий]ців|до\s*солунян|Солуньці|Солунян)|(?:1-?(?:ше|[ае])|I)\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*солунян|апостола\s*Павла\s*до\s*солунян|до\s*(?:(?:фессалонікі[ий]ців|салонікі[ий]ців)|солунян))|фессалонікі[ий]ців|до\s*солунян|Солуньці|Солунян)|Per[sš]e\s*poslannja\s*apostola\s*Pavla\s*do\s*solunjan|1(?:\s*послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*солунян|апостола\s*Павла\s*до\s*солунян|до\s*(?:(?:фессалонікі[ий]ців|салонікі[ий]ців)|солунян))|(?:(?:(?:\s*фессалонікі[ий]ців|(?:\s*Солуньці|Thess))|\s*Солунян)|\s*до\s*солунян))|1\s*Сол))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:2-?(?:ге|[ае])|2)|II)\.\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Тимофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|Тимо(?:те[ий]|фі[юя]))|Друг[ае]\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Тимофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|Тимо(?:те[ий]|фі[юя]))|(?:2-?(?:ге|[ае])|II)\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Тимофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|Тимо(?:те[ий]|фі[юя]))|Druhe\s*poslannja\s*apostola\s*Pavla\s*do\s*Tymofija|2(?:\s*послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Тимофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|(?:\s*Тимо(?:те[ий]|фі[юя])|Tim))|2\s*Тим))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:1-?(?:ше|[ае])|I)|1)\.\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Тимофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|Тимо(?:те[ий]|фі[юя]))|Перш[ае]\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Тимофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|Тимо(?:те[ий]|фі[юя]))|(?:1-?(?:ше|[ае])|I)\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Тимофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|Тимо(?:те[ий]|фі[юя]))|Per[sš]e\s*poslannja\s*apostola\s*Pavla\s*do\s*Tymofija|1(?:\s*послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Тимофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|(?:\s*Тимо(?:те[ий]|фі[юя])|Tim))|1\s*Тим))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:2-?(?:ге|[ае])|2)|II)\.\s*(?:соборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|послання\s*апостола\s*Петра|послання\s*Петра|Петр(?:ово|а))|Друг[ае]\s*(?:соборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|послання\s*апостола\s*Петра|послання\s*Петра|Петр(?:ово|а))|(?:2-?(?:ге|[ае])|II)\s*(?:соборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|послання\s*апостола\s*Петра|послання\s*Петра|Петр(?:ово|а))|2(?:\s*соборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|(?:\s*послання\s*апостола\s*Петра|(?:\s*послання\s*Петра|(?:\s*Петрово|(?:\s*Петра|Pet)))))|Druhe\s*poslannja\s*apostola\s*Petra|2\s*Петр?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:1-?(?:ше|[ае])|I)|1)\.\s*(?:соборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|послання\s*апостола\s*Петра|послання\s*Петра|Петр(?:ово|а))|Перш[ае]\s*(?:соборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|послання\s*апостола\s*Петра|послання\s*Петра|Петр(?:ово|а))|(?:1-?(?:ше|[ае])|I)\s*(?:соборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|послання\s*апостола\s*Петра|послання\s*Петра|Петр(?:ово|а))|1(?:\s*соборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|(?:\s*послання\s*апостола\s*Петра|(?:\s*послання\s*Петра|(?:\s*Петрово|(?:\s*Петра|Pet)))))|Per[sš]e\s*poslannja\s*apostola\s*Petra|1\s*Петр?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
...
function peg$parse(input, options) {
  ...
  var peg$e18 = peg$classExpectation(["a", "а", "б"], false, true);
  var peg$e19 = peg$literalExpectation("глави", true);
  var peg$e20 = peg$literalExpectation("глава", true);
  var peg$e21 = peg$literalExpectation("гл", true);
  var peg$e22 = peg$literalExpectation("розділ", true);
  var peg$e23 = peg$literalExpectation("розд", true);
  var peg$e24 = peg$literalExpectation("вірш", true);
  var peg$e25 = peg$literalExpectation("і", true);
  ...
  var peg$e30 = peg$literalExpectation("title", false);
  ...
  var peg$e34 = peg$literalExpectation("the", false);
  var peg$e35 = peg$literalExpectation("book", false);
  var peg$e36 = peg$classExpectation(["(", "["], false, false);
  var peg$e37 = peg$classExpectation([")", "]"], false, false);
  var peg$e38 = peg$literalExpectation("", false);
  var peg$e39 = peg$literalExpectation(",000", false);
