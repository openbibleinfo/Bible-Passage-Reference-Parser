...
var grammar_options = {
  ab: /^[a-e](?!\p{L})/iu,
  and: /^(?:(?:och|jfr\.?)|&)/i,
  c_explicit: /^[\s*]*(?:kapitlen|kapitlet|kapitel|kap\.?)[\s*]*/i,
  ...
  range: /^[\s*]*(?:[\-–—]|till)+[\s*]*/i,
  sequence_eu: /^(?:[;/:&\-–—~\s*]|\.(?!\s*\.\s*\.)|(?:och|jfr\.?))+/i,
  sequence_us: /^(?:[,;/:&\-–—~\s*]|\.(?!\s*\.\s*\.)|(?:och|jfr\.?))+/i,
  space: /^[\s*]+/,
  title: /^[\s*]*rubrik(?!\p{L})[\s*]*/iu,
  v_explicit: /^[\s*]*(?:verser|v\.?)[\s*]*(?!\p{L})/iu
};
