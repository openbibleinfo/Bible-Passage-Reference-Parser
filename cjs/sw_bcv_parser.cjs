...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = String.raw`(?:Kwanza|I|1)\.?\s*`;
    this.second = String.raw`(?:Pili|II|2)\.?\s*`;
    this.third = String.raw`(?:Tatu|III|3)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|(?:taz|na)|hadi)`;
    this.range_only = String.raw`(?:[\u2013\u2014-]|hadi)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:K(?:itabu\s*cha\s*Kwanza\s*ch|wanz)a\s*Ezra|[1I]\.\s*Ezra|[1I]\s*Ezra|1Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Kitabu\s*cha\s*Pili\s*cha\s*Ezra|(?:Pili|(?:II|2)\.)\s*Ezra|(?:II|2)\s*Ezra|2Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Kitabu\s*cha\s*Pili\s*cha\s*Samueli|(?:Pili\s*Sam[uw]|(?:II|2)\.\s*Sam[uw]|(?:II|2)\s*Sam[uw])eli|Samueli\s*II|(?:Pili|(?:(?:II|2)\.|(?:II|2)))\s*Sam|2Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:K(?:itabu\s*cha\s*Kwanza\s*cha\s*Samueli|wanza\s*Sam[uw]eli|wanza\s*Sam)|(?:[1I]\.\s*Sam[uw]|[1I]\s*Sam[uw])eli|Samueli\s*I|(?:[1I]\.|[1I])\s*Sam|1Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Kitabu\s*cha\s*Pili\s*cha\s*Wafalme|(?:Pili|(?:(?:II|2)\.|(?:II|2)))\s*Wafalme|Wafalme\s*II|Pili\s*Fal|(?:II|2)\.\s*Fal|(?:II|2)\s*Fal|2Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:K(?:itabu\s*cha\s*Kwanza\s*cha\s*Wafalme|wanza\s*(?:Wafalme|Fal))|(?:[1I]\.|[1I])\s*Wafalme|Wafalme\s*I|[1I]\.\s*Fal|[1I]\s*Fal|1Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Pili\s*(?:Mambo\s*ya\s*Nyakati|Nya)|(?:II|2)\.\s*(?:Mambo\s*ya\s*Nyakati|Nya)|(?:II|2)\s*(?:Mambo\s*ya\s*Nyakati|Nya)|Mambo\s*ya\s*Nyakati\s*II|2Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Kwanza\s*(?:Mambo\s*ya\s*Nyakati|Nya)|[1I]\.\s*(?:Mambo\s*ya\s*Nyakati|Nya)|[1I]\s*(?:Mambo\s*ya\s*Nyakati|Nya)|Mambo\s*ya\s*Nyakati\s*I|1Chr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Waraka\s*wa\s*Kwanza\s*wa\s*Yohane|Barua\s*ya\s*Kwanza\s*ya\s*Yohane|Kwanza\s*Yohan[ae]|(?:Kwanza|(?:[1I]\.|[1I]))\s*Yoh|[1I]\.\s*Yohan[ae]|Yohane\s*I|[1I]\s*Yohan[ae]|1John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Waraka\s*wa\s*Pili\s*wa\s*Yohane|Barua\s*ya\s*Pili\s*ya\s*Yohane|Pili\s*Yohan[ae]|(?:II|2)\.\s*Yohan[ae]|(?:II|2)\s*Yohan[ae]|Yohane\s*II|(?:Pili|(?:(?:II|2)\.|(?:II|2)))\s*Yoh|2John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Waraka\s*wa\s*Tatu\s*wa\s*Yohane|Barua\s*ya\s*Tatu\s*ya\s*Yohane|(?:III|3)\.\s*Yohan[ae]|Tatu\s*Yohan[ae]|(?:III|3)\s*Yohan[ae]|Yohane\s*III|(?:(?:(?:III|3)\.|(?:III|3))|Tatu)\s*Yoh|3John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Injili\s*ya\s*Yohan[ae]|Yohan[ae]|John|Yoh))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Waraka\s*wa\s*Pili\s*kwa|(?:Pili|(?:(?:II|2)\.|(?:II|2))))\s*Wakorintho|Wa(?:raka\s*wa\s*Pili\s*kwa\s*Wakorinto|korintho\s*II)|Barua\s*ya\s*Pili\s*kwa\s*Wakorintho|(?:Pili|(?:(?:II|2)\.|(?:II|2)))\s*Wakorinto|(?:Pili\s*K|(?:(?:II|2)\.\s*K|(?:(?:II|2)\s*K|2C)))or))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Waraka\s*wa\s*Kwanza\s*kwa|(?:Kwanza|(?:[1I]\.|[1I])))\s*Wakorintho|Wa(?:raka\s*wa\s*Kwanza\s*kwa\s*Wakorinto|korintho\s*I)|Barua\s*ya\s*Kwanza\s*kwa\s*Wakorintho|(?:Kwanza|(?:[1I]\.|[1I]))\s*Wakorinto|(?:Kwanza\s*K|(?:[1I]\.\s*K|(?:[1I]\s*K|1C)))or))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Wa(?:raka\s*wa\s*Pili\s*kwa\s*Wathesalonik[ei]|thesalonike\s*II)|Barua\s*ya\s*Pili\s*kwa\s*Wathesalonike|(?:Pili|(?:(?:II|2)\.|(?:II|2)))\s*Wathesalonike|(?:Pili\s*The|(?:(?:II|2)\.\s*The|(?:(?:II|2)\s*The|2Thes)))s|Pili\s*The?|(?:II|2)\.\s*The?|(?:II|2)\s*The?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Wa(?:raka\s*wa\s*Kwanza\s*kwa\s*Wathesalonik[ei]|thesalonike\s*I)|Barua\s*ya\s*Kwanza\s*kwa\s*Wathesalonike|(?:Kwanza|(?:[1I]\.|[1I]))\s*Wathesalonike|(?:Kwanza\s*The|(?:[1I]\.\s*The|(?:1Thes|[1I]\s*The)))s|Kwanza\s*The?|[1I]\.\s*The?|[1I]\s*The?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Waraka\s*wa\s*Pili\s*kwa\s*Timotheo|Barua\s*ya\s*Pili\s*kwa\s*Timotheo|(?:Pili|(?:(?:II|2)\.|(?:II|2)))\s*Timotheo|Timotheo\s*II|(?:Pili|(?:(?:II|2)\.|(?:II|2)))\s*Tim|2Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Waraka\s*wa\s*Kwanza\s*kwa\s*Timotheo|Barua\s*ya\s*Kwanza\s*kwa\s*Timotheo|(?:Kwanza|(?:[1I]\.|[1I]))\s*Timotheo|(?:Kwanza|(?:[1I]\.|[1I]))\s*Tim|Timotheo\s*I|1Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Waraka\s*wa\s*Pili\s*wa\s*Petro|Barua\s*ya\s*Pili\s*ya\s*Petro|(?:Pili|(?:(?:II|2)\.|(?:II|2)))\s*Petro|(?:Pili|(?:(?:II|2)\.|(?:II|2)))\s*Pet|Petro\s*II|2Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Waraka\s*wa\s*Kwanza\s*wa\s*Petro|Barua\s*ya\s*Kwanza\s*ya\s*Petro|(?:Kwanza|(?:[1I]\.|[1I]))\s*Petro|(?:Kwanza|(?:[1I]\.|[1I]))\s*Pet|Petro\s*I|1Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Kitabu\s*cha\s*Wamakabayo\s*II|Pili\s*(?:Wamakabayo|Mak)|(?:II|2)\.\s*(?:Wamakabayo|Mak)|(?:II|2)\s*(?:Wamakabayo|Mak)|Wamakabayo\s*II|2Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Kitabu\s*cha\s*Wamakabayo\s*III|(?:III|3)\.\s*(?:Wamakabayo|Mak)|Tatu\s*(?:Wamakabayo|Mak)|(?:III|3)\s*(?:Wamakabayo|Mak)|Wamakabayo\s*III|3Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Kitabu\s*cha\s*Wamakabayo\s*IV|(?:IV|4)\.\s*(?:Wamakabayo|Mak)|Nne\s*(?:Wamakabayo|Mak)|(?:IV|4)\s*(?:Wamakabayo|Mak)|Wamakabayo\s*IV|4Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Kitabu\s*cha\s*)?Wamakabayo\s*I|Kwanza\s*(?:Wamakabayo|Mak)|[1I]\.\s*(?:Wamakabayo|Mak)|[1I]\s*(?:Wamakabayo|Mak)|1Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John", "Jonah"],
        testament: "on",
...
function peg$parse(input, options) {
  ...
  var peg$e19 = peg$literalExpectation("sura", false);
  var peg$e20 = peg$literalExpectation("mistari", false);
  var peg$e21 = peg$literalExpectation(":", false);
  var peg$e22 = peg$classExpectation(['"', "'"], false, false);
  var peg$e23 = peg$classExpectation([",", ";", "/", ":", "&", "-", "–", "—", "~"], false, false);
  var peg$e24 = peg$literalExpectation("taz", false);
  var peg$e25 = peg$literalExpectation("na", false);
  var peg$e26 = peg$classExpectation(["-", "–", "—"], false, false);
  var peg$e27 = peg$literalExpectation("hadi", false);
