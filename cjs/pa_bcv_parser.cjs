...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = String.raw`(?:ਪਹਿਲੀ|pahilī|1)\.?\s*`;
    this.second = String.raw`(?:ਦੂਜੀ|dūjī|2)\.?\s*`;
    this.third = String.raw`(?:ਤੀਜੀ|3)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|ਜਾਂ|-)`;
