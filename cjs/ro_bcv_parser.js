...
var grammar_options = {
  ab: /^(?:[a-e])(?!\p{L})/iu,
  and: /^(?:[şs]i|cf\.?|cp\.?|&)/i,
  c_explicit: /^[\s*]*(?:capitolele|capitolul|cap\.?)[\s*]*/i,
  ...
  range: /^[\s*]*(?:[\-–—]|-)+[\s*]*/i,
  sequence_eu: /^(?:[;/:&\-–—~\s*]|\.(?!\s*\.\s*\.)|[şs]i|cf\.?|cp\.?)+/i,
  sequence_us: /^(?:[,;/:&\-–—~\s*]|\.(?!\s*\.\s*\.)|[şs]i|cf\.?|cp\.?)+/i,
  space: /^[\s*]+/,
  title: /^[\s*]*(?:titlu)(?!\p{L})[\s*]*/iu,
  v_explicit: /^[\s*]*(?:versetul|versetele|versete|vers\.?|vs\.?|v\.?)[\s*]*(?!\p{L})/iu
};
