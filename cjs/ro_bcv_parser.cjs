...
var bcv_regexps = class {
  constructor() {
    ...
    this.range_and = String.raw`(?:[&\u2013\u2014-]|(?:[şs]i|cf|cp)|-)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:II\.?\s*Ezdra|\.?\s*Ezdra)|1(?:\.\s*Ezdra|(?:\s*Ezdra|Esd))|3\.?\s*Ezdra))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I[IV]\.?\s*Ezdra|2(?:\.\s*Ezdra|(?:\s*Ezdra|Esd))|4\.?\s*Ezdra))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Cartea\s*(?:a\s*doua\s*a\s*Regilor|II\s*a\s*(?:lui\s*Samuel|Regilor))|(?:II\.?\s*R|2\.?\s*R)egilor|(?:II\.?\s*Samu|2\.?\s*Samu)el|II(?:\.\s*Sam?|\s*Sam?)|2(?:\.\s*Sam?|\s*Sam?)|2Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Cartea\s*(?:[iî]nt[aâ]i\s*a\s*Regilor|I\s*a\s*(?:lui\s*Samuel|Regilor))|(?:1\.?\s*R|I\.?\s*R)egilor|(?:1\.?\s*Samu|I\.?\s*Samu)el|1(?:\.\s*Sam?|\s*Sam?)|I(?:\.\s*Sam?|\s*Sam?)|1Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Cartea\s*(?:a\s*patra|IV)\s*a\s*Regilor|II\s*a\s*[IÎ]mp[aă]ra[tţ]ilor|I(?:(?:I(?:\.\s*[IÎ]mp[aă]ra[tţ]|\s*[IÎ]mp[aă]ra[tţ])|I\.?\s*Reg)i|V\.?\s*Regi)|2(?:\.\s*[IÎ]mp[aă]ra[tţ]|\s*[IÎ]mp[aă]ra[tţ])i|II(?:\.\s*[IÎ]mp|\s*[IÎ]mp)|2\.?\s*Regi|4\.?\s*Regi|2(?:\.\s*[IÎ]mp|\s*[IÎ]mp)|2Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Cartea\s*(?:a\s*treia|III)\s*a\s*Regilor|I\s*a\s*[IÎ]mp[aă]ra[tţ]ilor|(?:1(?:\.\s*[IÎ]mp[aă]ra[tţ]|\s*[IÎ]mp[aă]ra[tţ])|I(?:\.\s*[IÎ]mp[aă]ra[tţ]|\s*[IÎ]mp[aă]ra[tţ]))i|(?:III|3)\.?\s*Regi|(?:1\.?\s*R|I\.?\s*R)egi|1(?:\.\s*[IÎ]mp|\s*[IÎ]mp)|I(?:\.\s*[IÎ]mp|\s*[IÎ]mp)|1Kgs))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Cartea\s*a\s*doua\s*Paralipomena|(?:II\.?\s*P|2\.?\s*P)aralipomena|II\.?\s*Cronicilor|(?:2\.\s*Cronicilo|2(?:\s*Cronicilo|Ch))r|II(?:\.\s*Cron(?:ici)?|\s*Cron(?:ici)?)|2(?:\.\s*Cron(?:ici)?|\s*Cron(?:ici)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Cartea\s*[iî]nt[aâ]i\s*Paralipomena|(?:1\.?\s*P|I\.?\s*P)aralipomena|(?:1\.\s*Cronicilo|1(?:\s*Cronicilo|Ch))r|I\.?\s*Cronicilor|1(?:\.\s*Cron(?:ici)?|\s*Cron(?:ici)?)|I(?:\.\s*Cron(?:ici)?|\s*Cron(?:ici)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
      ...
      },
      {
        osis: ["SgThree"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:C[aâ]ntarea\s*celor\s*trei\s*(?:tiner|evre)i|(?:Trei|3)\s*tineri|SgThree))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Song"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:1\.\s*Ioa|(?:1\s*Ioa|1(?:Joh|\s*I)))n|I\.?\s*Ioan))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:II\.?\s*Ioan|(?:2\.\s*Ioa|(?:2\s*Ioa|2(?:Joh|\s*I)))n))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:III\.?\s*Ioan|(?:3\.\s*Ioa|(?:3\s*Ioa|3(?:Joh|\s*I)))n))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:F(?:(?:apte(?:le)?\s*Apostolilor|\.?\s*Ap|\.?A)|ap(?:t(?:e(?:le)?)?)?)|Acts))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Rev"],
        testament: "n",
      ...
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:I(?:oa)?|Joh)n)(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Rom"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:II(?:\.\s*Co(?:r(?:inti?eni)?)?|\s*Co(?:r(?:inti?eni)?)?)|2(?:\.\s*Co(?:r(?:inti?eni)?)?|(?:\s*Co(?:r(?:inti?eni)?)?|Cor))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:\.\s*Co(?:r(?:inti?eni)?)?|(?:\s*Co(?:r(?:inti?eni)?)?|Cor))|I(?:\.\s*Co(?:r(?:inti?eni)?)?|\s*Co(?:r(?:inti?eni)?)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:II(?:\.\s*Tes(?:aloniceni)?|\s*Tes(?:aloniceni)?)|2(?:\.\s*Tes(?:aloniceni)?|(?:\s*Tes(?:aloniceni)?|Thess))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:\.\s*Tes(?:aloniceni)?|(?:\s*Tes(?:aloniceni)?|Thess))|I(?:\.\s*Tes(?:aloniceni)?|\s*Tes(?:aloniceni)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:II(?:\.\s*Tim(?:otei)?|\s*Tim(?:otei)?)|2(?:\.\s*Tim(?:otei)?|(?:\s*Tim(?:otei)?|Tim))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:\.\s*Tim(?:otei)?|(?:\s*Tim(?:otei)?|Tim))|I(?:\.\s*Tim(?:otei)?|\s*Tim(?:otei)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:II(?:\.\s*P(?:et(?:ru)?|t)|\s*P(?:et(?:ru)?|t))|2(?:\.\s*P(?:et(?:ru)?|t)|(?:\s*P(?:et(?:ru)?|t)|Pet))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:\.\s*P(?:et(?:ru)?|t)|(?:\s*P(?:et(?:ru)?|t)|Pet))|I(?:\.\s*P(?:et(?:ru)?|t)|\s*P(?:et(?:ru)?|t))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:II\.?\s*Macabei|2(?:\.\s*Macabei|(?:\s*Macabei|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:III\.?\s*Macabei|3(?:\.\s*Macabei|(?:\s*Macabei|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:IV\.?\s*Macabei|4(?:\.\s*Macabei|(?:\s*Macabei|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:\.\s*Macabei|(?:\s*Macabei|Macc))|I\.?\s*Macabei))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      }
    ];
  }
};
...
function peg$parse(input, options) {
  ...
  var peg$e19 = peg$literalExpectation("cap", false);
  var peg$e20 = peg$literalExpectation("itolele", false);
  var peg$e21 = peg$literalExpectation("itolul", false);
  var peg$e22 = peg$literalExpectation("v", false);
  var peg$e23 = peg$literalExpectation("ersetul", false);
  var peg$e24 = peg$literalExpectation("ersetele", false);
  var peg$e25 = peg$literalExpectation("ersete", false);
  ...
  var peg$e31 = peg$classExpectation(["ş", "s"], false, true);
  var peg$e32 = peg$literalExpectation("i", false);
  var peg$e33 = peg$literalExpectation("cf", false);
  var peg$e34 = peg$literalExpectation("cp", false);
  var peg$e35 = peg$classExpectation(["-", "–", "—"], false, false);
  var peg$e36 = peg$literalExpectation("titlu", false);
