...
var bcv_regexps = class {
  constructor() {
    ...
    // The `judul` has `[a-z]` instead of `\w` because it could be followed by a number.
    // [a-e] allows `1:1a`.
    this.escaped_passage = /(?:^|[^\x1e\x1f\p{L}\p{N}])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s.:,;\x1e\x1f&\(\)（）\[\]\\/"'\*=~\-–—]|judul(?![a-z])|bandingkan|sampai|pasal|ayat|dst|lih|bdk|[a-e](?!\w)|$)+)/giu;
    ...
    this.range_and = String.raw`(?:[&\u2013\u2014-]|(?:bandingkan|lih|bdk)|sampai)`;
    this.range_only = String.raw`(?:[\u2013\u2014-]|sampai)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Judg"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:H(?:(?:(?:akim-?haki|k)m|ak\.?-?hak)|ak)|Judg))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ruth"],
        testament: "o",
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:E(?:sdras|zra)\s*Yunani|(?:1\.|3)\s*Esdras|1\s*Esdras|1\s*Esd|(?:I\s*|1)Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Semuel\s*Yang\s*Kedua|2(?:\.\s*Samuel|\s*Samuel|Sam)|II\s*Sam|2(?:\s*Sam|Sa)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Semuel\s*Yang\s*Pertama|1(?:\.\s*Samuel|\s*Samuel|Sam)|1(?:\s*Sam|Sa)|I\s*Sam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
      ...
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tawarikh\s*Yang\s*Kedua|2(?:(?:\.\s*Tawarikh|\s*Tawarikh|\s*Tawh|Chr)|Taw)|II\s*Taw|2\s*Taw))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tawarikh\s*Yang\s*Pertama|1(?:(?:\.\s*Tawarikh|\s*Tawarikh|\s*Tawh|Chr)|Taw)|1\s*Taw|I\s*Taw))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Neh"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Nehem[iy]a|2\s*Ezra|Nehm?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1\s*Ezra|Ezra?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["GkEsth"],
        testament: "a",
      ...
      },
      {
        osis: ["SgThree"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Lagu\s*Pujian\s*Ket|T)iga\s*Pemuda|(?:Lagu\s*)?3\s*Pemuda|Lagu\s*Pemuda|SgThree|LagPuj))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Song"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:(?:(?:\.\s*Yohanes|\s*Yohanes|\s*Y(?:ahya|hn)|John)|\s*Yoh)|Yoh)|I\s*Yoh))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:2(?:(?:(?:\.\s*Yohanes|\s*Yohanes|\s*Y(?:ahya|hn)|John)|\s*Yoh)|Yoh)|II\s*Yoh))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:3(?:(?:(?:\.\s*Yohanes|\s*Yohanes|\s*Y(?:ahya|hn)|John)|\s*Yoh)|Yoh)|III\s*Yoh))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Y(?:(?:oh(?:ane)?s|ahya)|oh)|John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:2(?:\.?\s*Korintus|\s*Kor?)|II\s*Kor|2[CK]or))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:\.?\s*Korintus|\s*Kor?)|I\s*Kor|1[CK]or))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:2(?:(?:(?:\.\s*Tesalonika|\s*Tes(?:alonika|l))|\s*Tes)|Thess)|II\s*Tes))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:(?:(?:\.\s*Tesalonika|\s*Tes(?:alonika|l))|\s*Tes)|Thess)|I\s*Tes))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:2(?:(?:(?:\.\s*Timotius|\s*T(?:imotius|m))|\s*Tim)|Tim)|II\s*Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:(?:(?:\.\s*Timotius|\s*T(?:imotius|m))|\s*Tim)|Tim)|I\s*Tim))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:2(?:(?:(?:\.\s*Petrus|\s*P(?:etrus|tr))|\s*Pet)|Pet)|II\s*Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:(?:(?:\.\s*Petrus|\s*P(?:etrus|tr))|\s*Pet)|Pet)|I\s*Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:1(?:(?:\.\s*Makabe|\s*Makabe|Macc)|\s*Mak)|I\s*Mak))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      }
    ];
  }
};
...
function peg$parse(input, options) {
  ...
  var peg$e12 = peg$literalExpectation("dst", false);
  ...
  var peg$e19 = peg$literalExpectation("pasal", false);
  var peg$e20 = peg$literalExpectation("ayat", false);
  var peg$e21 = peg$literalExpectation(":", false);
  var peg$e22 = peg$classExpectation(['"', "'"], false, false);
  var peg$e23 = peg$classExpectation([",", ";", "/", ":", "&", "-", "–", "—", "~"], false, false);
  var peg$e24 = peg$literalExpectation("bandingkan", false);
  var peg$e25 = peg$literalExpectation("lih", false);
  var peg$e26 = peg$literalExpectation("bdk", false);
  var peg$e27 = peg$classExpectation(["-", "–", "—"], false, false);
  var peg$e28 = peg$literalExpectation("sampai", false);
  var peg$e29 = peg$literalExpectation("judul", false);
