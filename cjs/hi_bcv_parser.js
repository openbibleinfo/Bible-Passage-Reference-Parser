  ...
  constructor() {
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:शमुऐयल\s*की\s*२री\s*पुस्तक|2(?:(?:\.\s*(?:Shamooael|शमूएल)|\s*(?:Shamooael|शमूएल)|Sam)|\.?\s*शमू)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:शमुऐल\s*की\s*१ली\s*पुस्तक|1(?:(?:\.\s*(?:Shamooael|शमूएल)|\s*(?:Shamooael|शमूएल)|Sam)|\.?\s*शमू)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:राजाओ\s*का\s*विर्तान्त\s*२रा\s*भाग|2(?:(?:\.\s*(?:राजाओं|Raja)|\s*(?:राजाओं|Raja)|Kgs)|\.?\s*राजा)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:राजाओ\s*का\s*विर्तान्त\s*१ला\s*भाग्|1(?:(?:\.\s*(?:राजाओं|Raja)|\s*(?:राजाओं|Raja)|Kgs)|\.?\s*राजा)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:इतिहास\s*२रा\s*भाग|2(?:(?:\.\s*(?:Itihas|इतिहास)|\s*(?:Itihas|इतिहास)|Chr)|\.?\s*इति)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:इतिहास\s*१ला\s*भाग|1(?:(?:\.\s*(?:Itihas|इतिहास)|\s*(?:Itihas|इतिहास)|Chr)|\.?\s*इति)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
