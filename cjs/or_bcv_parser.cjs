...
var bcv_regexps = class {
  constructor() {
    ...
    this.match_end_split = /\d\W*title|\d\W*ff(?:[\s*]*\.)?|\d[\s*]*[ଖ](?!\w)|\x1e(?:[\s*]*[)\]\uff09])?|[\d\x1f]/gi;
    this.control = /[\x1e\x1f]/g;
    // These are needed for ranges outside of this class.
    this.first = String.raw`(?:ପ୍ରଥମ|1)\.?\s*`;
    this.second = String.raw`(?:ଦ୍ୱିତୀୟ|2)\.?\s*`;
    this.third = String.raw`(?:ତୃତୀୟ|3)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|and|ଠାରୁ)`;
    this.range_only = String.raw`(?:[\u2013\u2014-]|ଠାରୁ)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଆଦି(?:ପୁସ୍ତକ)?|Gen))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଯାତ୍ରା(?:\s*ପୁସ୍ତକ|ପୁସ୍ତକ)?|Exod))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bel"],
        testament: "a",
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଲେବୀୟ(?:\s*ପୁସ୍ତକ)?|Lev))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଗଣନା(?:\s*ପୁସ୍ତକ)?|Num))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Sir"],
        testament: "a",
      ...
      },
      {
        osis: ["Lam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଯିରିମିୟଙ୍କ\s*ବିଳାପ|Lam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["EpJer"],
        testament: "a",
      ...
      },
      {
        osis: ["Rev"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଯୋହନଙ୍କ\s*ପ୍ରତି\s*ପ୍ରକାଶିତ\s*ବାକ୍ୟ|Rev))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["PrMan"],
        testament: "a",
      ...
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଦ୍ୱିତୀୟ\s*ବିବରଣୀ?|ବିବରଣି|Deut))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଯିହୋଶୂୟଙ୍କର(?:\s*ପୁସ୍ତକ)?|Josh))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Judg"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ବିଗ୍ଭରକର୍ତ୍ତାମାନଙ୍କ\s*ବିବରଣ|Judg))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ruth"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଋତର\s*ବିବରଣ\s*ପୁସ୍ତକ|Ruth))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Esd"],
        testament: "a",
      ...
      },
      {
        osis: ["Isa"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଯ(?:ିଶାଇୟ(?:\s*ଭବିଷ୍ୟଦ୍ବକ୍ତାଙ୍କର\s*ପୁସ୍ତକ)?|[ାୀ]ଶାଇୟ)|ୟିଶାୟ|ୟଶାଇୟ|Isa))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ଶାମୁୟେଲଙ୍କ\s*ଦ୍ୱିତୀୟ\s*ପୁସ୍ତକ|ଦ୍ୱିତୀୟ\s*ଶାମୁୟେଲଙ|(?:ଦ୍ୱିତୀୟ|2\.?)\s*ଶାମୁୟେଲ|2(?:\.\s*ଶାମୁୟେଲଙ|(?:\s*ଶାମୁୟେଲଙ|Sam))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ଶାମୁୟେଲଙ୍କ\s*ପ୍ରଥମ\s*ପୁସ୍ତକ|ପ୍ରଥମ\s*ଶାମୁୟେଲଙ|(?:ପ୍ରଥମ|1\.?)\s*ଶାମୁୟେଲ|1(?:\.\s*ଶାମୁୟେଲଙ|(?:\s*ଶାମୁୟେଲଙ|Sam))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ରାଜାବଳୀର\s*ଦ୍ୱିତୀୟ\s*ପୁସ୍ତକ|ଦ୍ୱିତୀୟ\s*ରାଜାବଳୀର|(?:ଦ୍ୱିତୀୟ|2\.?)\s*ରାଜାବଳୀ|2(?:\.\s*ରାଜାବଳୀର|(?:\s*ରାଜାବଳୀର|Kgs))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ରାଜାବଳୀର\s*ପ୍ରଥମ\s*ପୁସ୍ତକ|ପ୍ରଥମ\s*ରାଜାବଳୀର|(?:ପ୍ରଥମ|1\.?)\s*ରାଜାବଳୀ|1(?:\.\s*ରାଜାବଳୀର|(?:\s*ରାଜାବଳୀର|Kgs))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ବଂଶାବଳୀର\s*ଦ୍ୱିତୀୟ\s*ପୁସ୍ତକ|ଦ୍ୱିତୀୟ\s*ବଂଶାବଳୀର|(?:ଦ୍ୱିତୀୟ|2\.?)\s*ବଂଶାବଳୀ|2(?:\.\s*ବଂଶାବଳୀର|(?:\s*ବଂଶାବଳୀର|Chr))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ବଂଶାବଳୀର\s*ପ୍ରଥମ\s*ପୁସ୍ତକ|ପ୍ରଥମ\s*ବଂଶାବଳୀର|(?:ପ୍ରଥମ|1\.?)\s*ବଂଶାବଳୀ|1(?:\.\s*ବଂଶାବଳୀର|(?:\s*ବଂଶାବଳୀର|Chr))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଏଜ୍ରା|Ezra))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Neh"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ନିହିମିୟାଙ୍କର(?:\s*ପୁସ୍ତକ)?|Neh))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["GkEsth"],
        testament: "a",
      ...
      },
      {
        osis: ["Esth"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଏଷ୍ଟର\s*ବିବରଣ|Esth))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Job"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଆୟୁବ(?:\s*ପୁସ୍ତକ)?|Job))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ps"],
        testament: "oa",
        testament_books: { "Ps": "oa" },
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଗ(?:ୀତି?ସଂହିତା|ାତସଂହିତା)|Ps))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["PrAzar"],
        testament: "a",
      ...
      },
      {
        osis: ["Prov"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ହିତୋପଦେଶ|Prov))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Eccl"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଉପଦେଶକ|Eccl))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["SgThree"],
        testament: "a",
      ...
      },
      {
        osis: ["Song"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ପରମଗୀତ|Song))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jer"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଯିରିମିୟ(?:\s*ଭବିଷ୍ୟଦ୍ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ)?|Jer))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezek"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଯିହିଜିକଲ(?:\s*ଭବିଷ୍ୟଦ୍ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ)?|Ezek))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Dan"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଦାନିୟେଲଙ(?:୍କ\s*ପୁସ୍ତକ)?|Dan))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hos"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ହୋଶ(?:େୟ(?:\s*ଭବିଷ୍ୟଦ୍ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ)?|ହେ)|Hos))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Joel"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଯୋୟେଲ(?:\s*ଭବିଷ୍ୟଦ୍ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ)?|Joel))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Amos"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଆମୋଷ(?:\s*ଭବିଷ୍ୟଦ୍ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ)?|Amos))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Obad"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଓବଦିଅ(?:\s*ଭବିଷ୍ୟଦ୍ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ)?|Obad))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jonah"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଯୂନସ(?:\s*ଭବିଷ୍ୟଦ୍ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ)?|Jonah))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mic"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ମ(?:ୀଖା(?:\s*ଭବିଷ୍ୟଦ୍ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ)?|ିଖା)|Mic))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Nah"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ନାହୂମ(?:\s*ଭବିଷ୍ୟଦ୍ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ)?|Nah))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hab"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ହବକ(?:୍କୂକ(?:\s*ଭବିଷ୍ୟଦ୍ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ)?|[ୁୂ]କ୍)|Hab))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Zeph"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ସିଫନିୟ(?:\s*ଭବିଷ୍ୟଦ୍ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ)?|Zeph))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hag"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ହାଗୟ(?:\s*ଭବିଷ୍ୟଦ୍ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ)?|Hag))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Zech"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଯିଖରିୟ(?:\s*ଭବିଷ୍ୟଦ୍ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ)?|Zech))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mal"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ମଲାଖି(?:\s*ଭବିଷ୍ୟଦ୍ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ)?|Mal))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Matt"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ମାଥିଉ(?:\s*ଲିଖିତ\s*ସୁସମାଗ୍ଭର)?|Matt))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mark"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ମାର୍କ(?:\s*ଲିଖିତ\s*ସୁସମାଗ୍ଭର)?|Mark))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Luke"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଲୂକ(?:\s*ଲିଖିତ\s*ସୁସମାଗ୍ଭର)?|Luke))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ଯୋହନଙ୍କ\s*ପ୍ରଥମ\s*ପତ୍ର|ପ୍ରଥମ\s*ଯୋହନଙ|1(?:\.\s*ଯୋହନଙ|(?:\s*ଯୋହନଙ|John))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ଯୋହନଙ୍କ\s*ଦ୍ୱିତୀୟ\s*ପତ୍ର|ଦ୍ୱିତୀୟ\s*ଯୋହନଙ|2(?:\.\s*ଯୋହନଙ|(?:\s*ଯୋହନଙ|John))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ଯୋହନଙ୍କ\s*ତୃତୀୟ\s*ପତ୍ର|ତୃତୀୟ\s*ଯୋହନଙ|3(?:\.\s*ଯୋହନଙ|(?:\s*ଯୋହନଙ|John))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଯୋହନ(?:\s*ଲିଖିତ\s*ସୁସମାଗ୍ଭର)?|John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ପ୍ରେରିତ(?:ମାନଙ୍କ\s*କାର୍ଯ୍ୟର\s*ବିବରଣ)?|Acts))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Rom"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ରୋମୀୟଙ୍କ(?:\s*ପ୍ରତି\s*ପତ୍ର)?|Rom))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:କରିନ୍ଥୀୟଙ୍କ\s*ପ୍ରତି\s*ଦ୍ୱିତୀୟ\s*ପତ୍ର|ଦ୍ୱିତୀୟ\s*କରିନ୍ଥୀୟଙ୍କ|(?:ଦ୍ୱିତୀୟ|2\.?)\s*କରିନ୍ଥୀୟ|2(?:\.\s*କରିନ୍ଥୀୟଙ୍କ|(?:\s*କରିନ୍ଥୀୟଙ୍କ|Cor))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:କରିନ୍ଥୀୟଙ୍କ\s*ପ୍ରତି\s*ପ୍ରଥମ\s*ପତ୍ର|ପ୍ରଥମ\s*କରିନ୍ଥୀୟଙ୍କ|(?:ପ୍ରଥମ|1\.?)\s*କରିନ୍ଥୀୟ|1(?:\.\s*କରିନ୍ଥୀୟଙ୍କ|(?:\s*କରିନ୍ଥୀୟଙ୍କ|Cor))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଗାଲାତୀୟଙ୍କ(?:\s*ପ୍ରତି\s*ପତ୍ର)?|Gal))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Eph"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଏଫିସୀୟଙ୍କ(?:\s*ପ୍ରତି\s*ପତ୍ର)?|Eph))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Phil"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଫିଲିପ୍ପୀୟଙ୍କ(?:\s*ପ୍ରତି\s*ପତ୍ର)?|Phil))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Col"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:କଲସୀୟଙ୍କ(?:\s*ପ୍ରତି\s*ପତ୍ର)?|Col))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ଥେସଲନୀକୀୟଙ୍କ\s*ପ୍ରତି\s*ଦ୍ୱିତୀୟ\s*ପତ୍ର|ଦ୍ୱିତୀୟ\s*ଥେସଲନୀକୀୟଙ|2(?:\.\s*ଥେସଲନୀକୀୟଙ|(?:\s*ଥେସଲନୀକୀୟଙ|Thess))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ଥେସଲନୀକୀୟଙ୍କ\s*ପ୍ରତି\s*ପ୍ରଥମ\s*ପତ୍ର|ପ୍ରଥମ\s*ଥେସଲନୀକୀୟଙ|1(?:\.\s*ଥେସଲନୀକୀୟଙ|(?:\s*ଥେସଲନୀକୀୟଙ|Thess))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ତୀମଥିଙ୍କ\s*ପ୍ରତି\s*ଦ୍ୱିତୀୟ\s*ପତ୍ର|ଦ୍ୱିତୀୟ\s*ତୀମଥିଙ୍କ|2(?:\.\s*ତୀମଥିଙ୍କ|(?:\s*ତୀମଥିଙ୍କ|Tim))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ତୀମଥିଙ୍କ\s*ପ୍ରତି\s*ପ୍ରଥମ\s*ପତ୍ର|ପ୍ରଥମ\s*ତୀମଥିଙ୍କ|1(?:\.\s*ତୀମଥିଙ୍କ|(?:\s*ତୀମଥିଙ୍କ|Tim))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ତୀତସଙ୍କ(?:\s*ପ୍ରତି\s*ପତ୍ର)?|Titus))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Phlm"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଫିଲୀମୋନଙ୍କ(?:\s*ପ୍ରତି\s*ପତ୍ର)?|Phlm))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Heb"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଏବ୍ରୀ|Heb))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jas"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଯାକୁବଙ୍କ(?:\s*ପତ୍ର)?|Jas))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ପିତରଙ୍କ\s*ଦ୍ୱିତୀୟ\s*ପତ୍ର|ଦ୍ୱିତୀୟ\s*ପିତରଙ|2(?:\.\s*ପିତରଙ|(?:\s*ପିତରଙ|Pet))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ପ(?:ିତରଙ୍କ\s*ପ୍ରଥମ\s*ପତ୍ର|୍ରଥମ\s*ପିତରଙ)|1(?:\.\s*ପିତରଙ|(?:\s*ପିତରଙ|Pet))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଯିହୂଦାଙ୍କ(?:\s*ପତ୍ର)?|Jude))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Tob"],
        testament: "a",
...
function peg$parse(input, options) {
  ...
  var peg$e18 = peg$classExpectation(["ଖ"], false, true);
  ...
  var peg$e26 = peg$literalExpectation("ଠାରୁ", true);
