...
var bcv_regexps = class {
  constructor() {
    ...
    // The `overskrift` has `[a-z]` instead of `\w` because it could be followed by a number.
    // [a-e] allows `1:1a`.
    this.escaped_passage = /(?:^|[^\x1e\x1f\p{L}\p{N}])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s.:,;\x1e\x1f&\(\)（）\[\]\\/"'\*=~\-–—]|overskrift(?![a-z])|kapittelet|kapitlene|kapittel|kapitler|kapitel|vers|kap|ff|og|cf|jf|f|-|v|[a-e](?!\w)|$)+)/giu;
    ...
    this.first = String.raw`(?:Første|1)\.?\s*`;
    this.second = String.raw`(?:Andre|2)\.?\s*`;
    this.third = String.raw`(?:Tredje|3)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|(?:og|cf|jf)|-)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Første\s*Mos(?:ebok)?|1\.\s*Mos(?:ebok)?|1\s*Mos(?:ebok)?|Gen(?:esis)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:An(?:dre\s*Mos(?:ebok)?|nen\s*Mosebok)|2\.?\s*Mosebok|2\.?\s*Mos|Exod))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bel"],
        testament: "a",
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tredje\s*Mos(?:ebok)?|3\.\s*Mos(?:ebok)?|Lev(?:iticus)?|3\s*Mos(?:ebok)?))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fjerde\s*Mos(?:ebok)?|4\.\s*Mos(?:ebok)?|4\s*Mos(?:ebok)?|Num))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Sir"],
        testament: "a",
      ...
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Femte\s*Mos(?:ebok)?|5\.\s*Mos(?:ebok)?|5\s*Mos(?:ebok)?|Deut))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
      ...
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Første\s*Es(?:dras|ra)|(?:Tredje|3\.?)\s*Esra|1\.\s*Es(?:dras|ra)|1\s*Es(?:dras|ra)|1Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Andre\s*Esdras|Fjerde\s*Esra|(?:Andre|2\.?)\s*Esra|2(?:\.\s*Esdras|(?:\s*Esdras|Esd))|4\.\s*Esra|4\s*Esra))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Andre\s*Sam(?:uel(?:sbok)?)?|2(?:\.\s*Sam(?:uel(?:sbok)?)?|(?:\s*Sam(?:uel(?:sbok)?)?|Sam))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Første\s*Sam(?:uel(?:s(?:bok)?)?)?|1(?:\.\s*Sam(?:uel(?:s(?:bok)?)?)?|(?:\s*Sam(?:uel(?:s(?:bok)?)?)?|Sam))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Andre\s*Kong(?:ebok)?|2(?:\.\s*Kong(?:ebok)?|(?:\s*Kong(?:ebok)?|Kgs))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Første\s*Kong(?:ebok)?|1(?:\.\s*Kong(?:ebok)?|(?:\s*Kong(?:ebok)?|Kgs))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Andre\s*Krø(?:n(?:ikebok)?)?|2(?:\.\s*Krø(?:n(?:ikebok)?)?|(?:\s*Krø(?:n(?:ikebok)?)?|Chr))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Første\s*Krø(?:n(?:ikebok)?)?|1(?:\.\s*Krø(?:n(?:ikebok)?)?|(?:\s*Krø(?:n(?:ikebok)?)?|Chr))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(E(?:sra(?:s\s*bok|s?)|zra))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Neh"],
        testament: "o",
      ...
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Johannes’\s*første\s*brev|Første\s*Johannes|1(?:\.\s*Johannes|(?:\s*Johannes|John))|(?:Første|1\.?)\s*Joh))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Johannes’\s*andre\s*brev|Andre\s*Johannes|2(?:\.\s*Johannes|(?:\s*Johannes|John))|(?:Andre|2\.?)\s*Joh))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Johannes’\s*tredje\s*brev|Tredje\s*Johannes|3(?:\.\s*Johannes|(?:\s*Johannes|John))|(?:Tredje|3\.?)\s*Joh))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Evangeliet\s*etter\s*Johannes|Joh(?:(?:annesevangeliet|n)|(?:annes)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
      ...
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Paulus’\s*andre\s*brev\s*til\s*korinterne|Andre\s*(?:korinterbrev|Korinter)|(?:Andre|2\.?)\s*Korintierne|2(?:\.\s*(?:korinterbrev|Korinter)|(?:\s*(?:korinterbrev|Korinter)|Cor))|(?:Andre|2\.?)\s*Kor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Paulus’\s*første\s*brev\s*til\s*korinterne|Første\s*(?:korinterbrev|Korinter)|(?:Første|1\.?)\s*Korintierne|1(?:\.\s*(?:korinterbrev|Korinter)|(?:\s*(?:korinterbrev|Korinter)|Cor))|(?:Første|1\.?)\s*Kor))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
      ...
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Paulus’\s*andre\s*brev\s*til\s*tessalonikerne|Andre\s*tessalonikerbrev|(?:Andre|2\.?)\s*Tessalonikerne|2(?:\.\s*tessalonikerbrev|(?:\s*tessalonikerbrev|Thess))|Andre\s*Tess(?:aloniker)?|2(?:\.\s*Tess(?:aloniker)?|\s*Tess(?:aloniker)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Paulus’\s*første\s*brev\s*til\s*tessalonikerne|Første\s*tessalonikerbrev|(?:Første|1\.?)\s*Tessalonikerne|Første\s*Tess(?:aloniker)?|1(?:\.\s*tessalonikerbrev|(?:\s*tessalonikerbrev|Thess))|1(?:\.\s*Tess(?:aloniker)?|\s*Tess(?:aloniker)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Paulus’\s*andre\s*brev\s*til\s*Timoteus|Andre\s*Timoteusbrev|2(?:\.\s*Timoteusbrev|(?:\s*Timoteusbrev|Tim))|Andre\s*Tim(?:oteus)?|2(?:\.\s*Tim(?:oteus)?|\s*Tim(?:oteus)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Paulus’\s*første\s*brev\s*til\s*Timoteus|Første\s*Timoteusbrev|Første\s*Tim(?:oteus)?|1(?:\.\s*Timoteusbrev|(?:\s*Timoteusbrev|Tim))|1(?:\.\s*Tim(?:oteus)?|\s*Tim(?:oteus)?)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
      ...
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Peters\s*andre\s*brev|(?:Andre|2\.?)\s*Petersbrev|Andre\s*Pet(?:ers?)?|2(?:\.\s*Pet(?:ers?)?|\s*Pet(?:ers?)?)|2Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Peters\s*første\s*brev|(?:Første|1\.?)\s*Petersbrev|Første\s*Pet(?:ers?)?|1(?:\.\s*Pet(?:ers?)?|\s*Pet(?:ers?)?)|1Pet))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
      ...
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Andre\s*Makk(?:abeerbok)?|2(?:\.\s*Makk(?:abeerbok)?|(?:\s*Makk(?:abeerbok)?|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tredje\s*Makk(?:abeerbok)?|3(?:\.\s*Makk(?:abeerbok)?|(?:\s*Makk(?:abeerbok)?|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fjerde\s*Makk(?:abeerbok)?|4(?:\.\s*Makk(?:abeerbok)?|(?:\s*Makk(?:abeerbok)?|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Første\s*Makk(?:abeerbok)?|1(?:\.\s*Makk(?:abeerbok)?|(?:\s*Makk(?:abeerbok)?|Macc))))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      }
    ];
  }
};
...
function peg$parse(input, options) {
  ...
  var peg$e21 = peg$literalExpectation("ittelet", false);
  var peg$e22 = peg$literalExpectation("ittel", false);
  var peg$e23 = peg$literalExpectation("itler", false);
  var peg$e24 = peg$literalExpectation("itlene", false);
  var peg$e25 = peg$literalExpectation("itel", false);
  ...
  var peg$e31 = peg$literalExpectation("og", false);
  var peg$e32 = peg$literalExpectation("cf", false);
  var peg$e33 = peg$literalExpectation("jf", false);
  var peg$e34 = peg$classExpectation(["-", "–", "—"], false, false);
  var peg$e35 = peg$literalExpectation("overskrift", false);
  ...
  var peg$e39 = peg$literalExpectation("the", false);
  var peg$e40 = peg$literalExpectation("book", false);
  var peg$e41 = peg$classExpectation(["(", "["], false, false);
  var peg$e42 = peg$classExpectation([")", "]"], false, false);
  var peg$e43 = peg$literalExpectation("", false);
  var peg$e44 = peg$literalExpectation(",000", false);
