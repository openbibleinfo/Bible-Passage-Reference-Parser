...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = String.raw`(?:पहिल|1)\.?\s*`;
    this.second = String.raw`(?:दुसरे|2)\.?\s*`;
    this.third = String.raw`(?:तिसरे|3)\.?\s*`;
    this.range_and = String.raw`(?:[&\u2013\u2014-]|and|to)`;
    this.range_only = String.raw`(?:[\u2013\u2014-]|to)`;
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["Gen"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:उत्पत(?:्त)?ि|utpatti|Gen))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Exod"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:nirgam|निर्गम|Exod))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Bel"],
        testament: "a",
      ...
      },
      {
        osis: ["Lev"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:lew[iī]y|लेवीय|Lev))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Num"],
        testament: "o",
      ...
      },
      {
        osis: ["Lam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:wil[aā]pg[iī]t|विलापगीत|Lam))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["EpJer"],
        testament: "a",
      ...
      },
      {
        osis: ["Rev"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:yoh[aā]n[aā]l[aā]\s*ǳʰ[aā]lele\s*praka[tṭ][iī]kara[nṇ]|योहानाला\s*झालेले\s*प्रकटीकरण|praka[tṭ][iī]kara[nṇ]|प्रकटीकरण|Rev))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["PrMan"],
        testament: "a",
      ...
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:anuw[aā]d|अनुवाद|Deut))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:yaho[sŝ]aw[aā]|यहोशवा|Josh))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Judg"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:शास्ते|[sŝ][aā]ste|Judg))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ruth"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ruth|r[uū]tʰ|रूथ))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Esd"],
        testament: "a",
      ...
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:दुसरे\s*शमुवेल|2(?:(?:\s*[sŝ]amuwel|Sam)|\s*शमुवेल)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:पहिले\s*शमुवेल|1(?:(?:\s*[sŝ]amuwel|Sam)|\s*शमुवेल)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:दुसरे\s*राजे|2(?:(?:\s*r[aā]ǳe|Kgs)|\s*राजे)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Kgs"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:पहिले\s*राजे|1(?:(?:\s*r[aā]ǳe|Kgs)|\s*राजे)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:दुसरे\s*इतिहास|2(?:(?:\s*itih[aā]s|Chr)|\s*इतिहास)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:पहिले\s*इतिहास|1(?:(?:\s*itih[aā]s|Chr)|\s*इतिहास)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:e(?:dz|ǳ)r[aā]|एज्रा|Ezra))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Neh"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:nahemy[aā]|नहेम्या|Neh))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["GkEsth"],
        testament: "a",
      ...
      },
      {
        osis: ["Esth"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:एस्तेर|ester|Esth))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Job"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:(?:[iī]y|J)ob|[इई]योब))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ps"],
        testament: "oa",
        testament_books: { "Ps": "oa" },
        regexp: /(?:^|(?<=[^\p{L}]))((?:स्त(?:्रोत्रसंहिता|ोत्र(?:संहिता)?)|stotrasa[mṃ]hit[aā]|Ps))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["PrAzar"],
        testament: "a",
      ...
      },
      {
        osis: ["Prov"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:नीतिसूत्रें?|n[iī]tis[uū]tre|Prov))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Eccl"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:upade[sŝ]ak|उपदेशक|Eccl))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["SgThree"],
        testament: "a",
      ...
      },
      {
        osis: ["Song"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:g[iī]tratna|गीतरत्न|Song))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jer"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:yirmay[aā]|यिर्मया|Jer))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezek"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:yahe(?:dz|ǳ)kel|यहेज्केल|Ezek))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Dan"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:दानीएल(?:्र)?|d[aā]n[iī]el|Dan))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hos"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ho[sŝ]ey|होशेय|Hos))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Joel"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:[Jy]oel|योएल))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Amos"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:[Aaā]mos|[अआ]मोस))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Obad"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:obadʰ[aā]|ओब(?:द्य|ध)ा|Obad))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jonah"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Jonah|yon[aā]|योना))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mic"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:m[iī]kʰ[aā]|मीखा|Mic))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Nah"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:nah[uū]m|नहूम|Nah))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hab"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:habakk[uū]k|हबक्कूक?|Hab))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Zeph"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:sapʰany[aā]|सफन्या|Zeph))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hag"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:h[aā]ggay|हाग्गय|Hag))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Zech"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:jakʰary[aā]|जख[रऱ]्या|Zech))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mal"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:mal[aā]kʰ[iī]|मलाखी|Mal))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Matt"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:mattay[aā]ne\s*lihilele\s*[sŝ]ubʰavartam[aā]n|मत्तय(?:ाने(?:\s*लिहिलेले\s*शुभवर्तमान)?)?|mattay[aā]ne|Matt))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mark"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:m[aā]rk[aā]ne\s*lihilele\s*[sŝ]ubʰavartam[aā]n|मार्क(?:ाने(?:\s*लिहिलेले\s*शुभवर्तमान)?)?|m[aā]rk[aā]ne|Mark))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Luke"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:l[uū]k[aā]ne\s*lihilele\s*[sŝ]ubʰavartam[aā]n|लूक(?:ा(?:ने(?:\s*लिहिलेले\s*शुभवर्तमान)?)?)?|l[uū]k[aā]ne|Luke))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:yoh[aā]n[aā]ce[mṃ]\s*pahile\s*patra|योहानाचें\s*पहिले\s*पत्र|1(?:\s*(?:yoh[aā]n[aā]ce[mṃ]|योहानाच)|John)|1\s*योहान))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:yoh[aā]n[aā]ce[mṃ]\s*dusre\s*patra|योहानाचें\s*दुसरे\s*पत्र|2(?:\s*(?:yoh[aā]n[aā]ce[mṃ]|योहानाच)|John)|2\s*योहान))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:yoh[aā]n[aā]ce[mṃ]\s*tisre\s*patra|योहानाचें\s*तिसरे\s*पत्र|3(?:\s*(?:yoh[aā]n[aā]ce[mṃ]|योहानाच)|John)|3\s*योहान))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:yoh[aā]n[aā]ne\s*lihilele\s*[sŝ]ubʰavartam[aā]n|योहान(?:ाने(?:\s*लिहिलेले\s*शुभवर्तमान)?)?|yoh[aā]n[aā]ne|John))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:प्रेषितांची(?:ं\s*कृत्यें?|\s*कृत्यें)|pre[sš]it[aā][mṃ]c[iī][mṃ]\s*kr̥tye[mṃ]|Acts))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Rom"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:पौलाचे\s*रोमकरांस\s*पत्र|romkar[aā][mṃ]s\s*patra|रोमकरांस\s*पत्र|romkar[aā][mṃ]s|रोमकरांस|रोमकंरास|Rom))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:पौलाचे\s*करिंथकरांस\s*दूसरे\s*पत्र|kari[mṃ]tʰkar[aā][mṃ]s\s*dusre\s*patra|करिंथकरांस\s*दुसरे\s*पत्र|2(?:\s*(?:kari[mṃ]tʰkar[aā][mṃ]s|करिंथकरांस)|Cor)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:पौलाचे\s*करिंथकरांस\s*पहिले\s*पत्र|kari[mṃ]tʰkar[aā][mṃ]s\s*pahile\s*patra|करिंथकरांस\s*पहिले\s*पत्र|1(?:\s*(?:kari[mṃ]tʰkar[aā][mṃ]s|करिंथकरांस)|Cor)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:पौलाचे\s*गलतीकरांस\s*पत्र|galat[iī]kar[aā][mṃ]s\s*patra|गलतीकरांस\s*पत्र|galat[iī]kar[aā][mṃ]s|गलतीकरांस|Gal))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Eph"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:पौलाचे\s*इफिसकरांस\s*पत्र|ipʰiskar[aā][mṃ]s\s*patra|इफिसकरांस\s*पत्र|ipʰiskar[aā][mṃ]s|इफिसकरांस|Eph))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Phil"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:पौलाचे\s*फिलिप्पैकरांस\s*पत्र|pʰilippaikar[aā][mṃ]s\s*patra|फिलिप्पैकरांस\s*पत्र|pʰilippaikar[aā][mṃ]s|फिलिप्पैकरांस|Phil))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Col"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:पौलाचे\s*कलस्सैकरांस\s*पत्र|kalassaikar[aā][mṃ]s\s*patra|कलस्सैकरांस\s*पत्र|kalassaikar[aā][mṃ]s|कलस्सैकरांस|कलसैकरांस|Col))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:पौलाचे\s*थेस्सलनीकाकरांस\s*दुसरे\s*पत्र|tʰessalan[iī]k[aā]kar[aā][mṃ]s\s*dusre\s*patra|थेस्सलनीकाकरांस\s*दुसरे\s*पत्र|2(?:\s*(?:tʰessalan[iī]k[aā]kar[aā][mṃ]s|थेस्सलनीकाकरांस)|Thess)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Thess"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:पौलाचे\s*थेस्सलनीकाकरांस\s*पहिले\s*पत्र|tʰessalan[iī]k[aā]kar[aā][mṃ]s\s*pahile\s*patra|थेस्सलनीकाकरांस\s*पहिले\s*पत्र|1(?:\s*(?:tʰessalan[iī]k[aā]kar[aā][mṃ]s|थेस्सलनीकाकरांस)|Thess)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:पौलाचे\s*तीमथ्थाला\s*दुसरे\s*पत्र|t[iī]matʰtʰ[aā]l[aā]\s*dusre\s*patra|तीमथ्थाला\s*दुसरे\s*पत्र|2(?:\s*(?:t[iī]matʰtʰ[aā]l[aā]|तीमथ्थाला)|Tim)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:पौलाचे\s*तीमथ्याला\s*पहिले\s*पत्र|t[iī]matʰtʰ[aā]l[aā]\s*pahile\s*patra|तीमथ्थाला\s*पहिले\s*पत्र|1(?:\s*(?:t[iī]matʰtʰ[aā]l[aā]|तीमथ्[थय]ाला)|Tim)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:पौलाचे\s*तीताला\s*पत्र|t[iī]t[aā]l[aā]\s*patra|तीताला\s*पत्र|t[iī]t[aā]l[aā]|तीताला|Titus))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Phlm"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:पौलाचे\s*फिलेमोनाला\s*पत्र|pʰilemon[aā]l[aā]\s*patra|फिलेमोनाला\s*पत्र|pʰilemon[aā]l[aā]|फिलेमोना(?:ला)?|Phlm))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Heb"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ibr[iī]\s*lok[aā][mṃ]s\s*patra|इब्री(?:\s*लोकांस(?:\s*पत्र)?)?|ibr[iī]\s*lok[aā][mṃ]s|Heb))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jas"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:y[aā]kob[aā]ce[mṃ]\s*patra|याकोब(?:ाचें(?:\s*पत्र)?)?|y[aā]kob[aā]ce[mṃ]|Jas))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:petr[aā]ce[mṃ]\s*dusre\s*patra|प(?:ेत्र|ौल)ाचें\s*दुसरे\s*पत्र|2(?:\s*(?:पेत्राचें|petr[aā]ce[mṃ])|Pet)|2\s*पेत्र))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:petr[aā]ce[mṃ]\s*pahile\s*patra|पेत्राचें?\s*पहिले\s*पत्र|1(?:\s*(?:पेत्राचें|petr[aā]ce[mṃ])|Pet)|1\s*पेत्र))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:yah[uū]d[aā]ce[mṃ]\s*patra|यहूदा(?:चें(?:\s*पत्र)?)?|yah[uū]d[aā]ce[mṃ]|Jude))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Tob"],
        testament: "a",
