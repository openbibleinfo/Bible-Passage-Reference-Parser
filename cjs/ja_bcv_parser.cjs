...
var bcv_regexps = class {
  constructor() {
    ...
    this.first = String.raw`一\.?\s*`;
    this.second = String.raw`二\.?\s*`;
    this.third = String.raw`三\.?\s*`;
...
function peg$parse(input, options) {
  ...
  var peg$e19 = peg$literalExpectation("章", true);
  var peg$e20 = peg$literalExpectation("節", true);
